	...
	if(roootElement) 
	{
		if(roootElement.className=="Outline")
		{
			...
			if(targetElement.style.display=="none")
			{
				...
				roootElement.src="http://localhost/assets/tree/tree/ofolder.gif";
				//roootElement.src=sImagePathPrefix+"assets/tree/tree/tree/ofolder.gif";
			}
			else
			{
				targetElement.style.display="none";
				roootElement.src="http://localhost/assets/tree/tree/folder.gif";
...
function OnClickOutline(imgRootPath,iId,page_ac)
{
	if (page_img[iId] && page_img[page] && page >= 1 && page != iId) //收合前一個系統
	{
		...
		srcElement2.src="http://localhost/assets/tree/tree/folder.gif";
	}
	...
	if(srcElement.className=="Outline"){
		...
		if(targetElement.style.display =="none"){
			targetElement.style.display="";
			srcElement.src="http://localhost/assets/tree/tree/ofolder.gif";
			//srcElement.src=imgRootPath+"assets/tree/tree/tree/ofolder.gif";
			if (page_img[iId]) page = iId;
			
		}else{
			targetElement.style.display="none";
			srcElement.src="http://localhost/assets/tree/tree/folder.gif";
	...
	{
		document.getElementById('abgne_fade_pic').innerHTML = '<img src="http://localhost/assets/tree/flowpng2/'+page_img[page]+'" style="padding:5px" id="ad" width="495" height="500" usemap="#Map'+page+'" style="padding-top:5px"/>'; //顯示主圖
