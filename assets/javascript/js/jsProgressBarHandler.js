  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'percentImage.png',			// boxImage : image around the progress bar
			barImage	: 'percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
