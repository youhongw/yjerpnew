...
class Cmsq12a_model extends CI_Model {
	...
	function selbrowse($num,$offset)   //查詢 table 表所有資料
      {            
	    $this->db->select('mm001, mm002, mm003, mm004, create_date');
        $this->db->from('cmsmm');
	...
	//	$this->db->like('title', 'match', 'after'); 
	    ...
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mm001';  //檢查排序欄位是否在 table 內
	    $query = $this->db->select('mm001, mm002, mm003, mm004 ,create_date')
	                      ->from('cmsmm')
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " mm001, mm002, mm003, mm004, mm005, mm006, mm007, mm008, mm009, mm010, create_date FROM `cmsmm` ";
	...
	function delmutif()   //選取刪除多筆 
     ...
     function ajaxcmsq12a($seg1)    //ajax 查詢一筆 顯示用 請購公司
        { 	              
