...
class Cmsq15a_model extends CI_Model {
	...
	function __construct()
	  ...
	  { 
	   ...
	   function searchd2($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (全部)型態
	  { 
	    $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	    $sort_columns = array('mr001', 'mr002', 'mr003', 'mr004', 'mr005', 'create_date');
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mr001';  //檢查排序欄位是否在 table 內
	   ...
	   function searchd5($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (全部)線別
	  { 
	    $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	    $sort_columns = array('mr001', 'mr002', 'mr003', 'mr004', 'mr005', 'create_date');
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mr001';  //檢查排序欄位是否在 table 內
	   ...
	   function searchd6($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (全部)其他
	  { 
	    $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	    $sort_columns = array('mr001', 'mr002', 'mr003', 'mr004', 'mr005', 'create_date');
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mr001';  //檢查排序欄位是否在 table 內
	    ...
	    function search2($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (部份條件)型態
	  { 
	...
	//	$this->db->like('title', 'match', 'after'); 
	    ...
	    return $ret;
	      ...
	      function search5($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (部份條件)線別
	  { 
	    $seq4 = trim($this->uri->segment(4));    //欄位
	//	 $seq6 = trim($this->uri->segment(7)); //輸入資料
	//	if ($this->uri->segment(4) == "mb002") { $seq6 = $this->uri->segment(6); }
	...
	//	$this->db->like('title', 'match', 'after'); 
	    ...
	    return $ret;
	      ...
	      function search6($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料 (部份條件)其他
	  { 
	    $seq4 = trim($this->uri->segment(4));    //欄位
	//	 $seq6 = trim($this->uri->segment(7)); //輸入資料
	//	if ($this->uri->segment(4) == "mb002") { $seq6 = $this->uri->segment(6); }
