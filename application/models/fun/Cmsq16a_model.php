...
class Cmsq16a_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " mo001, mo002, mo003, mo004, mo005, mo006, mo007, mo008, mo009, mo010, create_date FROM `cmsmo` ";
	...
	function filterf1($limit, $offset , $sort_by  , $sort_order)    //篩選多筆        
	  {    
	    ...
	    $this->db->select('mo001, mo002, mo003, mo004, create_date');
	    $this->db->from('invma');
	...
	function excelnewf()           //轉excel檔,一筆以上
	    ...
	    $seq4=$this->input->post('mo004c'); 
	    $sql = " SELECT mo001,mo002,mo003,mo004,mo005,mo006,create_date FROM invma WHERE mo001 >= '$seq1'  AND mo001 <= '$seq2' AND mo002 >= '$seq3' AND mo002 <= '$seq4' "; 
	...
	function printfd()           //印明細表一筆以上
	    ...
	    $seq3=$this->input->post('mo003c'); 
	    $seq4=$this->input->post('mo004c'); 
	    $sql = " SELECT * FROM invma WHERE mo001 >= '$seq1'  AND mo001 <= '$seq2' AND mo002 >= '$seq3' AND mo002 <= '$seq4' "; 
            $query = $this->db->query($sql);
	    $ret['rows'] = $query->result();
	...
	function delmutif()   //選取刪除多筆 
     ...
     function ajaxcmsq16a($seg1)    //ajax 查詢一筆 顯示用 銀行名稱
        { 	              
	  ...
	  function ajaxcmsq16a1($seg1)    //ajax 查詢一筆 顯示用 銀行名稱
        { 	              
	  ...
	  function ajaxcmsq16a2($seg1)    //ajax 查詢一筆 顯示用 銀行名稱
        { 	              
