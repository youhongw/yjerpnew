...
class Cmsq17a_model extends CI_Model {
	...
	function __construct()
	    ...
	    $this->db->order_by('ms001 asc, ms002 asc');    //排序  單欄以上 asc 由小至大 desc預設由大至小
	...
	//	$array = array('ms001' => '1', 'ms002 >=' => $seq6, 'ms002 <=' => $seq6 );
	//	$this->db->like('title', 'match', 'after'); 
	    ...
	    $ret['rows'] = $query->get()->result();
	     ...
	     $array = array('ms001' => '1', 'ms002' => $seq6 );
	    $query = $this->db->select('COUNT(*) as count', FALSE)  //筆數查詢,如果設為FALSE不會使用反引號保護你的字段或者表名
	                      ->from('cmsms')
						   ->like($seq4, $seq6, 'after');  
					//	  ->where('ms001','1');
