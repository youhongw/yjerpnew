...
class Cmsq11a_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " ma001, ma002, ma003, ma004, ma005, ma006, ma007, ma008, ma009, ma010, create_date FROM `taxma` ";
	...
	function delmutif()   //選取刪除多筆 
     ...
     function ajaxcmsq11a($seg1)    //ajax 查詢一筆 顯示用 請購公司
        { 	              
