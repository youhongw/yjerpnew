...
class Admq04a_model extends CI_Model {
	...
	function excelnewf()           //轉excel檔,一筆以上
	    ...
	    $seq4=$this->input->post('me004c'); 
	    $sql = " SELECT me001,me002,me003,me004,create_date FROM admme WHERE me001 >= '$seq1'  AND me001 <= '$seq2' AND me002 >= '$seq3' AND me002 <= '$seq4' "; 
	...
	function printfd()           //印明細表一筆以上
	    ...
	    $seq3=$this->input->post('me003c'); 
	    $seq4=$this->input->post('me004c'); 
	    $sql = " SELECT * FROM admme WHERE me001 >= '$seq1'  AND me001 <= '$seq2' AND me002 >= '$seq3' AND me002 <= '$seq4' "; 
            $query = $this->db->query($sql);
	    $ret['rows'] = $query->result();
