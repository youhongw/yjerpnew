...
class Admq10a_model extends CI_Model {
	...
	function selbrowse($num,$offset)   //查詢 table 表所有資料
      {            
	    $this->db->select('mf001, mf002, mf003, mf004,  create_date');
        $this->db->from('admmf');
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " mf001, mf002, mf003, mf004, create_date FROM `admmf` ";
	...
	function excelnewf()           //轉excel檔,一筆以上
	    ...
	    $seq4=$this->input->post('mf004c'); 
	    $sql = " SELECT mf001,mf002,mf003,mf004,create_date FROM admmf WHERE mf001 >= '$seq1'  AND mf001 <= '$seq2' AND mf002 >= '$seq3' AND mf002 <= '$seq4' "; 
	...
	function printfd()           //印明細表一筆以上
	    ...
	    $seq3=$this->input->post('mf003c'); 
	    $seq4=$this->input->post('mf004c'); 
	    $sql = " SELECT * FROM admmf WHERE mf001 >= '$seq1'  AND mf001 <= '$seq2' AND mf002 >= '$seq3' AND mf002 <= '$seq4' "; 
            $query = $this->db->query($sql);
	    $ret['rows'] = $query->result();
	...
	function updatef()   //更改一筆
	    ...
	    $this->db->where('mf002', $mf002);
            $this->db->update('admmf',$data);                   //更改一筆
	...
	function ajaxadmq10a($seg1)    //ajax 查詢一筆 顯示用 程式代號
          { 	              
