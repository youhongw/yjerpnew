...
class Taxq02a_model extends CI_Model {
	...
	function selbrowse($num,$offset)   //查詢 table 表所有資料
      {            
	    $this->db->select('mb001, mb002, mb003, mb004, mb005, mb006, mb007, mb008, mb009, create_date');
        $this->db->from('taxmb');
	...
	function search($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料
	  { 
	    ...
	    $sort_columns = array('mb001', 'mb002', 'mb003', 'mb004', 'mb005', 'mb006', 'mb007', 'mb008', 'mb009','create_date');
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mb001';  //檢查排序欄位是否在 table 內
	    $query = $this->db->select('mb001, mb002, mb003, mb004, mb005, mb006, mb007, mb008, mb009, create_date')
	                      ->from('taxmb')
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " mb001, mb002, mb003, mb004, mb005, mb006, mb007, mb008, mb009,  create_date FROM `taxmb` ";
	...
	function delmutif()   //選取刪除多筆 
      ...
      function ajaxtaxq02a($seg1)    //ajax 查詢一筆 不更新網頁 廠別 
          { 	              
