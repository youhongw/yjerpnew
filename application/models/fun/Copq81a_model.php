...
class Copq81a_model extends CI_Model {
	...
	function search($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料
	  { 
	    ...
	    $query = $this->db->select('ma001, ma002, ma003, ma004, ma005, ma006,ma008,ma013,ma014,ma031,ma038,ma027,ma016,ma085,ma201,ma202,create_date')
	                      ->from('copma')
    ...
    function ajaxcopq81a($seg1)    //ajax 查詢一筆 不更新網頁 供應商 
          { 	              
	    ...
	    if ($query->num_rows() > 0) 
		 {
          ...
          {
               $result=$row->ma002.';'.$row->ma201.';'.$row->ma202;
            }
		   return $result;   
		 }
	  }  
