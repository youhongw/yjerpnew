...
class Posq02a_model extends CI_Model {
	...
	function selbrowse($num,$offset)   //查詢 table 表所有資料
      {            
	    $this->db->select('ma001, ma002, ma003, ma004, ma005, ma006, ma007, ma008, ma009, ma010, create_date');
        $this->db->from('posma');
	...
	function search($limit, $offset, $sort_by, $sort_order)     //欄位表頭排序流覽資料
	  { 
	    ...
	    $sort_columns = array('ma001', 'ma002', 'ma003', 'ma004', 'ma005', 'ma006', 'ma007', 'ma008', 'ma009', 'ma010','create_date');
	    $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'ma001';  //檢查排序欄位是否在 table 內
	    $query = $this->db->select('ma001, ma002, ma003, ma004, ma005, ma006, ma007, ma008, ma009, ma010, create_date')
	                      ->from('posma')
	...
	function findf($limit, $offset, $sort_by, $sort_order)    //查詢多筆進階查詢 mysql 
	  ...
	  //$seq5='';$seq51='';$seq7='';$seq71='';		  
	    ...
	    $seq1 = " ma001, ma002, ma003, ma004, ma005, ma006, ma007, ma008, ma009, ma010, create_date FROM `posma` ";
	...
	function delmutif()   //選取刪除多筆 
      ...
      function ajaxposq02a($seg1)    //ajax 查詢一筆 不更新網頁 門市 
          { 	              
