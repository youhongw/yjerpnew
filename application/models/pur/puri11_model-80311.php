...
class Puri11_model extends CI_Model {
	...
	function selone1($seg1)    
        {
	      $this->db->where('ti001', $this->input->post('purq04a35'));
    ...
    function selone1d($seg1)    
        {
	      $this->db->where('tj001', $this->input->post('purq04a35'));
	...
	function insertf()    //新增一筆 檔頭  purti
		...
		//	 if ($this->input->post('ti018')!='1') {$ti019=round($this->input->post('ti019'));}
		     $ti001=$this->input->post('purq04a35');
	     ...
	     $data = array( 
		         ...
		         'ti004' => $this->input->post('purq01a'),
				 'ti005' => $this->input->post('cmsq02a'),
		         'ti006' => $this->input->post('cmsq06a'),
                 ...
                 'ti014' => substr($this->input->post('ti014'),0,4).substr($this->input->post('ti014'),5,2).substr(rtrim($this->input->post('ti014')),8,2),		
				 ...
				 'ti023' =>  substr($this->input->post('ti023'),0,4).substr($this->input->post('ti023'),5,2).substr(rtrim($this->input->post('ti023')),8,2),
                 ...
                 'ti030' => $this->input->post('cmsq21a1'),
				 'ti031' => $this->input->post('ti031'),
				 'ti032' => $this->input->post('ti032')
                 
                );
         
	      $exist = $this->puri11_model->selone1($this->input->post('purq04a35'),$this->input->post('ti002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		// 新增明細 purtj
				//		$this->db->flush_cache(); 
            // 新增明細 purtj  主檔 purti 重計算合計金額 數量
			    $ti011=0;$ti015=0;$ti028=0;$ti029=0;$ti022b=0;				
			    $n = '0';
				$tj003='1000';
		
		    echo var_dump($_POST['order_product'][  $n  ]['tj004']);exit;
		if (!isset($_POST['order_product'][  $n  ]['tj004']) ) { $n='250'; }  
		  //  echo var_dump($_POST['order_product'][  $n  ]['tj004']);exit;
		...
		//	while ($_POST['order_product'][  $n  ]['tj004']) {		
		    while (isset($_POST['order_product'][  $n  ]['tj004'])) {
			   ...
			   $data_array = array( 
		         ...
		         'modi_date' => '',
		         'flag' => 0,
                 'tj001' => $this->input->post('purq04a35'),
				 ...
				 'tj035' =>  $_POST['order_product'][ $n  ]['tj035']
				 
                );   
						 
	     // $exist = $this->puri11_model->selone1d($this->input->post('purq04a34'),$this->input->post('ti002'));
		  if ($_POST['order_product'][  $n  ]['tj004']!='') {
		  $this->db->insert('purtj', $data_array); }
		      $ti011=$ti011+$_POST['order_product'][ $n  ]['tj030'];
			  $ti015=$ti015+$_POST['order_product'][ $n  ]['tj031'];
			  $ti028=$ti028+$_POST['order_product'][ $n  ]['tj032'];
			  $ti029=$ti029+$_POST['order_product'][ $n  ]['tj033'];
			  $ti022b=$ti022b+$_POST['order_product'][ $n  ]['tj009'];
		  //庫存增加減少
			 $tj004=$_POST['order_product'][ $n  ]['tj004'];
			 $tj011=$_POST['order_product'][ $n  ]['tj011'];
			 $tj009=$_POST['order_product'][ $n  ]['tj009'];
			 $exista = $this->puri11_model->selone2d($tj004,$tj011);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
         ...
         $sql = " UPDATE invmc set mc007=mc007-'$tj009' WHERE mc001 = '$tj004'  AND mc002 = '$tj011'  "; 
		 $query = $this->db->query($sql);	} 
			...
			//重新計算貨款 purti
		  $sql = " UPDATE purti set ti011='$ti011',ti015='$ti015',ti028='$ti028',ti029='$ti029',ti022='$ti022b' WHERE ti001 = '$ti001'  AND ti002 = '$ti002'  "; 
		 $query = $this->db->query($sql);		   
	...
	function printfd()          
        {
		  ...
		  FROM purti as a, purtj as b WHERE ti001=tj001 and ti002=tj002 and  ti001 >= '$seq1'  AND ti001 <= '$seq2' AND ti002 >= '$seq3'  AND ti002 <= '$seq4'  "; 
          $query = $this->db->query($sql);
	      $ret['rows'] = $query->result();
	...
	function updatef()   
		...
		//	while ($_POST['order_product'][  $n  ]['tj004']) {
			while (isset($_POST['order_product'][  $n  ]['tj004'])) {
			 ...
			 $tj011=$_POST['order_product'][ $n  ]['tj011'];
			 $tj009=$_POST['order_product'][ $n  ]['tj009'];
			 $tj009a=$_POST['order_product'][ $n  ]['tj009a'];
			 $exista = $this->puri11_model->selone2d($tj004,$tj011);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
         ...
         $sql = " UPDATE invmc set mc007=mc007-'$tj016'+'$tj009a' WHERE mc001 = '$tj004'  AND mc002 = '$tj011'  "; 
		 $query = $this->db->query($sql);	} 
			  }
			 $mtj003 = (int) $tj003+10;
			 $tj003 =  (string)$mtj003;
	...
	$sql95 =" update purtd as c,(select tj016,tj017,tj018,td015,td016,tj009 from purtj as b,purtd as c
	   ...
	   foreach ($query82->result() as $row)
			...
			while (isset($tj004[$i])) {
                        ...
                        $vtj011=$tj011[$i];
                        $vtj009=$tj009[$i];
         $sql83 = " UPDATE invmc set mc007=mc007+'$vtj009' WHERE mc001 = '$vtj004'  AND mc002 = '$vtj011'  "; 
