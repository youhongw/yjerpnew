...
class puri09_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq1 = "tg001, tg002, tg003, tg004, tg005, tg006,tg007,tg08,tg010,tg011,tg012,tg019,tg020, create_date FROM `purtg` ";
        ...
        if ($seq7!='') {$seq9=" ORDER BY ".$seq7;$seq33=$seq7;}
         $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	     $sort_columns = array('tg001', 'tg002', 'tg003', 'tg004', 'tg005', 'tg006','tg007','tg008','tg010','tg011','tg012','tg019','tg020','create_date');
	     $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'tg001';  //檢查排序欄位是否在 table 內
	     $query = $this->db->select('tg001, tg002, tg003, tg004, tg005, tg006,tg007,tg008,tg010,tg011,tg012,tg019,tg020, create_date')
	                       ->from('purtg')
		                   ->where($seq32)
			               ->order_by($seq33)
			              //->order_by($sort_by, $sort_order)
	...
	function insertf()    //新增一筆 檔頭  purtg
		...
		// 新增明細 purth
			    ...
			    $n = '0';
				$th003='1000';
		//	while (($_POST['order_product'][  $n  ]['th004']) > '0' ) {
		if (!isset($_POST['order_product'][  $n  ]['th004'])) {
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
		    if ($query->num_rows() == 1) 
		       {
				...
				$tg041=$row->tg041;$tg042=$row->tg042;$tg043=$row->tg043;
			endforeach;
		       }   
	        ...
	        $data = array( 
				   ...
				   'tg037' => $tg037,'tg038' => $tg038,'tg039' => $tg039,'tg040' => $tg040,'tg041' => $tg041,'tg042' => $tg042,'tg043' => $tg043				   				   
                   );
	...
	function printfd()          
        {
		  ...
		  $seq3=$this->input->post('tg002o');    
	      $seq4=$this->input->post('tg002c');
	      $sql = " SELECT * FROM purtg WHERE tg001 >= '$seq1'  AND tg001 <= '$seq2' AND tg002 >= '$seq3'  AND tg002 <= '$seq4'  "; 
          $query = $this->db->query($sql);
	      $ret['rows'] = $query->result();
	...
	function printfc()   
      {           
          $this->db->select('a.* ,c.mq002 AS tg001disp, d.mf002 AS tg005disp, e.mb002 AS tg010disp, f.mv002 AS tg011disp,h.mb007 AS th017disp,
		   i.ma002 AS tg027disp,g.ma002 AS tg004disp,g.ma014 AS tg004disp1,g.ma013 AS tg004disp2,g.ma008 AS tg004disp3,g.ma009 AS tg004disp4,g.ma051 AS tg004disp5,
		  b.company, b.creator, b.usr_group, b.create_date, b.modifier, b.modi_date, b.flag, b.th001, b.th002, b.th003, b.th004, b.th005,
		  b.th006, b.th007,b.th008,b.th009,b.th010, b.th011, b.th012, b.th013, b.th014,b.th015,b.th016,b.th017,b.th020,b.th021,b.th022,b.th025,b.th027');
		 
        $this->db->from('purtg as a');	
        $this->db->join('purth as b', 'a.tg001 = b.th001  and a.tg002=b.th002 ','left');		
		$this->db->join('cmsmq as c', 'a.tg001 = c.mq001 and c.mq003="33" ','left');
		$this->db->join('cmsmf as d', 'a.tg005 = d.mf001 ','left');
	    $this->db->join('cmsmb as e', 'a.tg010 = e.mb001 ','left');
		$this->db->join('cmsmv as f ', 'a.tg011 = f.mv001 and f.mv022 = " " ','left');
        $this->db->join('purma as g', 'a.tg004 = g.ma001 ','left');	
        $this->db->join('purmb as h', 'b.th004 = h.mb001 and a.tg004 = h.mb002 and a.tg005 = h.mb003 ','left');
		$this->db->join('cmsma as i', 'a.tg027 = i.ma001 ','left');		
