...
class Bomr04_model extends CI_Model {
	...
	function printfd()          
		...
		b.md005,b.md006,b.md007,b.md008,b.md009,b.md011,b.md012,b.md017,b.md018,c.mb002 as c_mb002,c.mb003 as c_mb003,c.mb025 as c_mb025,d.mb001,
		d.mb002,d.mb003,d.mb025,d.mb057,d.mb058,d.mb059,d.mb060');
		
        $this->db->from('bommc as a');
        $this->db->join('bommd as b', 'b.md001 = a.mc001 ','left');	//bom
		$this->db->join('invmb as c', 'a.mc001 = c.mb001 ','left');	//品號1
		$this->db->join('invmb as d', 'b.md003 = d.mb001 ','left');	//品號2
		$this->db->where('b.md003 ', $seq1); 
	   // $this->db->where('a.mc001 <=', $seq2); 
		...
		$head_col = array('md003','mb002','mb003','mb025','md004','md005');
		$ret_head=array();
		...
		$body_col = array('md001','md002','md004','md005','md006','md007','md008','md009','md011','md012'
		,'md017','md018','mc004','c_mb002','c_mb003','c_mb025','mb025','mb057','mb058','mb059','mb060');
		$ret_body=array();
		$num_count = 0;
