...
class Bomi02_model extends CI_Model {
	...
	function search($limit, $offset, $sort_by, $sort_order)     
	    { 
	     ...
	     $query = $this->db->select('a.mc001, b.mb002 as mc001disp, b.mb003 as mc001disp1, b.mb004 as mc001disp2,  a.mc004,a.create_date')
	                       ->from('bommc as a')
	...
	function filterf1($limit, $offset , $sort_by  , $sort_order)          
	    {    
	      ...
	      $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	      $sort_columns = array('mc001', 'mc002', 'mc003', 'mc004', 'mc012', 'mc013','mc016','create_date');
          $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'mc001';  //檢查排序欄位是否為 table
	      $this->db->select('mc001, mc002, mc003, mc004,b.mb002 as mc001disp,b.mb003 as mc001disp1,b.mb004 as mc001disp2, mc005, mc006,mc007,mc010,mc008,mc010, a.create_date');
	      $this->db->from('bommc as a');
	...
	function insertf()    //新增一筆 檔頭  bommc
		...
		// 新增明細 bommd
		     $n = '0';
				$md002='1000';
			if (!isset($_POST['order_product'][  $n  ]['md003']) ) { $n='15'; }  
			 //   $n = '0';
