...
class Bomr05_model extends CI_Model {
	...
	function get_bom_list_out($temp_list){
		...
		$sql = "select a.md001,a.md002,a.md003,a.md004,a.md006,a.md016,b.mb002,b.mb003,b.mb025 from bommd as a,invmb as b  where a.md003=b.mb001 and a.md003 = '".$temp_list."' order by a.md001,a.md002 ";
	//	$result = mysql_query($sql);
	...
	function get_bom_list($temp_list)          //get_bom_list  遞廻$m_count,$base_bom_list,$row_temp,$vmd003
    {
		...
		$sql = "select a.md001,a.md002,a.md003,a.md004,a.md006,a.md016,b.mb002,b.mb003,b.mb025 from bommd as a,invmb as b  where a.md003=b.mb001 and a.md003 = '".$temp_list['mb001']."' order by a.md001,a.md002 ";
		//$result = mysql_query($sql);
		$result = $this->db->query($sql);
		$count_temp = 0;
