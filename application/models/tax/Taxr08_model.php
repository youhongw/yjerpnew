...
class Taxr08_model extends CI_Model {
	...
	function insertf()    //新增一筆 檔頭  coptg
		...
		//	 if ($this->input->post('me018')!='1') {$me019=round($this->input->post('me019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->taxr08_model->selone1($this->input->post('copq03a23'),$this->input->post('me002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->taxr08_model->selone1d($this->input->post('copq03a23'),$this->input->post('me002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->taxr08_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->taxr08_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $exist = $this->taxr08_model->selone2($this->input->post('me001c'),$this->input->post('me002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
	...
	function printfd()          
        {
		  ...
		  $seq1=$this->input->post('cmsi11');   //公司
			 $seq2=substr($this->input->post('dateo'),0,4).substr($this->input->post('dateo'),5,2);
			 $seq3=substr($this->input->post('datec'),0,4).substr($this->input->post('datec'),5,2);
	        //刪除401計算當 taxmh  1071128
		   $this->db->where('mh001', $seq1);
		   $this->db->where('mh002', $seq2);
		   $this->db->delete('taxmh'); 
		   //申報公司
		   $sql1 = "INSERT INTO taxmh (mh001,mh002,mh003,mh004,mh005,mh006,mh007,mh008,mh009) 
		           select ma001,$seq2,$seq3,ma002,ma005,ma003,ma004,ma006,ma007 from taxma as a
		            WHERE a.ma001='$seq1'  "; 
		  $this->db->query($sql1); 
           //銷項1,2 
			 $sql2 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='31' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh601=c.mc013,b.mh602=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql2);		  
	      //銷項5,6 
			 $sql3 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='35' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh605=c.mc013,b.mh606=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql3);
          //銷項9,10 
			 $sql4 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='32' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh609=c.mc013,b.mh610=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql4);	
         //銷項13,14 
			 $sql5 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='36' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh613=c.mc013,b.mh614=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql5);
         //銷項17,18 
			 $sql6 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='33' and mc004<='34'  and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh617=c.mc013,b.mh618=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql6);	
          //合計21,22 
			 $sql7 =" update taxmh set mh621=mh601+mh605+mh609+mh613-mh617, mh622=mh602+mh606+mh610+mh614-mh618
                  where   mh001='$seq1' and mh002='$seq2' 
			      " ; 
			 $this->db->query($sql7);
          //銷售額總計 
			 $sql8 =" update taxmh set mh625=mh621+mh622
                  where  mh001='$seq1' and mh002='$seq2' 
			      " ; 
			 $this->db->query($sql8);
          //+++++++++++++++++++++++++++++++++++++++++++++++++1071129			 
          //進項(費)28,29 
			 $sql11 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='25' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh628=c.mc013,b.mh629=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql11);	
         //進項(固)30,31 
			 $sql12 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='25' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh630=c.mc013,b.mh629=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql12);
         //進項(費)32,33 
			 $sql13 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='21' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh632=c.mc013,b.mh633=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql13);	
         //進項(固)34,35 
			 $sql14 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='21' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh634=c.mc013,b.mh635=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql14);	
         //進項(費)36,37 
			 $sql15 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='22' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh636=c.mc013,b.mh637=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql15);	
         //進項(固)38,39 
			 $sql16 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='22' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh638=c.mc013,b.mh639=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql16);	
         //進項(費)78,79 
			 $sql17 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='28' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh678=c.mc013,b.mh679=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql17);	
         //進項(固)80,81 
			 $sql18 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='28' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh680=c.mc013,b.mh681=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql18);
          //進項(費)40,41 
			 $sql19 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='22' and mc004<='23' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh640=c.mc013,b.mh641=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql19);	
         //進項(固)42,43 
			 $sql20 =" update taxmh b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='22' and mc004<='23' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mh642=c.mc013,b.mh643=c.mc011
               where b.mh001=c.mc001 and b.mh002=c.mc002  " ; 
			 $this->db->query($sql20);
           //合計44,46 43 47
			 $sql21=" update taxmh set mh644=mh628+mh632+mh636+mh678+mh640,
                            		   mh646=mh630+mh634+mh638+mh680+mh642,
									   mh643=mh629+mh633+mh637+mh679+mh641,
									   mh647=mh631+mh635+mh639+mh681+mh643
                  where   mh001='$seq1' and mh002='$seq2' 
			      " ; 
			 $this->db->query($sql21);
           //進項總合計48,49
			 $sql22=" update taxmh set mh648=mh644+mh643,
                            		   mh649=mh646+mh647
                  where   mh001='$seq1' and mh002='$seq2' 
			      " ; 
			 $this->db->query($sql22);	
          //進口免稅貨物73 taxme購買國外勞務74 taxme
			 $sql23 =" update taxmh b,(select me001,me002,sum(me017) as me017,sum(me018) as me018,
              sum(me013) as me013,sum(me009) as me009 from taxme a where  me001='$seq1' and me002='$seq2' 
			   group by me001,me002 
                ) c
               set b.mh673=c.me017,b.mh674=c.me018,b.mh691=c.me013,b.mh692=c.me009
               where b.mh001=c.me001 and b.mh002=c.me002  " ; 
			 $this->db->query($sql23);
           //銷項特種 
		    $sql31 =" update taxmh b,(select me001,me002,sum(me025) as me025,sum(me026) as me026,
              sum(me027) as me027,sum(me028) as me028,sum(me029) as me029,sum(me030) as me030, 
			  sum(me033) as me033,sum(me034) as me034,sum(me035) as me035,sum(me036) as me036,
			  sum(me037) as me037
			  from taxme a where  me001='$seq1' and me002='$seq2' 
			   group by me001,me002 
                ) c
               set b.mh652=c.me025,b.mh653=c.me026,b.mh654=c.me027,b.mh655=c.me028,
			       b.mh684=c.me029,b.mh685=c.me030,b.mh660=c.me033,b.mh661=c.me034,
				   b.mh662=c.me035,b.mh663=c.me036,b.mh664=c.me037
               where b.mh001=c.me001 and b.mh002=c.me002  " ; 
			 $this->db->query($sql31);
         	//特種 合計65,66
			 $sql22=" update taxmh set mh665=mh652+mh654+mh684+mh656+mh660+mh662-mh663,
                            		   mh666=mh653+mh655+mh685+mh657+mh661-mh664
                  where   mh001='$seq1' and mh002='$seq2' 
			      " ; 
			 $this->db->query($sql22);			 
		 //列印檔
		 ...
		 $this->db->where('mh002 ', $seq2);
         $this->db->where('mh001 ', $seq1);	
		$this->db->order_by('mh001 , mh002');
		
		$query = $this->db->get();
	 
	      $ret['rows'] = $query->result();  
          $seq32 = "mh001 = '$seq1' and mh002= '$seq2' ";	
	      $query = $this->db->select('COUNT(*) as count', FALSE)  //筆數查詢,如果設為FALSE不會使用反引號保護你的字段或者表名
		              ->from('taxmh');
		           //   ->where($seq32);
	      $num = $query->get()->result();		
