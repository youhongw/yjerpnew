...
class taxr05_model extends CI_Model {
	...
	function insertf()    //新增一筆 檔頭  coptg
		...
		//	 if ($this->input->post('me018')!='1') {$me019=round($this->input->post('me019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->taxr05_model->selone1($this->input->post('copq03a23'),$this->input->post('me002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->taxr05_model->selone1d($this->input->post('copq03a23'),$this->input->post('me002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->taxr05_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->taxr05_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $exist = $this->taxr05_model->selone2($this->input->post('me001c'),$this->input->post('me002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
	...
	function printfd()          
        {
	        ...
	        //刪除401計算當 taxmg  1071128
		   $this->db->where('mg001', $seq1);
		   $this->db->where('mg002', $seq2);
		   $this->db->delete('taxmg'); 
		   //申報公司
		   $sql1 = "INSERT INTO taxmg (mg001,mg002,mg003,mg004,mg005,mg006,mg007,mg008,mg009) 
		           select ma001,$seq2,$seq3,ma002,ma005,ma003,ma004,ma006,ma007 from taxma as a
		            WHERE a.ma001='$seq1'  "; 
		  $this->db->query($sql1); 
           //銷項1,2 
			 $sql2 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='31' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg601=c.mc013,b.mg602=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql2);		  
	      //銷項5,6 
			 $sql3 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='35' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg605=c.mc013,b.mg606=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql3);
          //銷項9,10 
			 $sql4 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='32' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg609=c.mc013,b.mg610=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql4);	
         //銷項13,14 
			 $sql5 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='36' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg613=c.mc013,b.mg614=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql5);
         //銷項17,18 
			 $sql6 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='33' and mc004<='34'  and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg617=c.mc013,b.mg618=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql6);	
          //合計21,22 
			 $sql7 =" update taxmg set mg621=mg601+mg605+mg609+mg613-mg617, mg622=mg602+mg606+mg610+mg614-mg618
                  where   mg001='$seq1' and mg002='$seq2' 
			      " ; 
			 $this->db->query($sql7);
          //銷售額總計 
			 $sql8 =" update taxmg set mg625=mg621+mg622
                  where  mg001='$seq1' and mg002='$seq2' 
			      " ; 
			 $this->db->query($sql8);
          //+++++++++++++++++++++++++++++++++++++++++++++++++1071129			 
          //進項(費)28,29 
			 $sql11 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='25' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg628=c.mc013,b.mg629=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql11);	
         //進項(固)30,31 
			 $sql12 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='25' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg630=c.mc013,b.mg629=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql12);
         //進項(費)32,33 
			 $sql13 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='21' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg632=c.mc013,b.mg633=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql13);	
         //進項(固)34,35 
			 $sql14 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='21' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg634=c.mc013,b.mg635=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql14);	
         //進項(費)36,37 
			 $sql15 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='22' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg636=c.mc013,b.mg637=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql15);	
         //進項(固)38,39 
			 $sql16 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='22' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg638=c.mc013,b.mg639=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql16);	
         //進項(費)78,79 
			 $sql17 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='28' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg678=c.mc013,b.mg679=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql17);	
         //進項(固)80,81 
			 $sql18 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004='28' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg680=c.mc013,b.mg681=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql18);
          //進項(費)40,41 
			 $sql19 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='22' and mc004<='23' and mc014='12' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg640=c.mc013,b.mg641=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql19);	
         //進項(固)42,43 
			 $sql20 =" update taxmg b,(select mc001,mc002,sum(mc013) as mc013,sum(mc011) as mc011
               from taxmc1 a where mc004>='22' and mc004<='23' and mc014='13' and mc012<='3' and mc001='$seq1' and mc002='$seq2' 
			   group by mc001,mc002 
                ) c
               set b.mg642=c.mc013,b.mg643=c.mc011
               where b.mg001=c.mc001 and b.mg002=c.mc002  " ; 
			 $this->db->query($sql20);
           //合計44,46 43 47
			 $sql21=" update taxmg set mg644=mg628+mg632+mg636+mg678+mg640,
                            		   mg646=mg630+mg634+mg638+mg680+mg642,
									   mg643=mg629+mg633+mg637+mg679+mg641,
									   mg647=mg631+mg635+mg639+mg681+mg643
                  where   mg001='$seq1' and mg002='$seq2' 
			      " ; 
			 $this->db->query($sql21);
           //進項總合計48,49
			 $sql22=" update taxmg set mg648=mg644+mg643,
                            		   mg649=mg646+mg647
                  where   mg001='$seq1' and mg002='$seq2' 
			      " ; 
			 $this->db->query($sql22);	
          //進口免稅貨物73 taxme購買國外勞務74 taxme
			 $sql23 =" update taxmg b,(select me001,me002,sum(me017) as me017,sum(me018) as me018,
              sum(me013) as me013,sum(me009) as me009 from taxme a where  me001='$seq1' and me002='$seq2' 
			   group by me001,me002 
                ) c
               set b.mg673=c.me017,b.mg674=c.me018,b.mg691=c.me013,b.mg692=c.me009
               where b.mg001=c.me001 and b.mg002=c.me002  " ; 
			 $this->db->query($sql23);	
		 ...
		 $this->db->where('mg002 ', $seq2);
         $this->db->where('mg001 ', $seq1);	
		$this->db->order_by('mg001 , mg002');
		
		$query = $this->db->get();
	 
	      $ret['rows'] = $query->result();  
          $seq32 = "mg001 = '$seq1' and mg002= '$seq2' ";	
	      $query = $this->db->select('COUNT(*) as count', FALSE)  //筆數查詢,如果設為FALSE不會使用反引號保護你的字段或者表名
		              ->from('taxmg');
		           //   ->where($seq32);
	      $num = $query->get()->result();		
