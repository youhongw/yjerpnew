...
class Sfcp03_model extends CI_Model
{
	...
	function selone_g($seq1, $seq2, $seq3)
	{
	...
	function insertf_k()
	{
		...
		$sql = " INSERT INTO dbo.sfcpk (creator, create_date, flag, pk001, pk002, pk003, pk004, pk005)
					VALUES ('$creator', '$vtoday', '0', '$vpk001', '$vpk002', '$vpk003', '$vpk004', '$vpk005'); ";
