	...
	function updatef()
	{
		...
		if (isset($order_product)) {
			...
			foreach ($order_product as $key => $val) {
				...
				$TK007 = mb_convert_encoding($TK007, 'BIG5', 'utf-8');		//線別名稱
				$TK008 = date("Ymd", strtotime($TK008));		//預計開工日
				$TK009 = date("Ymd", strtotime($TK009));		//預計完工日
				//$TK024 = iconv("utf-8", "BIG5", $TK024);		//製程敘述
				$TK024 = mb_convert_encoding($TK024, 'BIG5', 'utf-8');		//製程敘述
				$TK020 = mb_convert_encoding($TK020, 'BIG5', 'utf-8');		//計價單位
				//$TK034 = iconv("utf-8", "BIG5", $TK034);		//備註
				$TK034 = mb_convert_encoding($TK034, 'BIG5', 'utf-8');		//備註
