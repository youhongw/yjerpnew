	...
	function printfd()          
		...
		/*  $sql = "SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002
				...
				RIGHT JOIN palmj as c on d.mv205 = c.mj001 
					WHERE a.yh001='$seq3' GROUP BY  mkj001,mkj002 ORDER BY mk004 ASC , mkj001 ASC"; del a.yh046  */
			$sql = "SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002 ,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,a.yh046,
sum(a.yh034) as yh034 , sum(a.yh051) as yh051, sum(yh053) as yh053, sum(yh054) as yh054, sum(yh056) as yh056 , sum(yh057) as yh057 
FROM palyh as a LEFT JOIN cmsmv as d on a.yh002 = d.mv001 and a.yh001='2017'
RIGHT JOIN palmk as b on d.mv206 = b.mk001 
RIGHT JOIN palmj as c on d.mv205 = c.mj001 WHERE a.yh001='$seq3' 
GROUP BY mkj001,mkj002,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,a.yh046
ORDER BY mk004 ASC , mkj001 ASC  ";
	     ...
	     /* $sql = "SELECT COUNT(o.mkj001) as count_num from(
		  ...
		  $query = $this->db->query($sql);  */
		  $sql = "SELECT COUNT(o.mkj001) as count_num from(
		  SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002 ,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,
		  a.yh046, count(*) as count_num 
		  FROM palyh as a LEFT JOIN cmsmv as d on a.yh002 = d.mv001 and a.yh001='2017' RIGHT JOIN palmk as b on d.mv206 = b.mk001 
		  RIGHT JOIN palmj as c on d.mv205 = c.mj001 WHERE a.yh001='$seq3'
		  GROUP BY mkj001,mkj002,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,a.yh046) as o";
         $query = $this->db->query($sql); 
