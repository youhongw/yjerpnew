...
class Palr31_model extends CI_Model {
	...
	function printfd()          
        {
	      ...
	      $seq6=$this->input->post('ta002c');
		   ...
		   $sql = " SELECT a.* FROM palyh as a  
		               WHERE yh002>='$seq1' and   yh002<='$seq2' and yh001='$seq3' and yh047>='$seq5' and   yh047<='$seq6'  GROUP BY  yh001,yh003,yh002 ";  
