	...
	function batchaf()           
		...
		//投保金額x4 ml006 yh050
           $sql19 =" update palyh as b,(select a.ml001,a.ml006  from palml as a   ) as c
               ...
               where  b.yh001=c.ml001 " ; 
			 $this->db->query($sql19);
		//實發金額  palyh  yh051 
           $sql20 =" update palyh as a set yh051=yh026  where yh026 > 0 and yh001='$vyy' " ; 
			 $this->db->query($sql20);
			 $sql201 =" update palyh as a set yh051=yh035  where yh035 >0 and yh046='2' and yh001='$vyy' " ; 
			 $this->db->query($sql201);
			 
			 $sql202 =" update palyh as a set yh052=0.05  where yh051 >70000  and yh001='$vyy' " ; 
			 $this->db->query($sql202);
			 $sql203 =" update palyh as a set yh053=round(yh051*yh052,0)  where  yh001='$vyy' " ; 
			 $this->db->query($sql203);
			  $sql204 =" update palyh as a set yh054=round(yh051*0.0191,0)  where  yh001='$vyy' " ; 
