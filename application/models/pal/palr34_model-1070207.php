...
class palr34_model extends CI_Model {
	...
	function printfd()          
		...
		/*  $sql = "SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002
			...
			$sql = "SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002 ,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,
...
GROUP BY mkj001,mkj002,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002
ORDER BY mk004 ASC , mkj001 ASC  ";
	     ...
	     /* $sql = "SELECT COUNT(o.mkj001) as count_num from(
		  ...
		  RIGHT JOIN palmj as c on d.mv205 = c.mj001 WHERE a.yh001='$seq3'
		  GROUP BY mkj001,mkj002,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002) as o";
         $query = $this->db->query($sql); 
