...
//計算 加班單 轉入月出勤  
	function batchaf()           
		...
		//新增年終試算 PALTE  select mv001,mv004,$vyymm1 from cmsmv where  mv022='' or substr(mv022,0,6)='$vyymm1' "; 
		  $sql2 = "INSERT INTO  palyh (create_date,yh001,yh002,yh003,yh008,yh015,yh016,yh017,yh018,yh019,yh025,yh041,yh042,yh010,yh011,yh012,yh013,yh014,yh044) 
		  SELECT $date,ye001,ye002,ye003,ye009,ye004,ye005,ye006,ye007,ye008,ye010,ye012,ye011,90,75,60,45,30,ye013 
          FROM palye
          WHERE  ye001='$vyy'  ";
		  $this->db->query($sql2);
		//  var_dump($vyy);exit;
    ...
    while($row=mysql_fetch_assoc($result)){
		...
		//發放天數*0.9809 yh010-14 
		  $sql202 =" update palyh as a set yh010=round(yh010*0.9809,2),yh011=round(yh011*0.9809,2),
		                  yh012=round(yh012*0.9809,2),yh013=round(yh013*0.9809,2)
                  		  where  yh001='$vyy' " ; 
		   $this->db->query($sql202);
	    //可發天數 palyh  yh010-14  -15-19   floor(yh015/5) 1080118
         /*  $sql21 =" update palyh as a set yh020=round((yh010+yh019+yh018-yh017-0-yh015)*0.9809,2),yh021=round((yh011+yh019+yh018-yh017-0-yh015)*0.9809,2),
                		  yh022=round((yh012+yh019+yh018-yh017-0-yh015)*0.9809,2),yh023=round((yh013+yh019+yh018-yh017-0-yh015)*0.9809,2),yh024=round((yh014+yh019+yh018-yh017-0-yh015)*0.9809,2)
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql21); */
			  $sql21 =" update palyh as a set yh020=(yh010+yh019+yh018-yh017-0-yh015),yh021=(yh011+yh019+yh018-yh017-0-yh015),
                		  yh022=(yh012+yh019+yh018-yh017-0-yh015),yh023=(yh013+yh019+yh018-yh017-0-yh015),yh024=(yh014+yh019+yh018-yh017-0-yh015)
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql21);
	    //可發金額 palyh  yh026-30  年資 基數yh009 1080121
           $sql22 =" update palyh as a set yh026=round(yh025*yh020*yh009,0),yh027=round(yh025*yh021*yh009,0),
                		  yh028=round(yh025*yh022*yh009,0),yh029=round(yh025*yh023*yh009,0),yh030=round(yh025*yh024*yh009,0)
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql22);
		//實發金額 palyh  yh031-35  
		...
		//效率獎金  palyh  31-35
           $sql24 =" update palyh as b,(select a.yg001,a.yg002,a.yg004,a.yg005,a.yg006,a.yg007,a.yg008 from palyg as a  order by a.yg001,a.yg002 ) as c
			 ...
			 $this->db->query($sql24);
		//效率獎金扣考勤功過 vyh32 	 1070118 floor(yh015/5)
			  $sql241 =" update palyh set yh032=round((yh019+yh018-yh017-0-yh015)*yh025,0)              
               where yh001='$vyy' and yh046='2' " ; 
			 $this->db->query($sql241);
			 
			 $sql242 =" update palyh set yh033=yh031+yh032              
               where yh001='$vyy' and yh046='2' " ; 
			 $this->db->query($sql242);
			  $sql243 =" update palyh set yh035=yh033+yh034              
               where yh001='$vyy' and yh046='2' " ; 
			 $this->db->query($sql243);
	    //期初獎金  palyh  43  1070112
           $sql25 =" update palyh as b,(select a.yd001,a.yd002,a.yd004 from palyd as a  order by a.yd001,a.yd002 ) as c
			 ...
			 $this->db->query($sql25);
		 //本年度考績  palyh  41,42 1070112
           $sql251 =" update palyh as b,(select a.yf001,a.yf004,a.yf005 from palyf as a  order by a.yf001,a.yf002 ) as c
               set b.yh041=c.yf004, b.yh042=c.yf005
               where b.yh001=c.yf001 and b.yh002=c.yf002 and b.yh001='$vyy' " ; 
			 $this->db->query($sql251);
	     //列印名稱  palyh  48
	...
	//    計算核算金額1060115 PALB42
	    ...
	    //可發天數 palyh  yh010-14  -15-19  1080118  /5
           $sql21g =" update palyh as a set yh020=round((yh010+yh019+yh018-yh017-0-yh015))*0.9809*yh009,2),yh021=round((yh011+yh019+yh018-yh017-0-yh015))*0.9809*yh009,2),
                		  yh022=round((yh012+yh019+yh018-yh017-0-yh015))*0.9809*yh009,2),yh023=round((yh013+yh019+yh018-yh017-0-yh015))*0.9809*yh009,2),yh024=round((yh014+yh019+yh018-yh017-0-yh015)*0.9809*yh009,2)
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql21g);
	    //可發金額 palyh  yh026-30  基數yh009 1080121
           $sql22g =" update palyh as a set yh026=round(yh025*yh020*yh009,0),yh027=round(yh025*yh021*yh009,0),
                		  yh028=round(yh025*yh022*yh009,0),yh029=round(yh025*yh023*yh009,0),yh030=round(yh025*yh024*yh009,0)
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql22g);
		//可發金額負數歸零 1070115
		      
		/*    $sql22g =" update palyh as a set yh026=0
						  where  yh001='$vyy' and yh020<0 " ; 
			 $this->db->query($sql22g);
			 $sql22g =" update palyh as a set yh027=0
						  where  yh001='$vyy' and yh021<0 " ; 
			 $this->db->query($sql22g);
			 $sql22g =" update palyh as a set  yh028=0
						  where  yh001='$vyy' and yh022<0 " ; 
			 $this->db->query($sql22g);
			 $sql22g =" update palyh as a set yh029=0
						  where  yh001='$vyy' and yh023<0 " ; 
			 $this->db->query($sql22g);
			 $sql22g =" update palyh as a set yh030=0
						  where  yh001='$vyy' and yh024<0 " ; 
			 $this->db->query($sql22g); */
		...
		//效率獎金扣考勤功過 vyh32 	 floor(yh015/5)
			  $sql241g =" update palyh set yh032=round((yh019+yh018-yh017-0-yh015)*yh025,0)              
               where yh001='$vyy' and yh046='2' " ; 
		...
		//效率獎金扣考勤功過負數歸零 1070115 
		 /*     $sql241g =" update palyh set yh032=0              
               where yh001='$vyy' and yh046='2'  and yh032<0  " ; 
			 $this->db->query($sql241g);
			 
			 $sql242g =" update palyh set yh033=0              
               where yh001='$vyy' and yh046='2' and yh033<0 " ; 
			 $this->db->query($sql242g);
			  $sql243g =" update palyh set yh035=0              
               where yh001='$vyy' and yh046='2' and yh035<0 " ; 
			 $this->db->query($sql243g);  */
	    //期初獎金  palyh  43
