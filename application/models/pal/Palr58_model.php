...
class Palr58_model extends CI_Model {
	...
	function printfd()          
        {
			...
			$sql = " SELECT b.me002,a.mv001,a.mv002,a.mv008,a.mv021,a.mv022 
				FROM cmsmv as a 
				LEFT JOIN cmsme as b on a.mv004=b.me001 
		            WHERE (mv022='' or mv022 is null or mv022 > '".$seq3."01"."') and substr(mv008,5,2) = '".substr($seq3,4,2)."'  ";
			...
			$sql .= " ORDER BY mv004 ASC, mv001 ASC ";
