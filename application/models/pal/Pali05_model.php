...
class Pali05_model extends CI_Model {
	...
	function updatef()   
	  {
		$data = array(
			...
			'mr006' => $this->input->post('mr006'),
			'mr011' => $this->input->post('mr011'),
			'mr012' => $this->input->post('mr012'),
			'mr013' => $this->input->post('mr013'),
			'mr014' => $this->input->post('mr014'),
			'mr015' => $this->input->post('mr015'),
			'mr021' => $this->input->post('mr021')
		);
		$this->load->vars($data);
		$this->db->where('company', '001');
		$this->db->update('palmr',$data);                   //更改一筆
