...
class Palr56_model extends CI_Model {
	...
	function printfd()
        {
			...
			$sql = " SELECT a.mv001,a.mv002,a.mv004,b.me002,a.mv021,a.mv215,a.mv216,a.mv217 FROM cmsmv as a LEFT JOIN cmsme as b on a.mv004 = b.me001 WHERE a.mv001 >= '$seq1'  AND a.mv001 <= '$seq2' AND a.mv022 = '' AND a.mv004 != '3000' AND a.mv004 != '4000' AND a.mv004 != '9000' ORDER BY mv004,mv021 "; 
