...
class Palr33_model extends CI_Model {
	...
	function printfd()          
        {
		  $seq3=$this->input->post('dateo');  //年度
		  $seq5=$this->input->post('ta002o');
	      $seq6=$this->input->post('ta002c');
		  
		  $sql1 = " SELECT a.* FROM palyh as a
		               WHERE yh001='$seq3' and yh047>='$seq5' and yh047<='$seq6'  ORDER BY yh003,yh002   ";  
		  $query = $this->db->query($sql1); 
		  
	      $ret['rows'] = $query->result();
		  
	      $sql2 = " SELECT COUNT(*) as count FROM palyh WHERE yh001='$seq3' and yh047>='$seq5' and yh047<='$seq6'  ";		  
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT yh001,yh002,yh024,yh004,yh011,yh003,create_date FROM palyh WHERE yh001 >= '$seq1'  AND yh001 <= '$seq2' AND  yh002 >= '$seq3'  AND yh002 <= '$seq4'  "; 
	   ...
	   $sql = " SELECT yh002,yh006,yh007,yh005,if (yh046='2', yh051-yh034,yh051 ),if (yh046='2',yh034 , 0 ) ,yh051,yh052,yh053,yh054,yh056,yh057,yh044,yh045 
		  FROM palyh as a
		 WHERE yh001='$seq3' and yh047>='$seq5' and yh047<='$seq6'  ORDER BY yh003,yh002   ";  
