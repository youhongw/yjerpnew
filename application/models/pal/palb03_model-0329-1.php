		  ...
		  /*	$spc_day = array(
			...
			foreach($ret as $row){
	          ...
	          if(substr($row->mv021,0,4) <= 2005 && $mv001!="70001" && $mv001!="73001" && $mv001!="67001" && $mv001!="77001" && $mv001!="82008"  ){$row->mv021="20050701";}
               ...
               from  paltc a 
               where a.tc001=$mv001  and a.tc003>='$str_day1' and a.tc003<='$end_day11'  group by a.tc001
                ) c
               set b.mv306=c.tc008 
			   ...
			   $this->db->query($sql21);
			    ...
			    //已請特休2
				 $sql22 =" update cmsmv as b,(select a.tc001,sum(a.tc008) as tc008
               from  paltc a 
               where a.tc001=$mv001  and a.tc003>='$str_day2' and a.tc003<='$end_day21'  group by a.tc001
                ) c
               set b.mv311=c.tc008 
               where b.mv001=c.tc001 and b.mv001='$mv001'  ";
			 $this->db->query($sql22);
