...
class Palr43_model extends CI_Model {
	...
	function printfd()          
        {
		  ...
		  $sql = "SELECT CONCAT(c.mj001,b.mk001) as mkj001,CONCAT(c.mj002,b.mk002) as mkj002
				,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002
				,SUM(a.td030) as td030,SUM(a.td031) as td031,SUM(a.td033) as td033
				,SUM(a.td034) as td034,SUM(a.td037) as td037,SUM(a.td036) as td036
				,sum(a.td038) as td038,SUM(a.td035) as td035,SUM(a.td039) as td039
				,SUM(a.td040) as td040,SUM(a.td041) as td041
				FROM paltd as a 
				LEFT JOIN cmsmv as d on d.mv001 = a.td001 
				RIGHT JOIN palmk as b on d.mv206 = b.mk001 
				RIGHT JOIN palmj as c on d.mv205 = c.mj001 
					WHERE a.td005='$seq3' GROUP BY  mkj001,mkj002 ORDER BY mk004 ASC , mkj001 ASC";  
	      ...
	      $sql = "SELECT COUNT(o.mkj001) as count_num from(
					...
					RIGHT JOIN palmk as b on d.mv206 = b.mk001 
					RIGHT JOIN palmj as c on d.mv205 = c.mj001 
					WHERE a.td005='$seq3' GROUP BY mkj001) as o";  
		  $query = $this->db->query($sql); 
	      $num = $query->result();
