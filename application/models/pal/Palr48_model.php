...
class Palr48_model extends CI_Model {
	...
	function printfd()          
        {
		 $seq1=$this->input->post('ta001o');
		  ...
		  $seq5=$this->input->post('mv202');
		   ...
		   $sql = " SELECT a.*,b.*,c.mv202,c.mv036 FROM paltd as a LEFT JOIN paltc as b on a.td001=b.tc001 LEFT JOIN cmsmv as c on a.td001=c.mv001 
		               WHERE substr(c.mv009,2,1) > '9' and td005='$seq3' and substr(td050,1,1)>'9'
					    ";  
			if(@$seq1){
		  ...
		  $sql .= " GROUP BY  c.mv004 asc, td001,td003 ";
	...
	function excelfd()          
        {
		  ...
		  $seq5=$this->input->post('mv202');
		   ...
		   $sql = " SELECT a.td003,a.td004,a.td001,a.td002,a.td017,a.td019,a.td021,a.td023,a.td025,a.td027,a.td044,a.td046
		   FROM paltd as a 
		   LEFT JOIN paltc as b on a.td001=b.tc001 
