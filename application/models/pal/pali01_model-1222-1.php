...
class Pali01_model extends CI_Model {
	...
	function excelnewf()           
        {			
	      ...
	      $sql = " SELECT mv001,mv002,mv004,mv008,mv009,mv012,mv014,mv019,mv020,mv021,mv022,mv215,create_date FROM cmsmv WHERE mv001 >= '$seq1'  AND mv001 <= '$seq2' ORDER BY mv004,mv001 "; 
