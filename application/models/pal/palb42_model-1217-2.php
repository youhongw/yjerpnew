	...
	function batchaf()           
		...
		//現金或轉帳 mv034
           $sql18 =" update palyh as b,(select a.mv001,a.mv034  from cmsmv as a  order by a.mv001 ) as c
			 ...
			 $this->db->query($sql18);
		//投保金額x4 ml006 yh050
           $sql19 =" update palyh as b,(select a.ml001,a.ml006  from palml as a   ) as c
               set b.yh050=c.ml006*4
		...
		//實發金額  palyh  yh051 
           $sql20 =" update palyh as a set yh051=yh033+yh034  where yh033+yh034 > 0 and yh046='2' and yh001='$vyy' " ; 
			 ...
			 //稅率
			 $sql202 =" update palyh as a set yh052=0.05  where yh046='2' and (yh051-yh034) >=73001  and yh001='$vyy' " ; 
			 $sql202 =" update palyh as a set yh052=0.05  where yh046='1' and (yh051) >=73001  and yh001='$vyy' " ; 
			 $this->db->query($sql202);
			 //稅額
			 $sql203 =" update palyh as a set yh053=round((yh051-yh034)*yh052,0)  where yh046='2' and yh001='$vyy' " ; 
			 $this->db->query($sql203);
			 $sql203 =" update palyh as a set yh053=round((yh051)*yh052,0)  where yh046='1' and yh001='$vyy' " ; 
			 $this->db->query($sql203);
			 //健保
			 ...
			 //未投保
			  $sql204 =" update palyh as a set yh054=round((yh051-yh034)*0.0191,0)  where (yh051-yh034)>21009 and yh058='Z' and  yh001='$vyy' " ; 
			 $this->db->query($sql204);
			 //實領金額 
