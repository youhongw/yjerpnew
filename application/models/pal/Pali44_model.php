...
class Pali44_model extends CI_Model {
	...
	function filterf1($limit, $offset , $sort_by  , $sort_order)            
	   {    
	      ...
	      $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	      $sort_columns = array('ye001', 'ye002', 'ye003','ye004','ye007','ye011','ye012', 'a.create_date');
	...
	function excelnewf()           
        {			
		  ...
		  $seq3=$this->input->post('ye003c'); 
	      $sql = " SELECT ye001,ye002,mv002,ye003,me002,ye004,ye005,ye006,ye007,ye008,ye009,ye010,ye011,ye012 FROM palye as a
		  left join cmsmv as b on a.ye002=b.mv001 left join cmsme as c on a.ye003=c.me001 WHERE  ye001 = '$seq3' AND ye002 >= '$seq1' AND ye002 <= '$seq2' order by a.ye001,a.ye003,a.ye002 "; 
