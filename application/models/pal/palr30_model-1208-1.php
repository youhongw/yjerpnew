	...
	function printfd()          
        {
		  ...
		  $sql1 = " SELECT a.* FROM palyh as a
		               WHERE yh001='$seq3' and yh045>='$seq5' and yh045<='$seq6'  ORDER BY yh003,yh002   ";  
		  $query = $this->db->query($sql1); 
		  
	      $ret['rows'] = $query->result();
		  
	      $sql2 = " SELECT COUNT(*) as count FROM palyh WHERE yh001='$seq3' and yh045>='$seq5' and yh045<='$seq6'  ";		  
