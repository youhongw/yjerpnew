...
class Palr55_model extends CI_Model {
	...
	function printfd()
        {
		  ...
		  $sql = " SELECT a.td002,b.mv202 FROM paltd as a 
		  LEFT JOIN cmsmv as b on a.td001=b.mv001 
		               WHERE td005='$seq3' and b.mv032 < 3 ";
		  if(@$seq5){
		  ...
		  $sql .= " GROUP BY td001,td003 ORDER BY mv004 ASC ,td001 ASC  ";  
