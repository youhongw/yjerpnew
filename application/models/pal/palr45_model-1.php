...
class Palr45_model extends CI_Model {
	...
	function printfd()          
        {
	      ...
	      $seq6=$this->input->post('ta002c');
		   ...
		   $sql = " SELECT a.*,b.*,c.mv202 FROM paltd as a LEFT JOIN paltc as b on a.td001=b.tc001 LEFT JOIN cmsmv as c on a.td001=c.mv001 
		               WHERE td001>='$seq1' and   td001<='$seq2' and td005='$seq3' and mv202>='$seq5' and   mv202<='$seq6'  GROUP BY  td001,td003 ";  
