...
class Palr59_model extends CI_Model {
	...
	function printfd()          
        {
			...
			$sql = " SELECT a.td001,a.td002,a.td003,a.td005,a.td054,a.td050,a.td047-td044 as td047,a.td037,a.td049,a.td044+a.td046 as td044,c.me002
				FROM paltd as a
				LEFT JOIN cmsmv as b on a.td001 = b.mv001 
				LEFT JOIN cmsme as c on b.mv004 = c.me001 
				WHERE (mv022 = '' or mv022 is null or mv022 > '".$seq3."01' ) ";
			...
			$sql .= " ORDER BY mv004 ASC, td001 ASC, td005 ASC ";
	...
	function excelfd()          
        {
		  ...
		  $sql = " SELECT a.td001,a.td002,c.mv036,a.td040,a.td041 
		  FROM paltd as a 
		  ...
		  if(@$seq5){
			  $sql.=" and ( mv206 = '".$seq5[0]."' ";
			  foreach($seq5 as $key => $val){
				  $sql .= " or mv206 = '".$val."'";
			  }
			  $sql.=" ) ";
		  }
		  $sql .= " GROUP BY td001,td003 ORDER BY td001 ASC  ";
