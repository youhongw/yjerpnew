...
//計算 加班單 轉入月出勤  
	function batchaf()           
		...
		//新增年終試算 PALTE  select mv001,mv004,$vyymm1 from cmsmv where  mv022='' or substr(mv022,0,6)='$vyymm1' "; 
		  $sql2 = "INSERT INTO  palyh (create_date,yh001,yh002,yh003,yh008,yh025,yh041,yh042,yh010,yh011,yh012,yh013,yh014) 
		  SELECT $date,ye001,ye002,ye003,ye009,ye010,ye012,ye011,90,75,60,45,30 
          FROM palye
          WHERE  ye001='$vyy'  ";
		  $this->db->query($sql2);
		//  var_dump($vyy);exit;
    ...
    while($row=mysql_fetch_assoc($result)){
	    ...
	    //可發天數 palyh  yh010-14  -15-19  
           $sql21 =" update palyh as a set yh020=yh010+yh019+yh018-yh017-yh016-yh015,yh021=yh011+yh019+yh018-yh017-yh016-yh015,
                		  yh022=yh012+yh019+yh018-yh017-yh016-yh015,yh023=yh013+yh019+yh018-yh017-yh016-yh015,yh024=yh014+yh019+yh018-yh017-yh016-yh015
						  where  yh001='$vyy' " ; 
			 $this->db->query($sql21);
	    //可發金額 palyh  yh026-30  
	    ...
	    //期初獎金  palyh  43
           $sql25 =" update palyh as b,(select a.yd001,a.yd002,a.yd004 from palyd as a  order by a.yd001,a.yd002 ) as c
			 ...
			 $this->db->query($sql25);
	     //列印名稱  palyh  48
           $sql26 =" update palyh as b,(select a.yb002 from palyb as a,palyh as d  where a.yb001=d.yh047 ) as c
               set b.yh048=c.yb002 
               where b.yh001='$vyy' and b.yh047=c.yb002 " ; 
			 $this->db->query($sql26);
