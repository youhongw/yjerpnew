...
class Palr49_model extends CI_Model {
	...
	function printfd()          
        {
		  $seq3=substr($this->input->post('dateo'),0,4).substr($this->input->post('dateo'),5,2).substr(rtrim($this->input->post('dateo')),8,2);
		   ...
		   $sql = " SELECT a.*,b.me002 as mv004disp 
		   FROM cmsmv as a 
		   LEFT JOIN cmsme as b on a.mv004=b.me001 
		               WHERE mv021 >= '$seq3' and mv021 <= '$seq4' GROUP BY mv004,mv001 ";  
	
		  $query = $this->db->query($sql); 
		  
	      $ret['rows'] = $query->result();  
          $seq32 = "mv021 >= '$seq3' and   mv021<='$seq4'  ";	
