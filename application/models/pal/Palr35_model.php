...
class palr35_model extends CI_Model {
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT yh001,yh002,yh024,yh004,yh011,yh003,create_date FROM palyh WHERE yh001 >= '$seq1'  AND yh001 <= '$seq2' AND  yh002 >= '$seq3'  AND yh002 <= '$seq4'  "; 
         $sql = " SELECT a.yh002,a.yh005,b.mv036,a.yh057,a.yh056 
		  FROM palyh as a
		  LEFT JOIN cmsmv as b ON a.yh002=b.mv001 
		  WHERE  yh001 = '$seq1'   AND yh047 >= '$seq3'  AND yh047 <= '$seq4' ORDER BY yh001,yh002 "; 
