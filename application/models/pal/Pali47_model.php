...
class Pali47_model extends CI_Model {
	...
	function filterf1($limit, $offset , $sort_by  , $sort_order)            
	   {    
	      ...
	      $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	      $sort_columns = array('yh001', 'yh002', 'yh005','yh006','yh008','yh009','yh010','yh020','yh059', 'create_date');
	...
	function insertf()    
	    ...
	    $exist = $this->pali47_model->selone1($this->input->post('yh001'),$this->input->post('palq01a'));   //查詢資料是否重複
	    if ($exist)
	     {
		  return 'exist';
		 } 
    ...
    function copyf()           
        {
	      ...
	      $data = array( 
           ...
           $exist = $this->pali47_model->selone2($this->input->post('yh002c'));
		   if ($exist)
		    {
			  return 'exist';
		    }         
