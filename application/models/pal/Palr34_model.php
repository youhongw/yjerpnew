...
FROM palyh as a LEFT JOIN cmsmv as d on a.yh002 = d.mv001 and a.yh001='$seq3'
RIGHT JOIN palmk as b on d.mv206 = b.mk001 
...
ORDER BY mk004 ASC , mkj001 ASC  ";
	     ...
	     /* $sql = "SELECT COUNT(o.mkj001) as count_num from(
		  ...
		  $query = $this->db->query($sql);  */
		  $sql = "SELECT COUNT(o.mkj001) as count_num from(
		  SELECT CONCAT(d.mv206,d.mv205) as mkj001,CONCAT(b.mk002,c.mj002) as mkj002 ,b.mk001,b.mk002,b.mk004,c.mj001,c.mj002,a.yh046,
		   count(*) as count_num 
		  FROM palyh as a LEFT JOIN cmsmv as d on a.yh002 = d.mv001 and a.yh001='$seq3' RIGHT JOIN palmk as b on d.mv206 = b.mk001 
		  RIGHT JOIN palmj as c on d.mv205 = c.mj001 WHERE a.yh001='$seq3'
