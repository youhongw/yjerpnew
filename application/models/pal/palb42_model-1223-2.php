...
//計算 加班單 轉入月出勤  
	function batchaf()           
	    ...
	    //可發天數 palyh  yh010-14  -15-19  
           $sql21g =" update palyh as a set yh020=round((yh010+yh019+yh018-yh017-0-floor(yh015/5))*0.9809,2),yh021=round((yh011+yh019+yh018-yh017-0-floor(yh015/5))*0.9809,2),
                		  yh022=round((yh012+yh019+yh018-yh017-0-floor(yh015/5))*0.9809,2),yh023=round((yh013+yh019+yh018-yh017-0-floor(yh015/5))*0.9809,2),yh024=round((yh014+yh019+yh018-yh017-0-floor(yh015/5))*0.9809,2)
						  where  yh001='$vyy' " ; 
