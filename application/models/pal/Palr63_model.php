...
class palr63_model extends CI_Model {
	...
	function printfd()          
        {
		  $seq3=substr($this->input->post('dateo'),0,4).substr($this->input->post('dateo'),5,2);
		   ...
		   $sql = " select a.td001,a.td002,a.td003,a.td004,a.td005,a.td039 from paltd as a
		               WHERE td005 = '$seq3' and td039<=0 GROUP BY td003,td001 ";  
	
		  $query = $this->db->query($sql); 
		  
	      $ret['rows'] = $query->result();  
          $seq32 = "td005 = '$seq3' and td039<=0  ";	
