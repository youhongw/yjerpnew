		...
		//實發金額  palyh  yh051 
           $sql20 =" update palyh as a set yh051=yh033+yh034  where yh033+yh034 >= 0 and yh046='2' and yh001='$vyy' " ; 
			...
			//稅率
			 ...
			 $sql202a =" update palyh as a set yh052=0.05  where yh046='2' and (yh051-yh034) >=73501  and yh001='$vyy' " ; 
			 $this->db->query($sql202a);
			 $sql202b =" update palyh as a set yh052=0.05  where yh046='1' and (yh051) >=73501  and yh001='$vyy' " ; 
			...
			// $this->db->query($sql202b);
			 ...
			 $this->db->query($sql2040);
			  ...
			  $sql204b =" update palyh as a set yh054=round((yh051-yh034)*0.0191,0)  where yh046='2' and (yh051-yh034)>22000 and yh058='z' and  yh001='$vyy' " ; 
