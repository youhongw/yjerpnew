...
class Admi05_model extends CI_Model {
	...
	function construct_sql($limit = 15, $offset = 0, $func = "")
	{
		...
		//	echo var_dump('test');exit;
			$sql21 = " SELECT  A.CREATE_DATE,A.MA001,A.MA003,A.MA005,A.MA006,A.MA008,A.MA027
             		   FROM  dbo.COPMA AS A " ;
		...
		$sql23 = " SELECT  A.CREATE_DATE,A.MA001,A.MA003,A.MA005,A.MA006,A.MA008,A.MA027 FROM  dbo.COPMA AS A
					    " ;
