...
class Admi05_model extends CI_Model {
	...
	function construct_sql($limit = 10, $offset = 0, $func = "")
	{
		...
		//	echo var_dump('test');exit;
			$sql21 = " SELECT TOP $limit A.CREATE_DATE,A.MA001,A.MA003,A.MA005,A.MA006,A.MA008,A.MA027
             		   FROM  dbo.COPMA AS A
                       WHERE MA001 Not in
		...
		$sql23 = " SELECT TOP $limit A.CREATE_DATE,A.MA001,A.MA003,A.MA005,A.MA006,A.MA008,A.MA027 
		           FROM  dbo.COPMA AS A 
				   WHERE MA001 Not in
                      (Select top $off1 MA001 from COPMA order by MA001)					   
					   ORDER BY A.MA001  " ;
