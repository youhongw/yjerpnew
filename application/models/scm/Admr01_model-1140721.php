	...
	function printfd($seq1,$seq2)  {  
        ...
        WHERE A.TG004 >='100000' AND A.TG004<='59999999' 
               AND A.TG003>='$seq1' AND A.TG003<='$seq2'   AND  TH013>0
                AND A.TG023='Y'    AND ( C.MA001<>'ACHN002'  AND C.MA001<>'ACHN003'
           AND C.MA001<>'AUSA035'   AND C.MA001<>'AUSA036'  AND  C.MA001<>'2000001' AND C.MA001<>'4807000' AND C.MA001<>'5600000' )
...
WHERE  A.TI004 >='1000000' AND A.TI004 <='59999999'   
      ...
      AND A.TI019='Y'   AND  ( C.MA001<>'ACHN002'  AND C.MA001<>'ACHN003'
           AND C.MA001<>'AUSA035'   AND C.MA001<>'AUSA036'  AND  C.MA001<>'2000001' AND C.MA001<>'4807000' AND C.MA001<>'5600000' )
