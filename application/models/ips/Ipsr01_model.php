...
class ipsr01_model extends CI_Model {
	...
	function selonebefore($seq1,$seq2)    
		...
		$this->db->join('ipsma as c', 'a.tc001 = c.ma001  ','left');  //單別
	...
	function selone($seq1,$seq2)    
		...
		$this->db->join('ipsma as c', 'a.ma001 = c.ma001  ','left');   //單別
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq1 = "ma001, ma002, ma003, ma004, ma005, ma006,ma007,tg13,ma025,ma042, create_date FROM `ipsma` ";
	...
	//新增一筆 檔頭  ipsma	
	function insertf()    //新增一筆 檔頭  ipsma
        {
		...
		//	 if ($this->input->post('ma018')!='1') {$ma019=round($this->input->post('ma019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->ipsr01_model->selone1($this->input->post('copq03a23'),$this->input->post('ma002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
             $this->db->insert('ipsma', $data);
			
		// 新增明細 copth
				//		$this->db->flush_cache();  
		// 新增明細 ipsma  主檔 copth 重計算合計金額 數量 庫存數量
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->ipsr01_model->selone1d($this->input->post('copq03a23'),$this->input->post('ma002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->ipsr01_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->ipsr01_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  $sql = " UPDATE ipsma set ma013='$ma013',ma025='$ma025',ma033='$ma033',ma045='$ma045',ma046='$ma046' WHERE ma001 = '$ma001'  AND ma002 = '$ma002'  "; 
		  $query = $this->db->query($sql);	
				return true;			
		 }
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $seq1=$this->input->post('ma001c');    //主鍵一筆檔頭ipsma
            ...
            $exist = $this->ipsr01_model->selone2($this->input->post('ma001c'),$this->input->post('ma002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
             $this->db->insert('ipsma', $data);      //複製一筆  
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT ma001,ma002,ma024,ma004,ma011,ma003,create_date FROM ipsma WHERE ma001 >= '$seq1'  AND ma001 <= '$seq2' AND  ma002 >= '$seq3'  AND ma002 <= '$seq4'  "; 
	...
	//	  FROM ipsma as a, copth as b WHERE ma001=th001 and ma002=th002 and  ma001 >= '$seq1'  AND ma001 <= '$seq2' AND ma002 >= '$seq3'  AND ma002 <= '$seq4'  "; 
		 $query = $this->db->query($sql);
	...
	function printfd1()   
       {           
		...
		$this->db->join('ipsma as c', 'a.ma001 = c.ma001 and c.ma003="31" ','left');
	...
	function printfc()   
      {           
        ...
        $this->db->from('ipsma as a');	
        $this->db->join('copth as b', 'a.ma001 = b.th001  and a.ma002=b.th002 ','left');	//單身	
		$this->db->join('ipsma as c', 'a.ma001 = c.ma001 and c.ma003="22" ','left');  //單別
	    $this->db->join('cmsmb as d', 'a.ma010 = d.ma001 ','left');    //廠別
		$this->db->join('cmsmf as e', 'a.ma011 = e.mf001 ','left');		//幣別
		$this->db->join('cmsmv as f ', 'a.ma006 = f.mv001 and f.mv022 = " " ','left');  //業務人員
	...
	function updatef()   
		...
		//	 while ($_POST['order_product'][  $n  ]['th004']) {
		   ...
		   //重新計算貨款 ipsma
		  $sql = " UPDATE ipsma set ma013='$th035',ma025='$th036',ma031='$th045',ma046='$th038',ma033='$th008b' WHERE ma001 = '$ma001'  AND ma002 = '$ma002'  "; 
		 $query = $this->db->query($sql);		   
