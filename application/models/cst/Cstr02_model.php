...
class Cstr02_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq1 = "mb001, mb002, mb003, mb004, mb005, mb006,mb007,tg13,mb025,mb042, create_date FROM `cstmb` ";
	...
	function insertf()    //新增一筆 檔頭  cstmb
		...
		//	 if ($this->input->post('mb018')!='1') {$mb019=round($this->input->post('mb019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->cstr02_model->selone1($this->input->post('copq03a23'),$this->input->post('mb002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		// 新增明細 copth
				//		$this->db->flush_cache();  
		// 新增明細 cstmb  主檔 copth 重計算合計金額 數量 庫存數量
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->cstr02_model->selone1d($this->input->post('copq03a23'),$this->input->post('mb002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->cstr02_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->cstr02_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  $sql = " UPDATE cstmb set mb013='$mb013',mb025='$mb025',mb033='$mb033',mb045='$mb045',mb046='$mb046' WHERE mb001 = '$mb001'  AND mb002 = '$mb002'  "; 
		  $query = $this->db->query($sql);	
				return true;			
		 }
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $exist = $this->cstr02_model->selone2($this->input->post('mb001c'),$this->input->post('mb002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT mb001,mb002,mb024,mb004,mb011,mb003,create_date FROM cstmb WHERE mb001 >= '$seq1'  AND mb001 <= '$seq2' AND  mb002 >= '$seq3'  AND mb002 <= '$seq4'  "; 
	...
	//	  FROM cstmb as a, copth as b WHERE mb001=th001 and mb002=th002 and  mb001 >= '$seq1'  AND mb001 <= '$seq2' AND mb002 >= '$seq3'  AND mb002 <= '$seq4'  "; 
		 $query = $this->db->query($sql);
	...
	function updatef()   
		...
		//	 while ($_POST['order_product'][  $n  ]['th004']) {
		   ...
		   //重新計算貨款 cstmb
		  $sql = " UPDATE cstmb set mb013='$th035',mb025='$th036',mb031='$th045',mb046='$th038',mb033='$th008b' WHERE mb001 = '$mb001'  AND mb002 = '$mb002'  "; 
		 $query = $this->db->query($sql);		   
