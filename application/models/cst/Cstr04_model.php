...
class Cstr04_model extends CI_Model {
	...
	function selonebefore($seq1,$seq2)    
        {
		 $this->db->select('a.* ,c.mq002 AS tc001disp, d.me002 AS tc007disp,e.mf002 AS tc008disp, f.mv002 AS tc006disp,g.na003 AS tc014disp,
		  ...
		  b.td006, b.td007, b.td008, b.td009, b.td010, b.td011, b.td012,b.td013, b.td014,b.td016,b.td020,b.td030,b.td031,i.me002 as td007disp,j.me002 as tc005disp');
	    ...
	    $this->db->join('cmsmb as d', 'a.tc007 = d.me001 ','left');    //廠別
		...
		$this->db->join('cmsmc as i', 'b.td007 = i.me001 ','left');   //庫別
	...
	function selone($seq1,$seq2)    
        {
		  $this->db->select('a.* ,c.mq002 AS me001disp, d.me002 AS me010disp,e.mf002 AS me011disp, g.na003 AS me047disp,j.me002 as me005disp,f.mv002 as me006disp
		  ...
		  b.th030, b.th035, b.th036, b.th037, b.th038,  b.th033,i.me002 as th007disp');
	    ...
	    $this->db->join('cmsmb as d', 'a.me010 = d.me001 ','left');             //廠別
		...
		$this->db->join('cmsmc as i', 'b.th007 = i.me001 ','left');        //庫別
	...
	function lookup($keyword){     
      $this->db->select('me001, me002, me003,me004,me017,b.me002 as me017disp');
	  $this->db->from('invmb as a');
	  $this->db->join('cmsmc as b', 'a.me017 = b.me001 ','left'); 
	...
	function lookupa($keyword){     
      $this->db->select('me001, me002')->from('cmsmc');  
      $this->db->like('me001',urldecode(urldecode($this->uri->segment(4))),'after');
	  $this->db->or_like('me002',urldecode(urldecode($this->uri->segment(4))), 'after');
      $this->db->limit('15');		
      $query = $this->db->get(); 
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq1 = "me001, me002, me003, me004, me005, me006,me007,tg13,me025,me042, create_date FROM `cstme` ";
	...
	//新增一筆 檔頭  cstme	
	function insertf()    //新增一筆 檔頭  cstme
        {
		...
		//	 if ($this->input->post('me018')!='1') {$me019=round($this->input->post('me019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->cstr04_model->selone1($this->input->post('copq03a23'),$this->input->post('me002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
             $this->db->insert('cstme', $data);
			
		// 新增明細 copth
				//		$this->db->flush_cache();  
		// 新增明細 cstme  主檔 copth 重計算合計金額 數量 庫存數量
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->cstr04_model->selone1d($this->input->post('copq03a23'),$this->input->post('me002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->cstr04_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->cstr04_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
         ...
         $sql = " UPDATE invmc set me007=me007+'$th008' WHERE me001 = '$th004'  AND me002 = '$th007'  "; 
		 $query = $this->db->query($sql);	} 
			  }
		  ...
		  $sql = " UPDATE cstme set me013='$me013',me025='$me025',me033='$me033',me045='$me045',me046='$me046' WHERE me001 = '$me001'  AND me002 = '$me002'  "; 
		  $query = $this->db->query($sql);	
				return true;			
		 }
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $seq1=$this->input->post('me001c');    //主鍵一筆檔頭cstme
            ...
            $exist = $this->cstr04_model->selone2($this->input->post('me001c'),$this->input->post('me002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
             $this->db->insert('cstme', $data);      //複製一筆  
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT me001,me002,me024,me004,me011,me003,create_date FROM cstme WHERE me001 >= '$seq1'  AND me001 <= '$seq2' AND  me002 >= '$seq3'  AND me002 <= '$seq4'  "; 
	...
	//	  FROM cstme as a, copth as b WHERE me001=th001 and me002=th002 and  me001 >= '$seq1'  AND me001 <= '$seq2' AND me002 >= '$seq3'  AND me002 <= '$seq4'  "; 
		 $query = $this->db->query($sql);
	...
	function printfd()          
	    ...
	    $this->db->where('a.me001 <=', $seq2); 
		$this->db->group_by(array("me001", "me002")); 
		$this->db->order_by('me001 , me002');
	...
	function printfd1()   
       {           
           $this->db->select('a.* ,c.mq002 AS me001disp, d.me002 AS me004disp, e.me002 AS me010disp, f.mv002 AS me012disp,
		  b.company, b.creator, b.usr_group, b.create_date, b.modifier, b.modi_date, b.flag, b.th001, b.th002, b.th003, b.th004, b.th005,
	    ...
	    $this->db->join('cmsmb as e', 'a.me010 = e.me001 ','left');
	...
	function printfc()   
      {           
          $this->db->select('a.* ,c.mq002 AS me001disp, d.me002 AS me010disp,e.mf002 AS me011disp, f.mv002 AS me006disp,g.na003 AS me047disp,
		  ...
		  b.th006, b.th007, b.th008, b.th009, b.th010, b.th011, b.th012,b.th013, b.th014,b.th016,b.th017,b.th018,b.th019,b.th031,i.me002 as th007disp,j.me002 as me005disp');
	...
	function updatef()   
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {
         ...
         $sql = " UPDATE invmc set me007=me007+'$th008'-'$th008a' WHERE me001 = '$th004'  AND me002 = '$th007'  "; 
		 $query = $this->db->query($sql);	} 
			  }
		...
		//	 while ($_POST['order_product'][  $n  ]['th004']) {
		   ...
		   //重新計算貨款 cstme
		  $sql = " UPDATE cstme set me013='$th035',me025='$th036',me031='$th045',me046='$th038',me033='$th008b' WHERE me001 = '$me001'  AND me002 = '$me002'  "; 
		 $query = $this->db->query($sql);		   
