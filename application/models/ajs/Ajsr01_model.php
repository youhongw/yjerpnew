...
class ajsr01_model extends CI_Model {
	...
	function selonebefore($seq1,$seq2)    
        {
		 $this->db->select('a.* ,c.mq002 AS tc001disp, d.ta002 AS tc007disp,e.mf002 AS tc008disp, f.mv002 AS tc006disp,g.na003 AS tc014disp,
		  ...
		  b.td006, b.td007, b.td008, b.td009, b.td010, b.td011, b.td012,b.td013, b.td014,b.td016,b.td020,b.td030,b.td031,i.mc002 as td007disp,j.ta002 as tc005disp');
	    ...
	    $this->db->join('cmsmb as d', 'a.tc007 = d.ta001 ','left');    //廠別
		...
		$this->db->join('cmsme as j', 'a.tc005 = j.ta001 ','left');   //部門
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq11 = "SELECT COUNT(*) as count  FROM `ajsta` ";
	      $seq1 = "ta001, ta002, ta003, ta004, ta005, ta006,ta007,tg13,ta025,ta042, create_date FROM `ajsta` ";
	...
	//新增一筆 檔頭  ajsta	
	function insertf()    //新增一筆 檔頭  ajsta
        {
		...
		//	 if ($this->input->post('ta018')!='1') {$ta019=round($this->input->post('ta019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->ajsr01_model->selone1($this->input->post('copq03a23'),$this->input->post('ta002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
             $this->db->insert('ajsta', $data);
			
		// 新增明細 copth
				//		$this->db->flush_cache();  
		// 新增明細 ajsta  主檔 copth 重計算合計金額 數量 庫存數量
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {		
	     ...
	     $exist = $this->ajsr01_model->selone1d($this->input->post('copq03a23'),$this->input->post('ta002'),$th003);
		...
		if ($_POST['order_product'][  $n  ]['th004']!='') {
		  ...
		  // 訂單已交數量
			 ...
			 $th016=$_POST['order_product'][ $n  ]['th016'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $existb = $this->ajsr01_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $th007=$_POST['order_product'][ $n  ]['th007'];
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $exista = $this->ajsr01_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  $sql = " UPDATE ajsta set ta013='$ta013',ta025='$ta025',ta033='$ta033',ta045='$ta045',ta046='$ta046' WHERE ta001 = '$ta001'  AND ta002 = '$ta002'  "; 
		  $query = $this->db->query($sql);	
				return true;			
		 }
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $seq1=$this->input->post('ta001c');    //主鍵一筆檔頭ajsta
            ...
            $exist = $this->ajsr01_model->selone2($this->input->post('ta001c'),$this->input->post('ta002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
             $this->db->insert('ajsta', $data);      //複製一筆  
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT ta001,ta002,ta024,ta004,ta011,ta003,create_date FROM ajsta WHERE ta001 >= '$seq1'  AND ta001 <= '$seq2' AND  ta002 >= '$seq3'  AND ta002 <= '$seq4'  "; 
	...
	//	  FROM ajsta as a, copth as b WHERE ta001=th001 and ta002=th002 and  ta001 >= '$seq1'  AND ta001 <= '$seq2' AND ta002 >= '$seq3'  AND ta002 <= '$seq4'  "; 
		 $query = $this->db->query($sql);
	...
	function printfd()          
        {
		  ...
		  $this->db->select('a.ta001,ta002,ta003,ta004,ta005,ta006,ta007,b.*,c.ma003 as tb005disp'); 
        $this->db->from('ajsta as a');	
        $this->db->join('ajstb as b', 'a.ta001 = b.tb001  and a.ta002=b.tb002 ','left');
		$this->db->join('actma as c', 'b.tb005 = c.ma001 ','left');
	...
	function updatef()   
        {
          ...
          $data = array(			
            ...
            $this->db->where('ta001', $this->input->post('copq03a23'));
			$this->db->where('ta002', $this->input->post('ta002'));
            $this->db->update('ajsta',$data);                   //更改一筆
		...
		//	 while ($_POST['order_product'][  $n  ]['th004']) {
		   ...
		   //重新計算貨款 ajsta
		  $sql = " UPDATE ajsta set ta013='$th035',ta025='$th036',ta031='$th045',ta046='$th038',ta033='$th008b' WHERE ta001 = '$ta001'  AND ta002 = '$ta002'  "; 
		 $query = $this->db->query($sql);		   
