...
class ajsi20_model extends CI_Model {
	...
	function selone($seq1,$seq2)    
        {
		  $this->db->select('a.*,f.mq002 as ta004disp , d.ma003 AS tb005disp,e.me002 AS tb006disp ,
		...
		$this->db->join('cmsmq as f', 'a.ta004 = f.mq001 ','left');  //單別
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
         {            		
	      ...
	      $seq1 = "ta001, ta002, ta003, ta004,ta007,ta008, ta011, ta012,ta016,ta015, create_date FROM `ajsta` ";
		...
		//下一頁不要跑掉 1050317
		if(@$_SESSION['ajsi20_sql_term']){$seq32 = $_SESSION['ajsi20_sql_term'];}
		if(@$_SESSION['ajsi20_sql_sort']){$seq33 = $_SESSION['ajsi20_sql_sort'];}
	...
	function insertf()    //新增一筆 檔頭  ajsta
		...
		//	 if ($this->input->post('ta018')!='1') {$ta019=round($this->input->post('ta019'));}
	     ...
	     $data = array( 
	      ...
	      $exist = $this->ajsi20_model->selone1($this->input->post('actq02a'),$this->input->post('ta002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		// 新增明細 ajstb
				//		$this->db->flush_cache(); 
            // 新增明細 ajstb  主檔 ajsta 重計算合計金額 數量
		...
		//	while ($_POST['order_product'][  $n  ]['tb004']) {		
	     ...
	     // $exist = $this->ajsi20_model->selone1d($this->input->post('purq04a34'),$this->input->post('ta002'));
		  if ($_POST['order_product'][  $n  ]['tb005'] >'0') {
		  $this->db->insert('ajstb', $data_array); }
			...
			//重新計算貨款 ajsta
		  $sql = " UPDATE ajsta set ta007='$ta0071',ta008='$ta0072' WHERE ta001 = '$ta001'  AND ta002 = '$ta002'  "; 
    ...
    function copyf()           
        {
         ...
         //   if ($query->num_rows() != 1) { return 'exist'; }
            ...
            $exist = $this->ajsi20_model->selone2($this->input->post('ta001c'),$this->input->post('ta002c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
          ...
          //  if ($query->num_rows() != 1) { return 'exist'; }
			...
			$seq1=$this->input->post('ta001c');    //主鍵一筆明細ajstb
			$seq2=$this->input->post('ta002c'); 
              $i=0;
            while ($i<$num) {	
			  $data_array = array( 
             ...
             $this->db->insert('ajstb', $data_array);      //複製一筆 
             $i++;			 
            }
             return true;		
	   }
	...
	function excelnewf()           
	  ...
	  //    $sql = " SELECT ta001,ta002,ta024,ta004,ta011,ta003,create_date FROM ajsta WHERE ta001 >= '$seq1'  AND ta001 <= '$seq2' AND  ta002 >= '$seq3'  AND ta002 <= '$seq4'  "; 
	   ...
	   $sql = " SELECT a.ta001,a.ta002,a.ta003,a.ta004,c.ma002 as ta004disp,b.tb003,b.tb004,b.tb005,b.tb006,b.tb007,b.tb008,
		  ...
		  FROM ajsta as a, ajstb as b,copma as c WHERE ta001=tb001 and ta002=tb002 and a.ta004=c.ma001 and ta001 >= '$seq1'  AND ta001 <= '$seq2' AND ta002 >= '$seq3'  AND ta002 <= '$seq4'  "; 
		 $query = $this->db->query($sql);
	...
	function printfd()          
        {
		 ...
		 b.company, b.creator, b.usr_group, b.create_date, b.modifier, b.modi_date, b.flag, b.tb001, b.tb002, b.tb003, b.tb004, b.tb005,
		  b.tb006, b.tb007, b.tb008, b.tb009, b.tb010, b.tb011, b.tb012,b.tb013, b.tb014,b.tb015, b.tb016,b.tb017,b.tb018
		  FROM ajsta as a left join ajstb as b on ta001=tb001 and ta002=tb002 
