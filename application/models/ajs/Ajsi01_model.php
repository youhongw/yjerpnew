...
class Ajsi01_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)    
	    ...
	    $seq11 = "SELECT COUNT(*) as count  FROM `ajsma` ";
	    $seq1 = " ma001, ma002, ma003, ma004, ma005, ma006, create_date FROM `ajsma` ";
	...
	function insertf()    
	    ...
	    $exist = $this->ajsi01_model->selone1($this->input->post('ma001'),$this->input->post('ma002'));
	    if ($exist)
	        {
		    return 'exist';
		} 
            return  $this->db->insert('ajsma', $data);
        }
    ...
    function copyf()          
        ...
        $exist = $this->ajsi01_model->selone2($this->input->post('ma003c'),$this->input->post('ma004c'));
		if ($exist)
		   {
		    return 'exist';
		   }         
            return $this->db->insert('ajsma', $data);      //複製一筆  
        }
	...
	function excelnewf()           
	    ...
	    $seq4=$this->input->post('ma004c'); 
	    $sql = " SELECT ma001,ma002,ma003,ma004,ma005,ma006,create_date FROM ajsma WHERE ma001 >= '$seq1'  AND ma001 <= '$seq2' AND ma002 >= '$seq3' AND ma002 <= '$seq4' "; 
	...
	function printfd()           
	    ...
	    $seq3=$this->input->post('ma003c'); 
	    $seq4=$this->input->post('ma004c'); 
	    $sql = " SELECT * FROM ajsma WHERE ma001 >= '$seq1'  AND ma001 <= '$seq2' AND ma002 >= '$seq3' AND ma002 <= '$seq4' "; 
        $query = $this->db->query($sql);
	    $ret['rows'] = $query->result();
	...
	function updatef()   
          {
			...
			$this->load->vars($data);
            $this->db->where('ma000', '001');
            $this->db->update('ajsma',$data);                   //更改一筆
