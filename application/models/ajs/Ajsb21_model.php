...
class ajsb21_model extends CI_Model {
	...
	function batchaf()           
        {
		   ...
		   //刪除付款單201-204號		   
		    $sql00 ="update acptc set tc015='N',tc201='',tc202='',tc203='',tc204='' where tc201='$vtd001' and tc202='$vtd002' ";   
	...
	function batchbf()           
        {
			...
			$vtd002=$this->input->post('td002c');
		   //刪除付款單201-204號		   
		    $sql00 ="update acrtc set tc016='N',tc201='',tc202='',tc203='',tc204='' where tc201='$vtd001' and tc202='$vtd002' ";   
	        $query=$this->db->query($sql00);
