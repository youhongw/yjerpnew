	 ...
	 */
	 function __construct()
	  ...
	  function search($limit, $offset, $sort_by, $sort_order) {
		...
		$sort_columns = array('ma001', 'ma002', 'ma003', 'ma004', 'ma005', 'ma006');
		$sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'ma001';
		
		// results query
		$q = $this->db->select('ma001, ma002, ma003, ma004, ma005, ma006')
			->from('invma')
			->limit($limit, $offset)
