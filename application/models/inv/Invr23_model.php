...
class Invr23_model extends CI_Model {
	...
	function printfd()          
        {
		 ...
		 // $vdate=$this->input->post('vdate');  //年月
		     preg_match_all('/\d/S',$this->input->post('vdate'), $matches);  //處理日期字串
			 $vdate = implode('',$matches[0]);
	   
		$sql2="select a.lc002,a.lc001,sum(a.lc004) as lc004,sum(a.lc006) as lc006,sum(a.lc008) as lc008,
		sum(a.lc010) as lc010,sum(a.lc012) as lc012,sum(a.lc014) as lc014,sum(a.lc016) as lc016,sum(a.lc018) as lc018,sum(a.lc020) as lc020,
		sum(a.lc022) as lc022,sum(a.lc024) as lc024,sum(a.lc031) as lc031,sum(a.lc033) as lc033,sum(a.lc035) as lc035,sum(a.lc037) as lc037,
		sum(a.lc041) as lc041,lc043,b.mb002 as lc001disp,b.mb003 as lc001disp1,mc002 as lc003disp
		from invlc as a left join invmb as b on a.lc001=b.mb001 left join cmsmc as c on a.lc003=c.mc001
		where a.lc001>='$seq1' and a.lc001<='$seq2' and   a.lc002='$vdate'
		group by lc002,lc001
		order by lc002,lc001
		"; 
		$query = $this->db->query($sql2);
		//$query = $this->db->get();
		
       $ret['rows'] = $query->result();  
          $seq32 = " a.lc001>='$seq1' and a.lc001<='$seq2' and   a.lc002='$vdate'   ";	
