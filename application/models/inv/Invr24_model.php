...
class Invr24_model extends CI_Model {
	...
	function printfd()          
        ...
        $sql5 = "SELECT A.TB004,B.QTY1,B.QTY2,A.QTY3,C.QTY4,D.QTY5 FROM (SELECT TB004,SUM(TB009) AS QTY3 FROM PURTA,PURTB WHERE TA001 = TB001 AND TA002 = TB002 AND TA001 = '3131' AND TB004 = '$seq1' AND TA003 >= '$seq3' AND TA003 <= '$seq4'
		GROUP BY TB004) A 

		LEFT JOIN (SELECT TD004 ,SUM(TD008-TD015) AS QTY2 ,SUM(TD015) AS QTY1 FROM PURTC,PURTD WHERE TC001 = TD001 AND TC002 = TD002 AND TD004 = '$seq1' AND TC001 = '3300' AND TC003 >= '$seq3' AND TC003 <= '$seq4'
		GROUP BY TD004) B ON A.TB004 = B.TD004 

		LEFT JOIN (SELECT TH004,SUM(TH015) AS QTY4 FROM PURTG,PURTH WHERE TG001 = TH001 AND TG002 = TH002 AND TG001 = '3400' AND TH004 = '$seq1' AND TG003 >= '$seq3' AND TG003 <= '$seq4'
		GROUP BY TH004) C ON A.TB004 = C.TH004 

		LEFT JOIN (SELECT TI004,SUM(TI007) AS QTY5 FROM MOCTH,MOCTI WHERE TH001 = TI001 AND TH002 = TI002 AND TH001 = '590' AND TI004 = '$seq1' AND TH003 >= '$seq3' AND TH003 <= '$seq4'
		GROUP BY TI004) D ON A.TB004 = D.TI004 ";
		  
		$query = $this->db->query($sql5);
		$ret['rows'] = $query->result();

		$sql_chk = "SELECT COUNT(*) AS NUM FROM INVMB WHERE MB001 = '$seq1'";
		...
		$sql6 = "SELECT MB001,MB002,MB003 FROM INVMB WHERE MB001 = '$seq1'";
