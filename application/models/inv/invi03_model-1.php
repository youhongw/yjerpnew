...
class Invi03_model extends CI_Model {
	   ...
	   function insertf()    //新增一筆
        {
		  ...
		  $exist = $this->invi03_model->selone1($this->input->post('ma001'),$this->input->post('ma002'));
		  if ($exist)
		    {
			  return 'exist';
		    } 
      ...
      function copyf()           //複製一筆
        {
		  ...
		  $data = array( 
            ...
            $exist = $this->invi03_model->selone2($this->input->post('ma003c'),$this->input->post('ma004c'));
		    if ($exist)
		      {
			    return 'exist';
		      }         
