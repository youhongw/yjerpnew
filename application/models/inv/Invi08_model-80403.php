...
class Invi08_model extends CI_Model {
	...
	function selone($seq1,$seq2)    
        {
		  $this->db->select('a.*,i.mc002 as ta018disp,j.mc002 as ta019disp ,c.mq002 AS ta001disp, d.me002 AS ta004disp, e.mb002 AS ta008disp,
		  b.company, b.creator, b.usr_group, b.create_date, b.modifier, b.modi_date, b.flag, b.tb001, b.tb002, b.tb003, b.tb004, b.tb005,
		  b.tb006, b.tb008, b.tb009, b.tb010, b.tb011,b.tb012,b.tb013,g.mc002 as tb012disp,h.mc002 as tb013disp,b.tb017,b.tb020');
	...
	//	$this->db->join('invmb as f', 'b.tb004 = f.mb001 ','left');  //品號
        ...
        $this->db->join('cmsmc as h', 'b.tb013 = h.mc001 ','left');  //庫別
        $this->db->join('cmsmc as i', 'a.ta018 = i.mc001 ','left');  //庫別a
		$this->db->join('cmsmc as j', 'a.ta019 = j.mc001 ','left');  //庫別b		
	...
	function insertf()    //新增一筆 檔頭  invta 
        {
			 $ta001=$this->input->post('invq04a12');
	     ...
	     $data = array( 
				 ...
				 'ta018' => $this->input->post('cmsq03a2'),
				 'ta019' => $this->input->post('cmsq03a3')
                );
         
	      $exist = $this->invi08_model->selone1($this->input->post('invq04a12'),$this->input->post('ta002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		//	while ($_POST['order_product'][  $n  ]['tb004']) {
			 while (isset($_POST['order_product'][  $n  ]['tb004'])) {	
			   $data_array = array( 
		         ...
		         'modi_date' => '',
		         'flag' => 0,
                 'tb001' => $this->input->post('invq04a12'),
			...
			//	 'tb013' =>  $_POST['order_product'][ $n  ]['tb013'],
			     'tb012' =>  $this->input->post('cmsq03a2'),
				 'tb013' =>  $this->input->post('cmsq03a3'),
				 'tb017' =>  $_POST['order_product'][ $n  ]['tb017'],
				 'tb020' =>  $_POST['order_product'][ $n  ]['tb020']
                );   
						 
	      $exist = $this->invi08_model->selone1d($this->input->post('invq04a12'),$this->input->post('ta002'),$tb003);
		  ...
		  //庫存增加減少 品號,庫別, 數量
			 ...
			 $tb012=$_POST['order_product'][ $n  ]['tb012'];
			 $tb009=$_POST['order_product'][ $n  ]['tb009'];
			 $exista = $this->invi08_model->selone2d($tb004,$tb012);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
		  ...
		  $ta012=$ta012+$_POST['order_product'][ $n  ]['tb011'];
			...
			//庫存增加減少 品號,庫別, 數量
			 ...
			 $tb012=$_POST['order_product'][ $n  ]['tb012'];
			 $tb009=$_POST['order_product'][ $n  ]['tb009'];
			 $th009b=$th009b+$_POST['order_product'][ $n  ]['tb009'];
			 $exista = $this->invi08_model->selone2d($tb004,$tb012);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
