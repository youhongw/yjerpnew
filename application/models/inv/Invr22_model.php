...
class Invr22_model extends CI_Model {
	...
	function printfd()          
		...
		$sql2="select a.lc003,a.lc002,a.lc001,sum(a.lc004) as lc004,sum(a.lc006) as lc006,sum(a.lc008) as lc008,
		...
		where a.lc001>='$seq1' and a.lc001<='$seq2' and  a.lc003>='$seq3' and a.lc003<='$seq4' and a.lc002='$vdate'
		group by lc003,lc002,lc001
		order by lc003,lc002,lc001
		"; 
		$query = $this->db->query($sql2);
		//$query = $this->db->get();
		
       $ret['rows'] = $query->result();  
          $seq32 = " a.lc001>='$seq1' and a.lc001<='$seq2' and  a.lc003>='$seq3' and a.lc003<='$seq4' and a.lc002='$vdate'   ";	
