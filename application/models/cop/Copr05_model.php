...
class Copr05_model extends CI_Model {
	...
	function printfd()          
        {
		  ...
		  $seq5=$this->input->post('cmsq09a3');  //業務員
	      $seq6=$this->input->post('cmsq09a31');
		  
		  $seq7=$this->input->post('th004');   //品號
	      $seq8=$this->input->post('th0041');
	...
	/*	$this->db->select('a.* ,c.mq002 AS tc001disp, d.mb002 AS tc007disp,e.mf002 AS tc008disp, f.mv002 AS tc006disp,g.na003 AS tc014disp,
		...
		$query = $this->db->get(); */
		  ...
		  //客戶代號,客戶名稱,品號,品名,規格,單位,數量,金額, 成本金額, 毛利
	     $sql = " SELECT a.tg004,c.ma002 as tg004disp,b.th004,b.th005,b.th006,b.th009,sum(b.th008) as th008,sum(b.th013) as th013,
		  (d.mb057+d.mb058+d.mb059+d.mb060)*sum(b.th008) as th013a,sum(b.th013)-((d.mb057+d.mb058+d.mb059+d.mb060)*sum(b.th008)) as th013b
		  FROM coptg as a
		  LEFT JOIN copth as b ON a.tg001=b.th001 and a.tg002=b.th002 
		  LEFT JOIN copma as c ON a.tg004=c.ma001 
		  LEFT JOIN invmb as d ON b.th004=d.mb001
		  WHERE th008>0 and  tg004 >= '$seq1'  AND tg004 <= '$seq2' AND tg042 >= '$seq3'  AND tg042 <= '$seq4'  AND tg006 >= '$seq5'  AND tg006 <= '$seq6' AND th004 >= '$seq7'  AND th004 <= '$seq8'
          GROUP BY c.ma002,a.tg004,b.th004,b.th005,b.th006,b.th009
		  UNION
          SELECT a.ti004 as tg004,c.ma002 as tg004disp,b.tj004 as th004,b.tj005 as th005,b.tj006 as th006,b.tj008 as th009,sum(b.tj007)*-1 as th008,sum(b.tj012)*-1 as th013,
		  (d.mb057+d.mb058+d.mb059+d.mb060)*sum(b.tj007)*-1 as th013a,sum(b.tj012)-((d.mb057+d.mb058+d.mb059+d.mb060)*sum(b.tj007)) as th013b
           FROM copti as a
		  LEFT JOIN coptj as b ON a.ti001=b.tj001 and a.ti002=b.tj002 
		  LEFT JOIN copma as c ON a.ti004=c.ma001 
		  LEFT JOIN invmb as d ON b.tj004=d.mb001
		  WHERE tj007>0 and ti004 >= '$seq1'  AND ti004 <= '$seq2' AND ti034 >= '$seq3'  AND ti034 <= '$seq4'  AND ti006 >= '$seq5'  AND ti006 <= '$seq6' AND tj004 >= '$seq7'  AND tj004 <= '$seq8'
		  GROUP BY c.ma002,a.ti004,b.tj004,b.tj005,b.tj006,b.tj008
		  "; 
          $query = $this->db->query($sql); 
	      $ret['rows'] = $query->result();  
          $seq32 = "tg004 >= '$seq1'  AND tg004 <= '$seq2' AND tg042 >= '$seq3'  AND tg042 <= '$seq4'  AND tg006 >= '$seq5'  AND tg006 <= '$seq6' ";	
