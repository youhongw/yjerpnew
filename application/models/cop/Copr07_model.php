...
class Copr07_model extends CI_Model {
	...
	function printfd()          
        {
	      ...
	      $seq8=$this->input->post('th0041');
		   ...
		   $this->db->where('th004 >', '0');
		   $this->db->delete('copth2'); 
		  //產品代號,產品名稱,品號,品名,規格,單位,數量,金額, 成本金額, 毛利
	     $sql9 = " SELECT b.th004,b.th005,b.th006,b.th009,sum(b.th008) as th008,sum(b.th013) as th013
		  FROM coptg as a
		  ...
		  UNION
          SELECT b.tj004 as th004,b.tj005 as th005,b.tj006 as th006,tj008 as th009 ,sum(b.tj007)*-1 as th008,sum(b.tj012)*-1 as th013		  
           FROM copti as a
   ...
   // while($row=mysql_fetch_assoc($result)){
		...
		$data1 = array(
		  ...
		  if ($th004>'0') {
			   $this->db->insert('copth2', $data1);		   
			   }
	}
		   $sql = " SELECT th004,th005,th006,th009,sum(th008) as th008,sum(th013) as th013 FROM copth2
		             GROUP BY  th004,th005,th006,th009  ORDER BY th008 desc "; 
