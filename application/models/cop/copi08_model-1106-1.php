...
class copi08_model extends CI_Model {
	...
	function search($limit, $offset, $sort_by, $sort_order)     
	    { 
	     ...
	     $query = $this->db->select('a.tg001, a.tg002, a.tg042, a.tg004,b.ma002 as tg004disp,  a.tg013, a.tg025,a.tg024,a.create_date')
	                       ->from('coptg as a')
	...
	function filterf1($limit, $offset , $sort_by  , $sort_order)          
	    {    
	      ...
	      $this->db->select('tg001, tg002, tg042, tg004,b.ma002 as tg004disp, tg007, tg013,tg025,a.tg024, a.create_date');
	      $this->db->from('coptg as a');
