...
class Copr08_model extends CI_Model {
	...
	/*	$this->db->select('a.* ,c.mq002 AS tc001disp, d.mb002 AS tc007disp,e.mf002 AS tc008disp, f.mv002 AS tc006disp,g.na003 AS tc014disp,
		...
		$query = $this->db->get(); */
		  ...
		  //品號,品名,規格,單位,數量,金額, 成本金額, 毛利
	     $sql = " SELECT b.th004,b.th005,b.th006,b.th009,sum(b.th008) as th008,sum(b.th013) as th013,
          ...
          GROUP BY b.th004,b.th005,b.th006,b.th009
		  UNION
          SELECT b.tj004 as th004,b.tj005 as th005,b.tj006 as th006,b.tj008 as th009,sum(b.tj007)*-1 as th008,sum(b.tj012)*-1 as th013,
		  ...
		  GROUP BY b.tj004,b.tj005,b.tj006,b.tj008
		  "; 
