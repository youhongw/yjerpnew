...
class Copr28_model extends CI_Model {
	...
	function printfd()          
		...
		//  $seq3=$this->input->post('dateo');   //日期 
		  ...
		  $seq1=$this->input->post('cuso');
		  $seq2=$this->input->post('cusc');
		  ...
		  //取銷貨資料
			$sql = "select concat(`ma002`,':',`th004`) as th004, `th005`, `th006`, `th009`,substring(tg042 ,1,6) as gp_th002, round(sum(th008)) as th008 
			        from copth as a 
				    LEFT JOIN coptg as b on a.th002 = b.tg002 and a.th001=b.tg001 
					LEFT JOIN copma as c on b.tg004 = c.ma001 
		  ...
		  //取銷退資料
			$sql = "select concat(`ma002`,':',`tj004`) as tj004, `tj005`, `tj006`, `tj008`, substring(ti034 ,1,6) as gp_tj002, sum(tj034) as tj034 
			        from coptj as a
                    LEFT JOIN copti as b on a.tj002 = b.ti002 and a.tj001=b.ti001 
                    LEFT JOIN copma as c on b.ti004 = c.ma001 					
