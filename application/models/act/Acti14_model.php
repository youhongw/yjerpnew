...
class Acti14_model extends CI_Model {
	...
	function insertf()    
	    ...
	    $exist = $this->acti14_model->selone1($this->input->post('ma001'),$this->input->post('ma002'));
	    if ($exist)
	        {
		    return 'exist';
		} 
    ...
    function copyf()          
        ...
        $exist = $this->acti14_model->selone2($this->input->post('ma003c'),$this->input->post('ma004c'));
		if ($exist)
		   {
		    return 'exist';
		   }         
