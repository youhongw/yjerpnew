...
class Acti10_model extends CI_Model {
	...
	function selone($seq1,$seq2)    
	    ...
	    $this->db->select('b.*,d.ma003 as tb005disp,e.me002 as tb006disp')
			->from('acttb as b')
	...
	//修改-已過帳資料
	  ...
	  {
		$this->db->select('b.*,d.ma002 as tb005disp,e.me002 as tb006disp,a.ta003')
			->from('acttb as b')
			->join('actta as a', 'a.ta001 = b.tb001  and a.ta002=b.tb002 ','left')
			->join('actma as d', 'b.tb005 = d.ma001 ','left')   //科目代號
			->join('cmsme as e', 'b.tb006 = e.me001 ','left')   //部門
		...
		while ($i<$ii) {
		       if ($tb004[$i]==1) {
				$sql2= "update actmb set mb009=mb009-'$tb015[$i]',mb004=mb004-'$tb007[$i]',
					        mb006=mb006-1						
					    where  mb001='$tb005[$i]' and mb002='$yy' and mb003='$mm' and mb008='$tb013[$i]' ";
				$this->db->query($sql2); }
				
				if ($tb004[$i]==-1) {
				$sql3= "update actmb set mb010=mb010-'$tb015[$i]',mb005=mb005-'$tb007[$i]',
					        mb007=mb007-1						
					    where  mb001='$tb005[$i]' and mb002='$yy' and mb003='$mm' and mb008='$tb013[$i]' ";
				$this->db->query($sql3); }
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
		...
		//下一頁不要跑掉 1050317
		if(@$_SESSION['acti10_sql_term']){$seq32 = $_SESSION['acti10_sql_term'];}
		if(@$_SESSION['acti10_sql_sort']){$seq33 = $_SESSION['acti10_sql_sort'];}
	...
	function deletedetailf($seg1,$seg2,$seg3)
        { 
		  $this->selold_del($seg1,$seg2,$seg3);
	      $this->db->where('tb001', $seg1);
	      $this->db->where('tb002', $seg2);
	      $this->db->where('tb003', $seg3);
          $this->db->delete('acttb'); 
