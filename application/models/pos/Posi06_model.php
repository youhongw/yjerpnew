...
class posi06_model extends CI_Model {
	...
	function insertf()   
       {
	    ...
	    $exist = $this->posi06_model->selone1($this->input->post('md001'),$this->input->post('md002'));
	    if ($exist)
	      {
		    return 'exist';
		  } 
    ...
    function copyf()           //複製一筆
       {
	    ...
	    $data = array( 
            ...
            $exist = $this->posi06_model->selone2($this->input->post('md002c'),$this->input->post('md004c'));
		    if ($exist)
		      {
			   return 'exist';
		      }         
