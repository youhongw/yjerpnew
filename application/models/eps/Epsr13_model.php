...
class epsr13_model extends CI_Model {
	...
	function printfd()          
	    ...
	    //  $seq4=$this->input->post('tc002c');
		  ...
		  if ($seq6=='') {$seq6='zz';}
		  if ($seq8=='') {$seq8='zz';}
		  $this->db->select('a.*,b.ma002 as tf003disp,f.mb002 as tf004disp,c.mo002 as tf005disp,d.mo002 as tf006disp,e.mo002 as tf007disp'); 
		...
		$this->db->join('cmsmb as f','a.tf004=f.mb001','left');
        ...
        $this->db->where('a.tf003 >=', $seq7); 
	    $this->db->where('a.tf003 <=', $seq8); 		
