...
class Acrr03_model extends CI_Model {
	...
	function printfd()          
	   ...
	   //   $seq10=$this->input->post('tc0021');
		...
		//銷貨
          $this->db->select('a.ta004,h.ma003 as ta004disp,h.ma015 as tb021,k.me002 as tb021disp,h.ma004,h.ma005,h.ma006,h.ma008,ma027,
		                  a.ta015,b.tb004,m.tg003,m.tg002,l.th005,l.th006,th008,l.th012,l.th013,m.tg044
		                         ');		
      ...
      //  if ($seq11 != "A")	{$this->db->where('upper(b.td016)', $seq11); }	
        ...
        $this->db->select('a.ta004,h.ma003 as ta004disp,h.ma015 as tb021,k.me002 as tb021disp,h.ma004,h.ma005,h.ma006,h.ma008,ma027,
		                  a.ta015,b.tb004,m.ti003 as tg003,m.ti002 as tg002 ,l.tj005 as th005,l.tj006 as th006,(l.tj007 * -1) as th008,l.tj011 as th012,(l.tj012 * -1) as th013,m.ti036 as tg044
		                         ');		
