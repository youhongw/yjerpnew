...
class acrr17_model extends CI_Model {
	...
	function printfd()          
	  ...
	  //    $seq4=substr($this->input->post('datec'),0,4).substr($this->input->post('datec'),5,2).substr(rtrim($this->input->post('datec')),8,2);
		 $seq3=substr($this->input->post('dateo'),0,4).substr($this->input->post('dateo'),5,2).'01';
		 $seq4=substr($this->input->post('datec'),0,4).substr($this->input->post('datec'),5,2).'31';
		 $seq5=$this->input->post('cmsq09a3');   //業務 
	      $seq6=$this->input->post('cmsq09a31');
		  
	
		  
	/*      $sql = " SELECT substr(a.ta003,1,6) as yymm,a.ta004,b.ma002 as ta004disp,b.ma016,ma031,a.ta009,sum(((a.ta029+a.ta030))-(a.ta031)) as amt
		  FROM acrta  a
		  LEFT JOIN copma as b ON a.ta004=b.ma001 
		  WHERE  a.ta025='Y' and substr(a.ta001,1,2)='61' and ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND
		  ta003 <= '$seq4'  AND ma016 >= '$seq5'  AND ma016 <= '$seq6' and ((a.ta029+a.ta030))-(a.ta031)<>0
group  by substr(a.ta003,1,6),a.ta004,b.ma002,b.ma016,ma031,a.ta009
union
SELECT substr(a.ta003,1,6) as yymm,a.ta004,b.ma002 as ta004disp,b.ma016,ma031,a.ta009,sum(a.ta029+a.ta030-a.ta031)*-1 as amt
		  FROM acrta  a
		  LEFT JOIN copma as b ON a.ta004=b.ma001 
		  WHERE  a.ta025='Y' and substr(a.ta001,1,2)<>'61' and ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND
		  ta003 <= '$seq4'  AND ma016 >= '$seq5'  AND ma016 <= '$seq6' and (a.ta029+a.ta030-a.ta031)<>0
group  by substr(a.ta003,1,6),a.ta004,b.ma002,b.ma016,ma031,a.ta009 ";  */
    ...
    $sql = " SELECT substr(a.ta003,1,6) as yymm,a.ta004,b.ma002 as ta004disp,b.ma016,ma031,a.ta009,1 as item,sum(a.ta029+a.ta030-a.ta031) as amt
		  FROM acrta  a
		  LEFT JOIN copma as b ON a.ta004=b.ma001 
		  WHERE  a.ta025='Y'  and ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND
		  ta003 <= '$seq4'  AND ma016 >= '$seq5'  AND ma016 <= '$seq6' and a.ta029>=0 and (a.ta029+a.ta030-a.ta031) != 0
group  by substr(a.ta003,1,6),a.ta004,b.ma002,b.ma016,ma031,a.ta009
union
SELECT substr(a.ta003,1,6) as yymm,a.ta004,b.ma002 as ta004disp,b.ma016,ma031,a.ta009,-1 as item,sum(a.ta029+a.ta030+a.ta031)*-1 as amt
		  FROM acrta  a
		  LEFT JOIN copma as b ON a.ta004=b.ma001 
		  WHERE  a.ta025='Y'  and ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND
		  ta003 <= '$seq4'  AND ma016 >= '$seq5'  AND ma016 <= '$seq6' and a.ta029<0   and (a.ta029+a.ta030+a.ta031) != 0
group  by substr(a.ta003,1,6),a.ta004,b.ma002,b.ma016,ma031,a.ta009  order by ta004 asc,yymm asc,item desc" ; 


          $query = $this->db->query($sql); 
	      $ret['rows'] = $query->result();  
          $seq32 = "ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND 
		  ta003 <= '$seq4'  AND ta005 >= '$seq5'  AND ta005 <= '$seq6' and ((a.ta029+a.ta030))-(a.ta031)<>0  and a.ta025='Y' and substr(a.ta001,1,2)='62'  ";	
	      $query = $this->db->select('COUNT(*) as count', FALSE)  //筆數查詢,如果設為FALSE不會使用反引號保護你的字段或者表名
		              ->from('acrta as a')
		              ->where($seq32);
	      $num = $query->get()->result();		
	...
	function updatef()   
		...
		//	while ($_POST['order_product'][  $n  ]['th004']) {
			while (isset($_POST['order_product'][  $n  ]['th004'])) {
			 ...
			 $existb = $this->acrr17_model->selone3d($th014,$th015,$th016);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
		 ...
		 $query = $this->db->query($sql);	} 
			 ...
			 $th008=$_POST['order_product'][ $n  ]['th008'];
			 $th008a=$_POST['order_product'][ $n  ]['th008a'];
			 $exista = $this->acrr17_model->selone2d($th004,$th007);
			  $data_add = array( 
	             'company' => $this->session->userdata('syscompany'),
	             'creator' => $this->session->userdata('manager'),
		         'usr_group' => 'A100',
