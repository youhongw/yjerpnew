...
class Asti15_model extends CI_Model {
	...
	function selone()
	    { 
		 $query = $this->db->select('a.*,b.mq002 as me001disp, c.mq002 as me002disp, d.ma003 as acti03disp, e.ma003 as acti03adisp')
            ->from('astme as a')
			->join('cmsmq as b','a.me001 = b.mq001','left')
			->join('cmsmq as c','a.me001 = c.mq001','left')
			->join('actma as d','a.me003 = d.ma001','left')
			->join('actma as e','a.me003 = e.ma001','left');
	...
	function updatef()   
	  {
		$data = array(
			...
			'modi_date' =>date("Ymd"),
			'flag' => '0',
			'me001' => $this->input->post('asti03_asti15'),
			'me002' => $this->input->post('asti03_asti15b'),
			'me003' => $this->input->post('acti03'),
			'me004' => $this->input->post('acti03a'),
		...
		$this->db->update('astme',$data);                   //更改一筆
