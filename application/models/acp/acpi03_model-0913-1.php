...
class Acpi03_model extends CI_Model {
	...
	function lookup($keyword,$seq5){     
	  ...
	  $this->db->select('ta001, ta002, ta008,ta009,abs(ta028+ta029) as ta0281,abs(ta028+ta029-ta030) as ta0301,abs(ta037+ta038) as ta0371,ta019,ta021,ta004');
	  $this->db->from('acpta');
	...
	function findf($limit, $offset, $sort_by, $sort_order)     
		...
		if(@$_SESSION['admi05_sql_sort']){$seq33 = $_SESSION['admi05_sql_sort'];}
         ...
         $sort_order = (substr($sort_order,0,3) == 'asc') ? 'asc' : 'desc';
	     $sort_columns = array('tc001', 'tc002', 'tc003','b.ma002', 'tc004', 'tc013', 'tc018','tc007','tc008','tc010','tc011','create_date');
	     $sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'tc001';  //檢查排序欄位是否在 table 內
