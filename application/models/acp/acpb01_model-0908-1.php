...
class Acpb01_model extends CI_Model {
	...
	function batchaf()           
        {
		  ...
		  $btg003=substr($this->input->post('ta034c'),0,4).substr($this->input->post('ta034c'),5,2).substr(rtrim($this->input->post('ta034c')),8,2);
	      $etg003=substr($this->input->post('ta034o'),0,4).substr($this->input->post('ta034o'),5,2).substr(rtrim($this->input->post('ta034o')),8,2);
   ...
   $n=2;
    ...
    $sql="select tg001,tg002,tg003,tg004,tg005,tg006,tg007,tg008,tg010,tg017-tg018 as tg017,tg019,tg016,tg030,tg031,tg032
	  ...
	  where  tg001=th001 AND tg002=th002 and tg005=ma001  AND tg005 >= '$btg005' AND tg005 <= '$etg005' AND tg003 >= '$btg003' AND tg003<='$etg003' AND tg005 !='' AND tg013='Y' AND tg015='N'
    ...
    while($row=mysql_fetch_assoc($result)){
        foreach($row as $i=>$v){
		  ...
		  if ($vdail==0) {$vtb010=$tg004;  }            //第一筆 廠商相等 1040306
	...
	$sql92 =" update purtg as c,(select tb005,tb006,tg015 from acptb as b,purtg as c
                   where  tb005=tg001 and tb006=tg002
                      and tg005 >= '$btg005' AND tg005 <= '$etg005' AND tg003 >= '$btg003' AND tg003<='$etg003' AND tg005 !='' AND tg013='Y' AND tg015='N'
                ) d
               set c.tg015='Y'
...
$this->db->query($sql92);
   ...
   $n=2;
    ...
    $sql="select ti001 as tg001,ti002 as tg002,ti003 as tg003,ti005 as tg004,ti004 as tg005,ti006 as tg007,ti007 as tg008,ti009 as tg010
	  ...
	  where  ti001=tj001 AND ti002=tj002 and ti004=ma001  AND ti004 >= '$btg005' AND ti004 <= '$etg005' AND ti003 >= '$btg003' AND ti003<='$etg003' AND ti004 !='' AND ti013='Y' AND ti020='N'
	...
	//退貨單更新碼N 改 Y TI020 
	$sql93 =" update purti as c,(select tb005,tb006,ti020 from acptb as b,purti as c
                   where  tb005=ti001 and tb006=ti002
                      and ti004 >= '$btg005' AND ti004 <= '$etg005' AND ti003 >= '$btg003' AND ti003<='$etg003' AND ti004 !='' AND ti013='Y' AND ti020='N'
                ) d
               set c.ti020='Y'
