...
class Acpi02_model extends CI_Model {
	...
	function lookup($keyword,$seq5){     
     ...
     //  $this->db->select('mb001, mb002, mb003,mb004,mb017,b.mc002 as mb017disp');
	   $this->db->select('th001, th002, th003,th004,th019,th045,th046,th047,th048,b.tg005');
	  $this->db->from('purth as a');
	  $this->db->join('purtg as b', "a.th001=b.tg001 and a.th002=b.tg002 and b.tg005>='$seq5' ",'left'); 
