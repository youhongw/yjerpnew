...
class acpr12_model extends CI_Model {
	 ...
	 //     $seq4=substr($this->input->post('datec'),0,4).substr($this->input->post('datec'),5,2).substr(rtrim($this->input->post('datec')),8,2);
		...
		// $seq4=$this->input->post('datec');
		 $seq5=$this->input->post('cmsq06a');   //幣別
	      ...
	      $sql = " SELECT substr(a.ta003,1,6) as yymm, a.ta004, b.ma002 as ta004disp, b.ma024, ma025,ta008,(sum(a.ta028+a.ta029)-sum(a.ta030)) as amt
		  FROM acpta as a
		  LEFT JOIN purma as b ON a.ta004=b.ma001 
		  LEFT JOIN acptb as c ON a.ta001=c.tb001 and a.ta002=c.tb002 
		  WHERE  a.ta024='Y' and ma024>='0' and substr(a.ta001,1,2)='71' and ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND
		  ta003 <= '$seq4'  AND ta008 = '$seq5'  AND (a.ta028+a.ta029)-(a.ta030)<>0  
group  by substr(a.ta003,1,6),a.ta004,b.ma002,b.ma024,ma025,ta008 "; 

          $query = $this->db->query($sql); 
	      $ret['rows'] = $query->result();  
          $seq32 = "ta004 >= '$seq1'  AND ta004 <= '$seq2' AND ta003 >= '$seq3'  AND 
		  ta003 <= '$seq4'  AND  ta008 = '$seq5' AND (a.ta029+a.ta030)-(a.ta031)<>0  and a.ta024='Y' and substr(a.ta001,1,2)='71'  ";	
	      $query = $this->db->select('COUNT(*) as count', FALSE)  //筆數查詢,如果設為FALSE不會使用反引號保護你的字段或者表名
		              ->from('acpta as a')
		              ->where($seq32);
	      $num = $query->get()->result();		
