...
$this->db->query($sql92);
   ...
   $n=2;
    ...
    $sql="select ti001 as tg001,ti002 as tg002,ti003 as tg003,ti014 as tg014,ti005 as tg004,ti004 as tg005,ti006 as tg007,ti007 as tg008,ti009 as tg010
	  ...
	  where  ti001=tj001 AND ti002=tj002 and ti004=ma001  AND ti004 >= '$btg005' AND ti004 <= '$etg005' AND ti014 >= '$btg003' AND ti014<='$etg003' AND ti004 !='' AND ti013='Y' AND ti020='N'
	...
	$sql93 =" update purti as c,(select tb005,tb006,ti020 from acptb as b,purti as c
                   where  tb005=ti001 and tb006=ti002
                      and ti004 >= '$btg005' AND ti004 <= '$etg005' AND ti014 >= '$btg003' AND ti014<='$etg003' AND ti004 !='' AND ti013='Y' AND ti020='N'
                ) d
               set c.ti020='Y'
