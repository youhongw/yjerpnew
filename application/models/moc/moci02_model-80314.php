...
class Moci02_model extends CI_Model {
	...
	function insertf()    //新增一筆 檔頭  mocta
		...
		//	 if ($this->input->post('ta018')!='1') {$ta019=round($this->input->post('ta019'));}
	     $data = array( 
	      ...
	      $exist = $this->moci02_model->selone1($this->input->post('mocq01a51'),$this->input->post('ta002'));
	      if ($exist)
	         {
		      return 'exist';
		     } 
		...
		if (!isset($_POST['order_product'][  $n  ]['tb003']) ) { $n='15'; }  }
		...
		//	while ($_POST['order_product'][  $n  ]['tb003']) {		
		  ...
		  $this->db->insert('moctb', $data_array); }
	...
	function updatef()   
		...
		//	$this->db->flush_cache();  
			// 新增明細 moctb
			    $tb045=0;$tb046=0;$tb047=0;$tb048=0;$tb016b=0;
			    $n = '0';		
				$tb003='1010';
		//	while ($_POST['order_product'][  $n  ]['tb003']) {
			while (isset($_POST['order_product'][  $n  ]['tb003'])) {
