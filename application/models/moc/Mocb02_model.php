...
class mocb02_model extends CI_Model {
...
//計算 產生盤點表 invtc  
	...
	/*		   $sql1=" select mb001,mb004 from invmb a
          ...
          while($row=mysql_fetch_assoc($result)){
            ...
            $data1 = array(
			   ...
			   $exist = $this->mocb02_model->selone1($vtd001,$mb001,$vtd003);
	      if ($exist)
	         {
		      return 'exist';
		     } 
	...
	function updf($ta001o,$ta001c,$ta002o)           
        {
			$user = $this->session->userdata('sysuser');
			
			$sql_chk = "SELECT COUNT(*) AS NUM FROM COPTD WHERE TD001 = '$ta001o' AND TD002 = '$ta001c' AND TD003 = '$ta002o' AND TD016 = 'Y'";
			...
			if($NUM1 != 0 ) {
				...
				$sql1 = "INSERT INTO coptd_temp
				SELECT TD001,TD002,TD003,TD009,TD016 FROM COPTD WHERE  TD001 = '$ta001o' AND TD002 = '$ta001c' AND TD003 = '$ta002o'
				";
				
				$query1 = $this->db->query($sql1);
				
				
				$sql2 = "UPDATE COPTD SET TD009 = '0' , TD016 = 'N' WHERE TD001 = '$ta001o' AND TD002 = '$ta001c' AND TD003 = '$ta002o'
				";
