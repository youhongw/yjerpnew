 		...
 		<div class="row ">
 			<div class="col-12 col-xs-12 col-sm-12">
 				...
 				<div class="box">
 					<div class="box-header">
 						...
 						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 							<!-- <div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03/addform" role="button"><i class="fa fa-plus"></i>新增</a>
 							</div> -->
 							<!-- <div class="btn-group mr-2" role="group" aria-label="First group">
 							...
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03/displayr" role="button"><i class="fa fa-refresh"></i> 重整</a>
 							</div>
 							<div class="btn-group mr-2" role="group" aria-label="Five group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03/exceldetailr"><i class="fa fa-file"></i> 匯出excel</a></li>
 							</div>
 					...
 					<div class="box-body">
 						<!-- <form action="<?php echo base_url() ?>index.php/sfc/sfci03/delete" method="post" enctype="multipart/form-data" id="form"> -->
 							...
 							<table id="example1" class="table table-bordered table-striped" style="width: 100%;">
 								<thead>
 									<tr style="background-color: #3C8DBC;cursor:pointer;color:#FFFFFF;">
 										...
 										<th style="text-align: center;vertical-align: middle;">產品Ｚ規格</th> -->
 									</tr>
 								</thead>
 								<tbody>
 									<?php $chkval = 1; ?>
 									<?php foreach ($results as $row) : ?>
 										<tr>
 											...
 											<!-- <div class="btn-group btn-group-sm" role="group" aria-label="First group">
 												<td style="text-align: center;vertical-align: middle;"><a class="btn btn-primary btn-sm" href="<?php echo site_url('sfc/sfci03/updform/' . trim($row->TD001) . '/' . trim($row->TD002) . '/') ?>" </a>修改</td>
 											</div> -->
 											...
 											<td style="text-align: center;vertical-align: middle;"><?php echo  $row->TA011; ?></td>
 											...
 											<td style="text-align: center;vertical-align: middle;"><?php echo  'Not Set'; ?></td>
 											<!-- 											
 ...
 <script>
 	...
 	function Msg() {
 		var sup = '<?php echo $super; ?>';
 		var prom = '<?php echo substr($rms, 4, 1); ?>';
 		if (!(sup == 'Y' || prom == 'Y')) {
 			alert("無此權限，系統強制登出!"); //設定60分鐘沒動作時強制登 
 			location = "<?php echo base_url() ?>index.php/login/";
 		}
 	}
 	window.setInterval("Msg()", 100);
 </script>