	...
	function updatef()   
        {
            $data = array(			
                  ...
                  'ma017' => $this->input->post('ma017'),'ma018' => $this->input->post('ma018'),'ma019' => $this->input->post('ma019'),
                  ...
                  'ma026' => $this->input->post('ma026'),
				  'ma027' => substr($this->input->post('ma027'),0,4).substr($this->input->post('ma027'),5,2).substr($this->input->post('ma027'),8,2),
				  'ma028' => substr($this->input->post('ma028'),0,4).substr($this->input->post('ma028'),5,2).substr($this->input->post('ma028'),8,2),
                  'ma029' => substr($this->input->post('ma029'),0,4).substr($this->input->post('ma029'),5,2).substr($this->input->post('ma029'),8,2),
				  'ma030' => substr($this->input->post('ma030'),0,4).substr($this->input->post('ma030'),5,2).substr($this->input->post('ma030'),8,2)
