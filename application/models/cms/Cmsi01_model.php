...
class Cmsi01_model extends CI_Model {
	...
	function findf($limit, $offset, $sort_by, $sort_order)    
	    ...
	    $seq1 = " ma001, ma002, ma003, ma004, ma005, ma006, create_date FROM `cmsma` ";
	...
	function insertf()    
	    ...
	    $exist = $this->cmsi01_model->selone1($this->input->post('ma001'),$this->input->post('ma002'));
	    if ($exist)
	        {
		    return 'exist';
		} 
    ...
    function copyf()          
        ...
        $exist = $this->cmsi01_model->selone2($this->input->post('ma003c'),$this->input->post('ma004c'));
		if ($exist)
		   {
		    return 'exist';
		   }         
	...
	function excelnewf()           
	    ...
	    $seq4=$this->input->post('ma004c'); 
	    $sql = " SELECT ma001,ma002,ma003,ma004,ma005,ma006,create_date FROM cmsma WHERE ma001 >= '$seq1'  AND ma001 <= '$seq2' AND ma002 >= '$seq3' AND ma002 <= '$seq4' "; 
	...
	function printfd()           
	    ...
	    $seq3=$this->input->post('ma003c'); 
	    $seq4=$this->input->post('ma004c'); 
	    $sql = " SELECT * FROM cmsma WHERE ma001 >= '$seq1'  AND ma001 <= '$seq2' AND ma002 >= '$seq3' AND ma002 <= '$seq4' "; 
        $query = $this->db->query($sql);
	    $ret['rows'] = $query->result();
	...
	function updatef()   
          {
            $data = array(		
                 //   'company' => $this->input->post('company'),
				    ...
				    'ma011' => substr($this->input->post('ma011'),0,4).substr($this->input->post('ma011'),5,2),
				    'ma012' => substr($this->input->post('ma012'),0,4).substr($this->input->post('ma012'),5,2),
				    'ma013' => substr($this->input->post('ma013'),0,4).substr($this->input->post('ma013'),5,2).substr($this->input->post('ma013'),8,2),
				    ...
				    'ma021' => substr($this->input->post('ma021'),0,4).substr($this->input->post('ma021'),5,2),
				    'ma022' => substr($this->input->post('ma022'),0,4).substr($this->input->post('ma022'),5,2),
				    'ma023' => $this->input->post('ma023'),
				    'ma024' => $this->input->post('ma024'),
				    'ma025' => $this->input->post('ma025'),
				    'ma026' => $this->input->post('ma026'),
				    'ma027' => substr($this->input->post('ma027'),0,4).substr($this->input->post('ma027'),5,2),
				    'ma028' => substr($this->input->post('ma028'),0,4).substr($this->input->post('ma028'),5,2),
		            'ma029' => substr($this->input->post('ma029'),0,4).substr($this->input->post('ma029'),5,2),    	
                    'ma030' => substr($this->input->post('ma030'),0,4).substr($this->input->post('ma030'),5,2),
                    'ma200' => $this->input->post('ma200'),
                    'ma201' => $this->input->post('ma201'),
                    'ma202' => $this->input->post('ma202'),
					'ma203' => $this->input->post('ma203'),
					'ma205' => $this->input->post('ma205'),
					'ma206' => $this->input->post('ma206'),
					'ma207' => $this->input->post('ma207'),
                    'ma204' => substr($this->input->post('ma204'),0,4).substr($this->input->post('ma204'),5,2).substr($this->input->post('ma204'),8,2)					
             );
			$this->load->vars($data);
