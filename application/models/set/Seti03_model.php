...
class seti03_model extends CI_Model
{
	...
	function get_detail_view($seg1, $seg2)
	{
		...
		// 	->where('ta001', $user)
		// 	->where('ta002', $process);
		$sql98 = " select a.*,b.td004,c.MQ002 as te001disp,d.MV002 as te004disp, e.MX003 as te005disp,
		f.MW003 as te009disp,d.MV002 as cmsi09ddisp
					from sfcte as a 
						...
						where te001='$seg1' and te002='$seg2' ";
