...
class Mymi01 extends CI_Controller {
...
//    showmessage('轉檔成功', 'main/index');
   ...
   if($msg === true)
   {
    show_error("導入成功<a href='".$site_url."/mym/mymi01'>返回</a>");
   }else
   {
    show_error("導入失敗<a href='".$site_url."/mym/mymi01'>返回</a>");
   }  
} 
