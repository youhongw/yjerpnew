<?php 
class copma extends CI_Controller {
    ...
    public  function index()
      {
	    ...
	    $data['message1'] = '';
		 ...
		 $data['systitle'] ='excel上傳資料至mysql';	
	      ...
	      $data['content_v'] = 'upl/copma_upload_v';		
	      $data['foot_v'] ='main_foot_v';
	      $this->load->vars($data);
	      $this->load->view('main_headbrow_v');	
      //  $this->load->view('upl/copma_upload_v');  
      }
	  ...
	  public  function do_del()
      {
	    ...
	    $data['message'] = '刪除資料成功!';
	    $this->load->model('upl/copma_model','',TRUE);
	    $this->copma_model->deletef($seg1,$seg2); 
    ...
    public function read()
	  {  
        $rows = array('company','creator','usr_group','create_date','modifier','modi_date','flag','ma001','ma002','ma003','ma004','ma005','ma006',
		               'ma007','ma008','ma009','ma010','ma011','ma012','ma013','ma014','ma015','ma016','ma017','ma018','ma019','ma020', 
					   'ma021','ma022','ma023','ma024','ma025','ma026','ma027','ma028','ma029','ma030','ma031','ma032','ma033','ma034',
					   'ma035','ma036','ma037','ma038','ma039','ma040','ma041','ma042','ma043','ma044','ma045','ma046','ma047','ma048',
					   'ma049','ma050','ma051','ma052','ma053','ma054','ma055','ma056','ma057','ma058','ma059','ma060','ma061','ma062',
					   'ma063','ma064','ma065','ma066','ma067','ma068','ma069','ma070','ma071','ma072','ma073','ma074','ma075','ma076',
					   'ma077','ma078','ma079','ma080','ma081','ma082','ma083','ma084','ma085','ma086','ma087','ma088','ma089','ma090',
					   'ma091','ma092','ma093','ma094','ma200' );
	...
	//	$KeyWord = explode(",",$KeyWord);
	  //  $KeyWord =  array('ta002','ta031');    //修改key值
	     ...
	     $KeyWord1 =  'ma001';    //修改key值
		 $KeyWord2 =  'ma002';    //修改key值
      ...
      //  $this->FilterExsel($Exsel_data,$KeyWord);            //檢查資料重複
	    ...
	    $this->load->model('upl/copma_model');   //true 系統會使用反單引號（`, 在英文鍵盤左上方）來保護你的欄位或資料表名稱
	       
        $DB_data  =  $this->copma_model->selUsers();                //查询DB中的全部數據
       //   return   'kk2';    
    ...
    public  function write()
      {
        $title = array('id','name','sex','tel');
        $data = $this->copma_model->selUsers();
    ...
    public   function addExcel($value='')
     {  
	    $this->load->model('upl/copma_model','',TRUE);   //true 系統會使用反單引號（`, 在英文鍵盤左上方）來保護你的欄位或資料表名稱
        return $this->copma_model->add_Excel($value);   
     }
     /**
      * 更新方法
      * 
    ...
    public    function updExcel($value='')
      {  
        return $this->copma_model->upd_Excel($value);  
      }
    /**
    *篩選所有的key欄位組成數组    
    *@param   DB數據
