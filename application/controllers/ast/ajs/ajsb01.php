	...
	//自訂類預設執行函數 流覽資料
	  public function index()           
	    {                      
	      ...
	      $this->load->model('ajs/ajsb01_model');     // 加載TABLE model 模型		
	      $result= $this->ajsb01_model->search($limit, $offset = 0 , $sort_by  , $sort_order ); //至model 取 mysql 資料 預設 15,0,ma001,desc
	    ...
	    //$config['NUM_LINKS'] = 2;   //分頁前後出現2個數字
	      ...
	      $config['base_url'] = site_url("ajs/ajsb01/display/$sort_by/$sort_order");   //設定分頁url路徑
	   ...
	   // $this->load->library('table');//加載table函數
	    ...
	    //$data['find07']=$this->session->userdata('find07');
	      ...
	      $data['systitle'] ='產生分錄底稿';  //網頁抬頭顯示名稱
	      $data['menu_v'] = 'main_menu_v';
	      $data['content_v'] = 'ajs/ajsb01_brow_v';		
      ...
      public function batcha()   
        {
	      ...
	      $data['message'] = '計算資料完成!';
		  $this->ajsb01_model->batchaf();   //invlc 表
