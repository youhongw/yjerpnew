...
<div id="content">   <!-- div-1  -->
  <div class="breadcrumb">
    ...
    <div class="box">  <!-- div-2  -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/invhome.png" alt="ERP系統首頁" /> demo-upload模組&nbsp;&nbsp;</h1><a href="<?=base_url()?>index.php/main9"  target="_blank" ><h1><span style="color:#FF0000">開新視窗</h1></span></a>
    </div>
	...
	<br><br>
		...
		<div class="home2" style="margin-left: 10px; margin-right: 10px;">   <!-- 第二區塊 -->
		  <div id='load1' class="home-heading">
			...
			<br><br>    <!-- 第三行 -->
			<a onclick="open_puri02();" style="background-image:linear-gradient(30deg, hsl(200,100%,70%), hsl(200,100%,30%));" class="button">品號廠商建立作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<a onclick="open_moci10();" style="background-image:linear-gradient(30deg, hsl(200,100%,70%), hsl(200,100%,30%));" class="button">調撥單據建立作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="home4" style="margin-left: 10px; margin-right: 10px;">
		  ...
		  <div class="home-content" style="background: #FFFAF0;">
			...
			<a onclick="open_copi10();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">外銷客戶品號建立</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<!--	<a onclick="open_tomysql();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">excel導入mysql作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  -->
	     	<a onclick="open_mymb01();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">excel導入mysql作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
     		<br><br>    <!-- 第三行 -->	
            <a onclick="location = '<?=base_url()?>index.php/mym/mymb01/index'";" style="background-image:linear-gradient(30deg, hsl(200,100%,70%), hsl(200,100%,30%));" class="button">mymy excel.xlsx導入</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
