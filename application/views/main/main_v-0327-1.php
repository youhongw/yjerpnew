	...
	<br><br>
		...
		<div class="home2" style="margin-left: 10px; margin-right: 10px;">   <!-- 第二區塊 -->
		  <div id='load1' class="home-heading">
			...
			<a onclick="open_copb02();"  style="background-image:linear-gradient(30deg,hsl(120,100%,80%), hsl(120,80%,50%));"  class="button">客戶訂單結案作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<br><br>    <!-- 第二行 -->
			...
			<a onclick="open_invi07();" style="background-image:linear-gradient(30deg, hsl(200,100%,70%), hsl(200,100%,30%));" class="button">開帳調整單據建立</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="home3" style="margin-left: 10px; margin-right: 10px;">
		  ...
		  <div class="home-content" style="background: #FFFAF0;">
			...
			<a onclick="open_acrr01();"  style="background-image:linear-gradient(30deg,hsl(120,100%,80%), hsl(120,80%,50%));" class="button">應收帳款結款單</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_acrr03();"  style="background-image:linear-gradient(30deg,hsl(120,100%,80%), hsl(120,80%,50%));" class="button">應收帳款對帳單</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<br><br>    <!-- 第二行 -->
			<a onclick="open_acrr17();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">未收帳款統計表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_acpr05();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">應付帳款明細表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_acpr12();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">未付帳款統計表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_invr18();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">現有庫存明細表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_invr19();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">進耗存統計報表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<br><br>    <!-- 第三行 -->
		...
		<!--	<a onclick="open_acri01();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">應收單據性質建立</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<a onclick="open_invq02();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">品號庫存查詢作業</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
		    <a onclick="open_mymb01();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">mymy excel　導 入</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a onclick="open_mymb02();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">mym 刪除導入資料</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			
			<a onclick="open_mymr01();" style="background-image:linear-gradient(30deg,hsl(240,100%,50%), hsl(240,100%,75%));" class="button">mym訂單列印導出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
