...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 庫存單據性質建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" tabIndex="7" type='submit' accesskey="k"  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('inv/invi04/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/inv/invi04/findsql" method="post" enctype="multipart/form-data" >
    </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/inv/invi04/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
