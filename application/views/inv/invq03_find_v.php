...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 庫別庫存資料查詢作業 - 設定查詢條件　　　</h1>
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit' accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('inv/invq03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/inv/invq03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
		    ...
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MC002'> MC002 庫別 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MC003'> MC003 儲位 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MC004'> MC004 安全存量 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MC006'> MC006 經濟批量 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MC007'> MC007 庫存數量 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MC001'> MC001 品號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MC002'> MC002 庫別 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MC003'> MC003 儲位 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MC004'> MC004 安全存量 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MC006'> MC006 經濟批量 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='MC007'> MC007 庫存數量 </option>
