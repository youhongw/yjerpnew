<div id="container">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
		<a onclick="location = '<?php echo base_url()?>index.php/inv/invi03/addform'" class="button"><span>新增</span></a>
		<a onclick="location = '<?php echo base_url()?>index.php/inv/invi03/copyform'" class="button"><span>複製</span></a>	
        <a onclick="location = '<?php echo base_url()?>index.php/inv/invi03/findform'" class="button"><span>進階查詢</span></a>	
	   ...
	   <!-- <a onclick="location = '<?php echo base_url()?>index.php/inv/invi03/printdetail'"  class="button"><span>列印</span></a>
	    <a onclick="location = '<?php echo base_url()?>index.php/inv/invi03/exceldetail'"  class="button"><span>轉EXCEL檔</span></a>  -->
		<a onclick="location = '<?php echo base_url()?>index.php/main/index/102'" class="button"><span>關閉</span></a>
	  </div>
    </div>
	
  <div class="content">
    <form action="<?php echo base_url()?>index.php/inv/invi03/delete" method="post" enctype="multipart/form-data" id="form">
...
function filter() {
	...
	if (filter_ma001 != '*') {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma001/desc/' + encodeURIComponent(filter_ma001);
	}
	
	var filter_ma002 = $('input[name=\'filter_ma002\']').attr('value');
	if (filter_ma002) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma002/desc/' + encodeURIComponent(filter_ma002);
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma003/desc/' + encodeURIComponent(filter_ma003);
	}
		
	var filter_ma004 = $('input[name=\'filter_ma004\']').attr('value');
	if (filter_ma004) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma004/desc/' + encodeURIComponent(filter_ma004); 
	}
	
	var filter_ma005 = $('input[name=\'filter_ma005\']').attr('value');
	if (filter_ma005) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma005/desc/' + encodeURIComponent(filter_ma005); 
	}
	
	var filter_ma006 = $('input[name=\'filter_ma006\']').attr('value');
	if (filter_ma006) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma006/desc/' + encodeURIComponent(filter_ma006); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').attr('value');
	if (filter_create) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/create_date/desc/' + encodeURIComponent(filter_create); 
	}
	
    if (filter_ma001 == '*' && !filter_ma002  && !filter_ma003 && !filter_ma004  && !filter_ma005 && !filter_ma006 && !filter_create) {         
	   url = '<?php echo base_url()?>index.php/inv/invi03/display';location = url;
...
function filtera() {
	...
	var filter_ma001 = $('select[name=\'filter_ma001\']').attr('value');
	if (filter_ma001 != '*') {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma001/asc/' + encodeURIComponent(filter_ma001);
	}
	
	var filter_ma002 = $('input[name=\'filter_ma002\']').attr('value');
	if (filter_ma002) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma002/asc/' + encodeURIComponent(filter_ma002);
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
		
	var filter_ma004 = $('input[name=\'filter_ma004\']').attr('value');
	if (filter_ma004) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma004/asc/' + encodeURIComponent(filter_ma004); 
	}
	
	var filter_ma005 = $('input[name=\'filter_ma005\']').attr('value');
	if (filter_ma005) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma005/asc/' + encodeURIComponent(filter_ma005); 
	}
	
	var filter_ma006 = $('input[name=\'filter_ma006\']').attr('value');
	if (filter_ma006) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/ma006/asc/' + encodeURIComponent(filter_ma006); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').attr('value');
	if (filter_create) {
		url = '<?php echo base_url()?>index.php/inv/invi03/filter1/create_date/asc/' + encodeURIComponent(filter_create); 
	}
