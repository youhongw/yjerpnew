...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 庫存狀況查詢</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invr20/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($mc0031)) { $mc0031=''; } else {  $mc0031=$this->input->post('mc0031'); }
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14z" >起始異動日期：</td>
	    <td class="normal14" ><input  tabIndex="6" id="mc003" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd(this)" onKeyPress="keyFunction()" type="text" name="mc003"   value="<?php echo $mc003; ?>" size="20"  type="text"   style="background-color:#E7EFEF"/>
			<img  onclick="scwShow(mc003,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> </td>
        <td class="normal14z" >結束異動日期：</td>
	    <td class="normal14" ><input  tabIndex="6" id="mc0031" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd(this)" onKeyPress="keyFunction()" type="text" name="mc0031"   value="<?php echo $mc0031; ?>" size="20"  type="text"   style="background-color:#E7EFEF"/>
