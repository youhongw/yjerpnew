 ...
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14y" width="9%">單位成本：</td>						
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="16" id="mb018" onKeyPress="keyFunction()" name="mb018" onBlur="startCheck21(this)" value="<?php echo $mb018; ?>"  size="10" type="text" disabled="disabled"  /><img id="ShowblockUI21" src="<?php echo base_url()?>assets/image/png/plan.png" alt="" align="top"/></a>		
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="16%"> 採購人員：</td>
	    ...
	    <td class="normal14y" width="16%" >最低補量：</td>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="11%"> 外包裝單位：</td>
	    ...
	    <td class="normal14y" width="14%" >外包裝含商品數：</td>
        ...
        <td class="normal14y"  width="14%">單位淨重：</td>
