  ...
  <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="12%" ><input type="text" tabIndex="2" id="mb004" onKeyPress="keyFunction()" name="mb004"  value="<?php echo  $mb004; ?>"    size="4"  required /></td>
		<!--<a href="javascript:;"><img id="Showinvi81a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="invi81adisp"> <?php //echo $invi81adisp; ?> </span>-->
   ...
   <!--	<div id="htabs" class="htabs14"  ><span>編輯項目-新增</span></div>    -->
	...
	<a accesskey="x" id='cancel' name='cancel' href="<?php echo site_url('inv/invi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
