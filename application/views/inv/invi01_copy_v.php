...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#ma002').focus();" accesskey="c" type='submit'  tabIndex="98" accesskey="s" name='submit' class="button"  value='&nbsp;儲存F8&nbsp;'><span>複 製Alt+c</span><img src="<?php echo base_url()?>assets/image/png/copy.png" /></button>&nbsp;&nbsp;
	   <a  accesskey="x" accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('inv/invi01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a></div>
	...
	<table class="form14">    <!-- 表格開始 -->
	 <tr>
	   <td class="normal14y" width="13%">原始品號類別代號：</td>
           <td class="normal14a" width="37%">
	      <input tabIndex="1" id="ma002" onKeyPress="keyFunction()" type="text" name="ma002c"  value="<?php echo $ma002c; ?>"   minlength="1" required /></td>
	   <td class="normal14y" width="13%">複製品號類別代號：</td>
           <td class="normal14a" width="37%">
	      <input tabIndex="2" id="ma004" onKeyPress="keyFunction()" type="text" name="ma004c"  value="<?php echo $ma004c; ?>"  minlength="1" required /></td>
	 </tr>
	  <tr>
	  ...
	  <!-- <div class="buttons">
	   <button  accesskey="c" type='submit'  tabIndex="98" accesskey="s" name='submit' class="button"  value='&nbsp;儲存F8&nbsp;'><span>複 製Alt+c</span><img src="<?php echo base_url()?>assets/image/png/copy.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
	   <a  accesskey="x" accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('inv/invi01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a></div>
	   -->
        </form>
		<?php  if ($message!=' ') { ?>
