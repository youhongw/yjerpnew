...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 現有庫存明細表 - 列印明細表　　　</h1>
   ...
   <button style= "cursor:pointer" form="commentForm" onfocus="$('#invq02a').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invr19/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($lc002)) {  $lc002=date("Y/m");  } else { $lc002=$this->input->post('lc002'); }
	  if(!isset($lc0021)) { $lc0021=date("Y/m"); } else { $lc0021=$this->input->post('lc0021'); }
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
        ...
        <td class="normal14y" width="10%">結束品號：</td>
	  ...
	  <tr>
	    <td class="normal14z" >起始年月：</td>
	    <td class="normal14" ><input  tabIndex="6" id="lc002" onKeyPress="keyFunction()" name="lc002"   value="<?php echo $lc002; ?>" size="20"  type="text"  /></td>
        <td class="normal14z" >結束年月：</td>
	    <td class="normal14" ><input  tabIndex="6" id="lc0021" onKeyPress="keyFunction()" name="lc0021"   value="<?php echo $lc0021; ?>" size="20"  type="text"  /></td>
	  </tr>
