...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 庫存重計算作業 - 結轉　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invb02/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	 ...
	 if (!$this->input->post('datemm1')) {$datemm1=date("Y/m/d");}	
   //  if (!$this->input->post('datemm'))  {$datemm=date("m");}	
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="12%">起始重算年月：</td>
        <td class="normal14a" width="88%"><input tabIndex="1" id="dateyy1"   onKeyPress="keyFunction()"   onChange="dataym1(this)"  type="text" name="dateyy1"  value="<?php echo $dateyy1; ?>"  size="10" style="background-color:#E7EFEF"  /></td>
	  </tr>
	   <tr>
	    <td class="normal14y"  width="12%">重算截止日期：</td>
        <td class="normal14a" width="88%"><input tabIndex="2" id="datemm1"  ondblclick="scwShow(this,event);" onChange="dataymd4(this)" onKeyPress="keyFunction()"    type="text" name="datemm1"  value="<?php echo $datemm1; ?>"  style="background-color:#E7EFEF"   /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
	  </tr> 
    </table>
