...
<body >
	...
	<table class="store">
	  <tr>
		<td align="center">群組明細表</td>
      </tr>
	</table>
	<table class="thead">
		<tr>
			<td width="15%" align="center">群組代號</td>
	        <td width="17%" align="center">群組名稱</td>
	        <td width="17%" align="left">群組權限代號</td>
        </tr>
	</table>
	...
	<table class="list">
	  ...
	  <tr>
		<td width="60" align="center"><?php echo  $row->me001;?></td>
		<td width="100" align="center"><?php echo  $row->me002;?></td>
		<td align="left"><?php echo  $row->me003;?></td>
      </tr>
	    <?php $pagenum +=1; ?> 
