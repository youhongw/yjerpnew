<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/inv/invi05/clear_sql_term'"  style="float:left" accesskey="d" class="button"><span>清除查詢條件 d </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/inv/invi05/addform'"  style="float:left" accesskey="+" class="button"><span>新增</span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
      ...
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/inv/invi05/findform'"  style="float:left" accesskey="k" class="button"><span>進階查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/inv/invi05/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
		  ...
		  <?php echo anchor("inv/invi05/display/ta001/".(($sort_order == 'asc' && $sort_by == 'rowid') ? 'desc' : 'asc') ,'序號'); ?>
           		  
	      </td>
	      <td width="10px" class="left">
	          <?php echo anchor("inv/invi05/display/ta001/" . (($sort_order == 'asc' && $sort_by == 'ta001') ? 'desc' : 'asc') ,'異動單別'); ?>
			  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="left"> 
		  <?php echo anchor("inv/invi05/display/ta002/" . (($sort_order == 'asc' && $sort_by == 'ta002') ? 'desc' : 'asc') ,'異動單號'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="left"> 
		  <?php echo anchor("inv/invi05/display/ta003/" . (($sort_order == 'asc' && $sort_by == 'ta003') ? 'desc' : 'asc') ,'單據日期'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
              </td>
	      <td width="5%" class="left">
	          <?php echo anchor("inv/invi05/display/ta005/" .(($sort_order == 'asc' && $sort_by == 'ta005') ? 'desc' : 'asc') ,'備註'); ?>
			  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
   	      </td>
	      <td width="5%" class="left">
		  <?php echo anchor("inv/invi05/display/ta011/".(($sort_order == 'asc' && $sort_by == 'ta011') ? 'desc' : 'asc') ,'總數量'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="5%" class="left">
		  <?php echo anchor("inv/invi05/display/ta012/" . (($sort_order == 'asc' && $sort_by == 'ta012') ? 'desc' : 'asc') ,'總金額'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
		  <td width="5%" class="left">
		  <?php echo anchor("inv/invi05/display/ta006/" . (($sort_order == 'asc' && $sort_by == 'ta006') ? 'desc' : 'asc') ,'碓認碼'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="center">
		  <?php echo anchor("inv/invi05/display/create_date/" . (($sort_order == 'asc' && $sort_by == 'create_date') ? 'desc' : 'asc') ,'建立日期'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
...
function open_winprint()
  {
   // window.open('/index.php/inv/invi05/printdetail')
	window.location="<?php echo base_url()?>index.php/inv/invi05/printdetail";
  }
  function open_winprint1()
  {
 //   window.open('/index.php/inv/invi05/printdetailc')
	window.location="<?php echo base_url()?>index.php/inv/invi05/printdetailc";
  }

function open_winexcel()
  {
  //  window.open('/index.php/inv/invi05/exceldetail')
	window.location="<?php echo base_url()?>index.php/inv/invi05/exceldetail";
  }
</script>
...
function filter() {
	...
	if (filter_ta001) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta001/desc/' + encodeURIComponent(filter_ta001);
	} 
	
	var filter_ta002 = $('input[name=\'filter_ta002\']').val();
	if (filter_ta002) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta002/desc/' + encodeURIComponent(filter_ta002);
	} 
	
	var filter_ta003 = $('input[name=\'filter_ta003\']').val();
	if (filter_ta003) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta003/desc/' + encodeURIComponent(filter_ta003);
	}
	
	var filter_ta005 = $('input[name=\'filter_ta005\']').val();
	if (filter_ta005) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta005/desc/' + encodeURIComponent(filter_ta005);
	}
		
	var filter_ta011 = $('input[name=\'filter_ta011\']').val();
	if (filter_ta011) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta011/desc/' + encodeURIComponent(filter_ta011); 
	}
	
	var filter_ta012 = $('input[name=\'filter_ta012\']').val();
	if (filter_ta012) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta012/desc/' + encodeURIComponent(filter_ta012); 
	}
	var filter_ta006 = $('input[name=\'filter_ta006\']').val();
	if (filter_ta006) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta006/desc/' + encodeURIComponent(filter_ta006); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/create_date/desc/' + encodeURIComponent(filter_create); 
	}
	
    if ( !filter_ta001  && !filter_ta002 && !filter_ta003 && !filter_ta005 && !filter_ta011 && !filter_ta012  && !filter_ta006 && !filter_create) {         
	   url = '<?php echo base_url() ?>index.php/inv/invi05/display';location = url;
...
function filtera() {
	...
	var filter_ta001 = $('input[name=\'filter_ta001\']').val();
	if (filter_ta001) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta001/asc/' + encodeURIComponent(filter_ta001);
	} 
		
	var filter_ta002 = $('input[name=\'filter_ta002\']').val();
	if (filter_ta002) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta002/asc/' + encodeURIComponent(filter_ta002);
	} 
	
	var filter_ta003 = $('input[name=\'filter_ta003\']').val();
	if (filter_ta003) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta003/asc/' + encodeURIComponent(filter_ta003);
	}
	
	var filter_ta005 = $('input[name=\'filter_ta005\']').val();
	if (filter_ta005) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta005/asc/' + encodeURIComponent(filter_ta005);
	}
		
	var filter_ta011 = $('input[name=\'filter_ta011\']').val();
	if (filter_ta011) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta011/asc/' + encodeURIComponent(filter_ta011);
		
	}
	var filter_ta012 = $('input[name=\'filter_ta012\']').val();
	if (filter_ta012) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta012/asc/' + encodeURIComponent(filter_ta012); 
	}
	
	var filter_ta006 = $('input[name=\'filter_ta006\']').val();
	if (filter_ta006) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/ta006/asc/' + encodeURIComponent(filter_ta006); 
	}
	
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echo base_url() ?>index.php/inv/invi05/filter1/create_date/asc/' + encodeURIComponent(filter_create); 
	}
