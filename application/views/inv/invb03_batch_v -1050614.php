...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 每月月底計價作業 - 計價</h1>
    </div>
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14a"  width="12%">選擇計價年月：</td>
        <td class="normal14" width="88%"><input tabIndex="3" id="ta034c"  class="date-picker"    onKeyPress="keyFunction()"    type="text" name="ta034c"  value="<?php echo $ta034c; ?>"  size="16" style="background-color:#E7EFEF" /></td>
	  </tr>
