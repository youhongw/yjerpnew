...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 品號請購/採購/進貨數量查詢</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invr24/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($mc003)) { $mc003=date("Y/m/d",strtotime("last month")); } else {  $mc003=$this->input->post('mc003'); }
	  if(!isset($mc0031)) { $mc0031=$date; } else {  $mc0031=$this->input->post('mc0031'); }
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">品號：</td>
	    <td class="normal14a" width="39%"><input tabIndex="5" id="invq02a" onKeyPress="keyFunction()"  name="invq02a" type="text" required /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始日期：</td>
	    <td class="normal14" ><input  tabIndex="6" id="mc003" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd(this)" onKeyPress="keyFunction()" type="text" name="mc003"   value="<?php echo $mc003; ?>" size="20"  type="text"  required  style="background-color:#E7EFEF" />
			<img  onclick="scwShow(mc003,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> </td>
        <td class="normal14z" >結束日期：</td>
	    <td class="normal14" ><input  tabIndex="6" id="mc0031" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd(this)" onKeyPress="keyFunction()" type="text" name="mc0031"   value="<?php echo $mc0031; ?>" size="20"  type="text" required  style="background-color:#E7EFEF"/>
			<img  onclick="scwShow(mc0031,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> </td>
	  </tr>
