	<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/inv/invi09/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="15%" align="center">儲位代號</td>
	    <td width="17%" align="center">儲位名稱</td>
	    <td width="17%" align="left">儲位備註</td>
       </tr>
	</table>
