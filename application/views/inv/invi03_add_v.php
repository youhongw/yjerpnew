...
<div id="content"> 
  <div class="box">
    ...
    <div class="content">
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/inv/invi03/addsave" >	
	...
	?>
	  ...
	  <table class="form14">     <!-- 表格 -->
		...
		<tr>
          ...
          <td class="normal14" ><input tabIndex="7" onKeyPress="keyFunction()" id="ma006" name="ma006"  value="<?php echo $ma006; ?>" size="20" minlength="2" type="text" required  /></td>	
