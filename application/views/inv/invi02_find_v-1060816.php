...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<tr>
	  ...
	  <div class="buttons">
	    <button tabIndex="7" accesskey="k" type='submit'  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = 'http://ci.dercaster.com/index.php/inv/invi02/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>