...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 品號進耗存統計表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invr23/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($cmsq03a)) { $cmsq03a=''; } else {  $cmsq03a=$this->input->post('cmsq03a'); }
	...
	<!--  <tr>
	  ...
	  <tr>
	    <td class="normal14z" >庫存年月：</td>
	    <td class="normal14" ><input tabIndex="3" id="vdate" onclick="fPopCalendar(event,vdate,vdate);" class="date-picker" onChange="dateformat_ym(this)"  onKeyPress="keyFunction()"    type="text" name="vdate"  value="<?php echo $vdate; ?>"  size="16" style="background-color:#E7EFEF" />
