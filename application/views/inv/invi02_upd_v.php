...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    ...
    <div class="content"> <!-- div-5   $uploadfile  -->
	 <?php   $uploadfile='';?>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invi02/updsave/<?php echo $result[0]->mb001;?>" method="post" enctype="multipart/form-data" >
	...
	<?php foreach($result as $row) { ?>
          ...
          <?php   $mb003=$row->mb003;?>
          <?php   $mb004=$row->mb004;?>
          <?php   $invi01a=$row->mb005;?>    <!--品號分類- 會計 -->
          <?php   $invi01b=$row->mb006;?>    <!--品號分類- 會計 -->
		  <?php   $invi01c=$row->mb007;?>    <!--品號分類- 產品 -->
		  <?php   $invi01d=$row->mb008;?>    <!--品號分類- 類別 --> 
		  <?php   $mb009=$row->mb009;?>
		  <?php   $bomi07=$row->mb010;?>    <!--品號分類- 途程品號 -->
		  <?php   $mb011=$row->mb011;?>
          <?php   $mb012=$row->mb012;?>
          <?php   $mb013=$row->mb013;?>
          <?php   $mb014=$row->mb014;?>
          ...
          <?php   $mb065=$row->mb065;?>
          <?php   $mb066=$row->mb066;?>
		  <?php   $cmsi09=$row->mb067;?>  <!-- 採購人員 -->
		  <?php   $cmsi04=$row->mb068;?>  <!-- 生產線別 -->
		  <?php   $mb069=$row->mb069;?>
		  <?php   $mb070=$row->mb070;?>
		  <?php   $mb071=$row->mb071;?>
          <?php   $mb072=$row->mb072;?>
		  ...
		  <?php   $mb201=$row->mb201;?>
		  <?php   $mb202=$row->mb202;?>
		  <?php   $invi01adisp=$row->mb005disp;?>
		  <?php   $invi01bdisp=$row->mb006disp;?>
		  <?php   $invi01cdisp=$row->mb007disp;?>
		  <?php   $invi01ddisp=$row->mb008disp;?>
		  <?php   $cmsi03disp=$row->mb017disp;?>
		  <?php   $cmsi04disp=$row->mb068disp;?>
		  <?php   $cmsi09adisp=$row->mb018disp;?>
		  <?php   $bomi07disp=$row->mb010disp;?>
		  <?php   $bomi07adisp=$row->mb011;?>
		  <?php   $cmsi09disp=$row->mb067disp;?>   <!-- 採購人員名稱 -->
		  <?php   $puri01disp=$row->mb032disp;?>    <!--品號分類- 主供應商名稱 -->
		  <?php   $mb991=' ';?>
		  <?php   $mb992=' ';?>
		  <?php   $mb999=' ';?>
		  <?php   $flag=$row->flag;?>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="18%"><input tabIndex="1" id="mb001"   readonly="value"   onKeyPress="keyFunction()" onchange="startCheck-test(this)"  name="mb001" value="<?php echo $mb001; ?>" size="20" type="text" readonly="readonly" />
		 <span id="mb001disp" ></span></td>
	    <td class="normal14y" width="7%" >單位： </td>
        <td class="normal14a"  width="12%" ><input tabIndex="2" id="mb004" onKeyPress="keyFunction()" name="mb004"   value="<?php echo  $mb004; ?>"    size="4" type="text" required /></td>
		<!-- <a href="javascript:;"><img id="Showinvi81a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a></td> -->
    ...
    <table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="16%" ><input type="text" tabIndex="10" id="invi01a" class="invi01a" onKeyPress="keyFunction()"   onchange="startinvi01a(this)" name="invi01a"   value="<?php echo  $invi01a; ?>"    size="6"  />
	  ...
	  <tr>
		...
		<td  class="normal14z" >生產線別：</td>     <!--   onchange="check_cmsi04(this)"   onchange="startcmsi04(this)"        -->
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td class="normal14" width="6%" ><input type="hidden" name="mb044" value="N" />
		  <input type='checkbox' tabIndex="44" id="mb044" onKeyPress="keyFunction()" name="mb044" <?php if($mb044 == 'Y' ) echo 'checked'; ?>  <?php if($mb044 !== 'Y' ) echo 'check'; ?> value="Y" size="1"   /></td>
