...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 成本調整單建立作業 - 開帳調整單　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invi07/printc"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">開帳調整單別：</td>
	    <td class="normal14a" width="39%"><input tabIndex="1" id="tj001o" onfocus="this.select()" onKeyPress="keyFunction()" type="text" name="tj001o"  value="<?php echo $tj001o; ?>"  size="20" /></td>
        <td class="normal14y" width="11%">開帳調整單號：</td>
	    <td class="normal14a" width="39%"><input tabIndex="2" id="tj002o" onfocus="this.select()" onKeyPress="keyFunction()" type="text" name="tj002o"  value="<?php echo $tj002o; ?>"  size="20" /></td>
	  </tr>	
		 <tr>
