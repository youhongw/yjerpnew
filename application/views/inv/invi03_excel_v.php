...
<div id="content">
 ...
 <div class="box">
    ...
    <div class="content">
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invi03/write"  method="post"  enctype="multipart/form-data" > 
	...
	?>
	  <table class="form14">
		...
		<tr>
		  <td class="normal14" width="20%"><span class="required">*</span> 起始品號類別代號：</td>
          <td class="normal14" width="30%"><input tabIndex="3" id="ma003c" onKeyPress="keyFunction()" type="text" name="ma003c"  value="<?php echo $ma003c; ?>"  size="06" /></td>
		  <td class="normal14" width="20%"><span class="required">*</span> 結束品號類別代號：</td>
          <td class="normal14" width="30%"><input tabIndex="4" id="ma004c" onKeyPress="keyFunction()" type="text" name="ma004c"  value="<?php echo $ma004c; ?>"  size="06" /></td>
		</tr>
		...
		<div class="buttons">
	      <button tabIndex="5" type='submit'  name='submit' class="button"  target="_new" value='轉excel檔F8'><span>轉excel檔 F8</span></button>&nbsp;&nbsp;&nbsp;&nbsp; 
