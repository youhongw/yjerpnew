  ...
  <div class="box"> <!-- div-4 -->
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	   ...
	   <div class="buttons">
	   <button tabIndex="5" type='submit'  name='submit' accesskey="c" class="button"  value='&nbsp;儲存F8&nbsp;'><span>複 製 Alt+c</span><img src="<?php echo base_url()?>assets/image/png/copy.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
