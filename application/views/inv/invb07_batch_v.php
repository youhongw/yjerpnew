...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 盤點品號產生作業 - 產生　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invb07/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a" width="88%"><input tabIndex="1" id="td001c"   onKeyPress="keyFunction()"    type="text" name="td001c"  value="<?php echo $td001c; ?>"    /></td>
	  </tr>
	   <tr>
	    <td class="normal14z"  width="12%">盤點日期：</td>
        <td class="normal14a" width="88%"><input tabIndex="2" id="td002c"  ondblclick="scwShow(this,event);" onchange="dataymd6(this)" onKeyPress="keyFunction()"    name="td002c"  value="<?php echo $td002c; ?>"  style="background-color:#EBEBE4" required /></td>
	  </tr>  
	    <tr>
	    <td class="normal14z"  width="12%">盤點庫別：</td>
        <td class="normal14a" width="88%"><input tabIndex="3" id="td003c"    onKeyPress="keyFunction()"  onchange="startcmsq03a(this)"  name="cmsq03a" value="<?php echo $cmsq03a; ?>"  type="text" required /><a href="javascript:;"><img id="Showcmsq03a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="cmsq03adisp"> <?php    echo $cmsq03adisp; ?> </span></td>
	  </tr>  
	    <tr>
	    <td class="normal14z"  width="12%">起始品號：</td>
        <td class="normal14a" width="88%"><input tabIndex="3" id="td004c"    onKeyPress="keyFunction()"  onchange="startinvq02a(this)"  name="invq02a" value="<?php echo $invq02a; ?>"  type="text" /><a href="javascript:;"><img id="Showinvq02a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="invq02adisp"> <?php    echo $invq02adisp; ?> </span></td>
	  </tr> 
	    <tr>
	    <td class="normal14z"  width="12%">截止品號：</td>
        <td class="normal14a" width="88%"><input tabIndex="3" id="td005c"    onKeyPress="keyFunction()"  onchange="startinvq02a1(this)"  name="invq02a1" value="<?php echo $invq02a1; ?>"  type="text" required /><a href="javascript:;"><img id="Showinvq02a1" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
...
<?php include("./application/views/fun/invb07_funjs_v.php"); ?>
<script>
  $(function() {
