	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
	      <tr>
	    <td width="10%" align="center"><?php echo  $row->mb017;?><br><?php echo  $row->mb017disp;?></td>
		...
		<td width="10%" align="right"><?php echo  $row->mb004;?></td>
		<td width="10%" align="right"><?php echo  round($row->mb064);?></td> 
       		
        </tr>		
		 <?php $pagenum +=2;$prow=1;$pagenum1=$pagenum;$mc007k=$mc007k+$row->mb064; ?> 
