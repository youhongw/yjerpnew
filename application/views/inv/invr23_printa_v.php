  <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/inv/invr23/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="9%" align="center">品  號</td>
	    <td width="19%" align="left">品  名<br>規  格</td>
		<td width="9%" align="center">單位</td>
