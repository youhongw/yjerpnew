...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 成本調整單建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/inv/invi07/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TJ001'> TJ001 開帳調整單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TJ002'> TJ002  開帳調整單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TJ003'> TJ003 開帳調整日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TJ006'> TJ006 備註 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TJ007'> TJ007 總數量 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TJ008'> TJ008 總金額 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='TJ010'> TJ010 確認碼 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TJ001'> TJ001 開帳調整單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TJ002'> TJ002 開帳調整單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TJ003'> TJ003 開帳調整日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TJ006'> TJ006 備註 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='TJ007'> TJ007 總數量 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TJ008'> TJ008 總金額 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='TJ010'> TJ010 確認碼 </option>
