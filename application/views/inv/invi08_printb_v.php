	 ...
	 <!-- 開始列印 -->	
		...
		<table class="store">
		  <tr>
			...
			<tr><td class="title" align="center" valign="top">轉  撥  單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>轉撥單別：</b><span><?php echo $results[0]->ta001 ?></span></td>
					  ...
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>轉撥單號：</b><?php echo $results[0]->ta002 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
				...
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  ...
					  <td align="right"><? echo $val->tb012;?><br><? echo $val->tb012disp;?></td>
					   <td align="right"><? echo $val->tb009;?><br><? echo $val->tb011;?></td>
