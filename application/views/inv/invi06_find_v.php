...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/inv/invi06/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TD1001'> TD1001 盤點底稿代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TD1002'> TD1002 盤點日期 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TD1003'> TD1003 庫別 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TD1004'> TD1004 儲位 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TD1001'> TD1001 盤點底稿代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TD1002'> TD1002 盤點日期 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TD1003'> TD1003 庫別 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TD1004'> TD1004 儲位 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('inv/invi06/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/inv/invi06/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
