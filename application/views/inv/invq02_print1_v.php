...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/puri05/printc"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form12">   <!-- 表格 -->
      <tr>
	    <td class="start12" width="10%">請購單別：</td>
	    <td class="normal12" width="40%"><input tabIndex="1" id="ta001o" onKeyPress="keyFunction()" type="text" name="ta001o"  value="<?php echo $ta001o; ?>"  size="20" /></td>
        <td class="start12" width="10%">請購單號：</td>
	    <td class="normal12" width="40%"><input tabIndex="2" id="ta002o" onKeyPress="keyFunction()" type="text" name="ta002o"  value="<?php echo $ta002o; ?>"  size="20" /></td>
	  </tr>	
    </table>
