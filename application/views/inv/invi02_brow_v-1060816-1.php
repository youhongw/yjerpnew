<div class="box2">  <!-- div-1 -->
    ...
    <!--  <div class="buttons"> -->
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/inv/invi02/display'"  style="float:left" accesskey="d" class="button"><span>清除查詢條件 d </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
