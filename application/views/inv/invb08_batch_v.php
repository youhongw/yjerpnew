...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 盤點數量轉入作業 - 轉入　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/inv/invb08/batcha"  method="post"  enctype="multipart/form-data" > 
   ...
   //  if (!$this->input->post('datemm'))  {$datemm=date("m");}	
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	   ...
	   <tr>
	    <td class="normal14y"  width="12%">盤點日期：</td>
        <td class="normal14a" width="88%"><input tabIndex="2" id="ta034c"  ondblclick="scwShow(this,event);" onChange="dataymd5(this)" onKeyPress="keyFunction()"    type="text" name="ta034c"  value="<?php echo $ta034c; ?>"   style="background-color:#EBEBE4"  /></td>
	  </tr>  
    </table>
