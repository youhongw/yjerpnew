...
<div id="content">  <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" />儲位條碼建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/inv/invi10/addsave" >	
	<!--<div id="htabs" class="htabs14"  ><span>編輯項目-新增</span></div>-->
	<div id="tab-general"> <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mz001=$this->input->post('mz001');
	  $mz001disp=$this->input->post('mz001disp');
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14z" width="11%"><span class="required">品號：</span></td>
        
		<td  class="normal14a" width="89%" ><input tabIndex="4" id="invi02" onKeyPress="keyFunction()"  ondblclick="search_invi02_window()"  onchange="check_invi02(this)" name="mz001" value="<?php echo $mz001; ?>" size="12" type="text"  />
	  ...
	  <tr>
        ...
        <td class="normal14a"  > <input  tabIndex="2" id="mz002" onKeyPress="keyFunction()"  name="mz002"   value="<?php echo  $mz002; ?>"    type="text"  />
	...
	<a  accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('inv/invi10/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
