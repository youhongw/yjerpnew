...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 儲位條碼建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/inv/invi10/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MF001'> MF001 儲位條碼代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MF002'> MF002 儲位條碼名稱 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MF003'> MF003 儲位條碼備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MF001'> MF001 儲位條碼代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MF002'> MF002 儲位條碼名稱 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MF003'> MF003 儲位條碼備註 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('inv/invi10/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/inv/invi10/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
