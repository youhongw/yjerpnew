      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admi10/updsave/<?php echo $results[0]->mf001;?>" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
 <div class="form-group"><label for="mf001" class="col-sm-2 control-label">使用者代號</label>
 <div class="col-sm-10"><input type="text" name="mf001" value="<?php echo $mf001; ?>" id="mf001"  class="form-control" readonly="readonly"  /></div></div>
