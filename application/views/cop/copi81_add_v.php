...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 潛在客戶資料建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<!--<div id="htabs" class="htabs14"><span>編輯項目-新增</span></div> -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/cop/copi81/addsave" >	
	<?php       
      // 頭部表格  isset 檢查變數
	  $date=date("Ymd");
	...
	<table class="form14">     <!-- 表格 -->
	 ...
	 <!--     <td class="normal14"><input type="text" tabIndex="22"  id="dateTextContainer" onKeyPress="keyFunction()"   name="ma020" value="<?php echo $ma020; ?>"   /><button onClick="javascript:displayCalendar();"> <img src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/></button></a>
                  </td> -->
	  </tr>
	  <tr>
	...
	<!--	<td class="normal14"   ><input type="text" tabIndex="80" id="ma056" onKeyPress="keyFunction()"   onchange="startcopq01a(this)" name="copq01a"   value="<?php echo  $copq01a; ?>"     /><a href="javascript:;"><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
	    ...
	    <a  accesskey="x"  onKeyPress="keyFunction()" id="cancel" name="cancel" href="<?php echo site_url('cop/copi81/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	    </div> 
