...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶銷退單資料建立作業 - 複製</h1>
	...
	　<button style= "cursor:pointer" form="commentForm" onfocus="$('#ti001o').focus();" type='submit'  accesskey="c" onKeyPress="keyFunction()" name='submit' class="button"  value='&nbsp;儲存F8&nbsp;'><span>複 製Alt+c</span><img src="<?php echo base_url()?>assets/image/png/copy.png" /></button>&nbsp;&nbsp;
	   <a  accesskey="x" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('cop/copi09/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a></div>
	   
	</div>
    </div>
    <div class="content"> <!-- div-5 -->
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi09/copysave" method="post" enctype="multipart/form-data" id="form">
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	    <td class="normal14y" width="11%">原始銷退單別：</td>           
		<td class="normal14a"  width="39%"><input tabIndex="1" id="ti001o"  onKeyPress="keyFunction()"   name="ti001o" value="<?php echo strtoupper($ti001o); ?>" size="20" type="text" required />
		 <span id="ti001dispo" ></span></td>
	    <td class="normal14y" width="11%">複製銷退單別：</td>
	  ...
	  <tr>
	    <td class="normal14z" >原始銷退單號：</td>           
		<td class="normal14a"  ><input tabIndex="3" id="ti002o"  onKeyPress="keyFunction()"   name="ti002o" value="<?php echo strtoupper($ti002o); ?>" size="20" type="text" required />
		 <span id="ti002dispo" ></span></td>
	    <td class="normal14z" >複製銷退單號：</td>
