		  ...
		  <tr>
				...
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>銷退單號：</b><span><?php echo $results[0]->ti002 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $results[0]->ti034 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" valign="top"><b>部門：</b><span><?php echo $results[0]->ti005.' '.$results[0]->ti005disp ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" valign="top"><b>備註：</b><?php echo $results[0]->ti020 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶名稱：</b><span><?php echo $results[0]->ti004.' '.$results[0]->ti004disp ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>付款條件：</b><span><?php echo $results[0]->ti039.' '.$results[0]->ti039disp ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>業務人員：</b><span><?php echo $results[0]->ti006.' '.$results[0]->ti006disp ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>連 絡 人：</b><?php echo $results[0]->ti004disp3 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶電話：</b><?php echo $results[0]->ti004disp1 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶傳真：</b><?php echo $results[0]->ti004disp2 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  <td align="left"><?php echo $val->tj004;?></td>
					  <td align="left"><?php echo $val->tj005;?></td>
					  <td align="left"><?php echo $val->tj006;?></td>
					  <td align="left"><?php echo $val->tj008;?></td>
					  <td align="right"><?php echo $val->tj007;?></td>
					  <td align="right"><?php echo $val->tj011;?></td>
					  <td align="right"><?php echo $val->tj012;?></td>
					</tr>
					<?php $rownum++;$rownum1++; ?>
					...
					<tr>
					  ...
					  <?php if ($totle_page == $page  ) { ?>
						<b>金額：</b><?php echo $results[0]->ti037;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;<b>稅額：</b><?php echo $results[0]->ti038;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;
						<b>合計金額：</b><?php echo $results[0]->ti037+$results[0]->ti038;?>  <?php echo '';} ?> 
						<?php if ($totle_page > $page ) { ?>						
						<b>金額：</b><?php echo '';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;<b>稅額：</b><?php '';?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;
						<b>合計金額：</b><?php echo '     ';?>  <?php echo ' 續下頁..';} ?> 
					  </td>
					</tr>
				</table>
			</td></tr>
