...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 業務訪問審核作業 - 查看　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <a  accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('cop/copi83/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi83/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14">
      <tr>
        ...
        <td class="normal14" width="40%" ><input   tabIndex="2" id="mm002" onKeyPress="keyFunction()" onchange="startcmsq09a3(this)" name="cmsq09a3" value="<?php echo $cmsq09a3; ?>"  type="text" required disabled="disabled" /><img id="Showcmsq09a3" src="<?php echo base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="normal14z" >審核：</td>
		<td  class="normal14"  ><input type="text" tabIndex="5" id="mm006" onKeyPress="keyFunction()" name="mm006"   value="<?php echo $mm006; ?>"  size="4" disabled="disabled" /></td>
		<td class="normal14z" >核准：</td>
		<td  class="normal14"  ><input type="text" tabIndex="6" id="mm007" onKeyPress="keyFunction()" name="mm007"   value="<?php echo $mm007; ?>"  size="4" disabled="disabled" /></td>	
	  </tr>	
	  <tr>
	    <td colspan="1" class="normal14z" >內容描述：</td>
        <td colspan="3"  class="normal14"><textarea  tabIndex="7" rows="8" cols="50" name="mm005"   id="mm005"  Wrap="Physical"  > <?php echo $mm005; ?> </textarea>  </td>	  
