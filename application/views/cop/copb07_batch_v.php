...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 銷貨單轉入商品計價 - 作業　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copb07/batcha"  method="post"  enctype="multipart/form-data" > 
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a" width="88%"><input tabIndex="3" id="ta034c"  onfocus="this.select()" onchange="dataym2(this)"    onKeyPress="keyFunction()"    type="text" name="ta034c"  value="<?php echo $ta034c; ?>"  size="16" style="background-color:#E7EFEF" /></td>
	  </tr>
