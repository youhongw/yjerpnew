...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
	...
	//  $ta008=$this->input->post('ta008'); 一筆存檔清空白
	  ...
	  $ta009=0;$ta023=0;$ta025=0;$ta027=0;$ta028=0;
	?>
   
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="normal14y"  width="11%"><span class="required">報價單別：</span> </td>
        <td class="normal14a"  width="22%"><input tabIndex="1" id="copi03"    onKeyPress="keyFunction()" ondblclick="search_copi03_window()"  name="ta001" onfocus="selverify();" onchange="check_copi03(this);check_title_no();"  value="<?php echo $ta001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="22%" ><input tabIndex="3" id="ta002" onKeyPress="keyFunction()" readonly="value" name="ta002" onfocus="check_title_no();" value="<?php echo $ta002; ?>" size="12" type="text" required /></td>
	  </tr>		
	  <tr>
		<td class="normal14z">客戶代號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="copi01" onKeyPress="keyFunction()" ondblclick="search_copi01_window()" onfocus="check_title_no();" onchange="check_copi01(this)" name="ta004" value="<?php echo $ta004; ?>" size="12" type="text"  />
	...
	<!-- 合計     -->
			...
			<!--	<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<td ><input type='text' readonly="value" name="ta0923" id="ta0923" size="8" value="<?php echo $ta009+$ta023; ?>"  style="background-color:#F0F0F0" /></td>
			  ...
			  <br><span>&nbsp;</span>
		<!-- 合計     -->	
	<?php if ($current_product_count >'1040' ) { ?>
	 <?php // echo var_dump($current_product_count); ?>
	 <div class="buttons">
