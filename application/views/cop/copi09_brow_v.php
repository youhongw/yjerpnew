<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/cop/copi09/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重新整理 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/cop/copi09/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
      ...
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/cop/copi09/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'ti001' => array('sort_name'=>"ti001",'name'=>"銷退單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"c.mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'ti002' => array('sort_name'=>"ti002",'name'=>"銷退單號",'width'=>"7%",'align'=>"left"),
		'ti034' => array('sort_name'=>"ti034",'name'=>"單據日期",'width'=>"7%",'align'=>"left"),
		'ti004' => array('sort_name'=>"ti004",'name'=>"客戶代號",'width'=>"7%",'align'=>"left"),
		'ma002' => array('sort_name'=>"b.ma002",'name'=>"客戶名稱",'width'=>"7%",'align'=>"left"),
		'ti010' => array('sort_name'=>"ti010",'name'=>"銷退金額",'width'=>"7%",'align'=>"left"),
		'ti011' => array('sort_name'=>"ti011",'name'=>"稅額",'width'=>"7%",'align'=>"left"),
		//'ti018' => array('sort_name'=>"ti018",'name'=>"已結帳",'width'=>"7%",'align'=>"left"),
		'see' => array('sort_name'=>"",'name'=>"查看管理",'width'=>"11%",'align'=>"center"),
		'edit' => array('sort_name'=>"",'name'=>"修改管理",'width'=>"11%",'align'=>"center"),
		'print' => array('sort_name'=>"",'name'=>"印銷退單",'width'=>"11%",'align'=>"center")
	  );
    ?>
  <div class="content"> <!-- div-2 -->
	...
	<?php 
	  $filter_array = array(
		...
		'ti001' => array('filter_name'=>"ti001",'name'=>"銷退單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'ti002' => array('filter_name'=>"ti002",'name'=>"銷退單號",'size'=>"10",'align'=>"left"),
		'ti034' => array('filter_name'=>"ti034",'name'=>"單據日期",'size'=>"10",'align'=>"left"),
		'ti004' => array('filter_name'=>"ti004",'name'=>"客戶代號",'size'=>"10",'align'=>"left"),
		'ma002' => array('filter_name'=>"ma002",'name'=>"客戶名稱",'size'=>"10",'align'=>"left"),
		'ti010' => array('filter_name'=>"ti010",'name'=>"銷退金額",'size'=>"10",'align'=>"left"),
		'ti011' => array('filter_name'=>"ti011",'name'=>"稅額",'size'=>"10",'align'=>"left"),
		//'ti018' => array('filter_name'=>"ti018",'name'=>"已結帳",'size'=>"10",'align'=>"left"),
	  );
    ?> 
         <!-- <tbody>     <!-- 表格內容輸入篩選查詢 第一,二欄 刪除選項及序號空白 --> <tr class="filter">
	      <tr class="filter">
	      <td class="left"></td>
		  <?php
        ...
        <tr>
          ...
          <td class="left"><?php echo  $row->ti001disp.' '.$row->ti018;?></td>		  
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/cop/copi09/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/cop/copi09/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>