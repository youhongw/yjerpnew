...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      ...
      <button style= "cursor:pointer" form="commentForm" onfocus="$('#cuso').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copr28/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($cuso)) { $cuso=$this->input->post('cuso'); }
	  if(!isset($cusc)) { $cusc=$this->input->post('cusc'); }
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="normal14y" width="11%" >起始客代：</td>
	    <td class="normal14" width="39%"><input tabIndex="1" id="cuso" onKeyPress="keyFunction()" type="text" name="cuso"  value=""  size="20"  /><span > <?php   echo ''; ?> </span></td>
        <td class="normal14y" width="11%">結束客代：</td>
	    <td class="normal14" width="39%"><input tabIndex="2" id="cusc" onKeyPress="keyFunction()" type="text" name="cusc"  value=""  size="20" /><span > <?php   echo ''; ?> </span></td>
	  </tr>
	   <tr>
	    <td class="normal14z" >起始品號：</td>
	    <td class="normal14" ><input tabIndex="3" id="numbero" onKeyPress="keyFunction()" type="text" name="numbero"  value=""  size="20"  /><span > <?php   echo ''; ?> </span></td>
        <td class="normal14z" >結束品號：</td>
	    <td class="normal14" ><input tabIndex="4" id="numberc" onKeyPress="keyFunction()" type="text" name="numberc"  value=""  size="20" /><span > <?php   echo ''; ?> </span></td>
	  </tr>
	  <tr>
...
<?php include_once("./application/views/fun/copr28_funjs_v.php"); ?> 
