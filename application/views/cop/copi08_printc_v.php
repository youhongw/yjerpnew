		...
		<tr>
		  ...
		  <tr>
				...
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>銷貨單號：</b><span><?php echo $results[$vi]->tg002 ?></span></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $results[$vi]->tg042 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" colspan="2" valign="top"><b>送貨地址：</b><?php echo $results[$vi]->tg008 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" colspan="2" valign="top"><b>帳單地址：</b><?php echo $results[$vi]->tg009 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶名稱：</b><span><?php echo $results[$vi]->tg004.' '.$results[$vi]->tg004disp ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							 
							  <td width="600" align="left" valign="top"><b>連 絡 人：</b><?php echo $results[$vi]->tg004disp3 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
						...
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶電話：</b><?php echo $results[$vi]->tg004disp1 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶傳真：</b><?php echo $results[$vi]->tg004disp2 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  ...
					  <td align="left"><?php echo $val->th009;?></td>
					  <td align="right"><?php echo $val->th008;?></td>
					  <td align="right"><?php echo $val->th012;?></td>
					  <td align="right"><?php echo $val->th013;?></td>				 
					</tr>
				  ...
				  <!--同一單據有2張以上         -->
					...
					<tr>
					  <td colspan="7" align="left">
						<b>備  註：</b><?php echo $results[$vi-1]->tg020;?>						
					  </td>
					</tr>		
					<tr>
					  <td colspan="7" align="left">
			...
			<tr>
			  ...
			  <td width="180" align="left"><b>送  貨：</b></td>
		  ...
		  <tr>
			...
			<tr><td valign="top">
				...
				<table class="product" border=1 cellspacing=0 cellpadding=0>
                    ...
                    <tr>
					  <td colspan="7" align="left">
						<b>備  註：</b><? echo $results[$vi-1]->tg020;?>						
					  </td>
					</tr>					
					<tr>
					  <td colspan="7" align="left">
					     <?php if ($totle_page >= $page  ) { ?>
						<b>未稅金額：</b> <?php if ($tprint=='Y') { echo $results[$vi-1]->tg045;} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>稅　　額：</b> <?php if ($tprint=='Y') { echo $results[$vi-1]->tg046;} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>合計金額：</b> <?php if ($tprint=='Y') { echo $results[$vi-1]->tg045+$results[$vi-1]->tg046;} ?>  <?php echo '';} ?> 
					    <?php if ($totle_page < $page ) { ?>
						<b>未稅金額：</b> <?php if ($tprint=='Y') { echo '';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>稅　　額：</b> <?php if ($tprint=='Y') { echo '';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
