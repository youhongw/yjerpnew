...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶已訂未交明細表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copr24/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    ...
	    <td class="normal14a" width="39%"><input tabIndex="1" id="copq01a" onKeyPress="keyFunction()"  onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>"  type="text"  /><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01adisp"> <?php   echo $copq01adisp; ?> </span></td>
        <td class="normal14y" width="11%">結束客戶代號：</td>
		<td class="normal14a" width="39%"><input tabIndex="2" id="copq01a1" onKeyPress="keyFunction()"  onchange="startcopq01a1(this)" name="copq01a1" value="<?php echo $copq01a1; ?>"  type="text"  /><img id="Showcopq01a1" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01a1disp"> <?php   echo $copq01a1disp; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始接單日期：</td>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><input tabIndex="5" id="invq02a" onKeyPress="keyFunction()"  name="invq02a" value="<?php echo $invq02a; ?>"  type="text"  /></td>
        <td class="normal14z" >結束業務代號：</td>
	    <td class="normal14" ><input tabIndex="6" id="invq02a1" onKeyPress="keyFunction()"   name="invq02a1" value="<?php echo $invq02a1; ?>"  type="text"  /></td>
	  </tr>
	   <tr>
