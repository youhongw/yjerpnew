...
<div id="container"> <!-- div-1 -->
  <div id="header"> <!-- div-2 -->
   ...
   <!--   <div class="div2"><a style="text-decoration: none; color: #FFFFFF;" href="<?php echo base_url()?>index.php/main"><span >&nbsp;&nbsp;公司別：<?php echo $this->session->userdata('sysml002'); ?></span></a></div>
		...
		z<?php  include_once("./application/views/funnew/fun_head_icon.html"); ?z>
    </div>
 ...
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	 ...
	 <?php if(isset($prev)){ 
		...
		?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('cop/copi05/see/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('cop/copi05/see/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
		<?php } ?>
	  </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
        ...
        <td class="normal14a"  width="22%"><input tabIndex="1" id="copi03"    onKeyPress="keyFunction()"   name="ta001"    value="<?php echo $ta001; ?>" size="12" type="text" required />
