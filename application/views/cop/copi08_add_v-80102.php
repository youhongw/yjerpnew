   ...
   <?php } ?>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="2"  ondblclick="scwShow(this,event);" onfocus="this.select()" onchange="dataymd1(this)"  id="tg042" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="tg042"  value="<?php echo $tg042; ?>"  size="12" type="text"  style="background-color:#E7EFEF" /></td>
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
	   ...
	   <td class="normal14a" width="9%">發票日期：</td>						
        <td  class="normal14a" width="25%" ><input type="text" tabIndex="28"   onKeyPress="keyFunction()" onfocus="this.select()" ondblclick="scwShow(this,event);" id="tg021" name="tg021"   value="<?php echo $tg021; ?>"  style="background-color:#E7EFEF"  /></td>
	</tr>			  
	 <tr>
