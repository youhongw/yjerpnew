...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶商品計價建立作業 - 查看　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi02/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14">
        ...
        <td class="normal14a" width="42%" ><input   tabIndex="1" id="mb002" onKeyPress="keyFunction()" onchange="startinvq02a(this)" name="invq02a" value="<?php echo $invq02a; ?>"  type="text" required disabled="disabled"/><img id="Showinvq02a" src="<?php echo base_url()?>assets/image/png/distance.png" alt="" align="top"/></a>
        ...
        <td class="normal14a"  width="40%"> <input   tabIndex="2" id="mb001" onKeyPress="keyFunction()" onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>"  type="text" required disabled="disabled"/><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input   tabIndex="3" id="mb004" onKeyPress="keyFunction()" onchange="startcmsq06a(this)" name="cmsq06a" value="<?php echo $cmsq06a; ?>"  type="text" required disabled="disabled"/><img id="Showcmsq06a" src="<?php echo base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
         <span id="cmsq06adisp"> <?php    echo $cmsq06adisp; ?> </span></td>
		<td class="normal14z" >佣金單價：</td>
		<td class="normal14"><input  tabIndex="4" onKeyPress="keyFunction()" id="mb015" name="mb015"  value="<?php echo $mb015; ?>"  type="text"  disabled="disabled"/></td>	
	  </tr>
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="11" id="mb003"      onKeyPress="keyFunction()"    name="mb003" value="<?php echo $mb003; ?>" disabled="disabled" /></td>	  
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="hidden" name="mb007" class="mb007"  value="N" />
		  <input  type='checkbox' id="mb007" tabIndex="13" onKeyPress="keyFunction()" name="mb007" <?php if($mb010 == 'Y' ) echo 'checked'; ?>  <?php if($mb007 != 'Y' ) echo 'check'; ?> value="Y" size="1" disabled="disabled"  />
        </td>	  
