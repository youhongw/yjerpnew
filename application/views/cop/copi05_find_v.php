...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報價單資料建立作業 -設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cop/copi05/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TA001'> TA001 報價單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TA002'> TA002 報價單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TA003'> TA003 報價日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TA004'> TA004 客戶代號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TA005'> TA005 業務人員 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TA006'> TA006 客戶名稱 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='TA013'> TA013 單據日期 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TA001'> TA001 報價單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TA002'> TA002 報價單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TA003'> TA003 報價日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TA004'> TA004 客戶代號 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='TA005'> TA005 業務人員 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TA006'> TA006 客戶名稱 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='TA013'> TA013 單據日期 </option>
