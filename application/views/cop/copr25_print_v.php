...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 品號年月銷售數量統計表 - 列印明細表　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#numbero').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	      <?PHP if (substr($this->session->userdata('sysmg006'),10,1)=='Y') { ?>
		  <button style= "cursor:pointer" form="commentForm" onfocus="$('#numbero').focus();" type='submit' accesskey="l" class="button" name='action' value='excel'>轉EXCEL檔Alt+l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></button>&nbsp;&nbsp;
		  <?PHP } ?>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copr25/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($dateo)) { $dateo=date("Ym"); }
	  if(!isset($datec)) { $datec=date("Ym"); }
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    ...
	    <td class="normal14" width="39%"><input tabIndex="3" id="numbero" onKeyPress="keyFunction()" type="text" name="numbero"  value=""  size="20" style="background-color:#E7EFEF" /><span > <?php   echo ''; ?> </span></td>
        <td class="normal14y" width="11%">結束品號：</td>
	    <td class="normal14" width="39%"><input tabIndex="4" id="numberc" onKeyPress="keyFunction()" type="text" name="numberc"  value=""  size="20" style="background-color:#E7EFEF"/><span > <?php   echo ''; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始日期：</td>
	    <td class="normal14" ><input tabIndex="2"    id="dateo" onKeyPress="keyFunction()"   name="dateo"  value="<?php echo $dateo; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
...
<?php include_once("./application/views/fun/copr25_funjs_v.php"); ?> 
