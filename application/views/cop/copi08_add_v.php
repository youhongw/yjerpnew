...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	 ...
	 <a  href="javascript:;"><span class="button"  >複製客戶訂單</span><img id="Showcopc08a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>　
  ...
  <?php  } ?> 
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="copi03"    onKeyPress="keyFunction()" ondblclick="search_copi03_window()"  name="tg001"  onchange="check_copi03(this);check_title_no();"  value="<?php echo $tg001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="24%" ><input tabIndex="3" id="tg002" onKeyPress="keyFunction()"  onfocus="check_title_no();" name="tg002" value="<?php echo $tg002; ?>" size="30" type="text" required /></td>
	  </tr>	
	  <tr>
		 <td class="normal14z">客戶代號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="copi01" onKeyPress="keyFunction()" ondblclick="search_copi01_window()" onfocus="check_title_no();" onchange="check_copi01(this)" name="tg004" value="<?php echo $tg004; ?>" size="12" type="text"  />
...
<!--	
	...
	<table class="form14">     <!-- 表格 -->
	 ...
	 <tr>
        ...
        <td  class="normal14"  ><input type="text"   tabIndex="29" id="tg038" ondblclick="fPopCalendar(event,this,this)" onfocus="this.select()" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" class="date-picker" name="tg038" value="<?php echo $tg038; ?>"   /></td>	   
