 ...
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
	  ...
	  <tr>	    
        ...
        <td  class="normal14"  ><input type="text" tabIndex="5" readonly="value"  onKeyPress="keyFunction()" id="tc040" name="tc040"   value="<?php echo $tc040; ?>" style="background-color:#F0F0F0"  /></td>
		 <td class="normal14">訂單日期：</td>
        <td  class="normal14"  ><input type="text" tabIndex="6" readonly="value"  onKeyPress="keyFunction()" id="tc003" name="tc003"   value="<?php echo $tc003; ?>"  style="background-color:#F0F0F0" style="background-color:#FFFFE4"/></td>
	  </tr>
	   <tr>
	   <td class="normal14">流程代號：</td>
        <td  class="normal14"  ><input type="text" tabIndex="7" readonly="value"  onKeyPress="keyFunction()" id="tc049" name="tc049"   value="<?php echo $tc049; ?>" style="background-color:#F0F0F0"  /></td>
	...
	<div id="tab1" class="tab_content">
	  ...
	  <td class="normal14a"  >幣別：</td>
	   ...
	   <td class="normal14"  >課稅別：</td>
        ...
        <td class="normal14"  ><input type="text"  readonly="value" tabIndex="19"   onKeyPress="keyFunction()"   name="tc028" value="<?php echo $tc028; ?>" style="background-color:#F0F0F0"  /></td>
	  </tr>
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
        ...
        <thead>
            <tr>
              <td width="3%"></td>			
		      <td width="11%" colspan="1" class="left">品號</td>
	...
	<!--     <td class="center"><img src="<?php echo base_url()?>assets/image/delete.png" title="移除" onclick="$(\'#product-row0\').remove();" /></td> --> 
		...
		<input type="hidden"  name="order_product[<?php echo $i ?>][td001]" value="<?php echo $td001[$i]; ?>" />
	     ...
	     <td class="left"><input type="text" onchange="startinvq02a(this,<?php echo $i+1 ?>)" <?php echo 'id='.'td004'.$i ?>  ondblclick="copi02a(this,<?php echo $i ?>);"  name="order_product[<?php echo $i ?>][td004]" value="<?php echo $td004[$i]; ?>" size="20" style="background-color:#FFFFE4"  /></td>
	  <!--    <td class="left" ><input width="5px" type="button" value="..." style="float:left;" onclick="invq02a(this,<?php echo $i ?>);" /></td> -->
		 <td class="left"><input  type="text"  onKeyPress="keyFunction()"  id="td005"  name="order_product[<?php echo $i ?>][td005]" value="<?php echo $td005[$i]; ?>"  style="background-color:#F0F0F0" /></td>
	     <td class="left"><input type="text"  onKeyPress="keyFunction()"  id="td006"   name="order_product[<?php echo $i ?>][td006]" value="<?php echo $td006[$i]; ?>"  size="30" style="background-color:#F0F0F0" /></td>
	     <td class="left"><input  type="text"  onKeyPress="keyFunction()"    id="td010"   name="order_product[<?php echo $i ?>][td010]" value="<?php echo $td010[$i]; ?>" size="6" style="background-color:#F0F0F0" /></td>
	     <td class="left"><input type="text"   readonly="value"   name="order_product[$i][td003]" value="<?php echo $td003[$i]; ?>" size="6" style="background-color:#F0F0F0" /></td>
		 <td class="left"><input type="text" onchange="startcmsq03a(this,<?php echo $i+1 ?>)"  <?php echo 'id='.'td007'.$i ?> ondblclick="cmsq03a(this,<?php echo $i ?>)"  name="order_product[<?php echo $i ?>][td007]" value="<?php echo $td007[$i]; ?>" size="10"  style="background-color:#FFFFE4" /></td>
		<td class="left"><input  type="text"  onKeyPress="keyFunction()"  id="td007disp" ondblclick="cmsq03a(this,<?php echo $i ?>)" name="order_product[<?php echo $i ?>][td007disp]" value="<?php echo $td007disp[$i]; ?>" size="10" style="background-color:#F0F0F0" /></td>
		<td class="left"><input type="text"    ondblclick="scwShow(this,event);"  id="td013[<?php echo $i ?>]" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td013]" value="<?php echo $td013[$i]; ?>" size="10"   style="background-color:#FFFFE4" /></td>
         ...
         <td class="center"><input type="text"   class="total_price" id="td012" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td012]" value="<?php echo $td012[$i]; ?>" size="10" style="text-align:right;"  /></td>
         ...
         <td class="right"><input type="text" name="order_product[<?php echo $i ?>][td014]" value="<?php echo $td014[$i]; ?>" size="20" style="text-align:right;" /></td>
