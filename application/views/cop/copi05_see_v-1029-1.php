...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報價單資料建立作業 -查看</h1>
	  <form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi05/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
        ...
        <td class="normal14a"  width="20%"><input tabIndex="1" id="ta001"    onKeyPress="keyFunction()" onfocus="selappr()" onchange="startcopq03a21(this)"  name="copq03a21" value="<?php echo strtoupper($copq03a21); ?>"  type="text" required disabled="disabled" /><a href="javascript:;"><img id="Showcopq03a21" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="copq03a21disp"> <?php    echo $copq03a21disp; ?> </span></td>
	    <td class="normal14a" width="8%" >單據日期： </td>
        <td class="normal14a"  width="22%" ><input tabIndex="2"  onclick="scwShow(this,event);"  class="date" id="ta013" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="ta013"  value="<?php echo $ta013; ?>"  size="12" type="text"  disabled="disabled" /></td>
		<td class="normal14a" width="8%" ><span class="required">報價單號：</span> </td>
        <td class="normal14a"  width="22%" ><input tabIndex="3" id="ta002" onKeyPress="keyFunction()" onfocus="chkno1(this)" name="ta002" value="<?php echo $ta002; ?>" size="20" type="text" required  disabled="disabled" /><span id="ta002disp" ></span></td>
	  </tr>		
	  <tr>
		<td class="normal14">客戶代號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="ta004" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>" size="10" type="text" disabled="disabled"  /><a href="javascript:;"><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01adisp"> <?php echo $copq01adisp; ?> </span></td>	    
	    <td class="normal14" >幣別：</td>
        <td class="normal14a" ><input tabIndex="5" id="ta007" onKeyPress="keyFunction()" name="cmsq06a" onchange="startcmsq06a(this)"  value="<?php echo $cmsq06a; ?>"  type="text" disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq06a" src="<?php echo base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
        <span id="cmsq06adisp"> <?php    echo $cmsq06adisp; ?> </span></td>
		<td class="normal14" >業務人員：</td>
        <td class="normal14a" ><input tabIndex="6" id="ta005" onKeyPress="keyFunction()" name="cmsq09a3" onchange="startcmsq09a3(this)"  value="<?php echo $cmsq09a3; ?>"  type="text"  disabled="disabled" /><a href="javascript:;"><img id="Showcmsq09a3" src="<?php echo base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
        <span id="cmsq09a3disp"> <?php    echo $cmsq09a3disp; ?> </span></td>
	  </tr>
	  <tr>
	<!--	<td class="start14">付款條件：</td>
        <td  class="normal14"  ><input tabIndex="7" id="ta011" onKeyPress="keyFunction()"  name="cmsq21a2" onfocus="startcmsq21a2(this)"  value="<?php echo $cmsq21a2; ?>"  type="text" disabled="disabled" /><a href="javascript:;"><img id="Showcmsq21a2" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="cmsq21a2disp"> <?php echo $cmsq21a2disp; ?> </span></td>	  -->   
	    <td class="normal14" >付款條件：</td>
        <td class="normal14a" ><input tabIndex="6" id="ta011" onKeyPress="keyFunction()" name="cmsq21a2" onchange="startcmsq21a2(this)"  value="<?php echo $cmsq21a2; ?>"  type="text"  disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq21a2" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="cmsq21a2disp"> <?php    echo $cmsq21a2disp; ?> </span></td>
		<td class="normal14" >價格條件：</td>
        <td class="normal14a" ><input type="text" tabIndex="8"  onKeyPress="keyFunction()" id="ta010" name="ta010"   value="<?php echo $ta010; ?>" disabled="disabled" /></td>
		<td class="normal14" >訂貨日內交：</td>
        <td class="normal14a" ><input type="text" tabIndex="9"  onKeyPress="keyFunction()" id="ta014" name="ta014" size="5"  value="<?php echo $ta014; ?>" disabled="disabled" /></td>
	   
	  </tr> 
	  <tr>
		<td class="normal14">匯率：</td>
        <td  class="normal14"  ><input type="text" tabIndex="10"  onKeyPress="keyFunction()" id="ta008" name="ta008"   value="<?php echo $ta008; ?>" disabled="disabled" /></td>
	    <td class="normal14" >營業稅率：</td>
        <td class="normal14a" ><input type="text" tabIndex="11"  onKeyPress="keyFunction()" id="ta024" name="ta024"   value="<?php echo $ta024; ?>" disabled="disabled" /></td>
		<td class="normal14" >列印格式：</td>
        <td class="normal14a" ><select id="ta017" onKeyPress="keyFunction()" name="ta017"   tabIndex="12" disabled="disabled">
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="13"  onKeyPress="keyFunction()" id="ta006" name="ta006"   value="<?php echo $ta006; ?>" disabled="disabled" /></td>
	    <td class="normal14" >備註一：</td>
        <td class="normal14a" ><input type="text" tabIndex="14"  onKeyPress="keyFunction()" id="ta020" name="ta020"   value="<?php echo $ta020; ?>" disabled="disabled" /></td>
		<td class="normal14" >客戶確認：</td>
        <td class="normal14a" ><input type="hidden" name="ta016" value="N" />
		<input type='checkbox' tabIndex="15" id="ta016" onKeyPress="keyFunction()" name="ta016" <?php if($ta016 == 'Y' ) echo 'checked'; ?>  <?php if($ta016 !== 'Y' ) echo 'check'; ?> value="Y" size="1" disabled="disabled" /></td> 
	  
	  </tr>
	  <tr>
	    <td class="normal14" >課稅別：</td>
        <td class="normal14" ><select id="ta022" onKeyPress="keyFunction()" name="ta022" onchange="taxa()" tabIndex="16" disabled="disabled" >
        ...
        <td  class="normal14"  ><select id="ta019" onKeyPress="keyFunction()" name="ta019"  onchange="selappr(this)" tabIndex="17" disabled="disabled">
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><select id="ta029" tabIndex="21" readonly="value" onKeyPress="keyFunction()" name="ta029"   style="background-color:#F5F5F5" disabled="disabled" >
	 ...
	 <div>
		...
		<tbody   <?php echo    "id=product-row".$product_row ?> >		
	     ...
	     <td class="left"><input type="text"  tabIndex="14" <?php echo 'id='.'tb004'.$i ?>   name="order_product[<?php echo $i ?>][tb004]" value="<?php echo $tb004[$i]; ?>" size="20" disabled="disabled" /></td>
		 ...
		 <td class="left"><input type="text" tabIndex="19"  onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  id="tb016[<?php echo $i ?>]" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb016]" value="<?php echo  $tb016[$i]; ?>" size="10"  class="date" disabled="disabled" /></td>
	    <td class="left"><input type="text"  tabIndex="20"  class="total_qty" id="tb007"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb007]" value="<?php echo $tb007[$i]; ?>" size="12" disabled="disabled" /></td>
        <td class="left"><input type="text"  tabIndex="20" id="tb009"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb009]" value="<?php echo $tb009[$i]; ?>" size="12"  /></td>        
		<td class="center"><input type="text" readonly="value" tabIndex="21" class="total_price" id="tb010" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb010]" value="<?php echo $tb010[$i]; ?>" size="6" style="text-align:right;" disabled="disabled" /></td>	
        <td class="left"><input type="text"  tabIndex="22" class="total_qty1" id="tb020"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb020]" value="<?php echo $tb020[$i]; ?>" size="10" disabled="disabled" /></td>
		<td class="left"><input type="text"  tabIndex="23" class="total_qty2" id="tb021"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb021]" value="<?php echo $tb021[$i]; ?>" size="10" disabled="disabled" /></td>
	    <td class="left"><input type="text"  tabIndex="24" id="tb018"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb018]" value="<?php echo $tb018[$i]; ?>" size="10" disabled="disabled" /></td>
	    <td class="left"><input type="text"  tabIndex="25" id="tb012"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][tb012]" value="<?php echo $tb012[$i]; ?>" size="20" disabled="disabled" /></td>
	     </tr>	    
        </tbody>
 ...
 <?php } ?>		
	...
	<a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('cop/copi05/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	</div> 
	  <br>
      </form>
