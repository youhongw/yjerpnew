<div class="box2"> <!-- div-1 -->
      ...
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶訂單資料建立作業 - 瀏覽　　　</h1>
	   <div style="float:left; "> 
	     <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	       <a onclick="location = '<?php echo base_url()?>index.php/cop/copi06/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重新整理 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
         <?PHP } ?>
	     <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	       <a onclick="location = '<?php echo base_url()?>index.php/cop/copi06/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	     <?PHP } ?>
         ...
         <?PHP } ?>
	     <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	       <a onclick="location = '<?php echo base_url()?>index.php/cop/copi06/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
         <?PHP } ?>
	     ...
	     <?PHP } ?>
	     <?PHP if (substr($this->session->userdata('sysmg006'),6,1)=='Y') { ?>
	       <a onclick="location = '<?php echo base_url()?>index.php/cop/copi06/printdetailc'"   style="float:left"  accesskey="o" class="button"><span>印訂單 o </span><img src="<?php echo base_url()?>assets/image/png/print1.png" /></a> 
	     <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'tc001' => array('sort_name'=>"tc001",'name'=>"客戶單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"c.mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'tc002' => array('sort_name'=>"tc002",'name'=>"客戶單號",'width'=>"7%",'align'=>"left"),
	...
	//	'tc006' => array('sort_name'=>"tc006",'name'=>"業務人員",'width'=>"6%",'align'=>"left"),
		'tc029' => array('sort_name'=>"tc029",'name'=>"訂單金額",'width'=>"5%",'align'=>"left"),
		'tc030' => array('sort_name'=>"tc030",'name'=>"稅額",'width'=>"5%",'align'=>"left"),
      ...
      <form action="<?php echo base_url()?>index.php/cop/copi06/delete" method="post" enctype="multipart/form-data" id="form">
        <table class="list">      <!-- 表格開始 -->
		  ...
		  <?php
			...
			// anchor("cop/copi06/display_search/".$this->uri->segment(4,0)."/order?val="tc001" asc ,
			...
			foreach($title_array as $key => $val){
			  ...
			  echo anchor("cop/copi06/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("cop/copi06/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	...
	<?php 
	  $filter_array = array(
		...
		'tc001' => array('filter_name'=>"tc001",'name'=>"客戶單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'tc002' => array('filter_name'=>"tc002",'name'=>"客戶單號",'size'=>"10",'align'=>"left"),
		...
		//'tc006' => array('filter_name'=>"tc006",'name'=>"業務人員",'size'=>"10",'align'=>"left"),
		'tc029' => array('filter_name'=>"tc029",'name'=>"訂單金額",'size'=>"10",'align'=>"left"),
		'tc030' => array('filter_name'=>"tc030",'name'=>"稅額",'size'=>"10",'align'=>"left"),
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/cop/copi06/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/cop/copi06/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>