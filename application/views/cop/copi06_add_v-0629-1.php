...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="start14a"  width="10%"><span class="required">客戶訂單別：</span> </td>
        <td class="normal14a"  width="23%"><input tabIndex="1" id="tc001"    onKeyPress="keyFunction()" onfocus="selappr()" name="copq03a22" onchange="startcopq03a22(this)"  value="<?php echo strtoupper($copq03a22); ?>"  type="text" required  /><a href="javascript:;"><img id="Showcopq03a22" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="copq03a22disp"> <?php    echo $copq03a22disp; ?> </span></td>
	    <td class="normal14a" width="8%" >單據日期： </td>
        <td class="normal14a"  width="25%" ><input tabIndex="2"  ondblclick="scwShow(this,event);" onfocus="this.select()" onchange="dataymd1(this)"  id="tc039" onKeyPress="keyFunction()"   name="tc039"  value="<?php echo $tc039; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /><span > <?php echo '範例yyyymmdd'; ?> </span></td>
	     <td class="start14a" width="8%"><span class="required">訂單單號：</span></td>
        <td class="normal14a" width="25%"><input tabIndex="3" id="tc002" onKeyPress="keyFunction()" onfocus="chkno1(this)" name="tc002" value="<?php echo $tc002; ?>" size="30" type="text" required /><span id="tc002disp" ></span></td>
	  </tr>	
	  <tr>	    
		 <td class="normal14a">客戶代號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="tc004" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>" size="10" type="text"  /><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="6" readonly="value"  onKeyPress="keyFunction()" id="tc003" name="tc003"   value="<?php echo $tc003; ?>"  style="background-color:#F0F0F0" /></td>
	  </tr>
	   <tr>
	...
	//	 $tc041=$this->input->post('tc041');
		// $tc045=$this->input->post('tc045');
		   if(!isset($tc045)) { $tc045=0.5; }
	  // $tc026=$this->input->post('tc026');
	
	   // if(!isset($tc026)) { $tc026=0.05; }
		if(!isset($tc041)) { $tc041=$this->session->userdata('sysma004'); }
		//NTD tc008
	...
	<table class="form14">     <!-- 表格 -->
	 ...
	 <div style="width:100%; overflow-x: auto;  ">
        ...
        <thead>
            <tr>
              <td width="3%"></td>			
		      <td width="11%" colspan="1" class="left">品號(按2下客戶計價查詢)</td>
...
'◎操作說明:[ 品號欄位,交貨庫別,可輸入部份品號或品名下拉視窗選擇,按鈕可品號資料查詢,欄位顏色不同抉按2下開視窗選擇,單價欄位可歷史單價查詢. ] ' ?> </div>  <?php } ?>
     ...
     <?php include_once("./application/views/fun/copi06_funjs_v.php"); ?>