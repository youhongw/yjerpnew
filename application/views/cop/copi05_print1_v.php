...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報價單資料建立作業 -列印報價單　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi05/printc"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-報價單</span></div> -->
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="10%">報價單別：</td>
	   ...
	   <tr>
	    <td class="normal14a" >迄報價單號：</td>
	    <td class="normal14a" ><input tabIndex="2" id="ta002c" onKeyPress="keyFunction()" type="text" name="ta002c"  value="<?php echo $ta002c; ?>"  size="20" /></td>
	  </tr>	
    </table>
