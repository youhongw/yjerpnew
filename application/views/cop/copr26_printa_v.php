 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copr25/printdetail';location = url; </script> 
  <?php exit;} ?>
...
?>       
	...
	<table class="store">    <!-- 跳頁用 a4橫式--> <!-- 跳頁用 1.a4橫式 2.Letter -->
	   <tr><td align="center"><?php echo $this->session->userdata('sysml003'); ?></td></tr>
		  ...
		  {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";} ?>
			...
			<td align="center" width="33%">客戶年月銷售金額統計表</td>
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="8%" align="center">客戶代號</td>
	    <td width="8%" align="center">客戶名稱</td>
		<?php
		...
		?>
		<td width="5%" align="right">合計金額</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
		   ...
		   <?php foreach($page_data[$key] as $k=>$val){
					foreach($val as $t_k=>$t_v){
																?>
				  <tr>
					<td width="8%" align="center"><?php echo $t_k;?></td>
					...
					<td width="5%" align="right"><?php echo round($item_totle_money);$totle_money = $totle_money+round($item_totle_money);?></td>
				  </tr>		
					<?php }$rownum++;$rownum1++; ?>
		   	...
		   	<?php if (($totle_page == $page) and ($totle_page==1) and  ($rownum1 <=16 ) )  { ?>
	                ...
	                <tr style="display:none;">
					  <td colspan="<?php echo 5+$month_count;?>" align="left">
						...
						<span style="float:right;"><b>合計金額：</b> <?php if ($tprint=='Y') { echo round($totle_money);} ?>  <?php echo '';} ?></span>
						<?php if ($totle_page > $page ) { ?>
