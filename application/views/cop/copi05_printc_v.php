			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  ...
					  <td align="left" ><?php echo $val->tb005;?><br><?php echo $val->tb006;?></td>
					  <td align="right" ><?php echo $val->tb007;?><br><?php echo $val->tb009;?></td>
					   <td align="right" ><?php echo $val->tb008;?><br><?php echo $val->tb010;?></td>
					  <td align="left" ><?php echo $val->tb016;?><br><?php echo $val->tb017;?></td>
					  <td align="left" ><?php echo $val->tb012;?></td>					 
					</tr>
