...
<body >
	...
	<table class="store">
		<tr>
			<td align="center">客戶類別明細表</td>
        </tr>
	</table>
	
	<table class="thead">
		<tr>
			<td width="15%" align="center">客戶類別代號</td>
	        <td width="17%" align="center">客戶類別名稱</td>
	...
	<table class="list">
		...
		<tr>
		  <td width="60" align="center"><?php echo  $row->ml001;?></td>
		  <td width="100" align="center"><?php echo  $row->ml002;?></td>
		  <td align="left"><?php echo  $row->ml003;?></td>
        </tr>
		<?php $pagenum +=1; ?> 
