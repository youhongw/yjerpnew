...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報價單資料建立作業 -列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi05/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">起報價單別：</td>
        ...
        <td class="normal14y" width="10%">迄報價單別：</td>
		<td class="normal14a" width="40%"><input tabIndex="2" id="ta001c" onKeyPress="keyFunction()" type="text" name="ta001c"  value="<?php echo $ta001c; ?>"  size="20" /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起報價單號：</td>
