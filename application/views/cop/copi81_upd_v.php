...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 潛在客戶資資料建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/cop/copi81/updsave" method="post" enctype="multipart/form-data" >
	...
	<?php foreach($result as $row) { ?>
		  ...
		  <?php   $ma020=substr($row->ma020,0,4).'/'.substr($row->ma020,4,2).'/'.substr($row->ma020,6,2);?>	
		  <?php   $ma021=substr($row->ma021,0,4).'/'.substr($row->ma021,4,2).'/'.substr($row->ma021,6,2);?>
          <?php   $ma022=substr($row->ma022,0,4).'/'.substr($row->ma022,4,2).'/'.substr($row->ma022,6,2);?>
          <?php   $ma023=$row->ma023;?>
          <?php   $ma024=$row->ma024;?>
          <?php   $ma025=$row->ma025;?>
          <?php   $ma026=$row->ma026;?>
          ...
          <?php   $ma066=$row->ma066;?>
		  <?php   $ma067=$row->ma067;?>
		  <?php   $ma068=substr($row->ma068,0,4).'/'.substr($row->ma068,4,2).'/'.substr($row->ma068,6,2);?>
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="14" id="ma065" onKeyPress="keyFunction()" name="copq01a" onchange="startcopq01a(this)"  value="<?php echo $copq01a; ?>"  type="text"   /><img id="Showcopq01a" src="<?=base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="18" id="ma014" onKeyPress="keyFunction()" name="cmsq06a" onchange="startcmsq06a(this)"  value="<?php echo $cmsq06a; ?>"  type="text"   /><img id="Showcmsq06a" src="<?=base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
          <span id="cmsq06adisp"> <?php    echo $cmsq06adisp; ?> </span></td>			
		<td class="normal14a" >部門別：</td>						
        <td  class="normal14"  ><input tabIndex="19" id="ma014" onKeyPress="keyFunction()" name="cmsq05a" onchange="startcmsq05a(this)"  value="<?php echo $cmsq05a; ?>"  type="text"   /><img id="Showcmsq05a" src="<?=base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
          <span id="cmsq05adisp"> <?php    echo $cmsq05adisp; ?> </span></td>
	 </tr>
	  
	  <tr>
	    <td  class="normal14b">業務人員：</td>						
        <td  class="normal14"  ><input tabIndex="20" id="ma016" onKeyPress="keyFunction()" name="cmsq09a3" onchange="startcmsq09a3(this)"   value="<?php echo  $cmsq09a3; ?>"     type="text"  /><img id="Showcmsq09a3" src="<?=base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
         <span id="cmsq09a3disp"> <?php    echo $cmsq09a3disp; ?> </span></td>
	    <td class="normal14a" >收款業務員：</td>
        <td class="normal14"><input tabIndex="21" id="ma085" onKeyPress="keyFunction()" name="cmsq09a31" onchange="startcmsq09a31(this)"   value="<?php echo  $cmsq09a31; ?>"     type="text"  /><img id="Showcmsq09a31" src="<?=base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
         <span id="cmsq09a31disp"> <?php    echo $cmsq09a31disp; ?> </span></td>       
	    <td class="normal14a">開業日期</td>
        <td class="normal14"><input type="text" tabIndex="22" onfocus="scwShow(this,event);" onclick="scwShow(this,event);" id="ma020" onKeyPress="keyFunction()"   name="ma020" value="<?php echo $ma020; ?>"  style="background-color:#E7EFEF" /></td>
	  </tr>
	  <tr>
        ...
        <td class="normal14"><input type="text" tabIndex="23" onfocus="scwShow(this,event);" onclick="scwShow(this,event);" id="ma068" onKeyPress="keyFunction()"   name="ma068" value="<?php echo $ma068; ?>"  style="background-color:#E7EFEF" /></td>      
		<td class="normal14"></td>
        <td class="normal14"></td>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
		...
		<td class="normal14a" width="19%">
		  <select id="ma020" onKeyPress="keyFunction()" name="ma032" " tabIndex="33">
	  ...
	  <tr>
       ...
       <td class="normal14"><input tabIndex="44" id="ma031" onKeyPress="keyFunction()" name="cmsq21a1" onchange="startcmsq21a1(this)"   value="<?php echo  $cmsq21a1; ?>"     type="text"  /><img id="Showcmsq21a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14"><select id="ma020" onKeyPress="keyFunction()" name="ma039" " tabIndex="49">
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="23%" ><input type="text" tabIndex="54" id="ma017" onKeyPress="keyFunction()"   onchange="startcmsq15a1(this)" name="cmsq15a1"   value="<?php echo  $cmsq15a1; ?>"     /><a href="javascript:;"><img id="Showcmsq15a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		<span id="cmsq15a1disp"> <?php  echo $cmsq15a1disp; ?></span></td>
	    <td class="normal14a" width="10%" >型態別：</td>
		<td class="normal14a"  width="23%" ><input type="text" tabIndex="55" id="ma076" onKeyPress="keyFunction()"   onchange="startcmsq15a2(this)" name="cmsq15a2"   value="<?php echo  $cmsq15a2; ?>"     /><a href="javascript:;"><img id="Showcmsq15a2" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		<span id="cmsq15a2disp"> <?php  echo $cmsq15a2disp; ?></span></td>
		<td class="normal14a"  width="10%">地區別：</td>
        <td class="normal14a"  width="23%" ><input type="text" tabIndex="56" id="ma018" onKeyPress="keyFunction()"   onchange="startcmsq15a3(this)" name="cmsq15a3"   value="<?php echo  $cmsq15a3; ?>"     /><a href="javascript:;"><img id="Showcmsq15a3" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="cmsq15a3disp"> <?php  echo $cmsq15a3disp; ?></span></td>
	  </tr>	
	   <tr>
	    <td class="normal14a"  width="10%">國家別：</td>
        <td class="normal14a"  width="23%" ><input type="text" tabIndex="57" id="ma019" onKeyPress="keyFunction()"   onchange="startcmsq15a4(this)" name="cmsq15a4"   value="<?php echo  $cmsq15a4; ?>"     /><a href="javascript:;"><img id="Showcmsq15a4" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		<span id="cmsq15a4disp"> <?php  echo $cmsq15a4disp; ?></span></td>
	    <td class="normal14a" width="10%" >路線別：</td>
		<td class="normal14a"  width="23%" ><input type="text" tabIndex="58" id="ma077" onKeyPress="keyFunction()"   onchange="startcmsq15a5(this)" name="cmsq15a5"   value="<?php echo  $cmsq15a5; ?>"     /><a href="javascript:;"><img id="Showcmsq15a5" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		<span id="cmsq15a5disp"> <?php  echo $cmsq15a5disp; ?></span></td>
		<td class="normal14a"  width="10%">其他別：</td>
        <td class="normal14a"  width="23%" ><input type="text" tabIndex="59" id="ma078" onKeyPress="keyFunction()"   onchange="startcmsq15a6(this)" name="cmsq15a6"   value="<?php echo  $cmsq15a6; ?>"     /><a href="javascript:;"><img id="Showcmsq15a6" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="cmsq15a6disp"> <?php  echo $cmsq15a6disp; ?></span></td>
	  </tr>	
	  
	  <tr>
	   <td class="normal14a" >初次交易：</td>
        <td class="normal14" ><input tabIndex="60"  id="datepicker1" onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  onKeyPress="keyFunction()" type="text" name="ma021"    value="<?php echo $ma021; ?>" style="background-color:#E7EFEF" /></td>
	    <td class="normal14a" >最近交易：</td>
        <td class="normal14"  > <input tabIndex="61"  id="datepicker2" onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  onKeyPress="keyFunction()" type="text" name="ma022"    value="<?php echo $ma022; ?>"  style="background-color:#E7EFEF" /></td>
	  ...
	  <tr>
	   <td class="normal14a"  >付款銀行1：</td>
        <td class="normal14" ><input type="text" tabIndex="63" id="ma046" onKeyPress="keyFunction()"   onchange="startcmsq16a(this)" name="cmsq16a"   value="<?php echo  $cmsq16a; ?>"     /><a href="javascript:;"><img id="Showcmsq16a" src="<?=base_url()?>assets/image/png/bank.png" alt="" align="top"/></a>
        ...
        <td class="normal14"  ><input type="text" tabIndex="65" id="ma069" onKeyPress="keyFunction()"   onchange="startcmsq16a1(this)" name="cmsq16a1"   value="<?php echo  $cmsq16a1; ?>"     /><a href="javascript:;"><img id="Showcmsq16a1" src="<?=base_url()?>assets/image/png/bank.png" alt="" align="top"/></a>
	  ...
	  <tr>
	   <td class="normal14"  >銀行帳號2：</td>
        ...
        <td class="normal14"  ><input type="text" tabIndex="67" id="ma070" onKeyPress="keyFunction()"   onchange="startcmsq16a2(this)" name="cmsq16a2"   value="<?php echo  $cmsq16a2; ?>"     /><a href="javascript:;"><img id="Showcmsq16a2" src="<?=base_url()?>assets/image/png/bank.png" alt="" align="top"/></a>
	  ...
	  <tr>
       ...
       <td  class="normal14"><input tabIndex="33" id="ma047" onKeyPress="keyFunction()" name="actq03a1" onchange="startactq03a1(this)"   value="<?php echo  $actq03a1; ?>"     type="text"  /><img id="Showactq03a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="actq03a1disp"> <?php   echo $actq03a1disp; ?> </span></td>
	   <td  class="normal14a">票據科目：</td>		
       <td  class="normal14"  ><input tabIndex="70" id="ma074" onKeyPress="keyFunction()" name="actq03a2" onchange="startactq03a2(this)"   value="<?php echo  $actq03a2; ?>"     type="text"  /><img id="Showactq03a2" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="23%"><select id="ma029" onKeyPress="keyFunction()" name="ma048" " tabIndex="73">
	  ...
	  <tr>
        ...
        <td class="normal14"   ><input type="text" tabIndex="78" id="ma054" onKeyPress="keyFunction()"   onchange="startpurq01a1(this)" name="purq01a1"   value="<?php echo  $purq01a1; ?>"     /><a href="javascript:;"><img id="Showpurq01a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="purq01a1disp"> <?php  echo $purq01a1disp; ?></span></td>
	  </tr>	
	  
	   <tr>
	    <td  class="normal14"  >空運公司：</td>
        <td class="normal14"   ><input type="text" tabIndex="79" id="ma055" onKeyPress="keyFunction()"   onchange="startpurq01a2(this)" name="purq01a2"   value="<?php echo  $purq01a2; ?>"     /><a href="javascript:;"><img id="Showpurq01a2" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="purq01a2disp"> <?php  echo $purq01a2disp; ?></span></td>
	    
		<td  class="normal14"  >代理商：</td>
	<!--	<td class="normal14"   ><input type="text" tabIndex="80" id="ma056" onKeyPress="keyFunction()"   onchange="startcopq01a(this)" name="copq01a"   value="<?php echo  $copq01a; ?>"     /><a href="javascript:;"><img id="Showcopq01a" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="copq01adisp"> <?php  echo $copq01adisp; ?></span></td> -->
		<td class="normal14"   ><input type="text" tabIndex="81" id="ma056" onKeyPress="keyFunction()"   onchange="startcopq01a1(this)" name="copq01a1"   value="<?php echo  $copq01a1; ?>"     /><a href="javascript:;"><img id="Showcopq01a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="copq01a1disp"> <?php  echo $copq01a1disp; ?></span></td>
		
		<td  class="normal14"  >報關行：</td>
        <td class="normal14"   ><input type="text" tabIndex="81" id="ma057" onKeyPress="keyFunction()"   onchange="startpurq01a3(this)" name="purq01a3"   value="<?php echo  $purq01a3; ?>"     /><a href="javascript:;"><img id="Showpurq01a3" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
  		<span id="purq01a3disp"> <?php  echo $purq01a3disp; ?></span></td>
	  </tr>	
	  
	  <tr>
	    <td  class="normal14"  >驗貨公司：</td>
        <td class="normal14"   ><input type="text" tabIndex="78" id="ma058" onKeyPress="keyFunction()"   onchange="startpurq01a4(this)" name="purq01a4"   value="<?php echo  $purq01a4; ?>"     /><a href="javascript:;"><img id="Showpurq01a4" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
       ...
       <div class="buttons">
	    ...
	    <a accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('cop/copi81/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
</div> <!-- div-3 -->
    <?php  if ($message!=' ') { ?>
...
'◎操作說明:[  欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料.  ] ' ?> </div>  <?php } ?>
 ...
 <?php include("./application/views/fun/copi81_funjs_v.php"); ?>