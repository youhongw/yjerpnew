 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copi09/printdetail';location = url; </script> 
 <?php exit;} ?>
  <!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="9%" align="center">銷退單號</td>
	    <td width="8%" align="left">銷退日期</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	    ...
	    <?php  $rownum=$vbb;$rownum1=0;$rownum2=$vaa;  ?>
	      ...
	      <tr>
	    <td width="8%" align="center"><?php echo  $val->ti001;?></td>
		<td width="9%" align="center"><?php echo  $val->ti002;?></td>
        ...
        <td width="6%" align="left"><?php echo  $val->tj003;?></td>		
        ...
        <td width="5%" align="left"><?php echo  $val->tj008;?></td>	
        <td width="6%" align="right"><?php echo  $val->tj009;?></td>	
        <td width="6%" align="right"><?php echo  $val->tj011;?></td>	
        <td width="6%" align="right"><?php echo  $val->tj012;?></td>	
       		
        </tr>		
		<?php $rownum++;$rownum1++;$vamt=$vamt+$val->tj033;$vtax=$vtax+$val->tj034; ?>
