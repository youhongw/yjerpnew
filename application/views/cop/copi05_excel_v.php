...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報價單資料建立作業 -轉Excel　　　</h1>
  ...
  　</div>
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi05/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
      <tr>
	    <td class="normal14y" width="11%">起始報價單別：</td>
        ...
        <td class="normal14y" width="11%">結束報價單別：</td>
