<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copi10/printdetail';location = url; </script> 
 <?php exit;} ?>
  <!--   頁直行數  -->
...
?>       
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	     <?php  $rownum=$vbb;$rownum1=0;$rownum2=$vaa;  ?>
					...
					<tr>					 
					  <td width="5%" align="left"><? echo $val->tg001;?></td>
					  <td width="8%" align="left"><? echo $val->tg002;?></td>
					  <td width="8%" align="left"><? echo substr($val->tg003,0,4).'/'.substr($val->tg003,4,2).'/'.substr($val->tg003,6,2);?></td>
					   <td width="8%" align="left"><? echo $val->tg004;?><br><?php echo  $val->tg004disp;?></td>
					  <td width="5%" align="left"><? echo $val->th003;?></td>
					  <td width="10%" align="left"><? echo $val->th004;?></td>
					  <td width="33%" align="left"><?php if ($val->th005!='') {  echo wordwrap($val->th005,75,"<br />\n",TRUE);} else {echo "_";}?> 
		      <br><?php  if ($val->th006!='') {echo wordwrap($val->th006,75,"<br />\n",TRUE);}  else {echo "_";} ?></td>
					  <td width="5%" align="left"><? echo $val->th009;?></td>
					  <td  width="6%" align="right"><? echo $val->th008;?></td>
					  <td  width="6%" align="right"><? echo $val->th012;?></td>
				      <td  width="6%" align="right"><? echo $val->th013;?></td>
					</tr>
					<?php $rownum++;$rownum1++;$vtotamt=$vtotamt+$val->th013; ?>
	                ...
	                <tr>
					  <td colspan="11" align="left">
						...
						<b>未稅金額：</b> <?php if ($tprint=='Y') { echo $vtotamt;} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>稅　　額：</b> <?php if ($tprint=='Y') { echo '0';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>合計金額：</b> <?php if ($tprint=='Y') { echo $vtotamt;} ?>  <?php echo '';} ?> 
						<?php if ($totle_page > $page ) { ?>
