...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 未輸入幣別轉入作業 - 作業　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copb03/batcha"  method="post"  enctype="multipart/form-data" > 
...
//	 if (!$this->input->post('ta003c')) {$ta003c=date("Y/m/d");}	
  //   if (!$this->input->post('tb008c')) {$tb008c='1';}	 
	...
	// if !isset($this->input->post('ta034c')) {$ta034c=date("Y/m");}
	 if(!isset($ta034c)) { $ta034c=date("Y/m"); } else { $ta034c=$this->input->post('ta034c');} 
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a" width="88%"><input tabIndex="3" id="ta034c"  onchange="dataym2(this)"    onKeyPress="keyFunction()"    type="text" name="ta034c"  value="<?php echo $ta034c; ?>"  size="16" style="background-color:#E7EFEF" /></td>
	  </tr>
