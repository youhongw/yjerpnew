 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copr27/printdetail';location = url; </script> 
  <?php exit;} ?>
	...
	<table class="store">    <!-- 跳頁用 a4橫式--> <!-- 跳頁用 1.a4橫式 2.Letter -->
	   <tr><td align="center"><?php echo $this->session->userdata('sysml003'); ?></td></tr>
		  ...
		  {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";} ?>
			...
			<td align="center" width="33%">客戶年月未收款統計表</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
		   ...
		   <?php foreach($page_data[$key] as $k=>$val){
				  ...
				  <tr>
					...
					<td width="5%" align="right"><?php echo $item_totle_money;$totle_money = $totle_money+$item_totle_money;?></td>
				  </tr>		
					<?php }$rownum++;$rownum1++; ?>
		   	...
		   	<?php if (($totle_page == $page) and ($totle_page==1) and  ($rownum1 <=16 ) )  { ?>
	                ...
	                <tr style="display:none;">
					  <td colspan="<?php echo 5+$month_count;?>" align="left">
						...
						<span style="float:right;"><b>合計金額：</b> <?php if ($tprint=='Y') { echo $totle_money;} ?>  <?php echo '';} ?></span>
						<?php if ($totle_page > $page ) { ?>
