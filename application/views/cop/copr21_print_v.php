...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶訂單銷售狀況表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copr21/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14z" >起始預交日期：</td>
	    <td class="normal14" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="dateo1" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="dateo1"  value="<?php echo $dateo1; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
		   <img  onclick="scwShow(dateo1,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
        <td class="normal14z" >結束預交日期：</td>
	    <td class="normal14" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="datec1" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="datec1"  value="<?php echo $datec1; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
		   <img  onclick="scwShow(datec1,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
	  </tr>
	   <tr>
	    <td class="normal14z" >起始訂單單別：</td>
	    <td class="normal14" ><input tabIndex="7" id="tc001"    onKeyPress="keyFunction()"  name="copq03a22" onchange="startcopq03a22(this)"  value="<?php echo strtoupper($copq03a22); ?>"  type="text"  /><a href="javascript:;"><img id="Showcopq03a22" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="copq03a22disp"> <?php    echo $copq03a22disp; ?> </span></td>
        <td class="normal14z" >結束訂單單別：</td>
	    <td class="normal14" ><input tabIndex="8" id="tc0011"    onKeyPress="keyFunction()"  name="copq03a221" onchange="startcopq03a221(this)"  value="<?php echo strtoupper($copq03a221); ?>"  type="text"  /><a href="javascript:;"><img id="Showcopq03a221" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="copq03a221disp"> <?php    echo $copq03a221disp; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始訂單單號：</td>
	    <td class="normal14" ><input type="text" id="tc002"   tabIndex="9"   onKeyPress="keyFunction()"    name="tc002" value="<?php echo $tc002; ?>"  /></td>
        
        <td class="normal14z" >結束訂單單號：</td>
	    <td class="normal14" ><input type="text" id="tc0021"   tabIndex="10"   onKeyPress="keyFunction()"    name="tc0021" value="<?php echo $tc0021; ?>"  /></td>
        
	  </tr>
	   <tr>
	     <td class="normal14z" >選擇結案碼：</td>
	    <td class="normal14" ><select id="td016" onKeyPress="keyFunction()" name="td016"  tabIndex="11">
            <option <?php if($td016 == 'N') echo 'selected="selected"';?> value='N'>N.未結案</option>                                                                        
		    <option <?php if($td016 == 'Y') echo 'selected="selected"';?> value='Y'>Y.已結案</option>
		    <option <?php if($td016 == 'A') echo 'selected="selected"';?> value='A'>A.全部</option>
		  </select></td>
