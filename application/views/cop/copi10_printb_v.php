...
<link href="<?php echo base_url()?>assets/image/icon.png" rel="icon" />
 ...
 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copi10/printdetailc';location = url; </script> 
    <?php exit;} ?>
  <!--   頁直行數  -->
 <?php $paper9="1"; ?> 
		  ...
		  <tr>
				...
				<table class="order">
					<tr>
					  <td width="70%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="300" align="left" valign="top"><b>銷貨單號：</b><span><?php echo $results[0]->tg002 ?></span></td>
							  <td width="300" align="left" valign="top"><b>客戶名稱：</b><span><?php echo $results[0]->tg004.' '.$results[0]->tg004disp ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="300" align="left" valign="top"><b>單據日期：</b><?php echo $results[0]->tg042 ?></td>
							   <td width="300" align="left" valign="top"><b>連 絡 人：</b><?php echo $results[0]->tg004disp3 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" colspan="2" valign="top"><b>送貨地址：</b><?php echo $results[0]->tg008 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" colspan="2" valign="top"><b>帳單地址：</b><?php echo $results[0]->tg009 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  ...
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶電話：</b><?php echo $results[0]->tg004disp1 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶傳真：</b><?php echo $results[0]->tg004disp2 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  <td align="left"><? echo $val->th004;?></td>
					  <td align="left"><? echo $val->th005;?></td>
					  <td align="left"><? echo $val->th006;?></td>
					  <td align="left"><? echo $val->th009;?></td>
					  <td align="right"><? echo $val->th008;?></td>
					  <td align="right"><? echo $val->th012;?></td>
					  <td align="right"><? echo $val->th013;?></td>
					</tr>
					<?php $rownum++;$rownum1++; ?>
