...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> pos客戶銷貨單建立作業 - 新增　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#tg001').focus();" type='submit' tabIndex="98" accesskey="s" name='submit' class="button" onclick="addItem();" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
	 <a  accesskey="x" tabIndex="96" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('cop/copi10/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 <b style="color: #FF0000;" ><span class="button">&nbsp;&nbsp;複製客戶訂單&nbsp;</span></b><a  href="javascript:;"><img id="Showcopc08a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/>
	 
	</div>
	</div>
    <div class="content"> <!-- div-5 -->
	<!--<div id="htabs" class="htabs14"><span>編輯項目-新增</span></div> -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/cop/copi10/addsave" >	
   ...
   <?php } ?>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    ...
	    <td class="normal14y"  width="9%" ><span class="required">銷貨單號：</span></td>
...
<!--	
	 ...
	 <tr>
	  ...
	  <tr>
	   <td class="normal14z"  >發票聯數：</td>
		...
		<td class="normal14z""normal14z"  >課稅別：</td>
 ...
 <?php } ?>		 
	...
	<?php IF ($this->uri->segment(3)=='copybefore') {  ?>
		<?php include_once("./application/views/fun/copi10_funjsupdjs_v.php"); ?> 
		 <?php   } ?>	
          <tfoot>
...
<form action="<?php echo base_url()?>index.php/cop/copi10/delete_detaila" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
			<input id="del_md001" name="del_md001" />
			<input id="del_md002" name="del_md002" />
			<input id="del_md003" name="del_md003" />
		</form>
     <?php include_once("./application/views/fun/copi10_funjs_v.php"); ?> 
