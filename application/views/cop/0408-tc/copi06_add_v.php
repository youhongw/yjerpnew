  ...
  <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="2"  ondblclick="scwShow(this,event);" onfocus="selappr()" onChange="dataapp(this)"  id="tc039" onKeyPress="keyFunction()"   name="tc039"  value="<?php echo $tc039; ?>"  size="12" type="text" style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
	...
	<div class="abgne_tab"> <!-- div-6 -->
		...
		<li><a href="#tab2"  accesskey="b">地址</a></li>
		</ul>
	...
	<table class="form14">     <!-- 表格 -->
	 ...
	 <div style="width:100%; overflow-x: auto;  ">
        ...
        <thead>
            <tr>
              <td width="3%"></td>			
		      <td width="11%" colspan="2" class="left">品號(按2下客戶計價查詢)</td>
