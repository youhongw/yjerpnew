...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 業務訪問建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?=base_url()?>index.php/cop/copi82/findsql" method="post" enctype="multipart/form-data" >
    </div>
	...
	<tr>
	  ...
	  <div class="buttons">
	    <button tabIndex="7" type='submit'  accesskey="k"  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?=base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a  accesskey="x"   tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('cop/copi82/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?=base_url()?>index.php/cop/copi82/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
