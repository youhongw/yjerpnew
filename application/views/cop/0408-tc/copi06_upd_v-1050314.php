...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    ...
    <!--   明細0  --> 
		...
		<tbody  <?php echo 'id='.'product-row'.$product_row ?> >		
	     ...
	     <td class="left"><input type="text" onchange="startinvq02a(this,<?php echo $i+1 ?>)" <?php echo 'id='.'td004'.$i ?>   name="order_product[<?php echo $i ?>][td004]" value="<?php echo $td004[$i]; ?>" size="20" style="background-color:#E7EFEF"  /></td>
		 ...
		 <td class="left"><input type="text" onchange="startcmsq03a(this,<?php echo $i+1 ?>)"  <?php echo 'id='.'td007'.$i ?>   name="order_product[<?php echo $i ?>][td007]" value="<?php echo $td007[$i]; ?>" size="10"  style="background-color:#E7EFEF" /></td>
 ...
 <?php } ?>		
	...
	<?php include("./application/views/fun/copi06_funjsupdjs_v.php"); ?> 
...
<?php include("./application/views/fun/copi06_funjsupd_v.php"); ?> 