...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶銷貨單資料建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cop/copi08/updsave" method="post" enctype="multipart/form-data" >
<!--	<div id="htabs" class="htabs14"><span>編輯項目-修改</span></div> -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="tg001"  readonly="value"  onKeyPress="keyFunction()" onfocus="selappr()" onChange="startcopq03a23(this)"  name="copq03a23" value="<?php echo strtoupper($copq03a23); ?>"  type="text" required /><a href="javascript:;"><img id="Showcopq03a23" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	    ...
	    <td class="start14a"  width="8%" ><span class="required">銷貨單號：</span></td>
        <td class="normal14a"  width="25%" ><input tabIndex="3" id="tg002" onKeyPress="keyFunction()" readonly="value" name="tg002" value="<?php echo $tg002; ?>" size="30" type="text" required /><span id="tg002disp" ></span></td>
	  </tr>	
	  <tr>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><select id="tg059" tabIndex="11" readonly="value" onKeyPress="keyFunction()" name="tg059"   style="background-color:#EBEBE4" >
		  ...
		  <td class="normal14"><input type='hidden' name='tg024' id='tg024' value="<?php echo $tg024; ?>" /></td>
...
<!--	
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
	   ...
	   <td class="normal14a" width="9%">發票日期：</td>						
        <td  class="normal14a" width="25%" ><input type="text" tabIndex="28"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);" id="tg021" name="tg021"   value="<?php echo $tg021; ?>"    /></td>
	</tr>			  
	 <tr>
	    <td  class="normal14" >申報年月：</td>
        <td  class="normal14"  ><input type="text"   tabIndex="29" id="tg038"  onKeyPress="keyFunction()"  onclick="dateym();" class="date-picker" name="tg038" value="<?php echo $tg038; ?>"   /></td>	   
	 ...
	 <tr>
	  ...
	  <!--   <td class="center"><img src="<?php echo base_url()?>assets/image/delete.png" title="移除" onclick="$(\'#product-row0\').remove();" /></td> --> 
	   ...
	   <input type="hidden"  name="order_product[<?php echo $i ?>][th001]" value="<?php echo $th001[$i]; ?>" />
	     ...
	     <td class="left"><input type="text" onchange="startinvq02a(this,product_row)" <?php echo 'id='.'th004'.$i ?>   name="order_product[<?php echo $i ?>][th004]" value="<?php echo $th004[$i]; ?>" size="20" style="background-color:#E7EFEF"  /></td>
	     ...
	     <td class="left"><input  type="text"  onKeyPress="keyFunction()"    id="th009"   name="order_product[<?php echo $i ?>][th009]" value="<?php echo $th009[$i]; ?>" size="6"  /></td>
		...
		<td class="left"><input  type="text"  onKeyPress="keyFunction()"  id="th007disp"  name="order_product[<?php echo $i ?>][th007disp]" value="<?php echo $th007disp[$i]; ?>"  size="10" style="background-color:#EBEBE4" /></td>
	     ...
	     <td class="center"><input type="text" onchange="startcopq02a(this,product_row)"  class="total_qty" id="th008" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][th008]" value="<?php echo $th008[$i]; ?>" size="10" style="text-align:right;" /></td>
 ...
 <?php } ?>		 
	...
	<?php include("./application/views/fun/copi08_funjsupdjs_v.php"); ?> 
	 ...
	 <!-- 合計     -->
	  ...
	  <a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('cop/copi08/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div> 
	  </div> <!-- div-加 -->
    </form>
	<?php	if ($message!=' ') { ?>
	<div class="success"><?php echo '  提示訊息：'.$message.'<span>'.'</span>'.
'◎操作說明:[ 品號欄位可輸入部份品號或品名下拉視窗選擇,欄位顏色不同抉按2下開視窗選擇,單價欄位可歷史單價查詢. ] ' ?> </div>  <?php } ?>
    </div> <!-- div-6 -->
  </div> <!-- div-5 -->
</div> <!-- div-4 -->
 ...
 <form action="<?php echo base_url()?>index.php/cop/copi08/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
			<input id="del_md001" name="del_md001" />
			<input id="del_md002" name="del_md002" />
			<input id="del_md003" name="del_md003" />
		</form>
 <?php include_once("./application/views/fun/copi08_funjsupd_v.php"); ?>