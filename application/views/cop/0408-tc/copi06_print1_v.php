 ...
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
        ...
        <td class="start14a" width="8%">訂單單號：</td>
	    <td class="normal14a" width="42%"><input tabIndex="2" id="tc002o" onKeyPress="keyFunction()" type="text" name="tc002o"  value="<?php echo $tc002o; ?>"  size="20" /></td>
	  </tr>	
	   <tr>
