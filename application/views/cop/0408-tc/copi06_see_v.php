...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="tc001"    onKeyPress="keyFunction()"  name="copq03a22" onchange="startcopq03a22(this)"  value="<?php echo strtoupper($copq03a22); ?>"  type="text" required disabled="disabled"/><a href="javascript:;"><img id="Showcopq03a22" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="copq03a22disp"> <?php    echo $copq03a22disp; ?> </span></td>
	    <td class="normal14a" width="8%" >單據日期： </td>
        <td class="normal14a"  width="25%" ><input tabIndex="2"  onclick="scwShow(this,event);" onfocus="selappr()" class="date" id="tc039" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="tc039"  value="<?php echo $tc039; ?>"  size="12" type="text"  disabled="disabled" style="background-color:#E7EFEF"/></td>
	     <td class="start14a" width="8%"><span class="required">訂單單號：</span></td>
        <td class="normal14a" width="25%"><input tabIndex="3" id="tc002" onKeyPress="keyFunction()" onfocus="chkno1(this)" name="tc002" value="<?php echo $tc002; ?>" size="30" type="text" required disabled="disabled"/><span id="tc002disp" ></span></td>
	  </tr>	
	  <tr>	    
		 <td class="normal14a">客戶代號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="tc004" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>" size="10" type="text" disabled="disabled" /><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01adisp"> <?php   echo $copq01adisp; ?> </span></td>
	    <td class="normal14">確認者：</td>
        <td  class="normal14"  ><input type="text" tabIndex="5" readonly="value"  onKeyPress="keyFunction()" id="tc040" name="tc040"   value="<?php echo $tc040; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
		 <td class="normal14">訂單日期：</td>
        <td  class="normal14"  ><input type="text" tabIndex="6" readonly="value"  onKeyPress="keyFunction()" id="tc003" name="tc003"   value="<?php echo $tc003; ?>"  style="background-color:#EBEBE4"disabled="disabled" style="background-color:#E7EFEF"/></td>
	  </tr>
	   <tr>
	   <td class="normal14">流程代號：</td>
        <td  class="normal14"  ><input type="text" tabIndex="7" readonly="value"  onKeyPress="keyFunction()" id="tc049" name="tc049"   value="<?php echo $tc049; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
        <td class="normal14">拋轉狀態：</td>
        <td  class="normal14"  ><select id="tc050" tabIndex="8" readonly="value" onKeyPress="keyFunction()" name="tc050"   style="background-color:#EBEBE4" disabled="disabled">
          ...
          <td  class="normal14"  ><select id="tc027" onKeyPress="keyFunction()" name="tc027" onChange="selappr(this)" tabIndex="9" disabled="disabled">
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
       ...
       <td class="normal14a"  width="24%" ><input type="text" tabIndex="10" onKeyPress="keyFunction()" id="tc005"  name="cmsq05a"  onchange="startcmsq05a(this)"    value="<?php echo  $cmsq05a; ?>"  disabled="disabled"   /><a href="javascript:;"><img id="Showcmsq05a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
	   <span id="cmsq05adisp" > <?php    echo $cmsq05adisp; ?> </span></td>
	   <td class="normal14a"  width="8%">業務人員：</td>
        <td class="normal14a"  width="26%" ><input tabIndex="6" id="tc006" onKeyPress="keyFunction()" name="cmsq09a3" onchange="startcmsq09a3(this)"  value="<?php echo $cmsq09a3; ?>"  type="text"  disabled="disabled" /><a href="javascript:;"><img id="Showcmsq09a3" src="<?php echo base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
        <span id="cmsq09a3disp"> <?php    echo $cmsq09a3disp; ?> </span></td>
	   <td class="normal14a"  width="8%">廠別：</td>
       <td class="normal14a"  width="26%" ><input type="text" tabIndex="10" onKeyPress="keyFunction()" id="tc007"  onchange="startcmsq02a(this)" name="cmsq02a"   value="<?php echo  $cmsq02a; ?>"  disabled="disabled"   /><a href="javascript:;"><img id="Showcmsq02a" src="<?php echo base_url()?>assets/image/png/store.png" alt="" align="top"/></a>
	   <span id="cmsq02adisp"> <?php    echo $cmsq02adisp; ?> </span></td>
	 </tr>	
		  
	  <tr>
        <td class="normal14a"  >幣別：</td>
        <td class="normal14" ><input tabIndex="11" id="tc008" onKeyPress="keyFunction()" name="cmsq06a" onchange="startcmsq06a(this)"  value="<?php echo $cmsq06a; ?>"  type="text" disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq06a" src="<?php echo base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
          <span id="cmsq06adisp"> <?php    echo $cmsq06adisp; ?> </span></td>	  
	  <td class="normal14" >匯率：</td>		
        <td class="normal14"  ><input type="text" id="tc009"   tabIndex="12"   onKeyPress="keyFunction()"    name="tc009" value="<?php echo $tc009; ?>"  disabled="disabled"  /></td>
	    <td class="normal14" >客戶單號：</td>		
        <td class="normal14"  ><input type="text" id="tc012"   tabIndex="13"   onKeyPress="keyFunction()"    name="tc012" value="<?php echo $tc012; ?>"  disabled="disabled"  /></td>
	  </tr>
	    <tr>
		<td class="normal14" >價格條件：</td>		
        <td class="normal14"  ><input type="text" id="tc013"   tabIndex="14"   onKeyPress="keyFunction()"    name="tc013" value="<?php echo $tc013; ?>"  disabled="disabled"  /></td>
	   <td  class="normal14a" >付款條件：</td>
        <td  class="normal14"  ><input tabIndex="15" id="tc014" onKeyPress="keyFunction()" name="cmsq21a2" onchange="startcmsq21a2(this)"   value="<?php echo  $cmsq21a2; ?>"     type="text" disabled="disabled" /><a href="javascript:;"><img id="Showcmsq21a2" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="cmsq21a2disp"> <?php    echo $cmsq21a2disp; ?> </span></td>
	    <td class="normal14" >營業稅率：</td>		
        <td class="normal14"  ><input type="text" id="tc041"   tabIndex="16"   onKeyPress="keyFunction()"    name="tc041" value="<?php echo $tc041; ?>" disabled="disabled" /></td>
	  </tr>
	  
	   <tr>
	   <td class="normal14" >訂金比率：</td>		
        <td class="normal14"  ><input type="text" id="tc045"   tabIndex="17"   onKeyPress="keyFunction()"    name="tc045" value="<?php echo $tc045; ?>"  disabled="disabled"/></td>
	   <td class="normal14a"  >課稅別：</td>
        <td class="normal14" ><select id="tc016" onKeyPress="keyFunction()" name="tc016" onChange="seltax(this)" tabIndex="18" disabled="disabled">
        ...
        <td class="normal14"  ><input type="text"  readonly="value" tabIndex="19"   onKeyPress="keyFunction()"   name="tc028" value="<?php echo $tc028; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
	  </tr>
		
	  <tr>
	     <td class="normal14">簽核狀態：</td>
        <td  class="normal14"  ><select id="tc048" tabIndex="21" readonly="value" onKeyPress="keyFunction()" name="tc048"   style="background-color:#EBEBE4" disabled="disabled" >
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
		...
		<!--   明細  -->
	     ...
	     <td class="left"><input type="text" onchange="startinvq02a(this,<?php echo $i+1 ?>)" <?php echo 'id='.'td004'.$i ?>   name="order_product[<?php echo $i ?>][td004]" value="<?php echo $td004[$i]; ?>" size="20"  disabled="disabled" /></td>
		 ...
		 <td class="left"><input type="text" onchange="startcmsq03a(this,<?php echo $i+1 ?>)"  <?php echo 'id='.'td007'.$i ?>   name="order_product[<?php echo $i ?>][td007]" value="<?php echo $td007[$i]; ?>" size="10" disabled="disabled"  /></td>
		<td class="left"><input  type="text"  onKeyPress="keyFunction()"  id="td007disp"  name="order_product[<?php echo $i ?>][td007disp]" value="<?php echo $td007disp[$i]; ?>"  style="background-color:#EBEBE4" /></td>
		<td class="left"><input type="text"   onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  id="td013[<?php echo $i ?>]" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td013]" value="<?php echo $td013[$i]; ?>" size="10"  class="date" disabled="disabled" /></td>
	     <td class="center"><input type="text"  class="total_qty" id="td008" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td008]" value="<?php echo $td008[$i]; ?>" size="10" style="text-align:right;" disabled="disabled" /></td>
		 <td class="center"><input type="text"  id="td011" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td011]" value="<?php echo $td011[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>
         <td class="center"><input type="text"   class="total_price" id="td012" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td012]" value="<?php echo $td012[$i]; ?>" style="text-align:right;" disabled="disabled" /></td>
          <td class="center"><input type="text" readonly="value"  id="td009" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td009]" value="<?php echo $td009[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>
          <td class="center"><input type="text" class="total_qty1"  id="td030" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td030]" value="<?php echo $td030[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>
          <td class="center"><input type="text" class="total_qty2"  id="td031" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td031]" value="<?php echo $td031[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>		  
         <td class="right"><input type="text" name="order_product[<?php echo $i ?>][td014]" value="<?php echo $td014[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>
	     <td class="left"><input type="text" id="td020"  onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td020]" value="<?php echo $td020[$i]; ?>" size="20" disabled="disabled" /></td>
	...
	<a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('cop/copi06/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	</div> 
