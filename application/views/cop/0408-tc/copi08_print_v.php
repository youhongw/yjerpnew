...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	//  $tg003c=$this->input->post('tg003c');
	   ...
	   if(!isset($tg003c)) { $tg003c='zzzzzz'; }
	  $tg009p='1';
	?>
       
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="11%">起始銷貨單別：</td>
        ...
        <td class="normal14a" width="11%">結束銷貨單別：</td>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="start14" >起始客戶代號：</td>
	    <td class="normal14" ><input tabIndex="5" id="tg003o" onKeyPress="keyFunction()" type="text" name="tg003o"  value="<?php echo $tg003o; ?>"  size="20" /></td>
        <td class="normal14" >結束客戶代號：</td>
	    <td class="normal14" ><input tabIndex="6" id="tg003c" onKeyPress="keyFunction()" type="text" name="tg003c"  value="<?php echo $tg003c; ?>"  size="20" /></td>
	  </tr>
	   <tr>
