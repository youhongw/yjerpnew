  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/cop/copi06/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
	      ...
	      <td width="5%" class="left">
		  <?php echo anchor("cop/copi06/display/tc004disp/".(($sort_order == 'asc' && $sort_by == 'tc004disp') ? 'desc' : 'asc') ,'客戶名稱'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="5%" class="left">
	     ...
	     <tr class="filter">
          ...
          <td  width="5%" align="left">
		  <div class="button-search"></div>
		   <input type="text" name="filter_tc004disp" readonly="value" size="12" value="" style="background-color:#EBEBE4" />
		  </td>
...
function open_winprint()
  {
   // window.open('/index.php/cop/copi06/printdetail')
	window.location="<?php echo base_url()?>index.php/cop/copi06/printdetail";
  }
  function open_winprint1()
  {
 //   window.open('/index.php/cop/copi06/printdetailc')
	window.location="<?php echo base_url()?>index.php/cop/copi06/printdetailc";
  }

function open_winexcel()
  {
  //  window.open('/index.php/cop/copi06/exceldetail')
	window.location="<?php echo base_url()?>index.php/cop/copi06/exceldetail";
  }
</script>
...
function filter() {
	...
	if (filter_tc001) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc001/desc/' + encodeURIComponent(filter_tc001);
	} 
	
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc002/desc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc003/desc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc004/desc/' + encodeURIComponent(filter_tc004);
	}
		
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc004disp/desc/' + encodeURIComponent(filter_tc004disp); 
	}
	
	var filter_tc029 = $('input[name=\'filter_tc029\']').val();
	if (filter_tc029) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc029/desc/' + encodeURIComponent(filter_tc029); 
	}
		var filter_tc030 = $('input[name=\'filter_tc030\']').val();
	if (filter_tc030) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc030/desc/' + encodeURIComponent(filter_tc030); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/create_date/desc/' + encodeURIComponent(filter_create); 
	}
	
    if ( !filter_tc001  && !filter_tc002 && !filter_tc003 && !filter_tc004 && !filter_tc004disp && !filter_tc029  && !filter_tc030 && !filter_create) {         
	   url = '<?php echobase_url() ?>index.php/cop/copi06/display';location = url;
...
function filtera() {
	...
	var filter_tc001 = $('input[name=\'filter_tc001\']').val();
	if (filter_tc001) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc001/asc/' + encodeURIComponent(filter_tc001);
	} 
		
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc002/asc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc003/asc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc004/asc/' + encodeURIComponent(filter_tc004);
	}
		
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc004disp/asc/' + encodeURIComponent(filter_tc004disp);
		
	}
	
	var filter_tc029 = $('input[name=\'filter_tc029\']').val();
	if (filter_tc029) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc029/asc/' + encodeURIComponent(filter_tc029); 
	}
	var filter_tc030 = $('input[name=\'filter_tc030\']').val();
	if (filter_tc030) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/tc030/asc/' + encodeURIComponent(filter_tc030); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echobase_url() ?>index.php/cop/copi06/filter1/create_date/asc/' + encodeURIComponent(filter_create); 
	}
