...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> pos客戶銷貨單建立作業 -設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cop/copi10/findsql" method="post" enctype="multipart/form-data" >
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TG001'> TG001 銷貨單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TG002'> TG002  銷貨單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TG003'> TG003 銷貨日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TG004'> TG004 客戶代號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TG023'> TG023 確認碼 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TG014'> TG014 發票號碼 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='TG042'> TG042 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TG001'> TG001 銷貨單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TG002'> TG002 銷貨單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TG003'> TG003 銷貨日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TG004'> TG004 客戶代號 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TG023'> TG023 確認碼 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TG014'> TG014 發票號碼 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='TG042'> TG042 建立日期 </option>
	    </select>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/cop/copi10/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
