...
function filter() {
	...
	if (filter_tc001) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc001/desc/' + encodeURIComponent(filter_tc001);
	} 
	
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc002/desc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc003/desc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc004/desc/' + encodeURIComponent(filter_tc004);
	}
	...
	if (filter_tc029) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc029/desc/' + encodeURIComponent(filter_tc029); 
	}
		var filter_tc030 = $('input[name=\'filter_tc030\']').val();
	if (filter_tc030) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc030/desc/' + encodeURIComponent(filter_tc030); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.create_date/desc/' + encodeURIComponent(filter_create); 
	}
...
function filtera() {
	...
	var filter_tc001 = $('input[name=\'filter_tc001\']').val();
	if (filter_tc001) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc001/asc/' + encodeURIComponent(filter_tc001);
	} 
		
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc002/asc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc003/asc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc004/asc/' + encodeURIComponent(filter_tc004);
	}
	...
	var filter_tc029 = $('input[name=\'filter_tc029\']').val();
	if (filter_tc029) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc029/asc/' + encodeURIComponent(filter_tc029); 
	}
	var filter_tc030 = $('input[name=\'filter_tc030\']').val();
	if (filter_tc030) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.tc030/asc/' + encodeURIComponent(filter_tc030); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php echo base_url() ?>index.php/cop/copi06/filter1/a.create_date/asc/' + encodeURIComponent(filter_create); 
	}
