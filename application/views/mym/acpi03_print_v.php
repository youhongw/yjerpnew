...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/acp/acpi03/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14" width="20%">&nbsp;&nbsp;起始付款單別：</td>
	    <td class="normal14" width="30%"><input tabIndex="1" id="tc001o" onKeyPress="keyFunction()" type="text" name="tc001o"  value="<?php echo $tc001o; ?>"  size="20" /></td>
        <td class="start14" width="20%">&nbsp;&nbsp;結束付款單別：</td>
		<td class="normal14" width="30%"><input tabIndex="2" id="tc001c" onKeyPress="keyFunction()" type="text" name="tc001c"  value="<?php echo $tc001c; ?>"  size="20" /></td>
	  </tr>
	  <tr>
	    <td class="start14" >&nbsp;&nbsp;起始付款單號：</td>
	  ...
	  <tr>
	    ...
	    <div class="buttons">	      
	      <button  type='submit' tabIndex="98" accesskey="s" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>&nbsp;列 印 F8&nbsp;</span><img src="<?=base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
		  <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('acp/acpi03/display'); ?>" class="button" ><span>返 回&nbsp;F9&nbsp;</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	    </div>
