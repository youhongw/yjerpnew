...
<!--<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> pos Excel檔.xlsx上傳資料 - myslq作業</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/mym/mymb11/do_upload"  method="post"  enctype="multipart/form-data" > 
	...
	<!--  <tr>
	    ...
	    <td class="start14" >銷貨單別：</td>
	    <td class="normal14" ><input tabIndex="2" id="ta002o"   onKeyPress="keyFunction()"  name="ta002o" value="<?php echo $ta002o; ?>" size="20" type="text" /></td>
		 <td class="start14" >&nbsp;&nbsp;</td>
	   ...
	   <tr>
		...
		<td class="start14" >&nbsp;&nbsp;</td>
	    <td class="normal14" ></td>
	    <td class="start14" ><a href="<?php echo site_url('mym/mymb11/do_del/'.$ta002o."/".$ta002c)?>" class="button"><span>刪除&nbsp</span><img src="<?=base_url()?>assets/image/png/del.png" /></a></td>
