...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> mymy訂單列印&導出 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?=base_url()?>index.php/mym/mymr01/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TA001'> TA001 訂單時間 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TA002'> TA002 訂單編號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TA003'> TA003 購買人 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TA005'> TA005 手機號碼 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TA015'> TA015 付款方式 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TA016'> TA016 配送方式 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='TA023'> TA023 訂單狀態 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
		    <option <?php if($find006 == '1') echo 'selected="selected"';?> value='TA001'> TA001 訂單時間 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TA002'> TA002 訂單編號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TA003'> TA003 購買人 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TA005'> TA005 手機號碼 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TA015'> TA015 付款方式 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TA016'> TA016 配送方式 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='TA023'> TA023 訂單狀態 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    <button  type='submit' accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?=base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('mym/mymr01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?=base_url()?>index.php/mym/mymr01/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
