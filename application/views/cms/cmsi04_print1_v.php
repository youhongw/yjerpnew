...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<table class="form12">   <!-- 表格 -->
      <tr>
	    <td class="start12" width="12%">請購單別：</td>
	    <td class="normal12" width="38%"><input tabIndex="1" id="ta001o" onKeyPress="keyFunction()" type="text" name="ta001o"  value="<?php echo $ta001o; ?>"  size="20" /></td>
