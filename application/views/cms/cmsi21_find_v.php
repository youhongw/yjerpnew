...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 付款條件資料建立作業 - 設定查詢條件　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit' tabIndex="98" accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('cms/cmsi21/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cms/cmsi21/findsql" method="post" enctype="multipart/form-data" >
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
             <option <?php if($find001 == '1') echo 'selected="selected"';?> value='NA001'> NA001 類別 </option>                                                                        
		     <option <?php if($find001 == '2') echo 'selected="selected"';?> value='NA002'> NA002 付款代號 </option>
             <option <?php if($find001 == '3') echo 'selected="selected"';?> value='NA003'> NA003 名稱 </option>
             <option <?php if($find001 == '4') echo 'selected="selected"';?> value='NA004'> NA004 收付款方式別 </option>
		     <option <?php if($find001 == '5') echo 'selected="selected"';?> value='NA005'> NA005 結帳後天 </option>
		     <option <?php if($find001 == '6') echo 'selected="selected"';?> value='NA008'> NA008 資金實現方式 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='NA001'> NA001 類別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='NA002'> NA002 付款代號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='NA003'> NA003 名稱 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='NA004'> NA004 收付款方式別 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='NA005'> NA005 結帳後天 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='NA008'> NA008 資金實現方式 </option>
	...
	<tr>
	 ...
	 <!-- <div class="buttons">
	    <button  type='submit' tabIndex="98" accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('cms/cmsi21/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>-->
    </form>
	 <?php	 if ($message!=' ') { ?>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = 'http://ci.dercaster.com/index.php/cms/cmsi21/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
