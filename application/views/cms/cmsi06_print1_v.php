...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 請購單資料建立作業 - 請購單</h1>
    </div>
	...
	<table class="form12">   <!-- 表格 -->
      <tr>
	    ...
	    <td class="normal12" width="30%"><input tabIndex="2" id="ta002o" onKeyPress="keyFunction()" type="text" name="ta002o"  value="<?php echo $ta002o; ?>"  size="20" /></td>
	  </tr>	
