...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工姓名建立作業 - 修改　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cms/cmsi10/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
       ...
       <td class="normal14y" width="8%"><span class="required">員工代號：</span></td>
        <td class="normal14a" width="42%" >
         <input  tabIndex="1" id="mv001" onKeyPress="keyFunction()" onchange="startkey(this)" name="mv001"   value="<?php echo  $mv001; ?>"    type="text" readonly="readonly" required />
