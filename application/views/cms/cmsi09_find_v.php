...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 職務類別資料建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cms/cmsi09/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MJ001'> MJ001 職務代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MJ002'> MJ002 職務名稱 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MJ003'> MJ003 職務分類 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MJ004'> MJ004 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MJ001'> MJ001 職務代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MJ002'> MJ002 職務名稱</option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MJ003'> MJ003 職務分類 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MJ004'> MJ004 備註 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('cms/cmsi09/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
