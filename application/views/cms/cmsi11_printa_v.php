<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cms/cmsi11/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="15%" align="center">申報公司代號</td>
	    <td width="17%" align="center">公司簡稱</td>
	    <td width="17%" align="left">統一編號</td>
	    <td width="17%" align="left">稅籍編號</td>
       </tr>
	</table>
