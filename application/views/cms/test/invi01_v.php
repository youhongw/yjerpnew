...
$(function()
{
    ...
    {
		if (e.keyCode == 113) {
			document.location='<?=base_url()?>index.php/inv/invi01';
		}
	});
});
...
<div id="content">
 ...
 <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
		<a onclick="location = '<?=base_url()?>index.php/inv/invi01/addform'" class="button"><span>新增</span></a>
		<a onclick="location = '<?=base_url()?>index.php/inv/invi01/copyform'" class="button"><span>複製</span></a>	
        <a onclick="location = '<?=base_url()?>index.php/inv/invi01/findform'" class="button"><span>進階查詢</span></a>				
		
	<!--	<a onclick="$('#form').attr('action', 'http://ci.dercaster.com/index.php/inv/invi01/copyform'); $('#form').submit();" class="button">刪除選取</a> -->
	...
	<!--	<a onclick="$('form').submit();" class="button" id="delete1"><span>刪除多筆</span></a>		-->
	  ...
	  <!-- 	    <a onclick="open_winexcel();"   class="button">轉EXCEL檔</a>  -->
	        ...
	        <a onclick="location = '<?=base_url()?>index.php/inv/invi01/printdetail'"  class="button"><span>列印</span></a>
		    <a onclick="location = '<?=base_url()?>index.php/inv/invi01/exceldetail'"  class="button"><span>轉EXCEL檔</span></a>
	<!--  <a onclick="location = '<?=base_url()?>index.php/inv/table_export/index/invma'" class="button"><span>轉EXCEL檔</span></a>	-->
			
	<!--	<a onclick="location = '<?=base_url()?>index.php/inv/invi01/printdetail'" target="_new" class="button"><span>列印</span></a>  -->
		<a onclick="location = '<?=base_url()?>index.php/main'" class="button"><span>關閉</span></a>
	  </div>
    </div>
    <div class="content">
      
      <form action="<?=base_url()?>index.php/inv/invi01/delete" method="post" enctype="multipart/form-data" id="form">
	
        <table class="list">
          <thead>
            <tr>
              <td width="1" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
			  <td width="40" class="left"><?php echo anchor("inv/invi01/display/ma001/" .
					(($sort_order == 'asc' && $sort_by == 'rowid') ? 'desc' : 'asc') ,
					'序號'); ?> 
			  </td>
			  <td class="left"><?php echo anchor("inv/invi01/display/ma001/" .
					(($sort_order == 'asc' && $sort_by == 'ma001') ? 'desc' : 'asc') ,
					'分類'); ?> 
			  </td>
			  <td width="80" class="left"> <?php echo anchor("inv/invi01/display/ma002/" .
					(($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,
					'品號類別代號'); ?> 
			  </td>
			  <td width="110"  class="left"> <?php echo anchor("inv/invi01/display/ma003/" .
					(($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,
					'品號類別名稱'); ?> 
            <!--  <a href="<?=base_url()?>index.php/inv/invi01/display/ma002">品號類別名稱</a> -->
                </td>
			  <td width="80" class="left"><?php echo anchor("inv/invi01/display/ma004/" .
					(($sort_order == 'asc' && $sort_by == 'ma004') ? 'desc' : 'asc') ,
					'存貨會計科目'); ?> 
			  </td>
			  
			  <td width="80" class="center">
			  <?php echo anchor("inv/invi01/display/ma005/" .
					(($sort_order == 'asc' && $sort_by == 'ma005') ? 'desc' : 'asc') ,
					'銷貨收入科目'); ?> 
			   </td>
			  <td width="80" class="right"><?php echo anchor("inv/invi01/display/ma006/" .
					(($sort_order == 'asc' && $sort_by == 'ma006') ? 'desc' : 'asc') ,
					'銷貨退回科目'); ?> 
			  </td>
			  <td width="70" class="center"><?php echo anchor("inv/invi01/display/create_date/" .
		 ...
		 <!-- <td class="center"> <a onclick="return CheckForm();" href="<?php echo site_url('inv/invi01/del/'.$row->ma001."/".trim($row->ma002))?>" id="delete1"  >[ 刪除 ]</a></td>  -->
		      <td class="center"><a href="<?php echo site_url('inv/invi01/see/'.$row->ma001."/".trim($row->ma002))?>">[ 查看 ]</a></td>
              <td class="center"><a href="<?php echo site_url('inv/invi01/editform/'.$row->ma001."/".trim($row->ma002))?>">[ 修改 ]</a></td>
			</tr>
		    <?php $chkval += 1; ?>
		    <?php endforeach;?>
...
function filter() {
	...
	if (filter_ma001 != '*') {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma001/desc/' + encodeURIComponent(filter_ma001);
	}
	
	
	var filter_ma002 = $('input[name=\'filter_ma002\']').attr('value');
	if (filter_ma002) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma002/desc/' + encodeURIComponent(filter_ma002);
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma003/desc/' + encodeURIComponent(filter_ma003);
	}
		
	var filter_ma004 = $('input[name=\'filter_ma004\']').attr('value');
	if (filter_ma004) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma004/desc/' + encodeURIComponent(filter_ma004); 
	}
	
	var filter_ma005 = $('input[name=\'filter_ma005\']').attr('value');
	if (filter_ma005) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma005/desc/' + encodeURIComponent(filter_ma005); 
	}
	
	var filter_ma006 = $('input[name=\'filter_ma006\']').attr('value');
	if (filter_ma006) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma006/desc/' + encodeURIComponent(filter_ma006); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').attr('value');
	if (filter_create) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/create_date/desc/' + encodeURIComponent(filter_create); 
	}
...
function filtera() {
	...
	var filter_ma001 = $('select[name=\'filter_ma001\']').attr('value');
	if (filter_ma001 != '*') {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma001/asc/' + encodeURIComponent(filter_ma001);
	}
	
	
	var filter_ma002 = $('input[name=\'filter_ma002\']').attr('value');
	if (filter_ma002) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma002/asc/' + encodeURIComponent(filter_ma002);
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
		
	var filter_ma004 = $('input[name=\'filter_ma004\']').attr('value');
	if (filter_ma004) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma004/asc/' + encodeURIComponent(filter_ma004); 
	}
	
	var filter_ma005 = $('input[name=\'filter_ma005\']').attr('value');
	if (filter_ma005) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma005/asc/' + encodeURIComponent(filter_ma005); 
	}
	
	var filter_ma006 = $('input[name=\'filter_ma006\']').attr('value');
	if (filter_ma006) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/ma006/asc/' + encodeURIComponent(filter_ma006); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').attr('value');
	if (filter_create) {
		url = 'http://ci.dercaster.com/index.php/inv/invi01/filter1/create_date/asc/' + encodeURIComponent(filter_create); 
	}
