...
<div id="content">
 ...
 <div class="box">
    <div class="heading">
	  ...
	  <form action="<?=base_url()?>index.php/inv/invi01/copysave" method="post" enctype="multipart/form-data" id="form">
      <div class="buttons">
	    <button type='submit'  name='buttoncopy' class="button" value='確定'><span>確定</span></button>
    ...
    <div class="content">
	<div id="htabs" class="htabs"><a href="#tab-general">編輯項目-複製</a></div>	
    ...
    <!--  <form action="<?=base_url()?>index.php/inv/invi01/updsave/$this->input->post('ma001')/$this->input->post('ma002')/$this->input->post('ma003')/$this->input->post('ma004')" method="post" enctype="multipart/form-data" id="form">  -->
		...
		<!-- 	<td width="20%"><span class="required">*</span> 原始品號類別代號：</td>
		  ...
		  <tr>
			...
			<td width="20%"><span class="required">*</span> 複製品號類別代號：</td>
            <td width="30%">
