...
if (document.form.find003.value != ' ') {
  document.form.find005.value=document.form.find003.value;
  return true;
};
...
<div id="content">
 ...
 <div class="box">
    ...
    <div class="content">
	<div id="htabs" class="htabs"><a href="#tab-general">進階資料條件查詢</a></div>
		...
		<td width="04">&nbsp;&nbsp;</td>
          ...
          <tr>
			   ...
			   <select name="find002" >
			     ...
			     <input type="text" name="find003"  value="<?php echo $find003; ?>"  size="20" />
              </td>
			</tr>
			...
			<tr>
			   ...
			   <select name="find004">
                       ...
                       <option value="OR">OR</option>				
							  ...
							  <a onclick="data_c();"   class="button">清除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <a onclick="return CheckForm()";  class="button" href="<?php echo site_url('inv/invi01/findform')?>">加入</a></td>							  
		  </tr>
		  <tr>
		         <td><textarea rows="6" cols="40" name="find005" Wrap="Physical"  >
                 </textarea></td>
		  ...
		  <tr>
			    <td  width="04">&nbsp;&nbsp;排序欄位：
				<select name="find005" >
                	<option <?php if($find005 == '1') echo 'selected="selected"';?> value='MA001'> MA001 分類方式 </option>                                                                        
					<option <?php if($find005 == '2') echo 'selected="selected"';?> value='MA002'> MA002 品號類別代號 </option>
                    <option <?php if($find005 == '3') echo 'selected="selected"';?> value='MA003'> MA003 品號類別名稱 </option>
                    <option <?php if($find005 == '4') echo 'selected="selected"';?> value='MA004'> MA004 存貨會計科目 </option>
					<option <?php if($find005 == '5') echo 'selected="selected"';?> value='MA005'> MA005 銷貨收入科目 </option>
					<option <?php if($find005 == '6') echo 'selected="selected"';?> value='MA006'> MA006 銷貨退回科目 </option>
					<option <?php if($find005 == '7') echo 'selected="selected"';?> value='CREATE_DATE'> CREATE_DATE 建立日期 </option>
			   </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			            
						<a onclick="clear_r();"  class="button">▼</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <a onclick="clear_l();"  class="button">▲</a></td>	
           
		  </tr>
		  <tr>
			  <td><textarea rows="6" cols="40" name="find006" Wrap="Physical" >
                 </textarea></td>
				</td>
		  ...
		  <tr>
			    <td  width="04">&nbsp;&nbsp;排序方式：
				<select name="find006" >
                	<option <?php if($find006 == 'asc') echo 'selected="selected"';?> value='asc'> 由小到大 </option>                                                                        
					<option <?php if($find006 == 'desc') echo 'selected="selected"';?> value='desc'> 由大到小 </option>
