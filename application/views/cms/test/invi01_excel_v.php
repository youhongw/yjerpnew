 ...
 <div class="box">
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 品號類別資料建立作業</h1>
	   <form action="<?=base_url()?>index.php/inv/invi01/write"  method="post"  enctype="multipart/form-data" id="form"> 
	<!--    <form action="<?=base_url()?>index.php/inv/invi01/write" target="_new" method="post"  enctype="multipart/form-data" id="form"> -->
	<!--     <form action="<?=base_url()?>index.php/inv/invi01/exceltra" target="_new" method="post"  enctype="multipart/form-data" id="form"> -->
	<!--    <form action="<?=base_url()?>index.php/inv/invi01/excela"  method="post"  enctype="multipart/form-data" id="form"> -->
      <div class="buttons">
	   <!--     <a onclick="open_win();"   class="button">列印</a>    -->
        
	    <button type='submit'  name='buttoncopy' class="button"  target="_new" value='轉excel檔'><span>轉excel檔</span></button> 
    ...
    <div class="content">
	<div id="htabs" class="htabs"><a href="#tab-general">轉Excel-明細</a></div>
