...
<div id="content">
 ...
 <div class="box">
    ...
    <div class="content">
	<div id="htabs" class="htabs"><a href="#tab-general">編輯項目-修改</a></div>
...
$this->load->helper('url');	
	?>
    <!--  <form action="<?=base_url()?>index.php/inv/invi01/updsave" method="post" enctype="multipart/form-data" id="form">  -->
        <div id="tab-general">
		<table class="form">
          <tr>
			<td width="20%">&nbsp;&nbsp;分類方式：</td>
		  ...
		  <tr>
            ...
            <td>
			    <input type="text" name="ma002"  value="<?php echo $ma002; ?>"  size="06" />
              </td>
			<td>				&nbsp;&nbsp;品號類別名稱：							</td>
            <td>
											<input type="text" name="ma003"   value="<?php echo $ma003; ?>"  size="12" />
						</td>
		  </tr>
		  <tr>
			<td>&nbsp;&nbsp;存貨會計科目：</td>
            <td><input type="text" name="ma004"    value="<?php echo $ma004; ?>"  size="20" /></td>
			
						<td>&nbsp;&nbsp;銷貨收入科目：</td>
            <td><input type="text" name="ma005"   value="<?php echo $ma005; ?>"  size="20"/></td>
					  </tr>
		  <tr>
			<td><span class="required">*</span> 銷貨退回科目：</td>
            <td><input type="text" name="ma006"  value="<?php echo $ma006; ?>" size="20"/>
				</td>
			<td>&nbsp;&nbsp;</td>
            <td></td>
		  </tr>
	...
	//if ($this->input->post('ma002')) {echo  header( 'Location: addform' ) ; } 
	// echo form_open('inv/invi01/addform');
	?>
