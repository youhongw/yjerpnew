...
<div id="content">
 <div class="box">
	...
	<div class="content">
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/inv/invi03/printa"  method="post"  enctype="multipart/form-data" > 
	...
	?>
	  ...
	  <table class="form14">   <!-- 表格 -->
		...
		<tr>
          ...
          <td class="normal14" width="30%"><input tabIndex="4" id="ma003c" onKeyPress="keyFunction()" type="text" name="ma004c"  value="<?php echo $ma004c; ?>"  size="06" /></td>
		</tr>
