...
$(document).ready(function(){ 
    ...
    $('#form').submit(function(){
		...
		document.location='<?=base_url()?>index.php/inv/invi01/addform';
    });
...
<div id="content">
 ...
 <div class="box">
	...
	<!--   <form action="<?=base_url()?>index.php/inv/invi01/addsave" method="post" enctype="multipart/form-data" id="form" name="form"> -->
	...
	<form action="<?=base_url()?>index.php/inv/invi01/addsave" method="post" enctype="multipart/form-data" id="commentForm" name="form">
	...
	<!--  <form action="<?=base_url()?>index.php/inv/invi01/addsave" method="post" enctype="multipart/form-data" id="commentForm" name="form"> -->
		...
		<table class="form">
		  ...
		  <tr>
            ...
            <td>
			    <input name="ma002"  value="<?php echo $ma002; ?>"  size="06" type="text" required  />
              </td>
			<td>				&nbsp;&nbsp;品號類別名稱：							</td>
            <td>
											<input name="ma003"   value="<?php echo $ma003; ?>"  size="12" type="text" required />
						</td>
		  </tr>
		  <tr>
			<td>&nbsp;&nbsp;存貨會計科目：</td>
            <td><input  name="ma004"    value="<?php echo $ma004; ?>"  size="20"  type="text" /></td>
			
						<td width="20%" >&nbsp;&nbsp;銷貨收入科目：</td>
            <td><input  name="ma005"   value="<?php echo $ma005; ?>"  size="20"   minlength="2"  type="text" required /></td>
					  </tr>
		  <tr>
			<td><span class="required">*</span> 銷貨退回科目：</td>
            <td><input  name="ma006"  value="<?php echo $ma006; ?>" size="20" id="ma006"  minlength="2" type="text" required  />
