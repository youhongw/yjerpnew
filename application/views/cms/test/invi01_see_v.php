...
<div id="content">
 ...
 <div class="box">
    <div class="heading">
	  ...
	  <form action="<?=base_url()?>index.php/inv/invi01/updsave" method="post" enctype="multipart/form-data" id="formupd">
      <div class="buttons">
	  <!--    <button type='submit'  name='buttonsave' class="button" value='儲存'><span>儲存</span></button> -->
	    <a href="<?php echo site_url('inv/invi01/display'); ?>" class="button" ><span>返回</span></a>
	   <!--   <a onclick="$('#form').submit();" class="button"><span>儲存</span></a>  -->
		  
	  </div>
    </div>
    <div class="content">
	<div id="htabs" class="htabs"><a href="#tab-general">編輯項目-查看</a></div>
...
$this->load->helper('url');	
	?>
    <!--  <form action="<?=base_url()?>index.php/inv/invi01/seeform" method="post" enctype="multipart/form-data" id="form">  -->
        <div id="tab-general">
		<table class="form">
          <tr>
			<td width="20%">&nbsp;&nbsp;分類方式：</td>
			...
			<td width="20%">&nbsp;&nbsp;狀　　態：</td>
            <td width="30%"><select disabled="disabled" name="status">
		  ...
		  <tr>
            ...
            <td>
			    <input type="text" name="ma002"  value="<?php echo $ma002; ?>"  size="06" disabled="disabled" />
              </td>
			<td>				&nbsp;&nbsp;品號類別名稱：							</td>
            <td>
											<input type="text" name="ma003"   value="<?php echo $ma003; ?>"  size="12"  disabled="disabled" />
						</td>
		  </tr>
		  <tr>
			<td>&nbsp;&nbsp;存貨會計科目：</td>
            <td><input type="text" name="ma004"    value="<?php echo $ma004; ?>"  size="20" disabled="disabled" /></td>
			
						<td>&nbsp;&nbsp;銷貨收入科目：</td>
            <td><input type="text" name="ma005"   value="<?php echo $ma005; ?>"  size="20" disabled="disabled" /></td>
					  </tr>
		  <tr>
			<td><span class="required">*</span> 銷貨退回科目：</td>
            <td><input type="text" name="ma006"  value="<?php echo $ma006; ?>" size="20" disabled="disabled" />
				</td>
			<td>&nbsp;&nbsp;</td>
            <td></td>
		  </tr>
		...
		<!--	<table width="100%" align="center">
			...
			<td width="49%" valign="top">
			  <table class="list">
				<thead>
				  <tr>
					<td class="center" width="110">採購日期</td>
					<td class="left">供應商名稱</td>
					<td class="center" width="100">數量</td>
					<td class="right" width="110">單價</td>
					<td class="right" width="110">小計</td>
				  </tr>
				</thead>
												<tr>
					<td class="left" colspan="5">※由資料庫中取得最後10筆記錄!</td>
				</tr>
			  </table>
			</td>
			<td> </td>
			<td width="49%" valign="top">
			  <table class="list">
				<thead>
				  <tr>
					<td class="center" width="110">銷售日期</td>
					<td class="left">訂單編號</td>
					<td class="center" width="100">銷售數量</td>
				  </tr>
				</thead>
												<tr>
					<td class="left" colspan="3">※由資料庫中取得最後10筆記錄!</td>
				</tr>
			  </table>
			</td>
			</tr>
