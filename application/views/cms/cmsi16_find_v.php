...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 金融機構建立作業 - 設定查詢條件　　　</h1>
	 ...
	 <button tabIndex="7" type='submit'  accesskey="k"   name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a  accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('cms/cmsi16/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	 </div>
	 <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cms/cmsi16/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
              <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MO001'> MO001 金融機構代號 </option>                                                                        
		      <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MO002'> MO002 金融機構種類 </option>
              <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MO003'> MO003 金融機構總行 </option>
              <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MO004'> MO004 金融機構地區 </option>
		      <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MO005'> MO005 金融機構分行 </option>
		      <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MO006'> MO006 金融機構名稱 </option>
	  ...
	  <tr>
	    <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	       <select name="find006" id="find006" " tabIndex="5" >
             <option <?php if($find006 == '1') echo 'selected="selected"';?> value='MO001'> MO001 金融機構代號 </option>                                                                        
		     <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MO002'> MO002 金融機構種類 </option>
             <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MO003'> MO003 金融機構總行 </option>
             <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MO004'> MO004 金融機構地區 </option>
		     <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MO005'> MO005 金融機構分行 </option>
			 <option <?php if($find006 == '6') echo 'selected="selected"';?> value='MO006'> MO006 金融機構名稱 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/cms/cmsi16/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>