 				...
 				<div class="box">
 					<div class="box-header">
 						...
 						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 							...
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/cms/cmsi04/displays" role="button"><i class="fa fa-refresh"></i> 重整</a>
 							</div>
							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfcp03ka/display" role="button"><i class="fa fa-refresh"></i> 回上一頁</a>
 							</div>
 							...
 							<table id="example1" class="table table-bordered table-striped" style="width: 100%;">
 								<thead>
 									<tr style="background-color: #3C8DBC;cursor:pointer;color:#FFFFFF;">
 										...
 										<th style="text-align: center;vertical-align: middle;">計價代號</th>
 										<th style="text-align: center;vertical-align: middle;">計價名稱</th>
