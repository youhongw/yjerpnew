...
<body >
	...
	<table class="store">
	  <tr>
		<td align="center">交易對象明細表</td>
      </tr>
	</table>
	<table class="thead">
	  <tr>
		<td width="60" align="center">分類方式</td>
		<td width="100" align="center">交易對象代號</td>
		<td align="left">交易對象名稱</td>
	...
	<table class="list">
		...
		<tr>
		  <td width="60" align="center"><?php echo  $row->ma001;?></td>
		  <td width="100" align="center"><?php echo  $row->ma002;?></td>
		  <td align="left"><?php echo  $row->ma003;?></td>
		  <td width="100" align="left"><?php echo  $row->ma004;?></td>
		  <td width="100" align="left" ><?php echo  $row->ma005;?></td>
		  <td width="100" align="center"><?php echo  $row->ma006;?></td>
        </tr>
		<?php $pagenum +=1; ?>
