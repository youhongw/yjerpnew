...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 交易對象資料建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cms/cmsi15/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
             <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MR001'> MR001 分類方式 </option>                                                                        
		     <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MR002'> MR002 分類代號 </option>
             <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MR003'> MR003 分類簡稱 </option>
             <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MR004'> MR004 分類全稱 </option>
		     <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MR005'> MR005 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MR001'> MR001 分類方式 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MR002'> MR002 分類代號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MR003'> MR003 分類簡稱 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MR004'> MR004 分類全稱 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MR005'> MR005 備註 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = 'http://ci.dercaster.com/index.php/cms/cmsi15/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
