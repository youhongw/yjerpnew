...
/* title欄位設定區域 */
	$title_array = array(
		...
		'mb003' => array('sort_name'=>"mb003",'name'=>"電話",'width'=>"",'align'=>"left"),
...
/* filter欄位設定區域 */
	$filter_array = array(
		...
		'mb003' => array('filter_name'=>"mb003",'name'=>"電話",'size'=>"12",'align'=>"left")
	);
?>
        ...
        <tr>
		  ...
		  <td class="center"><a href="javascript:send_back('<?php echo $row->mb001;?>','<?php echo $row->mb002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
...
function send_back(mb001, mb002){
	window.parent.$.unblockUI();
	if(window.parent.addtc004disp){	//以此判斷各呼叫此網頁的方法是否存在藉以給予相對應的需求
		window.parent.addtc004disp(mb001,mb002);
		$.ajax({
			method: "POST",
