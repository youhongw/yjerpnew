 ...
 <div class="content-wrapper">
  ...
  <div class="btn-group mr-2" role="group" aria-label="First group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi01/addform" role="button"><i class="fa fa-plus"></i> 新增</a>
  </div>
  
  <!--<div class="btn-group" role="group" aria-label="Third group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi01/printdetail" role="button"><i class="fa fa-print"></i> 列印</a>
  </div>
  <div class="btn-group" role="group" aria-label="Four group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi01/printdetail" role="button"><i class="fa fa-file"></i> 複製</a>
  </div> -->
  <div class="btn-group" role="group" aria-label="Five group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi01/clear_sql_term" role="button"><i class="fa fa-refresh"></i> 重整</a>
  </div>
</div>
            </div>
            <!-- /.box-header -->
  ...
  <!--  <table style="overflow-x: auto;width:100%;overflow-scrolling:touch;" id="example1" class="table table-bordered table-striped">-->
				...
				<!--  <td > <input type="checkbox" name="selected[]"   id="cbbox"  value="<?php echo $row->mf001?>" onclick="$('input[name=\'selected\']').attr('checked', this.checked);" /></td> -->
				  ...
				  <td ><a class="btn btn-primary btn-sm" href="<?php echo site_url('scm/admi01/updform/'.$row->mf001)?>"   </a>修改</td>
				  </div>
				  <div class="btn-group btn-group-sm" role="group" aria-label="Third group">
				  <td ><a class="btn btn-danger btn-sm" href="<?php echo site_url('scm/admi01/del/'.$row->mf001)?>"  role="button" </a>刪除</td>
				  </div>
			   ...
			   <!--   <div class="btn-group btn-group-sm" role="group" aria-label="First group">
				...
				<!--  <td class="center"><a href="<?php echo site_url('scm/admi01/del/'.$row->mf001)?>">[ 刪除 </a><img src="<?php echo base_url()?>assets/image/png/dele.png" />]</td> -->
				</tr>
				<?php $chkval += 1; ?>
               <?php endforeach;?>
                </tbody>
