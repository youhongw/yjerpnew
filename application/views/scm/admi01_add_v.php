 ...
 <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  $mf006=addslashes($this->input->post('mf006'));
	  $mf007=addslashes($this->input->post('mf007'));
 ...
 <div class="col-sm-11"><input type="text" style="width: 250px" onKeyPress="keyFunction()" name="mf004" placeholder="請輸入欲查詢品號或品名下拉選取" value="<?php echo $mf004; ?>"  id="mf004" onfocus="check_title_no();" 
 ...
 <div class="form-group form-inline"><label for="mf005" class="col-sm-1 control-label">數量</label>
