 ...
 <div class="content-wrapper">
  ...
  <!--<div class="btn-group" role="group" aria-label="Third group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi03/printdetail" role="button"><i class="fa fa-print"></i> 列印</a>
  </div>
  <div class="btn-group" role="group" aria-label="Four group">
    <a class="btn btn-primary" href="<?php echo base_url()?>index.php/scm/admi03/printdetail" role="button"><i class="fa fa-file"></i> 複製</a>
  </div> -->
