      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admi01/updsave/<?php echo $results[0]->mf001;?>" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
...
<!-- <button type="reset" class="btn btn-warning btn-flat" >取消</button>-->
 ...
 <?php if(isset($prev)){ 
    ...
    <?php include_once './application/views/foot_v.php';?>