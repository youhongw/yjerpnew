 ...
 <div class="content-wrapper">
	...
	?>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admi05/addsave" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
 ...
 <!-- <button  class="btn btn-warning btn-flat" onclick="javascript:location.href='../scm/admi05/display'>瀏覽</button> -->
...
function check_title_no(){
	...
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/scm/admi05/check_title_no/"+encodeURIComponent(vdate),
		data: {
			mf001: vdate,
		}
	})
