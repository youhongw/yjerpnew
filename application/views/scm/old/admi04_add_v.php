 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--  <li><a href="<?php echo base_url()?>assets/admin/groups">生產入庫單</a></li> -->
	...
	?>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admi04/addsave" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
  
 <div class="form-group"><label for="mf002" class="col-sm-2 control-label">儲位編號</label>
 <div class="col-sm-10"><input type="text"  onKeyPress="keyFunction()" name="mf002" value="<?php echo $mf002; ?>" id="mf002" onfocus="check_title_no();" class="form-control"   /></div></div>
 
 <div class="form-group"><label for="mf003"   class="col-sm-2 control-label">容器編號</label>
 <div class="col-sm-10"><input type="text"  onKeyPress="keyFunction()"name="mf003" value="<?php echo $mf003; ?>" id="mf003" class="form-control"  /></div></div>
		  
 <div class="form-group"><label for="mf004" class="col-sm-2 control-label">品號</label>
 <div class="col-sm-10"><input type="text"  onKeyPress="keyFunction()" name="mf004" value="<?php echo $mf004; ?>"  id="mf004" onfocus="check_title_no();" 
 ...
 <div class="col-sm-10"><input type="text" name="mf005" onfocus="this.select()" value="<?php echo $mf005; ?>" id="mf005" class="form-control"  /></div></div>
 ...
 <div class="col-sm-10"><input type="text" readonly="value" name="mf001" value="<?php echo $mf001; ?>" id="mf001" class="form-control"  />
 ...
 <!-- <button  class="btn btn-warning btn-flat" onclick="javascript:location.href='../scm/admi04/display'>瀏覽</button> -->
 <a href="<?php echo base_url()?>index.php/scm/admi04/display" class="btn btn-warning btn-flat">瀏覽</a>
 <a href="<?php echo base_url()?>index.php/main" class="btn btn-default btn-flat">返回</a>
 <?php if(isset($prev)){ 
			$prev_str = "";$prev_ary = explode('_',$prev);foreach($prev_ary as $k=>$v){if($prev_str){$prev_str.="/";}$prev_str.=$v;}
		?>
			<a accesskey="," tabIndex="11" class="btn btn-primary btn-flat" id='prev' name='prev' href="<?php echo site_url('scm/admi04/updform/'.$prev_str); ?>"  ><span>上一筆</span> </a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next'class="btn btn-primary btn-flat" name='next' href="<?php echo site_url('scm/admi04/updform/'.$next_str); ?>"  ><span>下一筆</span> </a>
		<?php } ?>
    ...
    <?php include_once("./application/views/scm/admi04_foot_v.php");?>
...
function check_title_no(){
	...
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/scm/admi04/check_title_no/"+encodeURIComponent(vdate),
		data: {
			mf001: vdate,
		}
	})
