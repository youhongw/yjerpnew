 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--  <li><a href="<?php echo base_url()?>assets/admin/groups">領料單</a></li> -->
	...
	?>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admi02/addsave" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
 ...
 <!-- <button  class="btn btn-warning btn-flat" onclick="javascript:location.href='../scm/admi02/display'>瀏覽</button> -->
 <a href="<?php echo base_url()?>index.php/scm/admi02/display" class="btn btn-warning btn-flat">瀏覽</a>
 <a href="<?php echo base_url()?>index.php/main" class="btn btn-default btn-flat">返回</a>
 <?php if(isset($prev)){ 
			$prev_str = "";$prev_ary = explode('_',$prev);foreach($prev_ary as $k=>$v){if($prev_str){$prev_str.="/";}$prev_str.=$v;}
		?>
			<a accesskey="," tabIndex="11" class="btn btn-primary btn-flat" id='prev' name='prev' href="<?php echo site_url('scm/admi02/updform/'.$prev_str); ?>"  ><span>上一筆</span> </a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next'class="btn btn-primary btn-flat" name='next' href="<?php echo site_url('scm/admi02/updform/'.$next_str); ?>"  ><span>下一筆</span> </a>
		<?php } ?>
    ...
    <?php include_once("./application/views/scm/admi02_foot_v.php");?>
...
function check_title_no(){
	...
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/scm/admi02/check_title_no/"+encodeURIComponent(vdate),
		data: {
			mf001: vdate,
		}
	})
