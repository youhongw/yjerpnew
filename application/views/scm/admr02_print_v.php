 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php
	  $date=date("Ymd");
	  if(!isset($dateo)) { $dateo=date("Ym/d"); }
	  ...
	  $vdate=date("Ymd");
	       ...
	       $vyy=substr($dateo,0,4);
			$vmm=substr($dateo,5,2);
		    $yyy = (int)$vyy-0 ;
			$num = (int)$vmm-1 ;
			$vnum =  (string)$num;
	...
	?>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form action="<?php echo base_url()?>index.php/scm/admr02/printa" class="form-horizontal"  id="form-edit_group" method="post" accept-charset="utf-8">
...
<!-- test -->
 ...
 <!-- <button  class="btn btn-warning btn-flat" onclick="javascript:location.href='../scm/admr02/display'>瀏覽</button> -->
 ...
 <a href="<?php echo base_url()?>index.php/main" class="btn btn-default btn-flat">返回</a>
    ...
    <?php include_once("./application/views/scm/admr02_foot_v.php");?>
