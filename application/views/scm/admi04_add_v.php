  					...
  					<div class="box-body">
  						<form action="<?php echo base_url() ?>index.php/scm/admi04/addsave" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
  							...
  							<div class="form-group form-inline"><label for="me001" class="col-sm-1 control-label">群組代號</label>
  								<div class="col-sm-11">
  									<input type="text" tabIndex="1" style="width: 300px" onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase();" maxlength='10' onblur="dupl(this)" onKeyPress="keyFunction()" name="me001" value="<?php echo $me001; ?>" id="me001" class="form-control" required />
