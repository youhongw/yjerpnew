    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        foreach ($result as $row) {
          $mm001 = trim($row->mm001);
          $mm002 = mb_convert_encoding(trim($row->mm002), "utf-8", "big-5");
          $mm003 = mb_convert_encoding(trim($row->mm003), "utf-8", "big-5");
          $flag = trim($row->flag);
        }
        ?>
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form action="<?php echo base_url() ?>index.php/scm/admi13/updsave" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">

              <div class="form-group form-inline"><label for="mm001" class="col-sm-1 control-label">不良原因代號</label>
                <div class="col-sm-11">
                  <input type="hidden" tabIndex="1" style="width: 300px" onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase();" maxlength='10' onblur="dupl(this)" onKeyPress="keyFunction()" name="mm001" value="<?php echo $mm001; ?>" id="mm001" class="form-control" required />
                  <?php echo $mm001; ?>
              ...
              <div class="form-group form-inline"><label for="mm003" class="col-sm-1 control-label">備註</label>
                <div class="col-sm-11">
                  <input type="text" tabIndex="4" style="width: 300px" onKeyPress=" keyFunction()" name="mm003" value="<?php echo $mm003; ?>" id="mm003" class="form-control" />
