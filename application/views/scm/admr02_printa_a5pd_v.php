...
<?php exit;} ?>
    ...
    <div style="padding:10px;">
        ...
        <a id="print1" href="<?php echo base_url() ?>index.php/scm/admr02/printdetail"  style="font-size: 1.1em;font-family: 微軟正黑體, Arial, Helvetica, sans-serif;padding: 0em 0.625em;border:1px solid black;text-decoration:none;background-color:#E7EFEF;">返回</a>
	</div>
    <center>
    <form id="data">
    ...
    <div id="print-header-wrapper" style="width:500px;">
		...
		<div style="padding:5px 5px 0 5px;width:600px;text-align:left;display:inline-block ;line-height:12px">
		 ...
		 <div style="padding:5px 5px 0 5px;width:590px;border-top:2px solid black;text-align:left;display:inline-block ;line-height:6px">
		
    </div>
    <div class="row-fluid" id="print-body-wrapper" style="width:600px;border:0px solid black;">
        <table style="width:600px;" id="table_data">
            <thead style="font-size:15px;width:600px;">
                <tr style="width:600px;">
                       <th style="width:150px;"> 
                        <div style="margin: 0 auto;font-family:Times New Roman,標楷體;font-weight:bold;padding:3px;border-bottom:2px solid black;">業務代號</div>
                      </th>
                    <th style="width:150px;"> 
                        <div style="margin: 0 auto;font-family:Times New Roman,標楷體;font-weight:bold;padding:3px;border-bottom:2px solid black;">業務名稱</div>
                    </th>
                    <th style="width:150px;">  
                        <div style="margin: 0 auto;font-family:Times New Roman,標楷體;font-weight:bold;padding:3px;border-bottom:2px solid black;">客戶代號</div>
                    </th> 
					<th style="width:150px;">  
                        <div style="margin: 0 auto;font-family:Times New Roman,標楷體;font-weight:bold;padding:3px;border-bottom:2px solid black;">客戶名稱</div>
                    </th>
                        <th style="width:150px;"> 
                        <div style="margin: 0 auto;font-family:Times New Roman,標楷體;font-weight:bold;padding:3px;border-bottom:2px solid black;">銷售額</div>
                    </th> 
                    
                </tr>
            </thead>
            <tbody style="font-size:20px;">
			    <?php $no=1;$totamt=0;$totamt1=0; ?>
                ...
                <tr style="height:20px;">
					...
					<td style="height:25px;border-bottom:1px dashed #999;">
                        <div style="font-family:Times New Roman,新細明體;padding:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;">
                            &nbsp; <?php echo iconv("big-5","utf-8//IGNORE",$val->MA003);?>
                        </div>
                    </td>
					<td style="height:25px;border-bottom:1px dashed #999;">
                        <div style="font-family:Times New Roman,新細明體;padding:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;">
                            &nbsp; <?php echo iconv("big-5","utf-8//IGNORE",$val->MA004);?>
                        </div>
                    </td>
                    <td style="height:25px;border-bottom:1px dashed #999;">
                        <div style="font-family:Times New Roman,新細明體;padding:2px 10px 2px 2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:right;">
                            &nbsp;<?php echo number_format(round($val->MA005), 0, '.' ,',');?>
                        </div>
                    </td>
                    
                </tr>
                   <?php $totamt=$totamt+round($val->MA005);  ?>
                <?php endforeach;?>
            
			<!-- 	<tr>
					  <td colspan="5" align="right" >
					    <?php //$totamt1=$totamt1+$totamt;  ?>
						<b>&nbsp;合計：</b><?php //echo  number_format(round($totamt1), 0, '.' ,',');?>
						<?php //$totamt1=$totamt1+$totamt;$totamt=0;  ?>
					  </td>
				</tr> -->
            </tbody>
            <tfoot>
               <!-- <tr>
                    <td colspan="5" style="font-size:15px;padding:10px;">
