...
<head>
    ...
    <link used="print" rel="stylesheet" media="print" href="<?php echo base_url()?>assets/report/css/print_a4pd.css" /> <!-- 列印使用的CSS -->
...
<?php exit;} ?>
    ...
    <div id="print-header-wrapper" style="width:880px;">
        <div class="TitleName" style="font-family:Times New Roman,標楷體;padding:5px;font-size:28px;font-weight:bold;letter-spacing: 3px;width:880px;border:0px solid black;text-align:center;">
            <?php echo $this->session->userdata('sysml003'); ?>
        </div>
        <div style="font-family:Times New Roman,標楷體;padding:5px;font-size:20px;font-weight:bold;letter-spacing: 1px;width:880px;border:0px solid black;text-align:center;">
            即時業績明細表
        </div>
        <div style="padding:5px 5px 0 5px;width:880px;border-bottom:2px solid black;text-align:center;">
            <div style="font-family:Times New Roman,標楷體;font-size:18px;font-weight:bold;padding:5px;width:14%;float:right;display:block;clear:both;text-align:right;">
                頁次：
            </div>
            <div style="font-family:Times New Roman,標楷體;font-size:18px;font-weight:bold;padding:5px;float:left;display:block;">
                製表日期：<?php echo date("Y/m/d");?>
            </div>
            <div style="font-family:Times New Roman,標楷體;font-size:18px;font-weight:bold;padding:5px;">
                起迄日期：<?php echo $dateo;?>&nbsp;&nbsp;至&nbsp;&nbsp;<?php echo $datec;?>
            </div>
        </div>
    </div>
    <div class="row-fluid" id="print-body-wrapper" style="width:880px;border:0px solid black;">
        <table style="width:880px;" id="table_data">
            <thead style="font-size:15px;width:880px;">
                <tr style="width:880px;">
