	...
	<div id="header">
		...
		<div id="content">
			...
			<div class="box">
				<!-- div-4 -->
				<div class="heading">
					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> 隱藏版-材料BOM建立作業 - 新增　　　</h1>
					<div style="float:left;padding-top: 5px; ">
						...
						<a accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('bom/bomi02b/display'); ?>" class="button"><span>返 回Alt+x</span><img src="<?php echo base_url() ?>assets/image/png/cancle.png" /></a>
				...
				<div class="content">
					...
					<form class="cmxform" id="commentForm" name="form" method="post" enctype="multipart/form-data" style="width: 90%;" action="<?php echo base_url() ?>index.php/bom/bomi02b/addsave">
						<?php
						// 頭部表格  isset 檢查變數
						$date = date("Y/m/d");
