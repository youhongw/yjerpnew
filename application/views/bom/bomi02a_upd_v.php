...
echo "</pre>";*/
	     ...
	     <img src="<?php echo base_url() ?>assets/image/exit.png" style="position: relative; top: 5px;" />&nbsp;<a style="text-decoration: none; color: #FFFFFF;" href="<?php echo base_url() ?>index.php">退出系統</a>
   		...
   		<div id="content">
   			...
   			<div class="box">
   				<!-- div-4 -->
   				<div class="heading">
   					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> 材料BOM建立作業 - 修改　　　</h1>
   					<div style="float:left;padding-top: 5px; ">
   						...
   						<a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('bom/bomi02a/display'); ?>" class="button"><span>返 回Alt+x</span><img src="<?php echo base_url() ?>assets/image/png/cancle.png" /></a>

   					</div>
   				</div>
   				<div class="content">
   					<!-- div-5 -->
   					<form class="cmxform" id="commentForm" name="form" style="width: 90%;" action="<?php echo base_url() ?>index.php/bom/bomi02a/updsave" method="post" enctype="multipart/form-data">
   						<div id="tab-general">
   							<!-- div-6 -->
   							<?php
								if (!isset($sysma200)) {
   ...
   <form action="<?php echo base_url() ?>index.php/bom/bomi02a/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
