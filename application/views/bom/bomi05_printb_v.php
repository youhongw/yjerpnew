...
<body onLoad="window.print()">
		...
		<?php $pagerow=10;$page=1;$pagetot=1; $te007qty=0; $te045amt=0; ?>	
        <?php foreach($results as $row ) : ?>
			  ...
			  <?php $rowtot++;$te007qty=$te007qty+round($row->te008,0);$te045amt=$te045amt+round($row->te011,0); ?>
        <?php endforeach;?>
		...
		<!--	<tr><td valign="top">
			...
			<!--		<tr>
					  <td colspan="5" align="left">
						<b>數量合計：</b><? echo $te007qty;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;
						<b>金額合計：</b><? echo $te045amt;?>
					  </td>
					</tr> -->
				</table>
			</td></tr>
