...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 組合單資料建立作業 - 修改　　　</h1>
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('bom/bomi05/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('bom/bomi05/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>
	</div>
	 </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="22%"><input tabIndex="1" id="bomi03"    onKeyPress="keyFunction()" ondblclick="search_bomi03_window()"  name="td001"  onchange="check_bomi03(this);"  value="<?php echo $td001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="24%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="td014" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="td014"  value="<?php echo $td014; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
        ...
        <td class="normal14a"  width="24%" ><input tabIndex="3" id="td002" onKeyPress="keyFunction()"  name="td002" value="<?php echo $td002; ?>" size="20" type="text" required /></td>
	  </tr>		
		  
	  <tr>
		 <td class="normal14z">成品品號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="invi02" onKeyPress="keyFunction()"  ondblclick="search_invi02_window();" name="td004" value="<?php echo $td004; ?>" size="20" type="text" required />
...
<form action="<?php echo base_url()?>index.php/bom/bomi05/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
