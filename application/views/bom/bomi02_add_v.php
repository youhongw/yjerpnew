...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> BOM用料建立作業 - 新增　　　</h1>
	...
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/bom/bomi02/addsave" >	
	<?php       
      // 頭部表格  isset 檢查變數
	  $date=date("Y/m/d");
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="22%"><input tabIndex="1" id="invi02"    onKeyPress="keyFunction()" onblur="check_key(this);" ondblclick="search_invi02_window();"  name="mc001"  onchange="check_invi02(this);"  value="<?php echo $mc001; ?>" size="12" type="text" required />
