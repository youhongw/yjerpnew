...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 拆解單建立作業 - 查看　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('bom/bomi06/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/bom/bomi06/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="tf001"    onKeyPress="keyFunction()"  onfocus="selappr()" onChange="stbomq03a43(this)"  name="bomq03a43" value="<?php echo strtoupper($bomq03a43); ?>"  type="text" required disabled="disabled"  /><a href="javascript:;"><img id="Showbomq03a43" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="bomq03a43disp"> <?php    echo $bomq03a43disp; ?> </span></td>
	    <td class="normal14y" width="8%" >單據日期： </td>
        <td class="normal14a"  width="25%" ><input tabIndex="2"  onclick="scwShow(this,event);" onfocus="selappr()"  id="tf012" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="tf012"  value="<?php echo $tf012; ?>"  size="12" type="text"  style="background-color:#E7EFEF"  disabled="disabled" /></td>
	    <td class="normal14y" width="9%"><span class="required">拆解單號：</span></td>
        <td class="normal14a" width="25%"><input tabIndex="3" id="tf002" onKeyPress="keyFunction()" onfocus="chkno1(this)" name="tf002" value="<?php echo $tf002; ?>" size="30" type="text" required disabled="disabled" /><span id="tf002disp" ></span></td>
	  </tr>	
	  <tr>
		 <td class="normal14z">成品品號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="tf004" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startinvq02a1(this)" name="invq02a1" value="<?php echo $kkk=$invq02a1; ?>" size="20" type="text" required disabled="disabled" /><img id="Showinvq02a1" src="<?php echo base_url()?>assets/image/png/distance.png" alt="" align="top"/></a>
        <span id="invq02a1disp"> <?php   echo $invq02a1disp; ?> </span></td>
        <td class="normal14z" >品名：</td>
        <td class="normal14a" ><input tabIndex="5" id="tf004disp" onKeyPress="keyFunction()"  name="tf004disp" value="<?php echo $tf004disp; ?>" size="30" type="text" style="background-color:#EBEBE4" disabled="disabled"  /></td>	 
         <td class="normal14z" >規格：</td>
        <td class="normal14a" ><input tabIndex="6" id="tf004disp1" onKeyPress="keyFunction()"  name="tf004disp1" value="<?php echo $tf004disp1; ?>" size="30" type="text" style="background-color:#EBEBE4" disabled="disabled" /></td>	 	
	</tr>
		
	  <tr>
	    <td class="normal14z" >單位：</td>
        <td class="normal14a" ><input tabIndex="7" id="tf005" onKeyPress="keyFunction()"  name="tf005" value="<?php echo $tf005; ?>" size="10" type="text" disabled="disabled"  /></td>
	    <td class="normal14z">成品數量：</td>
       <td class="normal14a" ><input tabIndex="8" id="tf007" onKeyPress="keyFunction()"  name="tf007" value="<?php echo $tf007; ?>" size="10" type="text" disabled="disabled"  /></td>
	    <td class="normal14z">出庫庫別：</td>
       <td class="normal14a" ><input tabIndex="9" id="tf008" onKeyPress="keyFunction()" name="cmsq03a" onchange="stcmsq03a1a(this)"  value="<?php echo $cmsq03a; ?>"  type="text"  disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq03a1" src="<?php echo base_url()?>assets/image/png/store.png" alt="" align="top"/></a>
        <span id="cmsq03adisp"> <?php    echo $cmsq03adisp; ?> </span></td>
	  
	  </tr>
	    <tr>
	     <td class="normal14z">備註：</td>
       <td class="normal14a" ><input tabIndex="10" id="tf009" onKeyPress="keyFunction()"  name="tf009" value="<?php echo $tf009; ?>" type="text" disabled="disabled"  /></td>
	   <td class="normal14z">確認碼：</td>
          <td  class="normal14"  ><select id="tf010" onKeyPress="keyFunction()" name="tf010" onChange="selappr(this)" tabIndex="11" disabled="disabled" >
        ...
        <td class="normal14a" ><input tabIndex="12" id="tf011" onKeyPress="keyFunction()"  name="tf011" value="<?php echo $tf011; ?>" size="10" type="text" style="background-color:#EBEBE4" disabled="disabled" /></td>
	...
	<tr>
       ...
       <td class="normal14a"  width="24%" ><input type="text" tabIndex="19" id="tf017"    onKeyPress="keyFunction()"    name="tf017" value="<?php echo $tf017; ?>" disabled="disabled"   /></td>
	   <td class="normal14y"  width="12%" >拆解日期：</td>
       <td class="normal14a"  width="21%" ><input type="text" tabIndex="18" id="tf003"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);"  name="tf003" value="<?php echo $tf003; ?>" style="background-color:#EBEBE4" disabled="disabled"  /></td>
	   <td class="normal14y"  width="9%" > 簽核狀態：</td>
       <td class="normal14a"  width="25" ><select id="tf014" tabIndex="15" readonly="value" onKeyPress="keyFunction()" name="tf014"   style="background-color:#EBEBE4" disabled="disabled" >
	 ...
	 <tr>
	   <td class="normal14a"  > 調整單別：</td>
       <td class="normal14a"  ><input type="text" tabIndex="16" id="tf016"    onKeyPress="keyFunction()"    name="tf016" value="<?php echo $tf016; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
	   <td class="normal14a"  > 調整單別：</td>
       <td class="normal14a"  ><input type="text" tabIndex="17" id="tf017"      onKeyPress="keyFunction()"    name="tf017" value="<?php echo $tf017; ?>"  style="background-color:#EBEBE4" disabled="disabled" /></td>
	   <td class="normal14a"  > 調整序號：</td>
       <td class="normal14a"  ><input type="text" tabIndex="18" id="tf018"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);"  name="tf018" value="<?php echo $tf018; ?>" style="background-color:#EBEBE4" disabled="disabled"  /></td>
	 </tr>
	  <tr>
	   
	   <td class="normal14z"  > 確認者：</td>
       <td class="normal14a"  ><input type="text" tabIndex="21" id="tf015"   onKeyPress="keyFunction()"    name="tf015" value="<?php echo $tf015; ?>" style="background-color:#EBEBE4" disabled="disabled"  /></td>
	   <td class="normal14z"  > 小單位：</td>
       <td class="normal14a"  ><input type="text" tabIndex="22" id="tf006"    onKeyPress="keyFunction()"    name="tf006" value="<?php echo $tf006; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
