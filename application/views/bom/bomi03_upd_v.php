...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> BOM單據性質建立作業 - 修改　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/bom/bomi03/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td class="normal14" ><input   tabIndex="14"  readonly="value" id="mq021" onKeyPress="keyFunction()" onchange="startcopq03a61(this)" name="copq03a61" value="<?php echo $copq03a61; ?>"  type="text"  style="background-color:#EBEBE4" disabled="disabled" /><img id="Showcopq03a61test" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
         <span id="copq03a61disp"> <?php    echo $copq03a61disp; ?> </span></td>
		 <td class="normal14z" >註記代號： </td>
        <td class="normal14" ><input   tabIndex="15" id="mq025" onKeyPress="keyFunction()" onchange="startcmsq17a1(this)" name="cmsq17a1" value="<?php echo $cmsq17a1; ?>"  type="text"  /><img id="Showcmsq17a1" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input   tabIndex="17" id="mq027" onKeyPress="keyFunction()" onchange="startcmsq17a2(this)" name="cmsq17a2" value="<?php echo $cmsq17a2; ?>"  type="text"  /><img id="Showcmsq17a2" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   ...
	   <tr>
        ...
        <td class="normal14" ><input   tabIndex="20"  readonly="value" id="mq023" onKeyPress="keyFunction()" onchange="starttaxq02a(this)" name="taxq02a" value="<?php echo $taxq02a; ?>"  type="text"  style="background-color:#EBEBE4" disabled="disabled" /><img id="Showtaxq02a" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14"><input type="hidden" name="mq019" class="mq019"  value="N" disabled="disabled"  />
