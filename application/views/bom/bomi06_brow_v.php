<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/bom/bomi06/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重整 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
      ...
      <!-- <a onclick="$('form').submitb();"   class="button">印拆解單</a>   -->
	...
	<!--  <a onclick="location = '<?php echo base_url()?>index.php/bom/bomi06/exceldetail'"  style="float:left"  accesskey="l" class="button"><span>轉EXCEL檔 l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></a> -->
	  <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'tf001' => array('sort_name'=>"tf001",'name'=>"拆解單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'tf002' => array('sort_name'=>"tf002",'name'=>"拆解單號",'width'=>"6%",'align'=>"left"),
		'tf012' => array('sort_name'=>"tf012",'name'=>"單據日期",'width'=>"6%",'align'=>"left"),
		'tf004' => array('sort_name'=>"tf004",'name'=>"成品品號",'width'=>"7%",'align'=>"left"),
		'mb002' => array('sort_name'=>"mb002",'name'=>"品名",'width'=>"7%",'align'=>"left"),
		'mb003' => array('sort_name'=>"mb003",'name'=>"規格",'width'=>"7%",'align'=>"left"),
		//'tf005' => array('sort_name'=>"tf005",'name'=>"單位",'width'=>"7%",'align'=>"left"),
		'tf007' => array('sort_name'=>"tf007",'name'=>"成品數量",'width'=>"7%",'align'=>"left"),
		'see' => array('sort_name'=>"",'name'=>"查看管理",'width'=>"11%",'align'=>"center"),
		'edit' => array('sort_name'=>"",'name'=>"修改管理",'width'=>"11%",'align'=>"center"),
		'print' => array('sort_name'=>"",'name'=>"印拆解單",'width'=>"11%",'align'=>"center")
	  );
    ?>
  <div class="content"> <!-- div-2 -->
       ...
       <table class="list">      <!-- 表格開始 -->
	      ...
	      <?php
			foreach($title_array as $key => $val){
			  ...
			  echo anchor("bom/bomi06/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("bom/bomi06/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	...
	<?php 
	  ...
	  $filter_array = array(
		...
		'tf001' => array('filter_name'=>"tf001",'name'=>"拆解單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'tf002' => array('filter_name'=>"tf002",'name'=>"拆解單號",'size'=>"10",'align'=>"left"),
		'tf012' => array('filter_name'=>"tf012",'name'=>"單據日期",'size'=>"10",'align'=>"left"),
		'tf004' => array('filter_name'=>"tf004",'name'=>"成品品號",'size'=>"10",'align'=>"left"),
		'mb002' => array('filter_name'=>"mb002",'name'=>"品名",'size'=>"10",'align'=>"left"),
		'mb003' => array('filter_name'=>"mb003",'name'=>"規格",'size'=>"10",'align'=>"left"),
		//'tf005' => array('filter_name'=>"tf005",'name'=>"單位",'size'=>"10",'align'=>"left"),
		'tf007' => array('filter_name'=>"tf007",'name'=>"成品數量",'size'=>"10",'align'=>"left"),
	  );
    ?> 
		...
		<!--  <td class="left"><?php echo  $row->tf005;?></td> -->
		  <td class="left"><?php echo  $row->tf007;?></td>
		  ...
		  <!-- 修改時 留在原來那一筆資料使用 -->
		  <?php $this->session->set_userdata('bomi06_search',$this->uri->segment(3)."/".$this->uri->segment(4,0));
		    if($this->uri->segment(3)=="display" || $this->uri->segment(3)=="display_leave"){
			  $this->session->set_userdata('bomi06_search',$this->uri->segment(3)."/".$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6,0));
			} ?>  
		<!-- 顯示頁次 -->	
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/bom/bomi06/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/bom/bomi06/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>