<div class="box2"> <!-- div-1 -->
    <div class="heading">
     ...
     <!--  <div class="buttons"> -->
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri03/addform'"  style="float:left" accesskey="+" class="button"><span>新增</span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri03/findform'"  style="float:left" accesskey="k" class="button"><span>進階查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	  ...
	  <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),6,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri03/printdetailc'"  style="float:left"  accesskey="o"  class="button"><span>印收款單 o </span><img src="<?php echo base_url()?>assets/image/png/print1.png" /></a> 
	  <?PHP } ?>
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/acr/acri03/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
		  ...
		  <?php echo anchor("acr/acri03/display/tc001/".(($sort_order == 'asc' && $sort_by == 'rowid') ? 'desc' : 'asc') ,'序號'); ?>
           		  
	      </td>
	      <td width="10px" class="left">
	          <?php echo anchor("acr/acri03/display/tc001/" . (($sort_order == 'asc' && $sort_by == 'tc001') ? 'desc' : 'asc') ,'收款單別'); ?>
			  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="left"> 
		  <?php echo anchor("acr/acri03/display/tc002/" . (($sort_order == 'asc' && $sort_by == 'tc002') ? 'desc' : 'asc') ,'收款單號'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="left"> 
		  <?php echo anchor("acr/acri03/display/tc003/" . (($sort_order == 'asc' && $sort_by == 'tc003') ? 'desc' : 'asc') ,'單據日期'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
              </td>
	      <td width="5%" class="left">
	          <?php echo anchor("acr/acri03/display/tc004/" .(($sort_order == 'asc' && $sort_by == 'tc004') ? 'desc' : 'asc') ,'客戶代號'); ?>
			  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
   	      </td>
	      <td width="5%" class="left">
		  <?php echo anchor("acr/acri03/display/tc004disp/".(($sort_order == 'asc' && $sort_by == 'tc004disp') ? 'desc' : 'asc') ,'客戶名稱'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="5%" class="left">
		  <?php echo anchor("acr/acri03/display/tc011/" . (($sort_order == 'asc' && $sort_by == 'tc011') ? 'desc' : 'asc') ,'借方金額'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
		  <td width="5%" class="left">
		  <?php echo anchor("acr/acri03/display/tc012/" . (($sort_order == 'asc' && $sort_by == 'tc012') ? 'desc' : 'asc') ,'貸方金額'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="7%" class="center">
		  <?php echo anchor("acr/acri03/display/create_date/" . (($sort_order == 'asc' && $sort_by == 'create_date') ? 'desc' : 'asc') ,'建立日期'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="12%" class="center">&nbsp查看管理&nbsp </td>
             <td width="12%" class="center">&nbsp修改管理&nbsp </td>
		      <td width="12%" class="center">&nbsp印收款單&nbsp </td>
            </tr>
          </thead>
	     ...
	     <tr class="filter">
	      ...
	      <td width="5%" class="left">
		    <div class="button-search"></div>
			<input type="text" name="filter_tc003" size="12" value=""  />
		    </div>			  
	      </td>
          ...
          <td  width="5%" align="left">
		  <div class="button-search"></div>
		   <input type="text" readonly="value"  name="filter_tc004disp" size="12" value="" style="background-color:#EBEBE4;" />
		  </td>
        ...
        <tr>
          <td style="text-align: center;"> <input type="checkbox" name="selected[]"   id="cbbox"  value="<?php $row->tc001."/".$row->tc002 ?>" onclick="$('input[name=\'selected\']').attr('checked', this.checked);" /></td>
...
function filter() {
	...
	if (filter_tc001) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc001/desc/' + encodeURIComponent(filter_tc001);
	} 
	
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc002/desc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc003/desc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc004/desc/' + encodeURIComponent(filter_tc004);
	}
		
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc004disp/desc/' + encodeURIComponent(filter_tc004disp); 
	}
	
	var filter_tc011 = $('input[name=\'filter_tc011\']').val();
	if (filter_tc011) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc011/desc/' + encodeURIComponent(filter_tc011); 
	}
		var filter_tc012 = $('input[name=\'filter_tc012\']').val();
	if (filter_tc012) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc012/desc/' + encodeURIComponent(filter_tc012); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/create_date/desc/' + encodeURIComponent(filter_create); 
	}
	
    if ( !filter_tc001  && !filter_tc002 && !filter_tc003 && !filter_tc004 && !filter_tc004disp && !filter_tc011  && !filter_tc012 && !filter_create) {         
	   url = '<?php base_url() ?>index.php/acr/acri03/display';location = url;
...
function filtera() {
	...
	var filter_tc001 = $('input[name=\'filter_tc001\']').val();
	if (filter_tc001) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc001/asc/' + encodeURIComponent(filter_tc001);
	} 
		
	var filter_tc002 = $('input[name=\'filter_tc002\']').val();
	if (filter_tc002) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc002/asc/' + encodeURIComponent(filter_tc002);
	} 
	
	var filter_tc003 = $('input[name=\'filter_tc003\']').val();
	if (filter_tc003) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc003/asc/' + encodeURIComponent(filter_tc003);
	}
	
	var filter_tc004 = $('input[name=\'filter_tc004\']').val();
	if (filter_tc004) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc004/asc/' + encodeURIComponent(filter_tc004);
	}
		
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc004disp/asc/' + encodeURIComponent(filter_tc004disp);
		
	}
	
	var filter_tc011 = $('input[name=\'filter_tc011\']').val();
	if (filter_tc011) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc011/asc/' + encodeURIComponent(filter_tc011); 
	}
	var filter_tc012 = $('input[name=\'filter_tc012\']').val();
	if (filter_tc012) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/tc012/asc/' + encodeURIComponent(filter_tc012); 
	}
	
	var filter_create = $('input[name=\'filter_create\']').val();
	if (filter_create) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/create_date/asc/' + encodeURIComponent(filter_create); 
	}
