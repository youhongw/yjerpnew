<div class="box2"> <!-- div-1 -->
    <div class="heading">
     ...
     <!--  <div class="buttons"> -->
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri03/exceldetail'"  style="float:left"  accesskey="l" class="button"><span>excel檔 l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></a> 
	  <?PHP } ?>
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/acr/acri03/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
	      ...
	      <td width="5%" class="left">
		  <?php echo anchor("acr/acri03/display/b.ma002/".(($sort_order == 'asc' && $sort_by == 'b.ma002') ? 'desc' : 'asc') ,'客戶名稱'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="5%" class="left">
        ...
        <tr>
    <!--   刪除要?=  不可以 ?php   <td style="text-align: center;"> <input type="checkbox" name="selected[]"   id="cbbox"  value="<?php $row->tc001."/".trim($row->tc002)?>" onclick="$('input[name=\'selected\']').attr('checked', this.checked);" /></td> 
...
function filter() {
	...
	if (filter_tc004disp) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/b.ma002/desc/' + encodeURIComponent(filter_tc004disp); 
	}
...
function filtera() {
	...
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php base_url() ?>index.php/acr/acri03/filter1/b.ma002/asc/' + encodeURIComponent(filter_tc004disp);
