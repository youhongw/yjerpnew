  ...
  <?php exit;} ?>
	...
	<?php if($paper9=="1")  { $paperal=30;$tot=$paperal-4;} else { $paperal=32;$tot=$paperal-4;}  ?>
	   ...
	   <?php foreach($results as $row ) : ?>
	      ...
	      <?php if($row->ta004 != $ta004key and $vfirst == 1 ) {?>  
			...
			<tr>
			  ...
			  <?php }; ?>
			  <?php if ($vtax == 1 ) { ?> 
			<td width="300" align="left"><b>本期應收：<?php echo  round($th013a/(1+$tg044a)) ?></b></td>
			  <td width="300" align="left"><b>本期稅額：<?php echo  round($th013a-round($th013a/(1+$tg044a)))?></b></td>
