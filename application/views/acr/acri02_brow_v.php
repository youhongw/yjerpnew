<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri02/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重整 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri02/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acr/acri02/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'ta001' => array('sort_name'=>"ta001",'name'=>"結帳單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'ta002' => array('sort_name'=>"ta002",'name'=>"結帳單號",'width'=>"6%",'align'=>"left"),
		'ta038' => array('sort_name'=>"ta038",'name'=>"單據日期",'width'=>"6%",'align'=>"left"),
		'ta004' => array('sort_name'=>"ta004",'name'=>"客戶代號",'width'=>"5%",'align'=>"left"),
		'ma002' => array('sort_name'=>"ma002",'name'=>"客戶名稱",'width'=>"5%",'align'=>"left"),
		//'ta005' => array('sort_name'=>"ta005",'name'=>"收款業務",'width'=>"6%",'align'=>"left"),
		'ta029' => array('sort_name'=>"ta029",'name'=>"應收金額",'width'=>"5%",'align'=>"left"),
		'ta030' => array('sort_name'=>"ta030",'name'=>"稅額",'width'=>"5%",'align'=>"left"),
		//'ta031' => array('sort_name'=>"ta031",'name'=>"已收款",'width'=>"5%",'align'=>"left"),
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/acr/acri02/delete" method="post" enctype="multipart/form-data" id="form">
		  ...
		  <input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" />
	       ...
	       <?php
		    foreach($title_array as $key => $val){
			  ...
			  echo anchor("acr/acri02/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("acr/acri02/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	  ...
	  $filter_array = array(
		...
		'ta001' => array('filter_name'=>"ta001",'name'=>"結帳單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'ta002' => array('filter_name'=>"ta002",'name'=>"結帳單號",'size'=>"10",'align'=>"left"),
		'ta038' => array('filter_name'=>"ta038",'name'=>"單據日期",'size'=>"10",'align'=>"left"),
		'ta004' => array('filter_name'=>"ta004",'name'=>"客戶代號",'size'=>"10",'align'=>"left"),
		'ma002' => array('filter_name'=>"ma002",'name'=>"客戶名稱",'size'=>"10",'align'=>"left"),
		//'ta005' => array('filter_name'=>"ta005",'name'=>"收款業務",'size'=>"10",'align'=>"left"),
		'ta029' => array('filter_name'=>"ta029",'name'=>"應收金額",'size'=>"10",'align'=>"left"),
		'ta030' => array('filter_name'=>"ta030",'name'=>"稅額",'size'=>"10",'align'=>"left"),
		//'ta031' => array('filter_name'=>"ta031",'name'=>"已收款",'size'=>"10",'align'=>"left"),
	  );
    ?> 
        ...
        <tr>
		  ...
		  <td class="left"><?php echo substr($row->ta038,0,4).'/'.substr($row->ta038,4,2).'/'.substr($row->ta038,6,2);?></td>
		...
		<!--  <td class="center"><?php echo $row->ta031;?></td>	-->	                 			
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/acr/acri02/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/acr/acri02/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>