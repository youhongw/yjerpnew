...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 客戶未收帳款統計表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/acr/acrr17/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    ...
	    <td class="normal14a" width="38%"><input tabIndex="1" id="copq01a" onKeyPress="keyFunction()"  onchange="startcopq01a(this)" name="copq01a" value="<?php echo $copq01a; ?>"  type="text"  /><img id="Showcopq01a" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01adisp"> <?php   echo $copq01adisp; ?> </span></td>
        <td class="normal14y" width="12%">結束客戶代號：</td>
		<td class="normal14a" width="38%"><input tabIndex="2" id="copq01a1" onKeyPress="keyFunction()"  onchange="startcopq01a1(this)" name="copq01a1" value="<?php echo $copq01a1; ?>"  type="text"  /><img id="Showcopq01a1" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="copq01a1disp"> <?php   echo $copq01a1disp; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始帳款年/月：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select()" onchange="dataym3(this)"  onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" /></td>
        <td class="normal14z" >結束帳款年/月：</td>
	    <td class="normal14" ><input tabIndex="4" id="datec"  onfocus="this.select()" onchange="dataym7(this)"   onKeyPress="keyFunction()" type="text" name="datec"  value="<?php echo $datec; ?>"  size="20" /></td>
	  </tr>
	   <tr>
