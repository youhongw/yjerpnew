		 ...
		 <tr>
				...
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>收款單別：</b><span><?php echo $results[0]->tc001 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>收款單號：</b><?php echo $results[0]->tc002 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" valign="top"><b>備註：</b><?php echo $results[0]->tc007 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>收款日期：</b><span><?php echo $results[0]->tc003 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>客戶名稱</b><span><?php echo $results[0]->tc004 ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>幣別</b><span><?php echo $results[0]->tc010  ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>確認：</b><?php echo $results[0]->tc008 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>	
                       <?php if ($val->td004==1)	{$td0041='借';} else   {$td0041='貸';} ?>					
					  <?php if ($val->td005=='1')	{$td0051='一般';} elseif ($val->td005=='2') {$td0051='票據';}  elseif ($val->td005=='3') {$td0051='待抵';}
		   elseif ($val->td005=='4') {$td0051='沖帳';}  elseif ($val->td005=='5') {$td0051='溢收';}  elseif ($val->td0051=='6') {$td0051='差額';} else   {$td0051='折讓';} ?>
					  <td align="left"><? echo $val->td004.' '.$td0041;?><br><? echo $val->td005.' '.$td0051;?></td>
					  <td align="left"><? echo $val->td006;?><br><? echo $val->td008;?><br><? echo $val->td008disp;?></td>
					  <td align="right"><? echo $val->td012;?><br><? echo $val->td013;?></td>
					  <td align="right"><? echo $val->td014;?><br><? echo $val->td015;?></td>
					  <td align="right"><? echo $val->td019;?><br><? echo $val->td017;?></td>
					...
					<tr>
					  ...
					  <?php if ($totle_page == $page  ) { ?>
						<b>原幣借方金額：<?php echo $results[0]->tc011 ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;原幣貸方金額：<?php echo $results[0]->tc012 ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;本幣借方金額：<?php echo $results[0]->tc013 ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;本幣貸方金額：<?php echo $results[0]->tc014 ?></b>  <?php echo '';} ?> 
					
					<?php if ($totle_page > $page ) { ?>
                           <b>原幣借方金額：<?php echo '' ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;原幣貸方金額：<?php echo '' ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;本幣借方金額：<?php echo '' ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;本幣貸方金額：<?php echo '' ?></b> 
					         <?php echo '續下頁..';} ?> 
					</td>
					</tr>
				</table>
