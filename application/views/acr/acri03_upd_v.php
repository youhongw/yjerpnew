...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('acr/acri03/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('acr/acri03/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>
	  </div>
	</div>
	</div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
        ...
        <td class="normal14a"  width="28%"><input tabIndex="1" id="acri01"    onKeyPress="keyFunction()"   name="tc001"  onchange="check_acri01(this);check_title_no();"  value="<?php echo $tc001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="28%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tc017" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="tc017"  value="<?php echo $tc017; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
        ...
        <td class="normal14a" width="28%" ><input tabIndex="3" id="tc002" onKeyPress="keyFunction()"  name="tc002" value="<?php echo $tc002; ?>"  type="text" required /><span id="tc002disp" ></span></td>
	 </tr>	
	  <tr>
	      <td class="normal14z">客戶代號：</td>
          <td  class="normal14"  ><input tabIndex="4" id="copi01" onKeyPress="keyFunction()" ondblclick="search_copi01_window()"  onchange="check_copi01(this);" name="tc004" value="<?php echo $tc004; ?>" size="12" type="text"  />
