...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報工單明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcr15/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="12%">起報工單號：</td>
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><select id="tc004o" onKeyPress="keyFunction()" name="tc004o"  tabIndex="7">
            <option <?php if($tc004o == '0') echo 'selected="selected"';?> value='0'>0.生產日期</option>  
