 		...
 		<div class="row ">
 			<div class="col-12 col-xs-12 col-sm-12">
 				...
 				<div class="box">
 					<div class="box-header">
 						...
 						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 							...
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03gj/displayr" role="button"><i class="fa fa-refresh"></i> 重整</a>
 							</div>
 							<div class="btn-group mr-2" role="group" aria-label="Five group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03gj/exceldetailr"><i class="fa fa-file"></i> 匯出excel</a></li>
 							</div>
 					...
 					<div class="box-body">
 						<!-- <form action="<?php echo base_url() ?>index.php/sfc/sfci03gj/delete" method="post" enctype="multipart/form-data" id="form"> -->
 									...
 									<?php foreach ($results as $row) : ?>
 										<tr>
 											...
 											<!-- <div class="btn-group btn-group-sm" role="group" aria-label="First group">
 												<td style="text-align: center;vertical-align: middle;"><a class="btn btn-primary btn-sm" href="<?php echo site_url('sfc/sfci03gj/updform/' . trim($row->TD001) . '/' . trim($row->TD002) . '/') ?>" </a>修改</td>
 											</div> -->
 											<td style="text-align: center;vertical-align: middle;"><?php echo  $chkval . '　'; ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TB001) . '-' . trim($row->TB002); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TB003); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TC004) . '-' . trim($row->TC005); ?></td>

 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TC047); ?></td>


 											<td style="text-align: center;vertical-align: middle;"><?php echo  mb_convert_encoding(trim($row->TC048), "utf-8", "big-5"); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  mb_convert_encoding(trim($row->TC049), "utf-8", "big-5"); ?></td>

 											<td style="text-align: center;vertical-align: middle;"><?php
																									if (trim($row->pg002) == '1')
																										echo "手動";
																									else if (trim($row->pg002) == '')
																										echo "";
																									else
																										echo  "自動"; ?>
 											</td>

 											<td style="text-align: center;vertical-align: middle;"><?php echo  round($row->TC014); ?></td>


 											<!-- <td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE030disp); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE030dispN); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE017) ?></td>
 											
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->MW001) . '<br>' . mb_convert_encoding(trim($row->TE009disp), "utf-8", "big-5"); ?></td> -->
 											<!-- <td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE012disp); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE013); ?></td>
 											<td style="text-align: center;vertical-align: middle;"><?php echo  trim($row->TE011); ?></td>
