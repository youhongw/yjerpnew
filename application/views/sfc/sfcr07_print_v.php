...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 移轉單明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcr07/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="12%">起移轉編號：</td>
	  ...
	  <tr>
	  <td class="normal14" >日期性質：</td>
		<td class="normal14">
			   <input type="radio" name="tc003o" <?php if (isset($tc003o) && $tc003o=="1") echo "checked";?> value="1" />移轉日期  &nbsp;&nbsp;&nbsp; 
               <input type="radio" name="tc003o" <?php if (isset($tc003o) && $tc003o=="2") echo "checked";?> value="2" />驗收日期
        </td>
	  </tr>
	    <tr>
	    <td class="start14a" >起日期：</td>
	  ...
	  <tr>
	    ...
	    <td class="normal14a" ><input tabIndex="5" id="dateo1" ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="dateo1"  value="<?php echo $dateo1; ?>"   style="background-color:#E7EFEF" />
	  ...
	  <tr>
	    ...
	    <td class="normal14a"><input tabIndex="6" id="datec1" ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="datec1"  value="<?php echo $datec1; ?>"   style="background-color:#E7EFEF" />
	  ...
	  <tr>
	    ...
	    <td class="normal14" ><select id="tc003c" onKeyPress="keyFunction()" name="tc003c"  tabIndex="7">
            <option <?php if($tc003c == '0') echo 'selected="selected"';?> value='0'>0.全部</option>  
            <option <?php if($tc003c == '1') echo 'selected="selected"';?> value='1'>1.正常完成</option> 			
		    <option <?php if($tc003c == '2') echo 'selected="selected"';?> value='2'>2.重工完成</option>
			<option <?php if($tc003c == '3') echo 'selected="selected"';?> value='3'>3.退回重工</option> 			
		    <option <?php if($tc003c == '4') echo 'selected="selected"';?> value='4'>4.撥轉</option>
			<option <?php if($tc003c == '5') echo 'selected="selected"';?> value='5'>5.盤盈損</option> 			
		    <option <?php if($tc003c == '6') echo 'selected="selected"';?> value='6'>6.投入</option>
		  </select></td>
	  </tr>	
	   <tr>
	    <td class="normal14" >選擇排序：</td>
	    <td class="normal14" ><select id="tc004o" onKeyPress="keyFunction()" name="tc004o"  tabIndex="7">
            <option <?php if($tc004o == '0') echo 'selected="selected"';?> value='0'>0.移轉日期</option>  
            <option <?php if($tc004o == '1') echo 'selected="selected"';?> value='1'>1.單據日期</option> 			
		    <option <?php if($tc004o == '2') echo 'selected="selected"';?> value='2'>2.驗收日期</option>
		  </select></td>
	  </tr>	
	   <tr>
