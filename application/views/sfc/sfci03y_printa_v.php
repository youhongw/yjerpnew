...
?>    	
	...
	<table class="list">     <!-- 列明細 -->
	  ...
	  <tr>
	    <td width="6%" align="left"><?php echo  $val->te001;?></td>
		<td width="8%" align="left"><?php echo  $val->te002;?></td>
	<!--<td width="8%" align="left"><?php // echo  substr($val->te039,0,4).'/'.substr($val->te039,4,2).'/'.substr($val->te039,6,2);?></td> -->
        <td width="8%" align="left"><?php echo  stringtodate("Y/m/d",$val->te039) ;?></td>
		<td width="8%" align="left"><?php echo  $val->te004;?></td>	
        <td width="10%" align="left"><?php echo  $val->te004disp;?></td>			
