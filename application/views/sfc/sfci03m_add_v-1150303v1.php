	...
	<div id="header">
		...
		<div id="content">
			...
			<div class="box">
				<!-- div-4 -->
				<div class="heading">
					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> 報工單 - 新增　　　</h1>
					<div style="float:left;padding-top: 5px;">
						...
						<a accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci03m/display'); ?>" class="button"><span>返 回Alt+x</span><img src="<?php echo base_url() ?>assets/image/png/cancle.png" /></a>
					</div>
				</div>

				<div class="content">
					<!-- div-5 -->
					<form class="cmxform" id="commentForm" name="form" method="post" enctype="multipart/form-data" style="width: 100%;" action="<?php echo base_url() ?>index.php/sfc/sfci03m/addsave">
						<?php
						...
						if (!isset($td004disp)) {
							$td004disp = $this->input->post('td004disp');
						}
						if (!isset($td005)) {
						...
						<table class="form14">
							...
							<!--	<td class="normal14">備註：確認者：</td>
								...
								<td class="normal14"><input type="hidden" tabIndex="10" onKeyPress="keyFunction()" id="td009" name="td009" value="<?php echo $td009; ?>" readonly="readonly" style="background-color:#F0F0F0" /></td>
