...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製令製程自動產生作業 - 產生</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcb02/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <td class="normal14" >製令性質：</td>
		<td class="normal14">
			   <input type="radio" name="td003o" <?php if (isset($td003o) && $td003o=="1") echo "checked";?> value="1" />廠內  &nbsp;&nbsp;&nbsp; 
               <input type="radio" name="td003o" <?php if (isset($td003o) && $td003o=="2") echo "checked";?> value="2" />託外
        </td>
    </table>
...
<?php include("./application/views/fun/sfcb02_funjs_v.php"); ?>
<script>
  $(function() {
