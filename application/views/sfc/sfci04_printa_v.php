    ...
    <!--    <td width="28%" align="left"><? if ($row->ta006disp!='') {  echo wordwrap($row->ta006disp,75,"<br />\n",TRUE);} else {echo "_";}?> 
		      <br><?  if ($row->ta006disp1!='') {echo wordwrap($row->ta006disp1,75,"<br />\n",TRUE);}  else {echo "_";} ?></td> -->
        <td width="8%" align="left"><?php echo  $row->tb008;?></td>		
        <td width="10%" align="left"><?php echo  $row->tb003;?></td>	
       
        <td width="24%" align="left"><? if ($row->tb012!='') {  echo wordwrap($row->tb012,75,"<br />\n",TRUE);} else {echo "_";}?> 
		      <br><?  if ($row->tb013!='') {echo wordwrap($row->tb013,75,"<br />\n",TRUE);}  else {echo "_";} ?></td>
