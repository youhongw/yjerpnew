...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 線別/廠商生產狀況表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcr09/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14a" >起產品品號：</td>
	    <td class="normal14a" ><input tabIndex="1" id="tc004o" onKeyPress="keyFunction()"   name="tc004o" value="<?php echo $tc004o; ?>"  type="text"   />
		</td>
	  </tr>
	  <tr>
	    <td class="start14a" >迄產品品號：</td>
	    <td class="normal14a"><input tabIndex="2" id="tc004c" onKeyPress="keyFunction()"   name="tc004c" value="<?php echo $tc004c; ?>"  type="text"  />
		 </td>
	  </tr>
	   <tr>
	    <td class="normal14" >製程性質：</td>
	    <td class="normal14" ><select id="tc005c" onKeyPress="keyFunction()" name="tc005c"  tabIndex="7">
            <option <?php if($tc005c == '0') echo 'selected="selected"';?> value='0'>0.全部</option>  
            <option <?php if($tc005c == '1') echo 'selected="selected"';?> value='1'>1.廠內製程</option> 			
		    <option <?php if($tc005c == '2') echo 'selected="selected"';?> value='2'>2.託外製程</option>
		  </select></td>
	  </tr>	
	   <tr>
