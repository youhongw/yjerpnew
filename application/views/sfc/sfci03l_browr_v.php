 					...
 					<div class="box-header">
 						...
 						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 							...
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03l/displayr" role="button"><i class="fa fa-refresh"></i> 重整</a>
 							</div>
 							<div class="btn-group mr-2" role="group" aria-label="Five group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03l/exceldetailr"><i class="fa fa-file"></i> 匯出excel</a></li>
 							</div>
