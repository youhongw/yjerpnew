...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製令製程重計作業 - 產生</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcb04/batcha"  method="post"  enctype="multipart/form-data" > 
...
<?php include("./application/views/fun/sfcb04_funjs_v.php"); ?>
<script>
  $(function() {
