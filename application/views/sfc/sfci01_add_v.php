...
<div id="content">  <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
	...
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/sfc/sfci01/addsave" >	
	...
	<a accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
