	...
	<div id="header">
		...
		<div id="content">
			...
			<div class="box">
				<!-- div-4 -->
				<div class="heading">
					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> 注塑 - 生產日報單 - 新增　　　</h1>
					<div style="float:left;padding-top: 5px;">
						...
						<a accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci03d/display'); ?>" class="button"><span>返 回Alt+x</span><img src="<?php echo base_url() ?>assets/image/png/cancle.png" /></a>
					</div>
				</div>

				<div class="content">
					<!-- div-5 -->
					<form class="cmxform" id="commentForm" name="form" method="post" enctype="multipart/form-data" style="width: 100%;" action="<?php echo base_url() ?>index.php/sfc/sfci03d/addsave">
						<?php
							...
							<tr>
								...
								<td class="normal14a" width="25%">
									...
									<select id="sfci01" onKeyPress="keyFunction()" name="td001" onfocus="check_title_no()" tabIndex="1" style="background-color:#EEF1CE">
										<option selected="selected" value='D404'>D404:注塑報工 </option>
										<option value='D504'>D504:注塑報工手動</option>
									</select>
								</td>
