...
<?php if (!$results)  { ?>
	<script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cop/copi06/printdetailc';location = url; </script> 
<?php exit;}
			...
			<tr><td valign="top">
				<table class="order">
				  <tr>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>訂單單號：</b><span><?php echo $value[0]->te002 ?></span></td>
						<td align="left" valign="top" ></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $value[0]->te039 ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>客戶代號：</b><?php echo $value[0]->te004.' '.$value[0]->te004disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					</table>
				    </td>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>業務人員：</b><span><?php echo $value[0]->te006.' '.$value[0]->te006disp ?></span></td>
						<td align="left" valign="top" ></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>課 稅 別：</b><?php echo $value[0]->te016 ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>交易幣別：</b><?php echo $value[0]->te008.' '.$value[0]->te008disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					</table>
				    </td>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>付款條件：</b><?php echo $value[0]->te014.' '.$value[0]->te014disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
				...
				<?php }?>
					...
					<tr>
					  ...
					  <?php if ($pages[$value[0]->td002] == $temp_page  ) { ?>
						<b>訂單金額：<?php echo $value[0]->te029 ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;訂單稅額：<?php echo $value[0]->te030 ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;合計金額：<?php echo $value[0]->te029+$value[0]->te030 ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;總數量：<?php echo $value[0]->te031 ?></b>  <?php echo '';} ?> 
