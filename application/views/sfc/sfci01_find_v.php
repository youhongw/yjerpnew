...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 訂單單據性質建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/sfc/sfci01/findsql" method="post" enctype="multipart/form-data" >
    </div>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/cms/cmsi03/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
