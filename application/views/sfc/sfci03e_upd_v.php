...
echo "</pre>";*/
 	...
 	<div id="header">
 		...
 		<div id="content">
 			...
 			<div class="box">
 				<!-- div-4 -->
 				<div class="heading">
 					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> PU - 生產日報單 - 修改　　　</h1>
 					...
 					<div style="float:left;padding-top: 5px;">
 						...
 						<a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci03e/display'); ?>" class="button"><span>返 回Alt+x</span><img src="<?php echo base_url() ?>assets/image/png/cancle.png" /></a>
 				...
 				<div class="content">
 					<!-- div-5 -->
 					<form class="cmxform" id="commentForm" name="form" action="<?php echo base_url() ?>index.php/sfc/sfci03e/updsave" method="post" style="width: 100%;" enctype="multipart/form-data">
 						<div id="tab-general">
 							<!-- div-6 -->
 ...
 <form action="<?php echo base_url() ?>index.php/sfc/sfci03e/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
