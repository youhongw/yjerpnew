     ...
     <div class="row ">
       <div class="col-12 col-xs-12 col-sm-12">
         ...
         <div class="box">
           <div class="box-header">
             ...
             <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
               <div class="btn-group mr-2" role="group" aria-label="First group">
                 <a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfcp03k/addform" role="button"><i class="fa fa-plus"></i>新增</a>
               </div>
               <div class="btn-group mr-2" role="group" aria-label="First group">
               ...
               <div class="btn-group" role="group" aria-label="Five group">
                 <a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfcp03k/clear_sql_term" role="button"><i class="fa fa-refresh"></i> 重整</a>
               </div>
               <div class="btn-group" role="group" aria-label="Five group">
           ...
           <div class="box-body">
             <form action="<?php echo base_url() ?>index.php/sfc/sfcp03k/delete" method="post" enctype="multipart/form-data" id="form">
                 ...
                 <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                   <thead>
                     <tr style="background-color: #3C8DBC;cursor:pointer;color:#FFFFFF;">
                       ...
                       <th style="text-align: center;vertical-align: middle;">每人每小時數量</th>
                       <th style="text-align: center;vertical-align: middle;">每顆時間/分</th>
                     ...
                     <?php foreach ($results as $row) : ?>
                       <tr>
                         ...
                         <div class="btn-group btn-group-sm" role="group" aria-label="First group">
                           <td style="text-align: center;vertical-align: middle;"><a class="btn btn-primary btn-sm" href="<?php echo site_url('sfc/sfcp03k/updform/' . trim($row->pk001) . '/') ?>">修改</td>
                         </div>
                         ...
                         <td style="text-align: center;vertical-align: middle;"><?php echo  round(trim($row->pk002), 3); ?></td>
                         <td style="text-align: center;vertical-align: middle;"><?php echo  round(trim($row->pk003), 2); ?></td>
                         <td style="text-align: center;vertical-align: middle;"><?php echo  round(trim($row->pk004), 2); ?></td>
                         <td style="text-align: center;vertical-align: middle;"><?php echo  mb_convert_encoding(trim($row->pk005), "utf-8", "big-5"); ?></td>
						 <td style="text-align: center;vertical-align: middle;"><?php echo  $row->pk006; ?></td>
