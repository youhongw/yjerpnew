		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form action="<?php echo base_url() ?>index.php/sfc/sfci03/writeday" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
                            ...
                            <input type="hidden" tabIndex="1" style="width: 300px"  onkeyup="this.value=this.value.replace(/[^0-9\/]/gi,'');" maxlength='10' onKeyPress=" keyFunction()" value="<?php echo $day; ?>" id="$day" name="$day" class="form-control" />
							<div class="form-group form-inline">
