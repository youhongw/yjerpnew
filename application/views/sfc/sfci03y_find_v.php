...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報工單建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/sfc/sfci03y/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='td001'> td001 報工單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='td002'> td002 報工單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='td008'> td008 單據日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='td004'> td004 生產線別 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='td003'> td003 生產日期 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='td006'> td006 備註     </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='td001'> td001 報工單別 </option>                                                                            
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='td002'> td002 報工單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='td008'> td008 單據日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='td004'> td004 生產線別 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='td003'> td003 生產日期 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='td006'> td006 備註     </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/sfc/sfci03y/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
