...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製令製程明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcr06/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    ...
	    <td class="normal14" ><select id="tc003o" onKeyPress="keyFunction()" name="tc003o"  tabIndex="7">
            <option <?php if($tc003o == '0') echo 'selected="selected"';?> value='0'>0.全部</option>  
            <option <?php if($tc003o == '1') echo 'selected="selected"';?> value='1'>1.廠內</option> 			
		    <option <?php if($tc003o == '2') echo 'selected="selected"';?> value='2'>2.託外</option>
		  </select></td>
	  </tr>	
