...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfci01/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td class="normal14" > <select tabIndex="4" id="mq003" onKeyPress="keyFunction()" name="mq003" >
            <option <?php if($mq003 == 'D1') echo 'selected="selected"';?> value='D1'>D1:投料</option>                                                                        
		    <option <?php if($mq003 == 'D2') echo 'selected="selected"';?> value='D2'>D2:移轉 </option>
            <option <?php if($mq003 == 'D3') echo 'selected="selected"';?> value='D3'>D3:入庫 </option>
            <option <?php if($mq003 == 'D4') echo 'selected="selected"';?> value='D4'>D4:報工 </option>
		  </select></td>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" id='cancel' name='cancel' href="<?php echo site_url('sfc/sfci01/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
...
'◎操作說明:[  欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料.  ] ' ?> </div>  <?php } ?>
 ...
 <?php include("./application/views/fun/sfci01_funjs_v.php"); ?> 
