		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form action="<?php echo base_url() ?>index.php/sfc/sfci03/writer_gnew" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-11">
									<div class="btn-group">
										...
										<a href="<?php echo base_url() ?>index.php/sfc/sfci03g/displayr" class="btn btn-warning btn-flat">上一頁</a>
