  <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/sfc/sfcr11/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="left">日人工產能(人時)</td>
	    <td width="10%" align="left" >日機器產能(機時)</td>
	    <td width="10%" align="left">標準人工效率%</td>
	    <td width="10%" align="left">標準機器負荷%</td>
		<td width="10%" align="left">標準人工成本(人時)</td>
		<td width="10%" align="left">標準製造費用(人時)</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
		...
		<td width="10%" align="left"><?php echo  $val->md009;?></td>
		<td width="10%" align="left"><?php echo  $val->md010;?></td>
		<td width="10%" align="left"><?php echo  $val->md011;?></td>
