					...
					<div class="box-body">
						<form action="<?php echo base_url() ?>index.php/sfc/sfci03/writer" class="form-horizontal" id="form-edit_group" method="post" accept-charset="utf-8">
							...
							<div class="form-group form-inline">
								...
								<div class="col-sm-11">
									<input tabIndex="1" id="sfci01" style="width: 300px;background-color: #d5cece;" onKeyPress="keyFunction()" name="td001" onkeyup="this.value=this.value.replace(/[^A-Z0-9\;]/gi,'');this.value=this.value.toLocaleUpperCase();" maxlength='30' value="D311" size="12" type="text" readonly="readonly" />
									<!-- <a href="javascript:;">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-11">
									<div class="btn-group">
										...
										<a href="<?php echo base_url() ?>index.php/sfc/sfci03k/displayrnew" class="btn btn-warning btn-flat">上一頁</a>
