...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 廠商託工預計進貨表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/sfc/sfcr02/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="12%">起移轉單號：</td>
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><select id="tc003o" onKeyPress="keyFunction()" name="tc003o"  tabIndex="7">
            ...
            <option <?php if($tc003o == '1') echo 'selected="selected"';?> value='1'>1.已結案</option> 			
		    <option <?php if($tc003o == '2') echo 'selected="selected"';?> value='2'>2.未結案</option>
		  </select></td>
	  </tr>	
	   <tr>
