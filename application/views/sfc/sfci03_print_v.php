	...
	<div id="header">
		...
		<div id="content">
			...
			<div class="box">
				<!-- div-4 -->
				<div class="heading">
					<h1><img src="<?php echo base_url() ?>assets/image/order.png" alt="" /> 客戶訂單資料建立作業 - 列印明細表</h1>
				</div>

				<div class="content">
					<!-- div-5 -->
					<form class="cmxform" id="commentForm" name="form" action="<?php echo base_url() ?>index.php/cop/copi06/printa" method="post" enctype="multipart/form-data">
						<div id="tab-general">
							<!-- div-6 -->
							<?php
							...
							<table class="form14">
								<!-- 表格 -->
								<tr>
									<td class="start14a" width="11%">起始訂單單別：</td>
									<td class="normal14a" width="39%">
										<input tabIndex="1" id="te001o" onKeyPress="keyFunction()" type="text" name="te001o" value="<?php echo $te001o; ?>" size="10" />
										<a href="javascript:;">
											<span id="Showmoci02disp1" class="glyphicon glyphicon-search"></span>
										</a>
									</td>
									<td class="normal14a" width="11%">結束訂單單別：</td>
								...
								<tr>
									...
									<td class="normal14"><select id="te009p" onKeyPress="keyFunction()" name="te009p" tabIndex="5">
