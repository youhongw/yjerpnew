  ...
  <div class="content-wrapper">
  	...
  	<section class="content">
       ...
       //   echo "<pre>";var_dump($price);exit;
                ...
                <div class="col-sm-11">
                  <input type="text" tabIndex="1" style="width: 300px" maxlength='11'  onKeyPress="keyFunction()" name="pg019" onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,3})?).*$/g, '$1');" value="<?php echo $pg019; ?>" id="pg019" class="form-control" />
                </div>
              </div>        
			  ...
			  <label for="pg011" class="col-sm-1 control-label">全檢/排箱</label>
                <div class="col-sm-11">
                  <input type="text" tabIndex="1" style="width: 300px"  maxlength='11' onKeyPress="keyFunction()" name="pg014" onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,3})?).*$/g, '$1');" value="<?php echo $pg014; ?>" id="pg014" class="form-control" />
                  全檢/排箱 產能　　　&nbsp;&nbsp;&nbsp;
