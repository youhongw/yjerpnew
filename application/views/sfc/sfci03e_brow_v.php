 		...
 		<div class="row ">
 			<div class="col-12 col-xs-12 col-sm-12">
 				...
 				<div class="box">
 					<div class="box-header">
 						...
 						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03e/addform" role="button"><i class="fa fa-plus"></i>新增</a>
 							</div>
 							<div class="btn-group mr-2" role="group" aria-label="First group">
 							...
 							<div class="btn-group" role="group" aria-label="Five group">
 								<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/sfc/sfci03e/clear_sql_term" role="button"><i class="fa fa-refresh"></i> 重整</a>
 							</div>
 							<div class="btn-group" role="group" aria-label="Five group">
 					...
 					<div class="box-body">
 						<form action="<?php echo base_url() ?>index.php/sfc/sfci03e/delete" method="post" enctype="multipart/form-data" id="form">
 										...
 										<?php foreach ($results as $row) : ?>
 											<tr>
 												...
 												<div class="btn-group btn-group-sm" role="group" aria-label="First group">
 													<td style="text-align: center;vertical-align: middle;"><a class="btn btn-primary btn-sm" href="<?php echo site_url('sfc/sfci03e/updform/' . trim($row->TD001) . '/' . trim($row->TD002) . '/') ?>" </a>修改</td>
 												</div>
