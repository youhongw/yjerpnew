  <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/sfc/sfcr12/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="left">生產日期</td>
	    <td width="10%" align="left">製程代號</td>
	    <td width="10%" align="left">使用人時</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
		...
		<td width="10%" align="left"><?php echo  $val->te009;?></td>
		<td width="10%" align="left"><?php echo  $val->te012;?></td>
		<td width="10%" align="left"><?php echo  $val->ta001;?></td>
		<td width="10%" align="left"><?php echo  $val->ta002;?></td>
		...
		<td width="10%" align="left"><?php echo  $val->te005;?></td>
		 ...
		 <?php $rownum++;$rownum1++;$vqty=$vqty+$val->te012;$vnoqty=$vnoqty+$val->te012;$vamt=$vamt+$val->te012; ?>
