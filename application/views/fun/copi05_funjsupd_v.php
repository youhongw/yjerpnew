...
//	html += '    <td class="left"><input type="text"  tabIndex="13"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input readonly="value" ondblclick="startinvq81a();"  onKeyPress="keyFunction()"   type="text" id="tb008"   name="order_product[' + product_row + '][tb008]" value="" size="6" /></td>';
