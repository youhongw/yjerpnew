      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
		 ...
		 <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		          echo anchor("fun/copq03a/display1/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'報價單別');} ?>
	     
		 <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		          echo anchor("fun/copq03a/display2/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'訂單單別');} ?>  
	     <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		          echo anchor("fun/copq03a/display3/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'銷貨單別');} ?>
				  
		<?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		          echo anchor("fun/copq03a/display4/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'退貨單別');} ?> 
		  </td>
	      <td width="16%" class="left"> 
		   <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		         echo anchor("fun/copq03a/display1/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'報價單別名稱');} ?>
           
		   <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		         echo anchor("fun/copq03a/display2/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'訂單名稱');} ?> 
				 
			<?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		         echo anchor("fun/copq03a/display3/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'銷貨名稱');} ?>  
				 
            <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		         echo anchor("fun/copq03a/display4/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'退貨名稱');} ?>  				 
			 </td>
	     ...
	     <tr class="filter">
		  ...
		  <div  class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter1()" /><span>篩選</span>  <?php } ?>	
             <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
             <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
              <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>				
		  ...
		  <div id="search">
		   <div class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter1()" /><span>篩選</span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
			
			<?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
           <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter4") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>				
		  </div>			  
	      </td>	 
		   <td  align="center">&nbsp;&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		//	var smq001 = $(this).parent().find('.smq001').val();
			...
			window.parent.addcopq03a21(smq001,smq002);
		});
		...
		$('.button2').click(function() {
		  //  var smq001 = encodeURIComponent($(this).parent().find('.smq001').val());
			...
			var smq002 = $(this).parent().find('.smq002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addcopq03a22(smq001,smq002);
		});
		$('.button3').click(function() {
		  //  var smq001 = encodeURIComponent($(this).parent().find('.smq001').val());
			...
			var smq002 = $(this).parent().find('.smq002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addcopq03a23(smq001,smq002);
		});
		$('.button4').click(function() {
		  //  var smq001 = encodeURIComponent($(this).parent().find('.smq001').val());
			...
			var smq002 = $(this).parent().find('.smq002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addcopq03a24(smq001,smq002);
		});
    });
</script>
...
function filter1() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter1/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter1/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/copq03a/display1/';location = url;
...
function filter2() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter2/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter2/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/copq03a/display2/';location = url;
...
function filter3() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter3/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter3/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/copq03a/display3/';location = url;
...
function filter4() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter4/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/copq03a/filter4/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/copq03a/display4/';location = url;
