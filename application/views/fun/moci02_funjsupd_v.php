...
<script type="text/javascript"><!--
  function addpurc09a(sma001,sma002) {
	...
	url = '<?=base_url() ?>index.php/moc/moci02/copybefore/'+encodeURIComponent(sma001)+'/'+encodeURIComponent(sma002); 
	location = url;
	return true;
}
//--></script>
...
<script type="text/javascript"><!--       
 function selappr(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	  var selval = document.getElementById('ta013').selectedIndex;
	 //  alert(selval);
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="41" id="tb004'+ product_row+'"  onchange="startinvq02a(this,product_row)"  name="order_product[' + product_row + '][tb004]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
	html += '    <td class="left"><input readonly="value"    onKeyPress="keyFunction()" type="text" id="tb005"  name="order_product[' + product_row + '][tb005]" value=""  style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input readonly="value"  onKeyPress="keyFunction()" type="text" id="tb006"   name="order_product[' + product_row + '][tb006]" value=""  size="30" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input  onKeyPress="keyFunction()"  type="text" id="tb008"   name="order_product[' + product_row + '][tb008]" value="" size="6"  /></td>';
	html += '    <td class="left"><input readonly="value" onKeyPress="keyFunction()" type="text"  id="tb003" name="order_product[' + product_row + '][tb003]" value="0" size="6" style="background-color:#EBEBE4" /></td>';
	...
	html += '    <td class="left"><input type="text"  tabIndex="45"  onclick="scwShow(this,event);"   id="tb014" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb014]" value="" size="10" class="date" style="background-color:#E7EFEF"/></td>';

	html += '    <td class="center"><input type="text" tabIndex="46"  id="tb007" onKeyPress="keyFunction()" onchange="pricepurq02a(this,product_row)" name="order_product[' + product_row + '][tb007]" value="1" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="47"  id="tb015" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb015]" value="1" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="48"  id="tb017" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb017]" value="0" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="49" class="total_qty" id="tb016" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb016]" value="1" size="10" style="text-align:right" /></td>';
    html += '    <td class="center"><input type="text" tabIndex="50" id="tb018" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb018]" value="0" size="10" style="text-align:right" /></td>';	
    html += '    <td class="right"><input readonly="value" type="text" class="total_price"  name="order_product[' + product_row + '][tb045]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	html += '    <td class="center"><input readonly="value" type="text"  id="tb046" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb046]" value="0" size="10" style="text-align:right;background-color:#EBEBE4"/></td>';	
    html += '    <td class="right"><input readonly="value"  type="text" class="total_price1"  name="order_product[' + product_row + '][tb047]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	html += '    <td class="center"><input type="text" readonly="value"   id="tb048" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb048]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	
	html += '    <td class="left"><input type="text"  tabIndex="55" id="tb011" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="56" id="tb012" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb012]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="57" id="tb013" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb013]" value="" size="10"  /></td>';
	//html += '    <td class="left"><input type="text"  tabIndex="58" id="tb028" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb028]" value="" size="10"  /></td>';
//	html += '    <td class="left"><input type="text"  tabIndex="58" id="tb028" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb028]" value="" size="10"  /></td>';
	html += '    <td class="left"><select id="tb028" tabIndex="58" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb028]" ><option  value="0">0.免檢</option><option value="1">1.待驗</option><option  value="2">2.合格</option><option  value="3">3.不良</option><option  value="4">4.特採</option></select></td>'; 
		
	html += '    <td class="left"><input type="text" id="tb033" tabIndex="59"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb033]" value="" size="20" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
