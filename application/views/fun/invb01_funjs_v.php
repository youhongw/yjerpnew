...
<script type="text/javascript"> 	   
	...
	<div id="divFinvq04a11" style="display:none"> 	   
...
<script type="text/javascript"><!--
  function addinvq04a11(sma001,sma002) {	
	form.invq04a11.value=sma001;
	var oSpan = document.getElementById("invq04a11disp");
		oSpan.innerHTML = sma002;
	document.form.invq04a11.focus();    
	return invq04a11;	
}
//--></script>
<!-- 開視窗 cmsq05a 部門別 -->
...
function showinvq04a17(sText){                 //不更新網頁 31  核價單別 inv/invi0501
	var oSpan = document.getElementById("invq04a17disp");
      //   chkno1();
     //   alert('test');		
 ...
 <!-- 不更新網頁帶出資料 invq04a11 單別 -->        
function startinvq04a17(oInput){            
  
	//建立非同步請求
   
	createXMLHttpRequest();
   
   	var sUrl = "<?php echo base_url()?>index.php/fun/invq04a/datainvq04a11/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showinvq04a17(xmlHttp.responseText);	//顯示服務器結果
...
function chkno1(oInput){  
	 var zno=$('input[name=\'invq04a11\']').val();
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/inv/invi05/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
function addItem() {
	...
	html += '    <td class="left"><input type="text" id="tb020" tabIndex="58"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb020]" value="" size="10" /></td>';
    ...
    $('input[name=\'order_product[' + product_row + '][tb004]\']').catcomplete({
		...
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('tb004').value;
             ...
             if (product_row == "21" ) { smb001= $('#tb00420').val(); }
			 if (product_row == "22" ) { smb001= $('#tb00421').val(); }
			 if (product_row == "23" ) { smb001= $('#tb00422').val(); }
		     if (product_row == "24" ) { smb001= $('#tb00423').val(); }
			 if (product_row == "25" ) { smb001= $('#tb00424').val(); }
			 if (product_row == "26" ) { smb001= $('#tb00425').val(); }
			 if (product_row == "27" ) { smb001= $('#tb00426').val(); }
		     if (product_row == "28" ) { smb001= $('#tb00427').val(); }
			 if (product_row == "29" ) { smb001= $('#tb00428').val(); }
			 if (product_row == "30" ) { smb001= $('#tb00429').val(); }	
    ...
    $('input[name=\'order_product[' + product_row + '][tb012]\']').catcomplete({
		...
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('ta009').value;
			 ...
			 if (product_row == 1 ) { smb001= $('#tb0120').val(); }
			 if (product_row == 2 ) { smb001= $('#tb0121').val(); }
			 if (product_row == 3 ) { smb001= $('#tb0122').val(); }
		     if (product_row == 4 ) { smb001= $('#tb0123').val(); }
			 if (product_row == 5 ) { smb001= $('#tb0124').val(); }
			 if (product_row == 6 ) { smb001= $('#tb0125').val(); }
			 if (product_row == 7 ) { smb001= $('#tb0126').val(); }
		     if (product_row == 8 ) { smb001= $('#tb0127').val(); }
			 if (product_row == 9 ) { smb001= $('#tb0128').val(); }
			 if (product_row == 10 ) { smb001= $('#tb0129').val(); }	
			 if (product_row == 11 ) { smb001= $('#tb01210').val(); }
			 if (product_row == 12 ) { smb001= $('#tb01211').val(); }
			 if (product_row == 13 ) { smb001= $('#tb01212').val(); }
		     if (product_row == 14 ) { smb001= $('#tb01213').val(); }
			 if (product_row == 15 ) { smb001= $('#tb01214').val(); }
			 if (product_row == 16 ) { smb001= $('#tb01215').val(); }
			 if (product_row == 17 ) { smb001= $('#tb01216').val(); }
		     if (product_row == 18 ) { smb001= $('#tb01217').val(); }
			 if (product_row == 19 ) { smb001= $('#tb01218').val(); }
			 if (product_row == 20 ) { smb001= $('#tb01219').val(); }	
             if (product_row == 21 ) { smb001= $('#tb01220').val(); }
			 if (product_row == 22 ) { smb001= $('#tb01221').val(); }
			 if (product_row == 23 ) { smb001= $('#tb01222').val(); }
		     if (product_row == 24 ) { smb001= $('#tb01223').val(); }
			 if (product_row == 25 ) { smb001= $('#tb01224').val(); }
			 if (product_row == 26 ) { smb001= $('#tb01225').val(); }
			 if (product_row == 27 ) { smb001= $('#tb01226').val(); }
		     if (product_row == 28 ) { smb001= $('#tb01227').val(); }
			 if (product_row == 29 ) { smb001= $('#tb01228').val(); }
			 if (product_row == 30 ) { smb001= $('#tb01229').val(); }	
	...
	//庫別 
	$('input[name=\'order_product[' + product_row + '][tb012]\']').focus(function(){
	    var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
	...
	//專案
	$('input[name=\'order_product[' + product_row + '][tb020]\']').focus(function(){
		totalSum1();
	});
	//備註,品號
