...
//	html += '    <td class="left"><input type="text" ondblclick="scwShow(this,event);"  tabIndex="55" id="md011['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][md011]" value="" size="10"  style="background-color:#E7EFEF"/></td>';
