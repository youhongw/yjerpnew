      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
       ...
       <table class="list">      <!-- 表格開始 -->
		 ...
		 <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		          echo anchor("fun/invq01a/display1/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'品號類別代號');} ?>
	     
		 <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		          echo anchor("fun/invq01a/display2/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'品號類別代號');} ?>	  
	      
		  <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		          echo anchor("fun/invq01a/display3/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'品號類別代號');} ?>
		  
		  <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		          echo anchor("fun/invq01a/display4/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'品號類別代號');} ?>
		  </td>
	      <td width="13%" class="left"> 
		   <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		         echo anchor("fun/invq01a/display1/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'品號類別名稱');} ?>
           
		   <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		         echo anchor("fun/invq01a/display2/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'品號類別名稱');} ?>   
			
			<?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		         echo anchor("fun/invq01a/display3/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'品號類別名稱');} ?>  
           
		   <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		         echo anchor("fun/invq01a/display4/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'品號類別名稱');} ?>			 
			 </td>
	     ...
	     <tr class="filter">
		  ...
		  <div  class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter1()" size="10" /><span>篩選</span>  <?php } ?>	
             <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter2()" size="10" /><span>篩選</span> <?php } ?>	
              <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter3()" size="10"/><span>篩選</span> <?php } ?>				
	         <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter4()" size="10" /><span>篩選</span> <?php } ?>	
		  </td>   
	      ...
	      <td class="left">		
		   ...
		   <div class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") { ?>
			<input type="text" id="filter_ma003" name="filter_ma003" value="" onblur="filter1()"  size="10" /><span>篩選</span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
			<input type="text" id="filter_ma003" name="filter_ma003" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") { ?>
			<input type="text" id="filter_ma003" name="filter_ma003" value="" onblur="filter3()" /><span>篩選</span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") { ?>
			<input type="text" id="filter_ma003" name="filter_ma003" value="" onblur="filter4()" /><span>篩選</span> <?php } ?>	
		  </div>			  
	      </td>	 
		   <td  align="center">&nbsp;&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		//	var sma001 = $(this).parent().find('.sma001').val();
			...
			window.parent.addinvq01a(sma001,sma002);
		});
		...
		$('.button2').click(function() {
		  //  var sma001 = encodeURIComponent($(this).parent().find('.sma001').val());
			...
			var sma002 = $(this).parent().find('.sma002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addinvq01a2(sma001,sma002);
		});
		...
		$('.button3').click(function() {
		  //  var sma001 = encodeURIComponent($(this).parent().find('.sma001').val());
			...
			var sma002 = $(this).parent().find('.sma002').val();			
			window.parent.$.unblockUI();
			window.parent.addinvq01a3(sma001,sma002);
		});
		...
		$('.button4').click(function() {
		  //  var sma001 = encodeURIComponent($(this).parent().find('.sma001').val());
			...
			window.parent.$.unblockUI();
			window.parent.addinvq01a4(sma001,sma002);
		});
    });
</script>
...
function filter1() {
	...
	if (filter_ma002) {
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter1/ma002/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').val();
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter1/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/invq01a/display1/';location = url;
...
function filter2() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter2/ma002/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').val();
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter2/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/invq01a/display2/';location = url;
...
function filter3() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter3/ma002/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').val();
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter3/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/invq01a/display3/';location = url;
...
function filter4() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter4/ma002/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').val();
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/fun/invq01a/filter4/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/invq01a/display4/';location = url;
