...
//	html += '    <td class="left"><input type="text"  tabIndex="41" id="tb004'+ product_row+'"   name="order_product[' + product_row + '][tb004]" value="" size="20"  /></td>';	
    ...
    $('input[name=\'order_product[' + product_row + '][tb005]\']').catcomplete({
		...
		//	alert(smb001);   
		     ...
		     if (product_row == 31 ) { smb001= $('#tb00530').val(); }
			 if (product_row == 32 ) { smb001= $('#tb00531').val(); }
			 if (product_row == 33 ) { smb001= $('#tb00532').val(); }
		     if (product_row == 34 ) { smb001= $('#tb00533').val(); }
			 if (product_row == 35 ) { smb001= $('#tb00534').val(); }
			 if (product_row == 36 ) { smb001= $('#tb00535').val(); }
			 if (product_row == 37 ) { smb001= $('#tb00536').val(); }
		     if (product_row == 38 ) { smb001= $('#tb00537').val(); }
			 if (product_row == 39 ) { smb001= $('#tb00538').val(); }
			 if (product_row == 40 ) { smb001= $('#tb00539').val(); }	
             if (product_row == 41 ) { smb001= $('#tb00540').val(); }
			 if (product_row == 42 ) { smb001= $('#tb00541').val(); }
			 if (product_row == 43 ) { smb001= $('#tb00542').val(); }
		     if (product_row == 44 ) { smb001= $('#tb00543').val(); }
			 if (product_row == 45 ) { smb001= $('#tb00544').val(); }
			 if (product_row == 46 ) { smb001= $('#tb00545').val(); }
			 if (product_row == 47 ) { smb001= $('#tb00546').val(); }
		     if (product_row == 48 ) { smb001= $('#tb00547').val(); }
			 if (product_row == 49 ) { smb001= $('#tb00548').val(); }
			 if (product_row == 50 ) { smb001= $('#tb00549').val(); }	
