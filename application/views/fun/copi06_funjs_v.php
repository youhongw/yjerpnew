...
function showymd1(oInput,n){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	     ...
	     var   sText=oInput.value.substring(0,4)+'/'+oInput.value.substring(4,6)+'/'+oInput.value.substring(6,8); 
	       $('input[name=\'order_product[' + nn + '][td013]\']').val(sText);   
}
//--></script>
...
<script type="text/javascript"><!--       
 function seleall(oInput){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示	
           document.getElementById('tc039').select();		   
}
//--></script>
...
<script type="text/javascript"><!--       
 function dataymd1(oInput){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	       // alert(test);
		   document.form.tc039.value=oInput.value.substring(0,4)+'/'+oInput.value.substring(4,6)+'/'+oInput.value.substring(6,8); 
		   var zstr=$('input[name=\'tc039\']').val();
		 //  alert(zstr.length);
		 
		if  ( zstr.length != 10) { 
		    document.form.tc039.focus(); return tc039;}	
}
...
//	html += '    <td class="left"><input type="text"  class="total_dc" tabIndex="51" onchange="startinvq02a(this,product_row)" id="td004'+ product_row+'" ondblclick="copi02a(this,'+ product_row +');"  name="order_product[' + product_row + '][td004]" value="" size="20" style="background-color:#FFFFE4" /><input width="5px" type="button" value="..." style="float:left;" onclick="invq02a(this,' + product_row + ');" /></td>';	
	html += '    <td class="left"><input type="text"  class="total_dc" tabIndex="51" onchange="startinvq02a(this,product_row)" id="td004'+ product_row+'" ondblclick="copi02a(this,'+ product_row +');"  name="order_product[' + product_row + '][td004]" value="" size="20" style="background-color:#FFFFE4" /></td>';
	html += '    <td class="left"><input readonly="value"   onKeyPress="keyFunction()" type="text" id="td005"  name="order_product[' + product_row + '][td005]" value=""  style="background-color:#F0F0F0" /></td>';
	html += '    <td class="left"><input readonly="value"  onKeyPress="keyFunction()" type="text" id="td006"   name="order_product[' + product_row + '][td006]" value=""  size="30" style="background-color:#F0F0F0" /></td>';
	html += '    <td class="left"><input readonly="value" ondblclick="startinvq81a();"  onKeyPress="keyFunction()"   type="text" id="td010"   name="order_product[' + product_row + '][td010]" value="" size="6" style="background-color:#F0F0F0" /></td>';
	html += '    <td class="left"><input type="text"   readonly="value" tabIndex="22"  name="order_product[' + product_row + '][td003]" value="0" size="6" style="background-color:#F0F0F0" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="52" onchange="startcmsq03a(this,product_row)" id="td007'+ product_row+'" ondblclick="cmsq03a(this,'+ product_row +')" name="order_product[' + product_row + '][td007]" value="" size="10" style="background-color:#FFFFE4" /></td>';	
	html += '    <td class="left"><input type="text" readonly="value" tabIndex="53" id="td007disp'+ product_row+'"   name="order_product[' + product_row + '][td007disp]" value="" size="10" style="background-color:#F0F0F0"  /></td>';	
	html += '    <td class="left"><input type="text"  onchange="showymd1(this,product_row)" ondblclick="scwShow(this,event);" onfocus="this.select()"  tabIndex="54" id="td013['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td013]" value="<?php echo date("Y/m/d"); ?>" size="10"  style="background-color:#FFFFE4"/></td>';
	html += '    <td class="center"><input type="text" tabIndex="55" onchange="startcopq02a(this,product_row)"  class="total_qty" onfocus="startcopq02a(this,product_row)" id="td008" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td008]" value="0" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="56" id="td011" ondblclick="copq06a(this,'+ product_row +');" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td011]" value="0" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" readonly="value" tabIndex="57" class="total_price" id="td012" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td012]" value="0" size="10" style="text-align:right;background-color:#F0F0F0" /></td>';
	html += '    <td class="center"><input type="text" readonly="value" tabIndex="58" class="total_qty" id="td009" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td009]" value="0" size="10" style="text-align:right" /></td>';
	...
	$('input[name=\'order_product[' + product_row + '][td008]\']').focusout(function(){
	  ...
	  //單價  游標停在 0 之後
	$('input[name=\'order_product[' + product_row + '][td011]\']').focus(function(){
		var real_value = $(this)[0].defaultValue;
		if ($(this).val()==real_value)
		    $(this).val(real_value);
		     if ($(this).val()=='0')
	  ...
	  //單價  
	$('input[name=\'order_product[' + product_row + '][td011]\']').focusout(function(){
		var real_value = $(this)[0].defaultValue;
		if ($(this).val()==real_value)
		    $(this).val(real_value);
	 ...
	 //金額  
	$('input[name=\'order_product[' + product_row + '][td012]\']').focus(function(){
	    var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
...
<script type="text/javascript"> 	   
	...
	if(!$("input[name$='"+str.replace(/td011/,"td004")+"']").val() || !$("#tc004").val()) {
		alert("請先選擇客戶代號與該欄位的產品品號");
		return;
	}
...
<script type="text/javascript"> 	   
	...
	<iframe src="<?php echo base_url()?>index.php/fun/copi02a/display/a.mb001/desc/0/cn00001/" allowTransparency="flase" id="copi02aifmain" name="ifmain" width="95%" height="500" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	 ...
	 <!-- 開啟交貨庫別 -->
<script type="text/javascript"> 	  
	function cmsq03a(thisobj,row_count) {
	// var n = this.name.replace(/order_product\[(\d+)].*/, '$1');    
	// var ifm = document.getElementById('ifm');
	//    ifm.innerHTML = $('input[name=\'order_product[' + n + '][tb004]\']').val(ui.item.value1);	
	var str = thisobj.name;
	...
	$('#cmsq03aifmain').attr('src','<?php echo base_url()?>index.php/fun/cmsq03a/display/a.mb001/desc/0/'+$("#tc004").val()+'/'+row_count);
	...
	function select_cmsq03a(id,name){
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td007]\']').val(id);
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td007disp]\']').val(name);
		$('.close').click();
	} 
	</script> 	    	
		   
	<div id="divcmsq03a" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/cmsq03a/display/a.mb001/desc/0/cn00001/" allowTransparency="flase" id="cmsq03aifmain" name="ifmain" width="95%" height="600px" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div>
	
	 <!-- 開啟品號資料 -->
<script type="text/javascript"> 	  
	function invq02a(thisobj,row_count) {
	// var n = this.name.replace(/order_product\[(\d+)].*/, '$1');    
	// var ifm = document.getElementById('ifm');
	//    ifm.innerHTML = $('input[name=\'order_product[' + n + '][tb004]\']').val(ui.item.value1);	
	//if($("input[name$='"+str.replace(/td011/,"td004")+"']").val())
	$('#select_rows').val(row_count);
	$('#invq02aifmain').attr('src','<?php echo base_url()?>index.php/fun/invq02a/display/a.mb001/desc/0/'+$("#tc004").val()+'/'+row_count);
	...
	function select_invq02a(id,name,spec,unit){
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td004]\']').val(id);
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td005]\']').val(name);
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td006]\']').val(spec);
		$('input[name=\'order_product[' + $('#select_rows').val() + '][td010]\']').val(unit);
		$('.close').click();
	} 
	</script> 	    	
		   
	<div id="divinvq02a" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/invq02a/display/a.mb001/desc/0/cn00001/" allowTransparency="flase" id="invq02aifmain" name="ifmain" width="95%" height="600px" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div>
