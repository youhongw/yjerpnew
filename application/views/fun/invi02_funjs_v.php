...
<script type="text/javascript"> 	   //開視窗 單位換算 invi02
	...
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/inv/invi81/display" allowTransparency="flase" name="ifmain" width="95%" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 
