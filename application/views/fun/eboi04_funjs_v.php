...
<script type="text/javascript"> 	   
	...
	$("#Showbomq03a44disp").click(function() { 	   
	$.blockUI({ 	   
	css: { 	   
	top: '20%', 	   
	left: '25%', 	   
	...
	<div id="divFbomq03a44" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/bomq03a/display4" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
  function addbomq03a44(std001,std002) {	
	form.bomq03a44.value=std001;
	var oSpan = document.getElementById("bomq03a44disp");
		oSpan.innerHTML = std002;
	document.form.bomq03a44.focus();    
	return bomq03a44;	
}
//--></script>
<!-- 開視窗 invq02a 主件品號 -->
          ...
          //  var smb001=document.getElementById('tj003').value;
            ...
            select:   
               function(event, ui) { 
                 ...
                 $('input[name=\'order_product[' + n + '][tj003]\']').val(ui.item.value1);				   
...
function check_title_no(){
	$('#ti002').val("");
	var bomq03a44 = $('#bomq03a44').val();
	var ti009 = $('#ti009').val();
	var zymd1 = ti009.substring(0,4);
	 var zymd2 = ti009.substring(5,7);
	 var zymd3 = ti009.substring(8,10);
	 var zymd=zymd1+zymd2+zymd3;
	//alert(copi03);
	
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/ebo/eboi04/check_title_no",
		data: {
			bomq03a44: bomq03a44, 
			ti009: zymd
		}
	...
	.done(function( msg ) {
		if($('#bomq03a44disp').text()!=""&&$('#bomq03a44disp').text()!="查無資料")
		$('#ti002').val(msg);
	});
}
</script>
