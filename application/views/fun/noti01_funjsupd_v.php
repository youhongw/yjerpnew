...
function addItem() {
  ...
  //	html += '    <input type="hidden"  name="order_product[' + product_row + '][mx002]" value="" />';
...
//	html += '  </tr>';	
	...
	//$('input[name=\'order_product[' + product_row + '][mx006]\']').blur(function(){
	//	$('input[name=\'order_product[' + product_row + '][mx002]\']').focus();
//	});
