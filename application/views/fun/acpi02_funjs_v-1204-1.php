...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?=base_url()?>index.php/acp/acpi02/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
//	html += '    <td class="left"><input type="text"  tabIndex="41" id="tb004'+ product_row+'"   name="order_product[' + product_row + '][tb004]" value="" size="20"  /></td>';	
    ...
    $('input[name=\'order_product[' + product_row + '][tb005]\']').catcomplete({
		...
		function(req, add){ 	
			...
			var kmb001=$('select[name=\'order_product[' + vrow + '][tb004]\']').val();
			alert(kmb001);   
			 if (product_row == 1 ) { smb001= $('#tb0050').val();vrow++; }
			 if (product_row == 2 ) { smb001= $('#tb0051').val();vrow++; }
			 if (product_row == 3 ) { smb001= $('#tb0052').val();vrow++; }
		     if (product_row == 4 ) { smb001= $('#tb0053').val();vrow++; }
			 if (product_row == 5 ) { smb001= $('#tb0054').val();vrow++; }
			 if (product_row == 6 ) { smb001= $('#tb0055').val();vrow++; }
			 if (product_row == 7 ) { smb001= $('#tb0056').val();vrow++; }
		     if (product_row == 8 ) { smb001= $('#tb0057').val();vrow++; }
			 if (product_row == 9 ) { smb001= $('#tb0058').val();vrow++; }
			 if (product_row == 10 ) { smb001= $('#tb0059').val();vrow++; }	
			 if (product_row == 11 ) { smb001= $('#tb00510').val();vrow++; }
			 if (product_row == 12 ) { smb001= $('#tb00511').val();vrow++; }
			 if (product_row == 13 ) { smb001= $('#tb00512').val();vrow++; }
		     if (product_row == 14 ) { smb001= $('#tb00513').val();vrow++; }
			 if (product_row == 15 ) { smb001= $('#tb00514').val();vrow++; }
			 if (product_row == 16 ) { smb001= $('#tb00515').val();vrow++; }
			 if (product_row == 17 ) { smb001= $('#tb00516').val();vrow++; }
		     if (product_row == 18 ) { smb001= $('#tb00517').val();vrow++; }
			 if (product_row == 19 ) { smb001= $('#tb00518').val();vrow++; }
