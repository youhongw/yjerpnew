...
<script type="text/javascript">    //傳回庫別名稱
    $(document).ready(function(){
		$('.button').click(function() {
			...
			window.parent.select_noti01a(sma001,sma002,sma004,sma005,sma011);
		});
    });
</script>
...
<script type="text/javascript"><!--
  function filter1() {
    ...
    if ( !filter_ma001  && !filter_ma002  && !filter_ma004  && !filter_ma005 ) {         
	   url = '<?php echo base_url()?>index.php/fun/noti01a/display/';location = url;
	   }
