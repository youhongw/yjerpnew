...
function startkey(oInput){         //不更新網頁 key  檢查資料重複 invi01-add
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/not/noti02/checkkey/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
...
function addItem() {
  ...
  html += '    <input type="hidden"  name="order_product[' + product_row + '][tg002]" value="" />';
	html += '	 <td class="left"><input type="text" tabIndex="17" id="tg003[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg003]" value="" size="10" /></td>';
	...
	html += '	 <td class="left"><input class="money" type="text"  tabIndex="18" id="tg008[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg008]" value="" size="10" style="text-align:right;" /></td>';
	...
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg005[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg005]" value="" size="15" style="text-align:right;" /></td>';
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg007[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg007]" value="" size="15" style="text-align:right;" /></td>';
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg012[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg012]" value="" size="15" style="text-align:right;" /></td>';
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg013[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg013]" value="" size="20" style="text-align:right;" /></td>';
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg006[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg006]" value="1101" size="20" style="text-align:right;" /></td>';
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg014[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg014]" value="" size="10" style="text-align:right;" /></td>';
	...
	html += '	 <td class="left"><input type="text"  tabIndex="18" id="tg009[' + product_row + ']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tg009]" value="" size="20" style="text-align:right;" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
	  $('#row_count').val(parseInt(product_row)+1);
	$('#order_product tfoot').before(html); 
	
	$('input[name=\'order_product[' + product_row + '][tg004]\']').blur(function(){
		$('input[name=\'order_product[' + product_row + '][tg011]\']').focus();
	});
...
function totalSum() {
   ...
   var sumTotal = 0;
    ...
    $(".money").each(function() {
  	...
  	form.tf013.value=Math.round(sumTotal);	  //原幣貨款
	form.tf014.value=Math.round(sumTotal);	  //原幣貨款
}
//--></script>
