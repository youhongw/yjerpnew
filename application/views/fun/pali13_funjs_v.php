...
<script type="text/javascript"><!--
  function addpalq01a(sma001,sma002) {
	...
	document.form.palq01a.focus();
 	startpalq01a($('#md001').get(0));
	//return palq01a;
}
//--></script>

<script type="text/javascript"> 	   //開視窗  條例 
	$(document).ready(function(){ 	   
	$("#Showpalq12a").click(function() { 	   
	$.blockUI({ 	   
	css: { 	   
	top: '20%', 	   
	left: '25%', 	   
	...
	<div id="divFpalq12a" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/palq12a/display" allowTransparency="flase" name="ifmain" width="620" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 

<script type="text/javascript"><!--
  function addpalq12a(sma001,sma002) {
   
	form.palq12a.value=sma001;
	var oSpan = document.getElementById("palq12adisp");
		oSpan.innerHTML = sma002;	
	document.form.palq12a.focus();
 	startpalq12a($('#mv006').get(0));
	//return palq01a;
}
//--></script>

<script type="text/javascript"> 	   //開視窗  類別 
	$(document).ready(function(){ 	   
	$("#Showpalq17a").click(function() { 	   
	$.blockUI({ 	   
	css: { 	   
	top: '20%', 	   
	left: '25%', 	   
	...
	<div id="divFpalq17a" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/palq17a/display" allowTransparency="flase" name="ifmain" width="620" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 

<script type="text/javascript"><!--
  function addpalq17a(sma001,sma002) {
   
	form.palq17a.value=sma001;
	var oSpan = document.getElementById("palq17adisp");
		oSpan.innerHTML = sma002;	
	document.form.palq17a.focus();
 	startpalq17a($('#mv004').get(0));
	//return palq01a;
}
//--></script>
...
function showpalq01a(sText){   //不更新網頁 32 員工代號 
     ...
     var str=(sText.split(";",14));
	 //alert(str);
	 if(!str[3]){alert('查無固定津貼資料!!');}
	...
	var oSpan = document.getElementById("palq01adisp");
     ...
     $('input[name=\'md003\']').val(str[3]);
     $('input[name=\'md004\']').val(str[4]);
     $('input[name=\'md005\']').val(str[5]);
     $('input[name=\'md006\']').val(str[6]);
     $('input[name=\'md007\']').val(str[7]);
     $('input[name=\'md008\']').val(str[8]);
     $('input[name=\'md009\']').val(str[9]);
     $('input[name=\'md010\']').val(str[10]);
     $('input[name=\'md011\']').val(str[11]);
     $('input[name=\'md012\']').val(str[12]);
     $('input[name=\'md013\']').val(str[13]);	 
...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/palq01a/datapalq01a3/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
	...
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	 // alert(oInput.value);
	  //   zamt3=$('input[name=\'md003\']').val();
		  ...
		  zamt13=parseInt(zamt4)+parseInt(zamt5)+parseInt(zamt6)+parseInt(zamt7)+parseInt(zamt8)+parseInt(zamt9)+parseInt(zamt10)+parseInt(zamt11)+parseInt(zamt12);
