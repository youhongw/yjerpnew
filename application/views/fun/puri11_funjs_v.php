...
<script type="text/javascript"> 	   
	...
	<iframe src="<?php echo base_url()?>index.php/fun/purq04a/display35" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
...
<script type="text/javascript"><!--
  function addinvq81a(stc001,stc002,stc003) {
	...
	$(".total_dc").each(function() {		
	 ...
	 $('input[name=\'order_product[' + product_row1  + '][tj007]\']').val(stc002);
	return $("#tj007").html(stc002);
...
//	}
	...
	createXMLHttpRequest();
   	...
   	var sUrl = "<?php echo base_url()?>index.php/fun/purq04a/datapurq04a35/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/pur/puri11/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
function showcmsq03a(sText,n){   //不更新網頁 6  庫別 
	...
	// alert(sysma200);
	 if (num>sysma200){
          $('input[name=\'order_product[' + nn + '][tj011disp]\']').val(sText); }  
}
...
function showinvq02a(sText,n){   //不更新網頁 6  品號 
	...
	// alert(str[1]);
	 ...
	 $('input[name=\'order_product[' + nn + '][tj007]\']').val(str[2]);}
...
function showpurq02a(sText,n){   //不更新網頁 6  單價 
	...
	// alert(sText);	
	 if (sText>0){
	 $('input[name=\'order_product[' + nn + '][tj008]\']').val(sText)};
}
...
//	}
    //   alert('test');
	  ...
	  var td004=$('input[name=\'order_product[' + nn + '][tj004]\']').val();  //品號
      var td010=$('input[name=\'order_product[' + nn + '][tj007]\']').val();  //單位
	//  alert(nn);
...
<script type="text/javascript"><!--       
 function selappr(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	  var selval = document.getElementById('ti013').selectedIndex;
	 //  alert(selval);
...
<script type="text/javascript"><!--       
 function seltax(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	  var selval = document.getElementById('ti009').selectedIndex;
	 //  alert(selval);
	   var oSpan = document.getElementById("taxdisp");
	  if (selval==0) {form.ti027.value=0.05;oSpan.innerHTML = "<span style='color:red'> 應稅外加</span>";}	    
      else if (selval==1){  form.ti027.value=0.05;oSpan.innerHTML = "<span style='color:red'> 應稅內含</span>";}
	  else {  form.ti027.value=0;oSpan.innerHTML = "<span style='color:red'> 不計稅</span>";}
}
...
<script type="text/javascript"><!--       
 function dataymd1(oInput){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	       // alert(test);
		   document.form.ti014.value=oInput.value.substring(0,4)+'/'+oInput.value.substring(4,6)+'/'+oInput.value.substring(6,8); 
		   var zstr=$('input[name=\'ti014\']').val();
		 //  alert(zstr.length);
		 
		if  ( zstr.length == 8 ) { 
		    document.form.ti014.focus(); return ti014;}	
}
...
$(document).keydown(function(event){
	...
	if(event.altKey && (keycode == '89')){  //tab6 y
		setTimeout(function() {
			$('input[name=\'order_product[250][tj004]\']').focus();
		}, 100);	
	}
	//新增一筆明細 alt+w
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tj003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text" class="total_dc" tabIndex="41" id="tj004'+ product_row+'" onchange="startinvq02a(this,product_row)"   name="order_product[' + product_row + '][tj004]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
	...
	html += '    <td class="left"><input   onKeyPress="keyFunction()" ondblclick="startinvq81a();"  type="text" id="tj007"   name="order_product[' + product_row + '][tj007]" value="" size="6"  /></td>';
	html += '    <td class="left"><input  onKeyPress="keyFunction()" type="text"  id="tj003" name="order_product[' + product_row + '][tj003]" value="0" size="6" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="46" id="tj011'+ product_row+'" onchange="startcmsq03a(this,product_row)"   name="order_product[' + product_row + '][tj011]" value="" size="10" style="background-color:#E7EFEF" /></td>';	
	...
	html += '    <td class="center"><input type="text" tabIndex="48" class="total_qty" id="tj009" onKeyPress="keyFunction()" onchange="pricepurq02a(this,product_row)" name="order_product[' + product_row + '][tj009]" value="0" size="5" style="text-align:right" /></td>';
	...
	html += '    <td class="center"><input type="text" tabIndex="50"  id="tj010" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj010]" value="0" size="5" style="text-align:right;background-color:#EBEBE4"" /></td>';
	 html += '    <td class="right"><input readonly="value" type="text" class="total_price" id="tj030" name="order_product[' + product_row + '][tj030]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	...
	//    var n = vproduct_row;
	 ...
	 //	alert(num_2);
	   ...
	   //數量
	 $('input[name=\'order_product[' + product_row + '][tj009]\']').focus(function(){
	...
	$('input[name=\'order_product[' + product_row + '][tj009]\']').focusout(function(){	    
		var real_value = $(this)[0].defaultValue;
		if ($(this).val()==real_value)
		     $(this).val(real_value);
		    if ($(this).val()=='')
	...
	$('input[name=\'order_product[' + product_row + '][tj008]\']').focus(function(){
	  ...
	  //單價  
	$('input[name=\'order_product[' + product_row + '][tj008]\']').focusout(function(){
		var real_value = $(this)[0].defaultValue;
		if ($(this).val()==real_value)
		    $(this).val(real_value);
		     if ($(this).val()=='')
	...
	//進貨單別
	$('input[name=\'order_product[' + product_row + '][tj013]\']').focus(function(){
		totalSum1();
	});
	//採購單號
