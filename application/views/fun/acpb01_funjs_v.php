...
function showpurq01ac(sText){   //不更新網頁 32 主供應商 
	var oSpan = document.getElementById("purq01acdisp");
	 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
function startpurq01ac(oInput){         //不更新網頁 32 主供應商
...
//	}
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showpurq01ac(xmlHttp.responseText);	//顯示服務器結果		
	}
	
	xmlHttp.send(null);
	 
}
function showpurq01ao(sText){   //不更新網頁 32 主供應商 
	var oSpan = document.getElementById("purq01aodisp");
	 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
function startpurq01ao(oInput){         //不更新網頁 32 主供應商
...
//	}
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showpurq01ao(xmlHttp.responseText);	//顯示服務器結果		
	}
