          ...
          <thead>
            <tr>                          <!-- 表格表頭 -->
	          <td width="7%" class="left"> 
		        <?php echo anchor("fun/admq10a/display/mf001/" . (($sort_order == 'asc' && $sort_by == 'mf001') ? 'desc' : 'asc') ,'使用者代號使用者代號'); ?>
              <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>	         
			 </td>
	          <td width="16%" class="left"> 
		        <?php echo anchor("fun/admq10a/display/mf002/" . (($sort_order == 'asc' && $sort_by == 'mf002') ? 'desc' : 'asc') ,'使用者名稱'); ?>
               <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>              
			  </td>
...
<script type="text/javascript">    //傳回庫別名稱
    $(document).ready(function(){
		$('.button').click(function() {
			...
			window.parent.addadmq10a(sma001,sma002);
		});
    });
</script>
...
<script type="text/javascript"><!--
  function filter1() {
	...
	if (filter_mf001) {
	   url = '<?php echo base_url()?>index.php/fun/admq10a/filter1/mf001/asc/' + filter_mf001 ;
	} 
	
	var filter_mf002 = $('input[name=\'filter_mf002\']').val();
	if (filter_mf002) {
		url = '<?php echo base_url()?>index.php/fun/admq10a/filter1/mf002/asc/' + encodeURIComponent(filter_mf002);
	}
	
    if ( !filter_mf001  && !filter_mf002 ) {         
	   url = '<?php echo base_url()?>index.php/fun/admq10a/display/';location = url;
	   }
