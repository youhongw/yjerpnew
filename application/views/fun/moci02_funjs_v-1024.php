...
<script type="text/javascript"> 	   
	...
	<iframe src="<?php echo base_url()?>index.php/fun/mocq01a/display51" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
  function addmocq01a51(sta001,sta002) {	
	form.mocq01a51.value=sta001;
...
<script type="text/javascript"> 	   //開視窗  品號單頭  ta006 invq02a1
	$(document).ready(function(){ 	   
...
<script type="text/javascript"><!--
  function addinvq02a1(sma001,sma002,sma003,sma004) {
	...
	form.ta034.value=sma002;
	form.ta035.value=sma003;
	form.ta007.value=sma004;
...
<script type="text/javascript"> 	 
   ...
   // alert(zno);	
	...
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/bomc02a/display/".$invq02a1.'/'.$ta015 allowTransparency="flase" name="ifmain" width="620" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div>

<!--1主件品號,2組成用量,  sta015 預計生產量, 3庫別,sta001 製令別  sma001 主件品號            -->
<script type="text/javascript">
  function addbomc02a(sma001,sma002,sma003) {
    var oSpan = document.getElementById("cmsq06adisp");
		oSpan.innerHTML = 'testtesttest';
    var sta015=$('input[name=\'ta015\']').val();
    var sta001=$('input[name=\'mocq01a51\']').val();
    var sta002=$('input[name=\'ta002\']').val();
    var sta034=$('input[name=\'ta034\']').val();
    var sta035=$('input[name=\'ta035\']').val();
    var sta007=$('input[name=\'ta007\']').val();	
       form.ta006.value=sma001;		
	 //  alert(sma001+sta015+sma003+sta001);
	url = '<?php echo base_url()?>index.php/moc/moci02/copybefore/'+encodeURIComponent(sma001)+'/'+sta015+'/'+sma003+'/'+sta001+'/'+sta002; 
	location = url;
	return true;
}
</script>
...
<script type="text/javascript"> 	   
	...
	<div id="divFcopq06a" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/copq06a/display" allowTransparency="flase" name="ifmain" width="620" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 

<script type="text/javascript"><!--
  function addcopq06a(sma001,sma002,sma003,sma004) {
	form.copq06a.value=sma001;
	form.ta027.value=sma002;
	form.ta028.value=sma003;
	var oSpan = document.getElementById("copq06adisp");
		oSpan.innerHTML = sma002;	
	document.form.copq06a.focus();    
	return copq06a;
}
//--></script>
<!-- 開視窗 cmsq03a 25 庫別 -->
...
function showmocq01a51(sText){                 //不更新網頁 31  製令單別 ta001
	var oSpan = document.getElementById("mocq01a51disp");
      //   chkno1();
     //   alert('test');		
 ...
 <!-- 不更新網頁帶出資料 mocq01a51  製令單別 -->        
function startmocq01a51(oInput){            
  //	if(!oInput.value){
...
//	}
	...
	createXMLHttpRequest();
   	...
   	var sUrl = "<?php echo base_url()?>index.php/fun/purq04a/datamocq01a51/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showmocq01a51(xmlHttp.responseText);	//顯示服務器結果		
	}
...
//	}
	//建立非同步請求
	 ...
	 var zno=$('input[name=\'mocq01a51\']').val();
	 ...
	 var zymd = zymd1+zymd2+zymd3;
	  document.getElementById("ta024").value=$('input[name=\'mocq01a51\']').val();
	  document.getElementById("ta025").value=$('input[name=\'ta002\']').val();
    //  alert(zstr);
	  
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/moc/moci02/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/cmsq03a/datacmsq03a/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
function showcmsq03a(sText,n){   //不更新網頁 6  庫別 
	...
	// alert(sysma200);
	 if (num>sysma200){
          $('input[name=\'order_product[' + nn + '][tb009disp]\']').val(sText); }  
}
...
function showpurq02a(sText,n){   //不更新網頁 6  單價 
	//var oSpan = document.getElementById("td007disp0");
	//	 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	// if (!sText) { 
	//    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
	...
	// alert(sText);	
	 if (sText>0){
	 $('input[name=\'order_product[' + nn + '][tb018]\']').val(sText)};
}

function pricepurq02a(oInput,n){         //不更新網頁 6 單價
...
//	}
    //   alert('test');
       var nn=n-1;
      var tc004=$('input[name=\'purq01a\']').val();     //廠代
	  var td004=$('input[name=\'order_product[' + nn + '][tb003]\']').val();  //品號
   ...
   // var nn=n;
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/purq02a/checkpurq02a/" + encodeURIComponent(tc004)+ "/" + encodeURIComponent(td004)+ "/"+ encodeURIComponent(td010)+ "/"+ new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showpurq02a(xmlHttp.responseText,nn);	//顯示服務器結果
       //   alert(xmlHttp.responseText);  
	}
...
<script type="text/javascript"><!--       
 function selappr(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	  var selval = document.getElementById('tg013').selectedIndex;
	 //  alert(selval);
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="41" onchange="startinvq02a(this,product_row)" id="tb003'+ product_row+'"   name="order_product[' + product_row + '][tb003]" value="" size="20"  style="background-color:#E7EFEF"/></td>';	
	html += '    <td class="left"><input readonly="value"    onKeyPress="keyFunction()" type="text" id="tb012"  name="order_product[' + product_row + '][tb012]" value=""  style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input readonly="value"  onKeyPress="keyFunction()" type="text" id="tb013"   name="order_product[' + product_row + '][tb013]" value=""  size="30" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input   onKeyPress="keyFunction()"  type="text" id="tb007"   name="order_product[' + product_row + '][tb007]" value="" size="6"  /></td>';
	html += '    <td class="left"><input readonly="value" onKeyPress="keyFunction()" type="text"  id="tb008" name="order_product[' + product_row + '][tb008]" value="" size="6" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="43" id="tb009'+ product_row+'"  onchange="startcmsq03a(this,product_row)"  name="order_product[' + product_row + '][tb009]" value="" size="10" style="background-color:#E7EFEF" /></td>';	
	html += '    <td class="left"><input readonly="value" type="text"   id="tb009disp'+ product_row+'"   name="order_product[' + product_row + '][tb009disp]" value="" size="10" style="background-color:#EBEBE4"  /></td>';	
	
	
	html += '    <td class="center"><input type="text" tabIndex="49"  class="total_qty" id="tb004" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb004]" value="1" size="10" style="text-align:right" /></td>';
    html += '    <td class="center"><input type="text" tabIndex="50" id="tb005" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb005]" value="0" size="10" style="text-align:right" /></td>';	
    html += '    <td class="right"><input readonly="value" type="text" class="total_price"  name="order_product[' + product_row + '][tb016]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
    html += '    <td class="left"><select id="tb011" tabIndex="52" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" ><option  value="1">1.直接材料</option><option value="2">2.間接材料</option><option  value="3">3.廠商供應</option><option  value="4">4.不發料</option><option  value="5">5.客戶供料</option></select></td>';  
	
	html += '    <td class="left"><input type="text"  tabIndex="55" id="tb010" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb010]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="56"  onclick="scwShow(this,event);"   id="tb015" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb015]" value="<?php echo date("Y/m/d"); ?>" size="10" class="date" style="background-color:#E7EFEF"/></td>';
	html += '    <td class="left"><input type="text" id="tb017" tabIndex="59"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb017]" value="" size="20" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
	 ...
	 $('#order_product tfoot').before(html);  
	   	   ...
	   	   //下拉視窗 網頁不更新  mb001 tb003 品號品名輸入
	
    $('input[name=\'order_product[' + product_row + '][tb003]\']').catcomplete({
        autoFocus: true,
		delay: 0,
        minLength: 1,  		
		source: 
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('tb003').value;
			 ...
			 if (product_row == 1 ) { smb001= $('#tb0030').val(); }
			 if (product_row == 2 ) { smb001= $('#tb0031').val(); }
			 if (product_row == 3 ) { smb001= $('#tb0032').val(); }
		     if (product_row == 4 ) { smb001= $('#tb0033').val(); }
			 if (product_row == 5 ) { smb001= $('#tb0034').val(); }
			 if (product_row == 6 ) { smb001= $('#tb0035').val(); }
			 if (product_row == 7 ) { smb001= $('#tb0036').val(); }
		     if (product_row == 8 ) { smb001= $('#tb0037').val(); }
			 if (product_row == 9 ) { smb001= $('#tb0038').val(); }
			 if (product_row == 10 ) { smb001= $('#tb0039').val(); }	
			 if (product_row == 11 ) { smb001= $('#tb00310').val(); }
			 if (product_row == 12 ) { smb001= $('#tb00311').val(); }
			 if (product_row == 13 ) { smb001= $('#tb00312').val(); }
		     if (product_row == 14 ) { smb001= $('#tb00313').val(); }
			 if (product_row == 15 ) { smb001= $('#tb00314').val(); }
			 if (product_row == 16 ) { smb001= $('#tb00315').val(); }
			 if (product_row == 17 ) { smb001= $('#tb00316').val(); }
		     if (product_row == 18 ) { smb001= $('#tb00317').val(); }
			 if (product_row == 19 ) { smb001= $('#tb00318').val(); }
			 if (product_row == 20 ) { smb001= $('#tb00319').val(); }	
             if (product_row == 21 ) { smb001= $('#tb00320').val(); }
			 if (product_row == 22 ) { smb001= $('#tb00321').val(); }
			 if (product_row == 23 ) { smb001= $('#tb00322').val(); }
		     if (product_row == 24 ) { smb001= $('#tb00323').val(); }
			 if (product_row == 25 ) { smb001= $('#tb00324').val(); }
			 if (product_row == 26 ) { smb001= $('#tb00325').val(); }
			 if (product_row == 27 ) { smb001= $('#tb00326').val(); }
		     if (product_row == 28 ) { smb001= $('#tb00327').val(); }
			 if (product_row == 29 ) { smb001= $('#tb00328').val(); }
			 if (product_row == 30 ) { smb001= $('#tb00329').val(); }	
    ...
    $('input[name=\'order_product[' + product_row + '][tb009]\']').catcomplete({
        autoFocus: true,
		delay: 0,
        minLength: 1,  		
		source: 
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('tb009').value;
			   
			 if (product_row == 1 ) { smb001= $('#tb0090').val(); }
			 if (product_row == 2 ) { smb001= $('#tb0091').val(); }
			 if (product_row == 3 ) { smb001= $('#tb0092').val(); }
		     if (product_row == 4 ) { smb001= $('#tb0093').val(); }
			 if (product_row == 5 ) { smb001= $('#tb0094').val(); }
			 if (product_row == 6 ) { smb001= $('#tb0095').val(); }
			 if (product_row == 7 ) { smb001= $('#tb0096').val(); }
		     if (product_row == 8 ) { smb001= $('#tb0097').val(); }
			 if (product_row == 9 ) { smb001= $('#tb0098').val(); }
			 if (product_row == 10 ) { smb001= $('#tb0099').val(); }	
			 if (product_row == 11 ) { smb001= $('#tb00910').val(); }
			 if (product_row == 12 ) { smb001= $('#tb00911').val(); }
			 if (product_row == 13 ) { smb001= $('#tb00912').val(); }
		     if (product_row == 14 ) { smb001= $('#tb00913').val(); }
			 if (product_row == 15 ) { smb001= $('#tb00914').val(); }
			 if (product_row == 16 ) { smb001= $('#tb00915').val(); }
			 if (product_row == 17 ) { smb001= $('#tb00916').val(); }
		     if (product_row == 18 ) { smb001= $('#tb00917').val(); }
			 if (product_row == 19 ) { smb001= $('#tb00918').val(); }
			 if (product_row == 20 ) { smb001= $('#tb00919').val(); }	
             if (product_row == 21 ) { smb001= $('#tb00920').val(); }
			 if (product_row == 22 ) { smb001= $('#tb00921').val(); }
			 if (product_row == 23 ) { smb001= $('#tb00922').val(); }
		     if (product_row == 24 ) { smb001= $('#tb00923').val(); }
			 if (product_row == 25 ) { smb001= $('#tb00924').val(); }
			 if (product_row == 26 ) { smb001= $('#tb00925').val(); }
			 if (product_row == 27 ) { smb001= $('#tb00926').val(); }
		     if (product_row == 28 ) { smb001= $('#tb00927').val(); }
			 if (product_row == 29 ) { smb001= $('#tb00928').val(); }
			 if (product_row == 30 ) { smb001= $('#tb00929').val(); }	
			//   smb001=$("#tb003"+(product_row-1)).val();
	...
	$('input[name=\'order_product[' + product_row + '][tb004]\'],input[name=\'order_product[' + product_row + '][tb005]\']').focusout(function() { 
		var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
	//    var n = vproduct_row;
	...
	//進貨數量
	$('input[name=\'order_product[' + product_row + '][tb004]\']').focus(function(){
	...
	//進貨數量copy 驗收數量
	$('input[name=\'order_product[' + product_row + '][tb005]\']').focus(function(){
	  	var real_value = $(this)[0].defaultValue;
	  	if ($(this).val()==real_value)
		     $(this).val(real_value);
	});
...
//	$('input[name=\'order_product[' + product_row + '][tb016]\']').blur(function(){	    
//		var real_value = $(this)[0].defaultValue;
//		if ($(this).val()=='')
//			$(this).val(real_value);
//	});
