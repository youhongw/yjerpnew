...
<script type="text/javascript"><!--
  ...
  //  var smocq01a51=$('input[name=\'mocq01a51\']').val();
  //   var sta003=$('input[name=\'ta003\']').val();
  //    var sta002=$('input[name=\'ta002\']').val();	 
    //   form.ta006.value=sma001;		
	   alert(sma001+sta015+sma003);
	url = '<?=base_url() ?>index.php/moc/moci02/copybefore/'+encodeURIComponent(sma001)+'/'+encodeURIComponent(sta015)+'/'+encodeURIComponent(sma003)); 
	location = url;
	return true;
}
//--></script>
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input readonly="value" onKeyPress="keyFunction()" type="text"  id="tb008" name="order_product[' + product_row + '][tb008]" value="0" size="6" style="background-color:#EBEBE4" /></td>';
