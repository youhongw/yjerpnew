...
function check_submit(){
	...
	if(tb003 == "" || exchange_rate == ""){
		...
		send_back_noti03a(tb003, exchange_rate);
	}
}
function send_back_noti03a(smb001, smb002){
	window.parent.$.unblockUI();
	if(window.parent.addnoti03adisp){
		window.parent.addnoti03adisp(smb001,smb002);
		/*a.ajax({
			method:"POST",
