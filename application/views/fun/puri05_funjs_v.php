...
function showymd1(oInput,n){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	     ...
	     var   sText=oInput.value.substring(0,4)+'/'+oInput.value.substring(4,6)+'/'+oInput.value.substring(6,8); 
	       $('input[name=\'order_product[' + nn + '][tb011]\']').val(sText);   
}
//--></script>
...
//	html += '    <td class="left"><input type="text"  tabIndex="13"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input   onKeyPress="keyFunction()" ondblclick="startinvq81a();"  type="text" id="tb007"   name="order_product[' + product_row + '][tb007]" value="" size="6" /></td>';
	...
	html += '    <td class="left"><input type="text"  onchange="showymd1(this,product_row)" ondblclick="scwShow(this,event);" onfocus="this.select()"  tabIndex="16" id="tb011['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" value="<?php echo date("Y/m/d"); ?>" size="10"  style="background-color:#E7EFEF" /></td>';
	...
	$('input[name=\'order_product[' + product_row + '][tb014]\']').blur(function(){
