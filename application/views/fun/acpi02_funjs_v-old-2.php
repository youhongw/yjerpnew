...
<script type="text/javascript"> 	   
	...
	<iframe src="<?=base_url()?>index.php/fun/acpq01a/display71" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
...
//	}
	...
	createXMLHttpRequest();
   	...
   	var sUrl = "<?=base_url()?>index.php/fun/acpq01a/dataacpq01a71/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?=base_url()?>index.php/acp/acpq01a/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	html += '    <td class="left"><select id="tb004" tabIndex="61" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb004]" ><option  value="1">1.進貨</option><option value="2">2.退貨</option><option value="3">3.託外進貨</option><option value="4">4.託外退貨</option><option value="5">5.報關/贖單</option><option value="6">6.出口費用</option></select></td>'; 
//	html += '    <td class="left"><input type="text"  tabIndex="41" id="tb004'+ product_row+'"   name="order_product[' + product_row + '][tb004]" value="" size="20"  /></td>';	
	html += '    <td class="left"><input type="text"  tabIndex="62" id="tb005'+ product_row+'"   name="order_product[' + product_row + '][tb005]" value="" size="10"  /></td>';	
	html += '    <td class="left"><input  tabIndex="63" onKeyPress="keyFunction()" type="text" id="tb006"   name="order_product[' + product_row + '][tb006]" value=""  size="10"  /></td>';
	html += '    <td class="left"><input tabIndex="64"  onKeyPress="keyFunction()"  type="text" id="tb007"   name="order_product[' + product_row + '][tb007]" value="" size="10" /></td>';
	...
	html += '    <td class="left"><input type="text" id="tb019" tabIndex="67"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb019]" value="" size="20" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
    ...
    $('input[name=\'order_product[' + product_row + '][tb005]\']').catcomplete({
		...
		function(req, add){ 	
			...
			alert(smb001);   
			 if (product_row == 1 ) { smb001= $('#tb0050').val(); }
			 if (product_row == 2 ) { smb001= $('#tb0051').val(); }
			 if (product_row == 3 ) { smb001= $('#tb0052').val(); }
		     if (product_row == 4 ) { smb001= $('#tb0053').val(); }
			 if (product_row == 5 ) { smb001= $('#tb0054').val(); }
			 if (product_row == 6 ) { smb001= $('#tb0055').val(); }
			 if (product_row == 7 ) { smb001= $('#tb0056').val(); }
		     if (product_row == 8 ) { smb001= $('#tb0057').val(); }
			 if (product_row == 9 ) { smb001= $('#tb0058').val(); }
			 if (product_row == 10 ) { smb001= $('#tb0059').val(); }	
			 if (product_row == 11 ) { smb001= $('#tb00510').val(); }
			 if (product_row == 12 ) { smb001= $('#tb00511').val(); }
			 if (product_row == 13 ) { smb001= $('#tb00512').val(); }
		     if (product_row == 14 ) { smb001= $('#tb00513').val(); }
			 if (product_row == 15 ) { smb001= $('#tb00514').val(); }
			 if (product_row == 16 ) { smb001= $('#tb00515').val(); }
			 if (product_row == 17 ) { smb001= $('#tb00516').val(); }
		     if (product_row == 18 ) { smb001= $('#tb00517').val(); }
			 if (product_row == 19 ) { smb001= $('#tb00518').val(); }
			 if (product_row == 20 ) { smb001= $('#tb00519').val(); }	
             if (product_row == 21 ) { smb001= $('#tb00520').val(); }
			 if (product_row == 22 ) { smb001= $('#tb00521').val(); }
			 if (product_row == 23 ) { smb001= $('#tb00522').val(); }
		     if (product_row == 24 ) { smb001= $('#tb00523').val(); }
			 if (product_row == 25 ) { smb001= $('#tb00524').val(); }
			 if (product_row == 26 ) { smb001= $('#tb00525').val(); }
			 if (product_row == 27 ) { smb001= $('#tb00526').val(); }
		     if (product_row == 28 ) { smb001= $('#tb00527').val(); }
			 if (product_row == 29 ) { smb001= $('#tb00528').val(); }
			 if (product_row == 30 ) { smb001= $('#tb00529').val(); }	
			//   smb001=$("#tb004"+(product_row-1)).val();
			 
            $.ajax({  
                url: '<?php echo base_url(); ?>index.php/acp/acpi02/lookup/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,  
            ...
            select:   
               function(event, ui) { 
			     ...
			     $('input[name=\'order_product[' + n + '][tb009]\']').val(ui.item.value4);
				 $('input[name=\'order_product[' + n + '][tb015]\']').val(ui.item.value4);
			     $('input[name=\'order_product[' + n + '][tb016]\']').val(ui.item.value5);
...
function totalSum1() {
    ...
    $("#sum_total").html(sumTotal.toFixed(1));
	 ...
	 var rate=$('input[name=\'ta009\']').val();  //匯率
	form.ta029.value=Math.round(sumTotal*tax);  //原幣稅額
	form.ta037.value=Math.round(sumTotal1*rate);	  //本幣貨款
	...
	//課稅別
	if ($('select[name=\'ta011\']').val()=='1') {form.ta015.value=Math.round(sumTotal-sumTax);sumTotal=Math.round(sumTotal-sumTax);}
	if ($('select[name=\'ta011\']').val()=='1') {form.ta017.value=Math.round(sumTotal1-sumTax1);sumTotal1=Math.round(sumTotal1-sumTax1);}
