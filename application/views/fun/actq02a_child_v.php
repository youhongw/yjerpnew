	...
	<table width="95%" align="center"><tr><td>
      <form action="" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
		 ...
		 <?php  if($this->uri->segment(3)=="display91" || $this->uri->segment(3)=="filter91") {
		          echo anchor("fun/actq02a/display91/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'轉帳傳票單別');} ?>
	     
		 <?php  if($this->uri->segment(3)=="display92" || $this->uri->segment(3)=="filter92") {
		          echo anchor("fun/actq02a/display92/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'現金收入單別');} ?>  
	     
		 <?php  if($this->uri->segment(3)=="display93" || $this->uri->segment(3)=="filter93") {
		          echo anchor("fun/actq02a/display93/mq001/" . (($sort_order == 'asc' && $sort_by == 'mq001') ? 'desc' : 'asc') ,'現金支出單別');} ?>  
		
		  
		  </td>
	      <td width="16%" class="left"> 
		   <?php  if($this->uri->segment(3)=="display91" || $this->uri->segment(3)=="filter91") {
		         echo anchor("fun/actq02a/display91/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'轉帳傳票名稱');} ?>
           
		      <?php  if($this->uri->segment(3)=="display92" || $this->uri->segment(3)=="filter92") {
		         echo anchor("fun/actq02a/display92/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'現金收入名稱');} ?>
				 
			 <?php  if($this->uri->segment(3)=="display93" || $this->uri->segment(3)=="filter93") {
		         echo anchor("fun/actq02a/display93/mq002/" . (($sort_order == 'asc' && $sort_by == 'mq002') ? 'desc' : 'asc') ,'現金支出名稱');} ?>
	     ...
	     <tr class="filter">
		  ...
		  <div  class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display91" || $this->uri->segment(3)=="filter91") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter91()" /><span></span>  <?php } ?>	
             <?php  if($this->uri->segment(3)=="display92" || $this->uri->segment(3)=="filter92") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter92()" /><span></span> <?php } ?>	
			  <?php  if($this->uri->segment(3)=="display93" || $this->uri->segment(3)=="filter93") { ?>
			<input type="text" id="filter_mq002" name="filter_mq002" value="" onblur="filter93()" /><span></span> <?php } ?>	
		  ...
		  <div id="search">
		   <div class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display91" || $this->uri->segment(3)=="filter91") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter91()" /><span></span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display92" || $this->uri->segment(3)=="filter92") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter92()" /><span></span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display93" || $this->uri->segment(3)=="filter93") { ?>
			<input type="text" id="filter_mq003" name="filter_mq003" value="" onblur="filter93()" /><span></span> <?php } ?>	
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		//	var smq001 = $(this).parent().find('.smq001').val();
			...
			window.parent.addactq02a91(smq001,smq002);
		});
		...
		$('.button2').click(function() {
		  //  var smq001 = encodeURIComponent($(this).parent().find('.smq001').val());
			...
			var smq002 = $(this).parent().find('.smq002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addactq02a92(smq001,smq002);
		});
		$('.button3').click(function() {
		  //  var smq001 = encodeURIComponent($(this).parent().find('.smq001').val());
			...
			var smq002 = $(this).parent().find('.smq002').val() ;			
			window.parent.$.unblockUI();
			window.parent.addactq02a93(smq001,smq002);
		});
...
function filter91() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter91/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter91/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/actq02a/display91/';location = url;
...
function filter92() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter92/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter92/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/actq02a/display92/';location = url;
...
function filter93() {
	...
	if (filter_mq002) {
		...
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter93/mq001/asc/' + filter_mq002 ;
	} 
	
	var filter_mq003 = $('input[name=\'filter_mq003\']').val();
	if (filter_mq003) {
		url = '<?php echo base_url()?>index.php/fun/actq02a/filter93/mq002/asc/' + encodeURIComponent(filter_mq003);
	}
	
    if ( !filter_mq002  && !filter_mq003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/actq02a/display93/';location = url;
