...
//	html += '    <td class="left" ><input width="5px" type="button" value="..." style="float:left;" onclick="invq02a(this,' + product_row + ');" /></td>';
	...
	html += '    <td class="left"><input type="text"  onchange="showymd1(this,product_row)" ondblclick="scwShow(this,event);" onfocus="this.select()"  tabIndex="54" id="td013['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td013]" value="" size="10"  style="background-color:#FFFFE4"/></td>';
	html += '    <td class="center"><input type="text" tabIndex="55" onchange="startcopq02a(this,product_row)"  class="total_qty" id="td008" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td008]" value="0" size="10" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="56" id="td011" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td011]" value="0" size="10" style="text-align:right" /></td>';
    ...
    html += '    <td class="center"><input type="text" tabIndex="59" class="total_qty1" id="td030" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td030]" value="0" size="10" style="text-align:right" /></td>';	
...
<script type="text/javascript"> 	  
	...
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/invq02a/display/a.mb001/desc/0/cn00001/" allowTransparency="flase" id="invq02aifmain" name="ifmain" width="110%" height="600px" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div>
