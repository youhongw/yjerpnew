...
function showpalq01a(sText){   //不更新網頁 32 員工代號 
	...
	var oSpan = document.getElementById("palq01adisp");
     ...
     $('input[name=\'ml003\']').val(str[3]);
     $('input[name=\'ml004\']').val(str[4]);
     $('input[name=\'ml005\']').val(str[5]);
     $('input[name=\'ml006\']').val(str[6]);
     $('input[name=\'ml007\']').val(str[7]);
     $('input[name=\'ml008\']').val(str[8]);
     $('input[name=\'ml009\']').val(str[9]);
...
function startpalq01a(oInput){         //不更新網頁 32 員工代號 異動勞建保
...
//	}
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/palq01a/datapalq01a4/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
