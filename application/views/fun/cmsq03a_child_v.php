...
<script type="text/javascript">    //傳回庫別名稱
    $(document).ready(function(){
		$('.button').click(function() {
			...
			if(window.parent.addcmsq03a){
				window.parent.addcmsq03a(sma001,sma002);
			}
			if(parent.select_cmsq03a){
				parent.select_cmsq03a(sma001,sma002);
			}
		});
		...
		$('.button1').click(function() {
			...
			var sma002 = $(this).parent().find('.sma002').val();			
			window.parent.$.unblockUI();
			if(window.parent.addcmsq03a3){
				window.parent.addcmsq03a3(sma001,sma002);
			}
		});
    });
</script>
...
<script type="text/javascript"><!--
  function filter() {
	...
	if (filter_mc001) {
	   url = '<?php echo base_url()?>index.php/fun/cmsq03a/filter/mc001/asc/' + filter_mc001 ;
	} 
	
	var filter_mc002 = $('input[name=\'filter_mc002\']').val();
	if (filter_mc002) {
		url = '<?php echo base_url()?>index.php/fun/cmsq03a/filter/mc002/asc/' + encodeURIComponent(filter_mc002);
	}
    ...
    if ( !filter_mc001  && !filter_mc002 ) {         
	   url = '<?php echo base_url()?>index.php/fun/cmsq03a/display1/';location = url;
	   }
