...
<!-- 不更新網頁帶出資料 cmsq03a 庫別  -->
function showcmsq03a(sText){   //不更新網頁 
	var oSpan = document.getElementById("cmsq03adisp");
...
<!-- 不更新網頁帶出資料 cmsq03a 庫別 -->
function startcmsq03a(oInput){         //不更新網頁 
	//建立非同步請求
    
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/cmsq03a/checkcmsq03a1/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
...
function showinvq02a(sText){   //不更新網頁 6  品號  品名規格單位
	var oSpan = document.getElementById("invq02adisp");
		 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
function showinvq02a1(sText){   //不更新網頁 6  品號  品名規格單位
	var oSpan = document.getElementById("invq02a1disp");
		 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
function startinvq02a1(oInput){         //不更新網頁 6 品號
	//建立非同步請求	
   // var nn=n;
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/invq02a/checkinvqa1/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
