...
function addItem() {
    ...
    html += '    <td class="left"><input type="text"  tabIndex="5" id="mk002'+ product_row+'" ondblclick="copi02a(this,'+ product_row +');"  name="order_product[' + product_row + '][mk002]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
