...
function showinvq04a11(sText){                 //不更新網頁 31  核價單別 inv/invi0501
	var oSpan = document.getElementById("invq04a11disp");
      //   chkno1();
     //   alert('test');		
...
function startinvq04a11(oInput){            
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showinvq04a11(xmlHttp.responseText);	//顯示服務器結果
...
function showcmsq03a(sText,n){   //不更新網頁 6  庫別 下拉視窗輸入
	...
	// alert(sysma200);
	// if (num>sysma200){
	 $('input[name=\'order_product[' + n + '][tb012disp]\']').val(sText); 
}
...
function addItem() {
	...
	$('input[name=\'order_product[' + product_row + '][tb003]\'],input[name=\'order_product[' + product_row + '][tb009]\'],input[name=\'order_product[' + product_row + '][tb010]\']').focusout(function() { 
		var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
