    ...
    $('input[name=\'order_product[' + product_row + '][tm004]\']').catcomplete({
		...
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('tm004').value;
			 ...
			 if (product_row == "1" ) { smb001= $('#tm0040').val(); }
			 if (product_row == "2" ) { smb001= $('#tm0041').val(); }
			 if (product_row == "3" ) { smb001= $('#tm0042').val(); }
		     if (product_row == "4" ) { smb001= $('#tm0043').val(); }
			 if (product_row == "5" ) { smb001= $('#tm0044').val(); }
			 if (product_row == "6" ) { smb001= $('#tm0045').val(); }
			 if (product_row == "7" ) { smb001= $('#tm0046').val(); }
		     if (product_row == "8" ) { smb001= $('#tm0047').val(); }
			 if (product_row == "9" ) { smb001= $('#tm0048').val(); }
			 if (product_row == "10" ) { smb001= $('#tm0049').val(); }	
			 if (product_row == "11" ) { smb001= $('#tm00410').val(); }
			 if (product_row == "12" ) { smb001= $('#tm00411').val(); }
			 if (product_row == "13" ) { smb001= $('#tm00412').val(); }
		     if (product_row == "14" ) { smb001= $('#tm00413').val(); }
			 if (product_row == "15" ) { smb001= $('#tm00414').val(); }
			 if (product_row == "16" ) { smb001= $('#tm00415').val(); }
			 if (product_row == "17" ) { smb001= $('#tm00416').val(); }
		     if (product_row == "18" ) { smb001= $('#tm00417').val(); }
			 if (product_row == "19" ) { smb001= $('#tm00418').val(); }
			 if (product_row == "20" ) { smb001= $('#tm00419').val(); }	
             if (product_row == "21" ) { smb001= $('#tm00420').val(); }
			 if (product_row == "22" ) { smb001= $('#tm00421').val(); }
			 if (product_row == "23" ) { smb001= $('#tm00422').val(); }
		     if (product_row == "24" ) { smb001= $('#tm00423').val(); }
			 if (product_row == "25" ) { smb001= $('#tm00424').val(); }
			 if (product_row == "26" ) { smb001= $('#tm00425').val(); }
			 if (product_row == "27" ) { smb001= $('#tm00426').val(); }
		     if (product_row == "28" ) { smb001= $('#tm00427').val(); }
			 if (product_row == "29" ) { smb001= $('#tm00428').val(); }
			 if (product_row == "30" ) { smb001= $('#tm00429').val(); }	
			  if (product_row == "31" ) { smb001= $('#tm00430').val(); }
			 if (product_row == "32" ) { smb001= $('#tm00431').val(); }
			 if (product_row == "33" ) { smb001= $('#tm00432').val(); }
		     if (product_row == "34" ) { smb001= $('#tm00433').val(); }
			 if (product_row == "35" ) { smb001= $('#tm00434').val(); }
			 if (product_row == "36" ) { smb001= $('#tm00435').val(); }
			 if (product_row == "37" ) { smb001= $('#tm00436').val(); }
		     if (product_row == "38" ) { smb001= $('#tm00437').val(); }
			 if (product_row == "39" ) { smb001= $('#tm00438').val(); }
			 if (product_row == "40" ) { smb001= $('#tm00439').val(); }	
			  if (product_row == "41" ) { smb001= $('#tm00440').val(); }
			 if (product_row == "42" ) { smb001= $('#tm00441').val(); }
			 if (product_row == "43" ) { smb001= $('#tm00442').val(); }
		     if (product_row == "44" ) { smb001= $('#tm00443').val(); }
			 if (product_row == "45" ) { smb001= $('#tm00444').val(); }
			 if (product_row == "46" ) { smb001= $('#tm00445').val(); }
			 if (product_row == "47" ) { smb001= $('#tm00446').val(); }
		     if (product_row == "48" ) { smb001= $('#tm00447').val(); }
			 if (product_row == "49" ) { smb001= $('#tm00448').val(); }
			 if (product_row == "50" ) { smb001= $('#tm00449').val(); }	
