...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][td003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text"  class="total_dc" tabIndex="51" onchange="startinvq02a(this,product_row)" id="td004'+ product_row+'"   name="order_product[' + product_row + '][td004]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
