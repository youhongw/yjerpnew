...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][td003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input type="text"  onclick="scwShow(this,event);"  tabIndex="54" id="td013['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td013]" value="" size="10" class="date" style="background-color:#E7EFEF"/></td>';
	html += '    <td class="center"><input type="text" tabIndex="55" onchange="startcopq02a(this,product_row)"  class="total_qty" id="td008" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td008]" value="1" size="8" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="56" id="td011" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td011]" value="0" size="8" style="text-align:right" /></td>';
