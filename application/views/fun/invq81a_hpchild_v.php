...
<body >
	...
	<th ><?php if(@$_SESSION["hp_tc004"]) echo $_SESSION["hp_tc004"]." 購買 "; if(@$_SESSION["hp_td004"])echo $_SESSION["hp_td004"]." ── ";?>單位換算</th>
...
<script type="text/javascript">    //傳回交易公司
    $(document).ready(function(){
		$('.button').click(function() {
			...
			window.parent.addinvq81a1(smd001,smd002,smd003);
		});
    });
</script>
