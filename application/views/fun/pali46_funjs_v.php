...
<script>
 ...
 var num2=$('input[name=\'yg005\']').val();
 form.yg006.value=parseInt(num1)+parseInt(num2);
 }
 function amt2()
 {
 var num1=$('input[name=\'yg006\']').val();
 var num2=$('input[name=\'yg007\']').val();
 form.yg008.value=parseInt(num1)+parseInt(num2);
 }
</script>