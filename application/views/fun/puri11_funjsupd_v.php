...
function showchkno1(sText){   
       ...
       if  (!sText) { sText=$('input[name=\'tg014\']').val();   
...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tj003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text" class="total_dc" tabIndex="51" id="tj004'+ product_row+'"   name="order_product[' + product_row + '][tj004]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
	html += '    <td class="left"><input readonly="value"  tabIndex="52" onKeyPress="keyFunction()" type="text" id="tj005"  name="order_product[' + product_row + '][tj005]" value=""  style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input readonly="value" tabIndex="53" onKeyPress="keyFunction()" type="text" id="tj006"   name="order_product[' + product_row + '][tj006]" value=""  size="30" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input  tabIndex="54" onKeyPress="keyFunction()" ondblclick="startinvq81a();"  type="text" id="tj007"   name="order_product[' + product_row + '][tj007]" value="" size="6"  /></td>';
	html += '    <td class="left"><input  tabIndex="55" onKeyPress="keyFunction()" type="text"  id="tj003" name="order_product[' + product_row + '][tj003]" value="0" size="6" style="background-color:#EBEBE4" /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="56" id="tj011'+ product_row+'"   name="order_product[' + product_row + '][tj011]" value="" size="10" style="background-color:#E7EFEF" /></td>';	
	html += '    <td class="left"><input readonly="value" type="text"  tabIndex="57"  id="tj011disp'+ product_row+'"   name="order_product[' + product_row + '][tj011disp]" value="" size="12" style="background-color:#EBEBE4"  /></td>';

	html += '    <td class="center"><input type="text" tabIndex="59" class="total_qty" id="tj009" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj009]" value="0" size="6" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="60"  id="tj008" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj008]" value="0" size="6" style="text-align:right" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="61"   id="tj010" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj010]" value="0" size="10" style="text-align:right;background-color:#EBEBE4"" /></td>';
	 html += '    <td class="right"><input readonly="value"  tabIndex="62" type="text" class="total_price"  name="order_product[' + product_row + '][tj030]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	html += '    <td class="center"><input readonly="value" tabIndex="63" type="text"  id="tj031" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj031]" value="0" size="10" style="text-align:right;background-color:#EBEBE4"/></td>';	
    html += '    <td class="right"><input readonly="value" tabIndex="64" type="text" class="total_price1"  name="order_product[' + product_row + '][tj032]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	html += '    <td class="center"><input type="text" readonly="value" tabIndex="65"  id="tj033" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj033]" value="0" size="10" style="text-align:right;background-color:#EBEBE4" /></td>';
	
	html += '    <td class="left"><input type="text"  tabIndex="66" id="tj013" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj013]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="67" id="tj014" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj014]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="68" id="tj015" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj015]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="69" id="tj016" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj016]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="70" id="tj017" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj017]" value="" size="10"  /></td>';
	html += '    <td class="left"><input type="text"  tabIndex="71" id="tj018" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj018]" value="" size="10"  /></td>';
	html += '    <td class="left"><select id="tj035" tabIndex="72" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj035]" ><option  value="1">1.退貨</option><option value="2">2.折讓</option></select></td>'; 
	html += '    <td class="left"><input type="text" id="tj019" tabIndex="73"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj019]" value="" size="20" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
