...
<script type="text/javascript"><!--       
 function dataapp6(oInput){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
		...
		/*
		var zstr=$('input[name=\'ti006\']').val();
		if  ( zstr.length == 8) { 
		    document.form.ti006.focus(); return ti006;
		}*/
}
...
function addItem() {
  ...
  //  html += '    <td class="left"><input type="text" onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  tabIndex="8" id="tj002['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj002]" value="<?php echo date("Y/m/d"); ?>" size="10" class="date" style="background-color:#E7EFEF" /></td>';
	...
	html += 	'<td class="left"><select  tabIndex="'+ product_row +'58" id="tj013" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj013]" ><option value="1">1:標準</option><option value="2">2:輕度(25%)</option><option value="3">3:中度(50%)</option><option value="4">4:重度(100%)</option></select></td>';
	html += '    <td class="left"><input type="text" ondblclick="scwShow(this,event);"  tabIndex="'+ product_row +'59" id="tj010['+ product_row +']" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="order_product[' + product_row + '][tj010]" value="" size="10" style="background-color:#E7EFEF" /></td>';
	 html += '    <td class="left"><input type="text" tabIndex="'+ product_row +'60" id="tj011" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj011]" value="" size="30" style="text-align:left" /></td>'; 
	  html += '    <td class="left"><input type="text" tabIndex="'+ product_row +'61" id="tj012" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tj012]" value="" size="30" style="text-align:left" /></td>'; 
	html += '  </tr>';	
    html += '</tbody>';
	 
	 $('#order_product tfoot').before(html); 
	
	$('input[name=\'order_product[' + product_row + '][tj012]\']').blur(function(){
