...
//	html += '    <td class="left"><input type="text"  tabIndex="13"  name="order_product[' + product_row + '][md002]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input type="text" id="md006" tabIndex="59"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][md008]" value="0.00" size="10" style="text-align:right" /></td>';
