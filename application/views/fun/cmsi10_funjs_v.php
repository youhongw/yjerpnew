 <script type="text/javascript"> 	   //開視窗 一定要寫 04 部門ta004
...
function startkey(oInput){         //不更新網頁 key 庫別代號函數 檢查資料重複
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/cms/cmsi10/checkkey/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
...
function showcmsq05a(sText){   //不更新網頁 mf007 部門
	var oSpan = document.getElementById("cmsq05adisp");
