...
function addItem() {
    ...
    html += '    <td class="left"><input type="text" onfocus="scwShow(this,event);" onclick="scwShow(this,event);"  tabIndex="8" id="mg002['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mg002]" value="" size="10" class="date" style="background-color:#E7EFEF"/></td>';
	...
	html += '    <td class="left"><input type="text" tabIndex="9" id="mg004" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mg004]" value="" size="6" style="text-align:right" /></td>';
	html += '    <td class="left"><input type="text" tabIndex="9" id="mg005" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mg005]" value="" size="6" style="text-align:right" /></td>';
	html += '    <td class="left"><input type="text" tabIndex="9" id="mg006" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mg006]" value="" size="6" style="text-align:right" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
