          ...
          <thead>
            <tr>                          <!-- 表格表頭 -->
	          <td width="7%" class="left"> 
		        <?php echo anchor("fun/cmsq04a/display/md001/" . (($sort_order == 'asc' && $sort_by == 'md001') ? 'desc' : 'asc') ,'生產線代號'); ?>
	          </td>
	          <td width="13%" class="left"> 
		        <?php echo anchor("fun/cmsq04a/display/md002/" . (($sort_order == 'asc' && $sort_by == 'md002') ? 'desc' : 'asc') ,'生產線名稱'); ?>
              </td>
	          ...
	          <td class="left">
			   <div id="search">
		        <div  class="button-search"></div>
			       <input type="text" id="filter_md001" name="filter_md001" value="" onblur="filter1()" /><span></span>
		        </td>
	          <td class="left">
		        <div id="search">
		        <div class="button-search"></div>
			      <input type="text" id="filter_md002" name="filter_md002" value="" onblur="filter1()" /><span></span>
		        </div>			  
	          </td>	 
		     <td  align="center">&nbsp;&nbsp;</td>
            </tr>
...
<script type="text/javascript">    //傳回線別名稱
