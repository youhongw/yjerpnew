...
<script type="text/javascript"> 	   
	...
	<div id="divFinvq04a12" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/invq04a/display2" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
  function addinvq04a12(sma001,sma002) {	
	form.invq04a12.value=sma001;
	var oSpan = document.getElementById("invq04a12disp");
		oSpan.innerHTML = sma002;
	document.form.invq04a12.focus();    
	return invq04a12;	
}
//--></script>
<!-- 開視窗 cmsq05a 部門別 -->
...
<script type="text/javascript"> 	   
	...
	<div id="divFcmsq03a2" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/cmsq03a/display" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 

<script type="text/javascript"><!--
  function addcmsq03a(sta001,sta002) {
	  	  form.cmsq03a2.value=sta001;
	var oSpan = document.getElementById("cmsq03a2disp");
		oSpan.innerHTML = sta002;
	document.form.cmsq03a2.focus();    
	return cmsq03a2;
...
<script type="text/javascript"> 	   
	...
	<div id="divFcmsq03a3" style="display:none"> 	   
	<div style="float:right;"><input type="button" class="close" value="close" /></div> 	   
	<iframe src="<?php echo base_url()?>index.php/fun/cmsq03a/display1" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 

<script type="text/javascript"><!--
  function addcmsq03a3(sta001,sta002) {
	  	  form.cmsq03a3.value=sta001;
	var oSpan = document.getElementById("cmsq03a3disp");
		oSpan.innerHTML = sta002;
	document.form.cmsq03a3.focus();    
	return cmsq03a3;
...
function showinvq04a12(sText){                 //不更新網頁 31  轉撥單單別 inv/invi0801
	var oSpan = document.getElementById("invq04a12disp");
      //   chkno1();
     //   alert('test');		
 ...
 <!-- 不更新網頁帶出資料 invq04a12 單別 -->        
function startinvq04a12(oInput){            
  
	//建立非同步請求
   
	createXMLHttpRequest();
   
   	var sUrl = "<?php echo base_url()?>index.php/fun/invq04a/datainvq04a12/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showinvq04a12(xmlHttp.responseText);	//顯示服務器結果
...
<!-- 不更新網頁帶出資料 cmsq0322a 轉出庫別 -->
function showcmsq03a2(sText){   //不更新網頁 
	var oSpan = document.getElementById("cmsq03a2disp");
		 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
<!-- 不更新網頁帶出資料 轉出庫別 -->
function startcmsq03a2(oInput){         //不更新網頁 
	//建立非同步請求
    
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/cmsq03a/checkcmsq03a2/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
	...
	xmlHttp.onreadystatechange = function(){	
		...
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)	
          // alert(xmlHttp.responseText);			
		  showcmsq03a2(xmlHttp.responseText);	//顯示服務器結果		
	}
	xmlHttp.send(null);
}

<!-- 不更新網頁帶出資料 cmsq0323a 轉入庫別 -->
function showcmsq03a3(sText){   //不更新網頁 
	var oSpan = document.getElementById("cmsq03a3disp");
		 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
<!-- 不更新網頁帶出資料 轉入庫別 -->
function startcmsq03a3(oInput){         //不更新網頁 
	//建立非同步請求
    
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/fun/cmsq03a/checkcmsq03a3/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
	...
	xmlHttp.onreadystatechange = function(){	    
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)					
		  showcmsq03a3(xmlHttp.responseText);	//顯示服務器結果		
	}
	xmlHttp.send(null);
}

function showcmsq03a(sText,n){   //不更新網頁 6  庫別 下拉視窗輸入
	 var nn=n-1;
	...
	// alert(sysma200);
	 if (num>sysma200){
          $('input[name=\'order_product[' + nn + '][tb012disp]\']').val(sText); }  
}
...
function showinvq02a(sText,n){   //不更新網頁 6  品號 下拉視窗輸入 品名規格單位
	 var nn=n-1;	
	  var num = sText.length;
...
function showchkno1(sText){ 
       if  (!sText) { sText=$('input[name=\'ta014\']').val();   
...
function chkno1(oInput){  
	 var zno=$('input[name=\'invq04a12\']').val();
	 var zstr=$('input[name=\'ta014\']').val();
	...
	createXMLHttpRequest();
   	var sUrl = "<?php echo base_url()?>index.php/inv/invi08/datachkno1/" + encodeURIComponent(zno)+ "/" + encodeURIComponent(zymd)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
<script type="text/javascript"><!--       
 function selappr(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
	  var selval = document.getElementById('ta006').selectedIndex;
...
function addItem() {
    ...
    html += '    <input type="hidden" name="order_product[' + product_row + '][tb009b]" value="" />';
	html += '    <td class="left"><input type="text"  tabIndex="51" id="tb004'+ product_row+'" onchange="startinvq02a(this,product_row)"   name="order_product[' + product_row + '][tb004]" value="" size="20" style="background-color:#E7EFEF" /></td>';	
	...
	html += '    <td class="left"><input type="text"   readonly="value" tabIndex="52"  name="order_product[' + product_row + '][tb003]" value="0" size="6" style="background-color:#EBEBE4" /></td>';
	
	html += '    <td class="center"><input type="text" tabIndex="53"  class="total_qty" id="tb009" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb009]" value="0" size="10" style="text-align:right" /></td>';
	html += '    <td class="left"><input type="text" id="tb010"  tabIndex="54" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb010]" value="0" size="10" style="text-align:right"  /></td>';
	html += '    <td class="left"><input type="text" id="tb011"  tabIndex="55" class="total_price" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" value="0" size="10" style="text-align:right"  /></td>';
    html += '    <td class="left"><input type="text"  tabIndex="56" onchange="startcmsq03a(this,product_row)" id="tb012'+ product_row+'"   name="order_product[' + product_row + '][tb012]" value="" size="10"  /></td>';	
	html += '    <td class="left"><input readonly="value" type="text"  tabIndex="57"  id="tb012disp'+ product_row+'"   name="order_product[' + product_row + '][tb012disp]" value="" size="10" style="background-color:#EBEBE4"  /></td>';   
    html += '    <td class="left"><input type="text"  tabIndex="58" onchange="startcmsq03a(this,product_row)" id="tb013'+ product_row+'"   name="order_product[' + product_row + '][tb013]" value="" size="10"  /></td>';	
	html += '    <td class="left"><input readonly="value" type="text"  tabIndex="59"  id="tb013disp'+ product_row+'"   name="order_product[' + product_row + '][tb013disp]" value="" size="10" style="background-color:#EBEBE4"  /></td>'; 
	html += '    <td class="left"><input type="text" id="tb020" tabIndex="60"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb020]" value="" size="10" /></td>';
	html += '    <td class="left"><input type="text" id="tb017" tabIndex="61"  onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb017]" value="" size="20" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
	 ...
	 $('#order_product tfoot').before(html);  
	   	   ...
	   	   //下拉視窗 網頁不更新  mb001 tb004 品號品名輸入  預設轉出庫
	   //  $('input[name=\'order_product[' + product_row + '][tb012]\']').val()=document.getElementById('ta018').value;
    ...
    $('input[name=\'order_product[' + product_row + '][tb004]\']').catcomplete({
		...
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('tb004').value;
            ...
            $.ajax({  
                url: '<?php echo base_url(); ?>index.php/inv/invi08/lookup/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,  
    ...
    $('input[name=\'order_product[' + product_row + '][tb012]\']').catcomplete({
        autoFocus: true,
		delay: 0,
        minLength: 1,  		
		source: 
		function(req, add){ 	
          ...
          //  var smb001=document.getElementById('ta009').value;
			   
		
			 vtj0= product_row - 1;
		       smb001= $('#tb012'+vtj0 ).val();
			//   smb001=$("#ta004"+(product_row-1)).val();
			 
            $.ajax({  
                url: '<?php echo base_url(); ?>index.php/inv/invi08/lookupa/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,  
    ...
    $('input[name=\'order_product[' + product_row + '][tb013]\']').catcomplete({
		...
		function(req, add){ 	
            ...
            $.ajax({  
                url: '<?php echo base_url(); ?>index.php/inv/invi08/lookupb/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,  
	...
	$('input[name=\'order_product[' + product_row + '][tb009]\'],input[name=\'order_product[' + product_row + '][tb010]\']').focusout(function() { 
		var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
	...
	$('input[name=\'order_product[' + product_row + '][tb010]\']').focusout(function(){
	   // var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
		var real_value = $(this)[0].defaultValue;
		if ($(this).val()==real_value)
		    $(this).val(real_value);
	...
	//專案
	$('input[name=\'order_product[' + product_row + '][tb020]\']').blur(function(){
	 	var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
		totalSum1();
	});
	//備註,品號
...
function totalSum1() {
	...
	$(".total_qty").each(function() {
     ...
     $("#sum_tot").html(sumQty.toFixed(1));
     $("#sum_tot1").html(sumTotal.toFixed(1));
	
	form.ta011.value=Math.round(sumQty);	  //; 總數量
	form.ta012.value=Math.round(sumTotal);	  //; 總金額
