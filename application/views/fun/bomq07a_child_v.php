          ...
          <thead>
            <tr>                          <!-- 表格表頭 -->
	          <td width="7%" class="left"> 
		        <?php echo anchor("fun/bomq07a/display/mf001/" . (($sort_order == 'asc' && $sort_by == 'md001') ? 'desc' : 'asc') ,'品號'); ?>
	         <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
			 </td>
	          <td width="8%" class="left"> 
		        <?php echo anchor("fun/bomq07a/display/mb002/" . (($sort_order == 'asc' && $sort_by == 'md002') ? 'desc' : 'asc') ,'品名'); ?>
              <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
			  </td>
			    <td width="8%" class="left"> 
		        <?php echo anchor("fun/bomq07a/display/mb003/" . (($sort_order == 'asc' && $sort_by == 'md002') ? 'desc' : 'asc') ,'規格'); ?>
               <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
			  </td>
			    <td width="8%" class="left"> 
		        <?php echo anchor("fun/bomq07a/display/mf002/" . (($sort_order == 'asc' && $sort_by == 'md002') ? 'desc' : 'asc') ,'途程代號'); ?>
                 <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>             
			 </td>
			    <td width="8%" class="left"> 
		        <?php echo anchor("fun/bomq07a/display/me003/" . (($sort_order == 'asc' && $sort_by == 'md002') ? 'desc' : 'asc') ,'途程名稱'); ?>
               <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
			  </td>
	        ...
	        <tr class="filter">
	          <td class="left">
		        <div  class="button-search"></div>
			       <input type="text" id="filter_mf001" name="filter_mf001" value="" onblur="filter1()" /><span></span>
				    </div>	
		        </td>
	          <td class="left">
		        <div id="search">
			  ...
			  <td class="left">
		        <div id="search">
		        <div class="button-search"></div>
			      <input type="text" id="filter_mb003" name="filter_mb003" value="" onblur="filter1()" /><span></span>
		        </div>			  
	          </td>	 
			  <td class="left">
		        <div id="search">
		        <div class="button-search"></div>
			      <input type="text" id="filter_mf002" name="filter_mf002" value="" onblur="filter1()" /><span></span>
		        </div>			  
	          </td>	 
			  <td class="left">
		        <div id="search">
		        <div class="button-search"></div>
			      <input type="text" id="filter_me003" name="filter_me003" value="" onblur="filter1()" /><span></span>
		        </div>			  
	          </td>	 
		     <td  align="center">&nbsp;&nbsp;</td>
            </tr>
...
<script type="text/javascript">    //傳回庫別名稱
    $(document).ready(function(){
		$('.button').click(function() {
			...
			window.parent.addbomq07a(sma001,sma002);
...
<script type="text/javascript"><!--
  function filter1() {
	...
	if (filter_mf001) {
	   url = '<?php echo base_url()?>index.php/fun/bomq07a/filter1/mf001/asc/' + filter_mf001 ;
	} 
	
	var filter_mb002 = $('input[name=\'filter_mb002\']').val();
	if (filter_mb002) {
		url = '<?php echo base_url()?>index.php/fun/bomq07a/filter1/mb002/asc/' + encodeURIComponent(filter_mb002);
	}
	
	var filter_mb003 = $('input[name=\'filter_mb003\']').val();
	if (filter_mb003) {
		url = '<?php echo base_url()?>index.php/fun/bomq07a/filter1/mb003/asc/' + encodeURIComponent(filter_mb003);
	}
	
	var filter_mf002 = $('input[name=\'filter_mf002\']').val();
	if (filter_mf002) {
		url = '<?php echo base_url()?>index.php/fun/bomq07a/filter1/mf002/asc/' + encodeURIComponent(filter_mf002);
	}
	
	var filter_me003 = $('input[name=\'filter_me003\']').val();
		url = '<?php echo base_url()?>index.php/fun/bomq07a/filter1/me003/asc/' + encodeURIComponent(filter_me003);
	}
	
    if ( !filter_mf001  && !filter_mb002  && !filter_mb003  && !filter_mf002  && !filter_me003 ) {         
	   url = '<?php echo base_url()?>index.php/fun/bomq07a/display/';location = url;
	   }
