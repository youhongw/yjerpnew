...
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][td003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input readonly="value"  ondblclick="startinvq81a();"  onKeyPress="keyFunction()"   type="text" id="td009"   name="order_product[' + product_row + '][td009]" value="" size="6" /></td>';
	...
	html += '    <td class="left"><input type="text"  onchange="startcmsq03a(this,product_row)" tabIndex="23" id="td007'+ product_row+'"   name="order_product[' + product_row + '][td007]" value="" size="10" style="background-color:#E7EFEF" /></td>';	
	...
	html += '    <td class="left"><input type="text" onchange="showymd1(this,product_row)" ondblclick="scwShow(this,event);" onfocus="this.select()" tabIndex="25" id="td012['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][td012]" value="<?php echo date("Y/m/d"); ?>" size="10"  style="background-color:#E7EFEF"/></td>';
