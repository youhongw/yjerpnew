   ...
   function showadmq05a(sText,oInput){   //不更新網頁 mg004  判斷程式代號權限 
    ...
    //庫存報表 
	 ...
	 if (sText == 'Y' && oInput == 'NOTI11'){ 
	     window.location="<?php echo base_url()?>index.php/not/noti11/display";
	 } 
	  ...
	  if (sText == 'Y' && oInput == 'NOTI14'){ 
	   ...
	   if (sText == 'Y' && oInput == 'NOTI05'){ 
	    ...
	    if (sText == 'Y' && oInput == 'NOTR06'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr06/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR07'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr07/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR09'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr09/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR13'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr13/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR01'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr01/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR02'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr02/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR04'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr04/display";
	 } 
	    if (sText == 'Y' && oInput == 'NOTR20'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr20/display";
	 } 
	   if (sText == 'Y' && oInput == 'NOTR18'){ 
	     window.location="<?php echo base_url()?>index.php/not/notr18/display";
	 } 
	   if (sText == 'Y' && oInput == 'NOTB03'){ 
	     window.location="<?php echo base_url()?>index.php/not/notb03/display";
	 } 
	   if (sText == 'Y' && oInput == 'NOTB04'){ 
	     window.location="<?php echo base_url()?>index.php/not/notb04/display";
	 } 
	 //人事系統
