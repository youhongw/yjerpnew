...
//--></script>
	...
	$('input[name=\'order_product['  + vrow +  '][tb007]\'],input[name=\'order_product['  + vrow +  '][tb009]\']').focusout(function() { 
	 var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
	...
	$('input[name=\'order_product[' + vrow + '][tb007]\']').focus(function(){
		...
		if ($(this).val()==real_value)
		    $(this).val(real_value);
		document.getElementById('tb007').select();
	});
	...
	$('input[name=\'order_product[' + vrow + '][tb009]\']').focus(function(){
		...
		if ($(this).val()==real_value)
		    $(this).val(real_value);
		document.getElementById('tb009').select();
	});
	   //金額  
	...
	$('input[name=\'order_product[' + vrow + '][tb018]\']').blur(function(){
	    totalSum1();
	});
	
	$('input[name=\'order_product['  + vrow + '][tb012]\']').blur(function(){
