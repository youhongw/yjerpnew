...
//	html += '    <td class="left"><input type="text"  tabIndex="13"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input readonly="value"   onKeyPress="keyFunction()"   type="text" id="tk006disp"   name="order_product[' + product_row + '][tk006disp]" value="" size="6" /></td>';
	...
	html += '    <td class="center"><input type="text" tabIndex="54"  class="total_qty" id="tk007" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tk007]" value="0" size="12" style="text-align:right" /></td>';
