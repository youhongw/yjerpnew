...
function addItem() {
    ...
    html += '    <input type="hidden" name="order_product[' + product_row + '][tj008a]" value="0" />';		
//	html += '    <td class="left"><input type="text"  tabIndex="20"  name="order_product[' + product_row + '][tj003]" value="0" size="6" /></td>';
	html += '    <td class="left"><input type="text"  class="total_dc" tabIndex="61" onchange="startinvq02a(this,product_row)" id="tj004'+ product_row+'"   name="order_product[' + product_row + '][tj004]" value="" size="20" style="background-color:#E7EFEF"  /></td>';	
