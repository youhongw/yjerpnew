<script type="text/javascript"> 	   //開視窗  品號類別 1 會計 invi02
	...
	<iframe src="<?php echo base_url()?>index.php/fun/invq02a/display" allowTransparency="true" name="ifmain" width="620" height="460" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 	  
<script type="text/javascript"><!--
  function addinvq02a(sma001,sma002,sma003,sma004) {	
	...
	var oSpan = document.getElementById("invq02adisp");
		oSpan.innerHTML = sma002+sma003+sma004;
	document.form.invq02a.focus();    
	return invq02a;	
}
//--></script>

 <script type="text/javascript"> 	   //開視窗 一定要寫 04 庫別ta004
	$(document).ready(function(){ 	   
...
function showinvq02a(sText){   //不更新網頁 6  品號
	var oSpan = document.getElementById("invq02adisp");
		 oSpan.innerHTML = "<span style='color:black'>"+sText+"</span>"; 	
	 if (!sText) { 
	    oSpan.innerHTML = "<span style='color:red'>無此資料!</span>"; 	
...
function startinvq02a(oInput){         //不更新網頁 6 品號
...
<script type="text/javascript"><!--       
 function dataymd(oInput){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
		   ...
		   document.form.te1002.value=oInput.value.substring(0,4)+'/'+oInput.value.substring(4,6)+'/'+oInput.value.substring(6,8); 
		   var zstr=$('input[name=\'te1002\']').val();
		 //  alert(zstr.length
		if  ( zstr.length == 8) { 
		    document.form.te1002.focus(); return te1002;}	
}
