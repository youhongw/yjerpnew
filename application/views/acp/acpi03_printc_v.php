...
<link href="<?php echo base_url()?>assets/image/icon.png" rel="icon" />
 ...
 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/acp/acpi03/printdetailc';location = url; </script> 
  <?php exit;} ?>
  <!--   頁直行數  -->
 <?php $paper9="1"; ?> 
	 ...
	 <!-- 開始列印 -->		
		...
		<table class="store">
		 <tr>
			...
			<tr><td class="title" align="center" valign="top">付  款  單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>付款單別：</b><span><?php echo $results[0]->tc001 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>付款單號：</b><?php echo $results[0]->tc002 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
					  ...
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>付款日期：</b><span><?php echo $results[0]->tc003 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>供應廠商</b><span><?php echo $results[0]->tc004 ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  ...
					  <td align="left"><? echo $val->td004;?><br><? echo $val->td005;?></td>
					...
					<tr>
					  ...
					  <?php if ($totle_page == $page  ) { ?>
						<b>本幣借方金額：<?php echo $results[0]->tc013 ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;本幣貸方金額 ：<?php echo $results[0]->tc014 ?></b> <?php echo '';} ?> 
