...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 付款單資料建立作業 - 查看　　　</h1>
	  <a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('acp/acpi03/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/acp/acpi03/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="24%"><input tabIndex="1" id="tc001"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startacpq01a73(this)"  name="acpq01a73" value="<?php echo strtoupper($acpq01a73); ?>"  type="text" required disabled="disabled" /><a href="javascript:;"><img id="Showacpq01a73" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="acpq01a73disp"> <?php    echo $acpq01a73disp; ?> </span></td>
	    <td class="normal14y" width="8%" >單據日期： </td>
        <td class="normal14a"  width="26%" ><input tabIndex="2"  onclick="scwShow(this,event);"  class="date" id="tc016" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="tc016"  value="<?php echo $tc016; ?>"  size="12" type="text"  disabled="disabled" /></td>
		<td class="start14a" width="8%" ><span class="required">付款單號：</span> </td>
        <td class="normal14a"  width="26%" ><input tabIndex="3" id="tc002" onKeyPress="keyFunction()" onfocus="chkno1(this)" name="tc002" value="<?php echo $tc002; ?>" size="20" type="text" required disabled="disabled" /><span id="tc002disp" ></span></td>
	  </tr>	
	  <tr>
	    
		 <td class="normal14z">供應廠商：</td>
        <td  class="normal14"  ><input tabIndex="4" id="tc004" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startpurq01a(this)" name="purq01a" value="<?php echo $purq01a; ?>" size="10" type="text" disabled="disabled" /><a href="javascript:;"><img id="Showpurq01a" src="<?php echo base_url()?>assets/image/png/factory.png" alt="" align="top"/></a>
	   ...
	   <span id="cmsq02adisp"> <?php    echo $cmsq02adisp; ?> </span></td>
        ...
        <td  class="normal14"  ><select id="tc008" onKeyPress="keyFunction()" name="tc008"  onchange="selappr(this)" tabIndex="8" disabled="disabled">
        ...
        <td  class="normal14"  ><input type="text" tabIndex="10"  readonly="value"  onKeyPress="keyFunction()" id="tc006" name="tc006" size="5"  value="<?php echo $tc006; ?>" style="background-color:#EBEBE4" disabled="disabled" /></td>
	  </tr>
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="12" id="tc017" readonly="value" onKeyPress="keyFunction()"  name="tc017" value="<?php echo $tc017; ?>" size="10" type="text" style="background-color:#EBEBE4" disabled="disabled" /></td>
  
		 <td class="normal14z">簽核狀態：</td>
        <td  class="normal14"  ><select id="tc018" tabIndex="12" readonly="value" onKeyPress="keyFunction()" name="tc018"   style="background-color:#EBEBE4" disabled="disabled" >
        ...
        <td class="normal14" ><input tabIndex="13" id="tc003" readonly="value"  onKeyPress="keyFunction()"  name="tc003" value="<?php echo $tc003; ?>" size="12" type="text" style="background-color:#EBEBE4" disabled="disabled" /></td>
	...
	<div class="abgne_tab"> <!-- div-7 -->
	  ...
	  <!--   <td class="left"><input type="text"   readonly="value"   name="order_product[$i][td003]" value="<?php echo $td003[$i]; ?>" size="6" style="background-color:#EBEBE4" /></td>  -->
		 ...
		 <td class="center"><input type="text"   id="td008disp" onKeyPress="keyFunction()" name="order_product[<?php echo $i ?>][td008disp]" value="<?php echo $td008disp[$i]; ?>" size="8" style="text-align:right;background-color:#E7EFEF;"  disabled="disabled"/></td>
