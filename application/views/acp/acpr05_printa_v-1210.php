    <?php php $numrow1 =1; $numrow2 =1;$th013a=0;$tg044a=0;$vtax=0;  ?>
	<?php php   $ta004key ='';$vfirst=0;$row1=0;  ?>   
	...
	<table class="store">    <!-- 跳頁用 a4橫式--> <!-- 跳頁用 1.a4橫式 2.Letter -->
	  <!-- <tr><td align="center"><?php php echo $br ; ?><?php php echo $this->session->userdata('sysml003'); ?></td></tr> -->
	   ...
	   <br><tr> <td align="left">帳款期間:&nbsp;<?php php echo $dateo.' 至 '.$datec; ?>
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   <?php php echo $this->session->userdata('sysml003'); ?></td></tr>
		  ...
		  {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";} ?>		    
			...
			應付帳款明細表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<?php php if($paper9=="1")  {echo "&nbsp;";} else {echo "&nbsp;";} ?>頁次:&nbsp;<?php php echo $page ?></td>
           </tr>
	</table>
	...
	<table >    <!-- 列表頭 -->
	  <tr>
	    <td width="8%" align="left">廠商代號: <?php php echo $ta004k; ?></td>
		<td width="3%" align="left">　部門: <?php php echo $tb021k ?></td>
      </tr>
	   <tr>
	    <td width="8%" align="left">廠商電話: <?php php echo $ma006k ?></td>
		<td width="3%" align="left">　廠商傳真: <?php php echo $ma008k ?></td>
      </tr>
	   <tr>
	    <td width="8%" align="left">聯絡地址: <?php php echo $ma027k ?></td>
      </tr>
	</table>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31  廠商key-->
	   ...
	   <?php php foreach($results as $row ) : ?>
	      ...
	      <?php php if($row->ta004 != $ta004key and $vfirst == 1 ) {?>  
               <table >
			<tr>
			 <td width="300" align="left"><b>本期應付：<?php php echo round($th013a) ?></b></td>
			  <td width="300" align="left"><b>本期稅額：<?php php echo round($th013a*$tg044a) ?></b></td>
			  <td width="300" align="left"><b>合計應付：<?php php echo round($th013a+($th013a*$tg044a)) ?></b></td> 			
			  
			</tr>
			<?php php $th013a=0;$tg044a=0;$vtax=0; ?>
	 </table>         
	...
	<table >    <!-- 列表頭 -->
	  <tr>
	    <td width="8%" align="left">廠商代號: <?php php echo $row->ta004.$row->ta004disp; ?></td>
		<td width="3%" align="left">　部門: <?php php echo $tb021k ?></td>
      </tr>
	   <tr>
	    <td width="8%" align="left">廠商電話: <?php php echo $ma006k ?></td>
    ...
    <table class="list">
	    ...
	    <td width="8%" align="center"><?php  echo $row->ta015;?></td>
		<?php  if ($row->tb004=='1') {$tb004v='1:進貨';} else if ($row->tb004=='2') {$tb004v='2:退出';} else {$tb004v='9:其他';} ?>
		<td width="8%" align="center"><?php  echo $tb004v;?></td>
		<td width="8%" align="center"><?php  echo $row->tg003;?></td>
		<td width="8%" align="center"><?php  echo $row->tg002;?></td>		
		<td width="44%" align="left"><?php  if ($row->th005!='') {  echo wordwrap($row->th005,75,"<br />\n",TRUE);} else {echo "_";}?><br>
		<?php   if ($row->th006!='') {echo wordwrap($row->th006,75,"<br />\n",TRUE);}  else {echo "_";} ?></td>
		<td width="8%" align="right"><?php  echo $row->th016;?></td>	
        <td width="8%" align="right"><?php  echo $row->th018;?></td>		
        <td width="8%" align="right"><?php  echo $row->th019;?></td> 
       		
        </tr>		
		 <?php php $pagenum +=2;$prow=1;$pagenum1=$pagenum;$th013a=$th013a+$row->th019;$tg044a=$row->tg044; ?> 
		   <!-- 1041209 -->		
