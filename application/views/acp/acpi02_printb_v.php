...
foreach($results as $key=>$value){
	...
	$pur_date = substr($value->ta034,0,4).'/'.substr($value->ta034,4,2).'/'.substr($value->ta034,6,2);
}
$totle_page = $page;
	 ...
	 <!-- 開始列印 -->		
		...
		<table class="store">
		 <tr>
			...
			<tr><td class="title" align="center" valign="top">應付憑單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $results[0]->ta034 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>                                      
							  <td width="600" align="left" valign="top"><b>備註：</b><?php echo $results[0]->ta021 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>供應廠商</b><span><?php echo $results[0]->ta004 ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>營業稅率</b><span><?php echo $results[0]->ta036 ?></span></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>付款條件：</b><?php echo $results[0]->ta039 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					<tr class="heading">
					  <td align="center" width="10%"><b>憑證單別</b><br><b>憑證單號</b></td>
					  <td align="center" width="10%"><b>來源</b><br><b>憑證日期</b></td>
					  <td align="right" width="10%"><b>科目代號</b><br><b>科目名稱</b></td>
					  <td align="right" width="8%"><b>應付金額</b><br><b>差    額</b></td>
					...
					<tr>					 
					  ...
					  <td align="right"><? echo $val->tb013;?><br><? echo $val->tb013disp;?></td>
					...
					<tr>
					  ...
					  <?php if ($totle_page == $page  ) { ?>
						<b>應付金額：<?php echo $results[0]->ta028 ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;稅額：<?php echo $results[0]->ta029 ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;已付金額：<?php echo $results[0]->ta030 ?></b> <?php echo '';} ?> 
					
					<?php if ($totle_page > $page ) { ?>
                           <b>應付金額：<?php echo '' ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;稅額：<?php echo '' ?></b>
						<b>&nbsp;&nbsp;&nbsp;&nbsp;已付金額：<?php echo '' ?></b> 
					         <?php echo '續下頁..';} ?> 
					</td>
					</tr>
