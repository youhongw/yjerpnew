		<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/acp/acpi03/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="list">     <!-- 列明細 -->
        ...
        <td width="6%" align="left"><?php echo  $val->td004;?></td>	
        <td width="6%" align="left"><?php echo  $val->td005;?></td>	
        <td width="8%" align="left"><?php echo  $val->td006;?></td>	
        <td width="10%" align="left"><?php echo  $val->td007;?></td>	
        <td width="8%" align="right"><?php echo  $val->td009;?></td>	
