...
?>       
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php $i=1; ?>
	      ...
	      <tr>
	    <td width="20%" align="left"><?php  echo $val->ta004;?><br><?php  echo $val->ta004disp;?></td>
		<td width="10%" align="left"><?php  echo $val->yymm;?></td>
		<td width="10%" align="right"><?php  echo $val->ma025;?></td>	
        <td width="10%" align="right"><?php  echo $val->ta008;?></td>		
        <td width="10%" align="right"><?php  echo round($val->amt);?></td> 
       		
        </tr>		
		 <?php // $pagenum +=2;$prow=1;$pagenum1=$pagenum;$ta031a=$ta031a+$row->amt; ?> 
	      <?php $rownum++;$rownum1++;$vqty=$vqty+round($val->amt);$i++; ?>			
		   	...
		   	<?php if (($totle_page == $page) and ($totle_page==1) and  ($rownum1 <=$vaa ) )  { ?>
	                ...
	                <tr>
					  <td colspan="5" align="right">
						...
						<b>合計未付金額：</b> <?php if ($tprint=='Y') { echo $vqty;} ?>
						  <?php echo '';} ?> 
						<?php if ($totle_page > $page ) { ?>
						<b>合計未付金額：</b> <?php if ($tprint=='Y') { echo '　　　　　　';} ?>  <?php echo '續下頁..';} ?> 
