...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 付款單資料建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/acp/acpi03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TC001'> TC001 付款單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TC002'> TC002 付款單號 </option>
		    ...
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TC008'> TC024 確認碼 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TC017'> TC007 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TC001'> TC001 付款單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TC002'> TC002 付款單號 </option>
		    ...
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TC017'> TC017 備註 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/acp/acpi03/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
