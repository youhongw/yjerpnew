...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 廠商未付款統計表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/acp/acpr12/printa"  method="post"  enctype="multipart/form-data" > 
	...
	//  if(!isset($datec)) { $datec=date("Y/m/d"); }
	  if(!isset($dateo)) { $dateo=$this->input->post('dateo'); }
	  if(!isset($datec)) { $datec=date("Y/m/d"); }
	...
	<table class="form14">   <!-- 表格 -->
     <tr>
	    <td class="normal14y" width="12%">起始廠商代號：</td>
	    <td class="normal14a" width="38%"><input tabIndex="4" id="purq01a" onKeyPress="keyFunction()"  onchange="startpurq01a(this)" name="purq01a" value="<?php echo $purq01a; ?>"  type="text"  /><img id="Showpurq01a" src="<?php echo base_url()?>assets/image/png/factory.png" alt="" align="top"/></a>
        <span id="purq01adisp"> <?php   echo $purq01adisp; ?> </span></td>
        <td class="normal14y" width="12%">結束廠商代號：</td>
		<td class="normal14a" width="38%"><input tabIndex="4" id="purq01a1" onKeyPress="keyFunction()"  onchange="startpurq01a1(this)" name="purq01a1" value="<?php echo $purq01a1; ?>"  type="text"  /><img id="Showpurq01a1" src="<?php echo base_url()?>assets/image/png/factory.png" alt="" align="top"/></a>
        <span id="purq01a1disp"> <?php   echo $purq01a1disp; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始帳款日期：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo"  onKeyPress="keyFunction()" type="text" name="dateo" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd(this)" value="<?php echo $dateo; ?>"  size="20" /></td>
        <td class="normal14z" >結束帳款日期：</td>
	    <td class="normal14" ><input tabIndex="4" id="datec"   onKeyPress="keyFunction()" type="text" name="datec" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dataymd1(this)" value="<?php echo $datec; ?>"  size="20" /></td>
	  </tr>
	   <tr>
	    <td class="normal14z" >幣別：</td>
	    <td class="normal14" ><input tabIndex="14" id="ta008" onKeyPress="keyFunction()" name="cmsq06a" onchange="startcmsq06a(this)"  value="<?php echo $cmsq06a; ?>"  type="text"   /><a href="javascript:;"><img id="Showcmsq06a" src="<?php echo base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
