<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/acp/acpi03/clear_sql_term'"  style="float:left" accesskey="d" class="button"><span>清除查詢條件 d </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/acp/acpi03/addform'" style="float:left" accesskey="+" class="button"><span>新增</span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
      ...
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/acp/acpi03/findform'" style="float:left" accesskey="k" class="button"><span>進階查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/acp/acpi03/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
	      ...
	      <td width="5%" class="left">
		  <?php echo anchor("acp/acpi03/display/tc0104disp/".(($sort_order == 'asc' && $sort_by == 'tc004disp') ? 'desc' : 'asc') ,'廠商名稱'); ?>
		  <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		          <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	      <td width="5%" class="left">
	     ...
	     <tr class="filter">
		  ...
		  <td width="5%" align="left">
		  <div class="button-search"></div>
		  <input type="text" name="filter_tc012" size="8" value="" />
		  </td>
...
function filter() {
	...
	if (filter_tc004disp) {
		url = '<?php echo base_url() ?>index.php/acp/acpi03/filter1/tc004disp/desc/' + encodeURIComponent(filter_tc004disp); 
	}
...
function filtera() {
	...
	var filter_tc004disp = $('input[name=\'filter_tc004disp\']').val();
	if (filter_tc004disp) {
		url = '<?php echo base_url() ?>index.php/acp/acpi03/filter1/tc004disp/asc/' + encodeURIComponent(filter_tc004disp);
