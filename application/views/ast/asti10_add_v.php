...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產調整建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ast/asti10/addsave" >	
	<?php       
      // 頭部表格  isset 檢查變數 存檔後可保留值
	  if(!isset($tc001)) { $tc001=$this->input->post('asti03_asti10'); }
	  ...
	  if(!isset($tc001disp)) { $tc001disp=$this->input->post('asti03_asti10disp'); }
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td  class="normal14a" width="25%"><input tabIndex="1" id="asti03_asti10" class="asti03_asti10" onKeyPress="keyFunction()" onfocus="check_title_no();"  onchange="check_asti03_asti10(this);check_title_no();" name="asti03_asti10" value="<?php echo $tc001; ?>" size="12" type="text" required />
	 ...
	 <div class="buttons">
	   ...
	   <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ast/asti10/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 </div> 
   </div> 	<!-- end 頁標籤 -->   
   </form>
	   <?php	if ($message!=' ') { ?>
