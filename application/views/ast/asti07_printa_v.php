<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/asti07/printdetail';location = url; </script> 
<?php exit;} ?>
  <!--   頁直行數44 橫行28  -->
...
?>    	
	...
	<table class="store">    <!-- 跳頁用 --> <!-- 跳頁用 1.a4橫式 2.Letter -->
	   ...
	   <tr>
			...
			<td align="center"><?php if($paper9=="1"){echo "";} else {echo "";} ?>資產重估明細表</td>
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
		...
		<td width="50%" align="left" style="border-left:0px">重估差價：<?php echo $tc006; ?></td>
	  </tr>
	  
	  <tr>
		<td align="left" style="border-right:0px">單號：<?php echo $tc002; ?></td>
		<td align="left" style="border-left:0px">增減殘值：<?php echo $tc010; ?></font></td>
	  </tr>
	  
	  <tr>
		<td align="left" style="border-right:0px">單據日期：<?php echo $tc027; ?></td>
		<td align="left" style="border-left:0px">備註：<?php echo $tc013; ?></td>
	  </tr>
