...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產報廢建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ast/asti08/addsave" >	
	<?php       
      // 頭部表格  isset 檢查變數 存檔後可保留值
	  if(!isset($tc001)) { $tc001=$this->input->post('asti03_asti08'); }
	  ...
	  if(!isset($tc001disp)) { $tc001disp=$this->input->post('asti03_asti08disp'); }
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td  class="normal14a" width="25%" ><input tabIndex="1" id="asti03_asti08" onKeyPress="keyFunction()" onfocus="check_title_no();"  onchange="check_asti03_asti08(this);check_title_no();" name="asti03_asti08" value="<?php echo $tc001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="24%" ><input tabIndex="4" id="tc005" onKeyPress="keyFunction()" onfocus="change_asti08_tc005();" onchange="change_asti08_tc005();" name="tc005" value="<?php echo $tc005; ?>" size="12" type="text" /></td>
	  ...
	  <tr>	    
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="2" onfocus="this.select" ondblclick="scwShow(this,event);"   id="tc027" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="tc027"  value="<?php echo $tc027; ?>"  size="12" type="text" style="background-color:#FFFFE4"  />
	  ...
	  <tr>
        ...
        <td class="normal14a"><input tabIndex="" id="tc002" onKeyPress="keyFunction()" readonly="value" name="tc002" onfocus="check_title_no();" value="<?php echo $tc002; ?>" size="12" type="text"  required /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="3" id="asti02" onKeyPress="keyFunction()"  onchange="check_asti02(this);" onblur="change_asti08_tc005();" name="asti02" value="<?php echo $tc004; ?>" size="12" type="text" required />
	  ...
	  <tr>
        ...
        <td  class="normal14"><input tabIndex="8" id="tc010" onKeyPress="keyFunction()"  onchange="" name="tc010"  value="<?php echo $tc010; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
		...
		<input tabIndex="9" id="tc025" onKeyPress="keyFunction()" name="tc025" <?php if($tc025 == 'Y' ) echo 'checked'; ?>  <?php if($tc025 !== 'Y' ) echo 'check'; ?> value="Y" size="1" type='checkbox'  /></td>		
        
		<td class="normal14">產生分錄：</td>
        <td class="normal14"><input type="hidden" name="tc031" value="N" />
		<input tabIndex="10" id="tc031" onKeyPress="keyFunction()" name="tc031" <?php if($tc031 == 'Y' ) echo 'checked'; ?>  <?php if($tc025 !== 'Y' ) echo 'check'; ?> value="Y" size="1" type='checkbox'  /></td>		
	  </tr>
	 ...
	 <div class="buttons">
	   ...
	   <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ast/asti08/display'); ?>" class="button" ><span>返 回Alt+x </span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 </div> 
   </div> 	<!-- end 頁標籤 -->   
   </form>
	   <?php	if ($message!=' ') { ?>
