...
<div class="box2"> <!-- div-1 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產報廢圖表 - 瀏覽</h1>
	   <div style="float:right; "> 
	      <a onclick="location = '<?php echo base_url()?>index.php/ast/asti08/display_search'"  style="float:left" accesskey="x" class="button"><span>退出</span><img src="<?php echo base_url()?>assets/image/png/close.png" /></a> 
      </div>
    </div>  <!--end heading -->
