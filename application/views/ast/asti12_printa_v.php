<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/asti12/printdetail';location = url; </script> 
		  <?php exit;} ?>
<!--   頁直行數  -->
	  ...
	  <?php  $rownum=$vbb;$rownum1=0;$rownum2=$vaa;  ?>
		 <?php foreach($page_data[$key] as $k=>$val){?>
	      <tr>
		    ...
		    <td width="12%" align="left"><?php echo  $val->tf003;?></td>
            <td width="10%" align="left"><?php echo  $val->asti02_mb002;?></td>
			<td width="12%" align="left"><?php echo  $val->asti02_mb003;?></td>
            <td width="8%" align="left"><?php echo  $val->asti02_asti12_mc002disp;?></td>
            <td width="10%" align="left"><?php echo  $val->asti02_asti12_mc003disp;?></td>
            <td width="8%" align="right"><?php echo  $val->tf006;?></td>
		<!--    <td width="10%" align="right"><?php// echo  $val->puri01_ma002;?></td>	-->	
			<td width="8%" align="right"><?php echo  $val->tf008;?></td>			
         </tr>
	  <?php $rownum++;$rownum1++; ?>
