...
foreach($results as $key=>$value){
	...
	$pur_date =stringtodate("Y/m/d",$value->te008);
}
$totle_page = $page;
	...
	<!-- 開始列印 -->
		<table class="store">
		  ...
		  <tr>
			...
			<tr><td class="title" align="center" valign="top">資 產 收 回 單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>單別：</b><span><?php echo $results[0]->te001.'&nbsp&nbsp&nbsp'.$results[0]->te001disp ?></span></td>
					  ...
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>單號：</b><span><?php echo $results[0]->te002 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $results[0]->te008 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					<tr class="heading">
					  <td align="left"  width="15%"><b>外送單別</b></br><b>外送單號</b></td>
					  <td align="left"  width="15%"><b>資產編號</b></td>
					  <td align="left"  width="15%"><b>資產名稱</b></td>
					  <td align="left"  width="15%"><b>規格</b></td>
					  <td align="left"  width="10%"><b>部門名稱</b></td>
					  <td align="left"  width="10%"><b>人員名稱</b></td>
					  <td align="right" width="10%"><b>未收回量</b></td>
					...
					<tr>					 
					  <td align="left"><? echo $val->th003;?></br><? echo $val->th004;?></td>
					  <td align="left"><? echo $val->th005;?></td>
					  <td align="left"><? echo $val->th005_mb002;?></td>
					  <td align="left"><? echo $val->th005_mb003;?></td>
					  <td align="left"><? echo $val->th006disp;?></td>
					  <td align="left"><? echo $val->th007_mv002;?></td>
					  <td align="right"><? echo $val->th008;?></td>
			    	  <td align="right"><? echo $val->th009;?></td>
					</tr>
					   <?php $rownum++;$rownum1++; ?>
