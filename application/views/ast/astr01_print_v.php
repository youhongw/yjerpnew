...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 財產目錄明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/astr01/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <td class="normal14a" ><input tabIndex="1" id="dateo" ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF" /></td>
      
	  </tr>
	  <tr>
	    <td class="start14a" >截止日期：</td>
	    <td class="normal14a"><input tabIndex="1" id="datec" ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="datec"  value="<?php echo $datec; ?>"  size="20" style="background-color:#E7EFEF" /></td>
      
	  </tr>
	   
	  <tr>
	    <td class="normal14" >折舊方法：</td>
	    <td class="normal14" ><select id="tc001o" onKeyPress="keyFunction()" name="tc003o"  tabIndex="4">
            <option <?php if($tc003o == '3') echo 'selected="selected"';?> value='3'>3.全部</option>  
            <option <?php if($tc003o == '0') echo 'selected="selected"';?> value='0'>0.不提折舊</option> 			
		    <option <?php if($tc003o == '1') echo 'selected="selected"';?> value='1'>1.平均法</option>
			<option <?php if($tc003o == '2') echo 'selected="selected"';?> value='2'>2.定率遞減法</option>
		  </select></td>
	  </tr>	
