...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產調整建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/asti10/updsave" method="post" enctype="multipart/form-data" >
	<div id="tab-general"> <!-- div-6 -->
	
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
	    <td class="normal14a" width="8%"><span class="required">單別：</span></td>
        <td  class="normal14a" width="25%"><input tabIndex="1" id="asti03_asti10" onKeyPress="keyFunction()"  onchange="check_title_no();" name="asti03_asti10" value="<?php echo $tc001; ?>" size="12"  readonly="value" type="text" required />
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="4" id="tc005" onKeyPress="keyFunction()" onfocus="change_asti10_tc005();" onchange="change_asti10_tc005();" name="tc005" value="<?php echo $tc005; ?>" size="12" type="text" /></td>
	    
		<td class="normal14a" width="8%">產生分錄：</td>
        <td class="normal14a" width="25%"><input type="hidden" name="tc031" value="N" />
	  ...
	  <tr>
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tc027" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="tc027"  value="<?php echo $tc027; ?>"  size="12" type="text" style="background-color:#FFFFE4"  />
        ...
        <td class="normal14a"  ><input type="text" tabIndex="17" onKeyPress="keyFunction()" id="tc009" name="tc009" value="<?php echo $tc009; ?>" size="12" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="3" id="asti02" onKeyPress="keyFunction()"  onchange="check_asti02(this);" onblur="change_asti10_tc005();" name="asti02" value="<?php echo $tc004; ?>" size="12" type="text" required style="background-color:#FFFFE4" />
        ...
        <td class="normal14a"><input tabIndex="5" id="tc006" onKeyPress="keyFunction()"  onchange="" name="tc006"  value="<?php echo $tc006; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"><input tabIndex="6" id="tc007" onKeyPress="keyFunction()"  onchange="" name="tc007"  value="<?php echo $tc007; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"><input tabIndex="7" id="tc008" onKeyPress="keyFunction()"  onchange="" name="tc008"  value="<?php echo $tc008; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"><input tabIndex="8" id="tc010" onKeyPress="keyFunction()"  onchange="" name="tc010"  value="<?php echo $tc010; ?>"  size="12" type="text" />
		<a href="javascript:;"><img id="Showtc010disp" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top" ondblclick="change_asti10_tc005();"  /></a>
        <span id="tc010disp"> </span></td>
	  ...
	  <a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ast/asti10/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  <?php if(isset($prev)){ 
			$prev_str = "";$prev_ary = explode('_',$prev);foreach($prev_ary as $k=>$v){if($prev_str){$prev_str.="/";}$prev_str.=$v;}
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('ast/asti10/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('ast/asti10/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>	
	  </div> 
	  </div> <!-- div-加 -->
    </form>  <!-- end 表單 -->
...
<form action="<?php echo base_url()?>index.php/ast/asti10/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
...
<?php  include_once("./application/views/funnew/asti10_fundjs_v.php"); ?>  <!-- 明細開視窗 --> 
