...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產出售建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ast/asti09/addsave" >	
	<?php       
      // 頭部表格  isset 檢查變數 存檔後可保留值
	  if(!isset($tc001)) { $tc001=$this->input->post('asti03_asti09'); }
	  if(!isset($tc001disp)) { $tc001disp=$this->input->post('asti03_asti09disp'); }
	  if(!isset($tc002)) { $tc002=$this->input->post('tc002'); }
	  if(!isset($tc004)) { $tc004=$this->input->post('asti02'); }
	  if(!isset($tc005)) { $tc005='0'; }
	  if(!isset($tc006)) { $tc006='0'; }
	  if(!isset($tc007)) { $tc007='0'; }
	  if(!isset($tc004disp)) { $tc004disp=$this->input->post('asti02disp'); }
	  if(!isset($tc004disp2)) { $tc004disp2=$this->input->post('asti02disp2'); }
	  if(!isset($tc004disp3)) { $tc004disp3=$this->input->post('asti02disp3'); }
	  if(!isset($tc008)) { $tc008='0'; }
	  if(!isset($tc010)) { $tc010='0'; }
	  if(!isset($tc011)) { $tc011=$this->input->post('tc011'); }
	  if(!isset($tc012)) { $tc012=$this->input->post('tc012'); }
	  if(!isset($tc013)) { $tc013=$this->input->post('tc013'); }
	  if(!isset($tc016)) { $tc016='0'; }
	  if(!isset($tc017)) { $tc017=$this->input->post('tc017'); }
	  if(!isset($tc017disp)) { $tc017disp=$this->input->post('tc017disp'); }
	  if(!isset($tc019)) { $tc019=$this->input->post('tc019'); }
	  if(!isset($tc019disp)) { $tc019disp=$this->input->post('tc019disp'); }
	  if(!isset($tc020)) { $tc020=$this->input->post('exchage_rate'); }
	  if(!isset($tc021)) { $tc021=$this->input->post('tc021'); }
	  if(!isset($tc022)) { $tc022='0'; }
	  if(!isset($tc023)) { $tc023=$this->input->post('tc023'); }
	  if(!isset($tc024)) { $tc024=$this->input->post('tc024'); }
	  if(!isset($tc025)) { $tc025=$this->input->post('tc025'); }
	  if(!isset($tc031)) { $tc031=$this->input->post('tc031'); }
	  if(!isset($exchange_tc021)) { $exchange_tc021=$this->input->post('exchange_tc021'); }
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="normal14a" width="8%"><span class="required">單別：</span></td>
        <td  class="normal14a" width="25%" ><input tabIndex="1" id="asti03_asti09" onKeyPress="keyFunction()" onfocus="check_title_no();"  onchange="check_asti03_asti09(this);check_title_no();" name="asti03_asti09" value="<?php echo $tc001; ?>" size="12" type="text" required />
		<a href="javascript:;"><img id="Showasti03_asti09disp" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="asti03_asti09disp"> <?php   echo $tc001disp; ?> </span></td>
		  
		  
	    <td class="normal14a" width="10%" >客戶代號：</td>  
        <td  class="normal14a" width="23%" ><input tabIndex="1" id="copi01" onKeyPress="keyFunction()" onfocus=""  onchange="check_copi01(this);" name="copi01" value="<?php echo $tc017; ?>" size="12" type="text" required style="background-color:#FFFFE4" />
	  ...
	  <tr>	    
        ...
        <td class="normal14a"><input tabIndex="3" id="tc002" onKeyPress="keyFunction()" readonly="value" name="tc002" onfocus="check_title_no();" value="<?php echo $tc002; ?>" size="12" type="text" required /></td>
	    
		<td class="normal14a">客戶簡稱：</td>
        <td class="normal14a"><input tabIndex="2" id="copi01disp" onKeyPress="keyFunction()"  onchange="" name="copi01disp"  value="<?php echo $tc017disp; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14"   ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tc027" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="tc027"  value="<?php echo $tc027; ?>"  size="12" type="text" style="background-color:#FFFFE4"  />
        <img  onclick="scwShow(tc027,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
		<td class="normal14">幣別：</td>
        <td class="normal14" ><input tabIndex="11" id="cmsi06" onKeyPress="keyFunction()" name="cmsi06" onblur="check_cmsi06(this);check_rate(this);"  value="<?php echo $tc019; ?>"  type="text"   size="12"  required style="background-color:#FFFFE4" />
	  ...
	  <tr>
	    <td class="normal14">資產編號：</td>
        <td  class="normal14"  ><input tabIndex="1" id="asti02" onKeyPress="keyFunction()"  onchange="check_asti02(this);" name="asti02" value="<?php echo $tc004; ?>" size="12" type="text" required style="background-color:#FFFFE4" />
        ...
        <td class="normal14"  ><input type="text" id="exchange_rate"  name="exchange_rate" tabIndex="12"   onKeyPress="keyFunction()" name="tc020" value="<?php echo $tc020; ?>"  size="12" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14a"><input tabIndex="2" id="tc021" onKeyPress="keyFunction()"  onchange="change_asti09_tc021();" name="tc021" value="<?php echo $tc021; ?>" size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="2" id="exchange_tc021" onKeyPress="keyFunction()"  onchange="" name="exchange_tc021" value="<?php echo $exchange_tc021; ?>" size="12" type="text" readonly="value" style="background-color:#F0F0F0"/></td>
        
		<td class="normal14">異動日期：</td>
        <td class="normal14"><input tabIndex="2"  ondblclick="scwShow(this,event);" id="tc003" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="tc003"  value="<?php echo $tc003; ?>"  size="12" type="text" style="background-color:#F0F0F0" readonly="value" /></td>
	  </tr>
	  
	  <tr>
	    <td class="normal14">數量：</td>
        <td class="normal14"><input tabIndex="2" id="tc005" onKeyPress="keyFunction()" onblur="change_asti09_tc005();" name="tc005"  value="<?php echo $tc005; ?>"  size="12" type="text" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="2" id="tc006" onKeyPress="keyFunction()"  onchange="" name="tc006" value="<?php echo $tc006; ?>" size="12" type="text" /></td>
        
		<td class="normal14">累積折舊：</td>
        <td class="normal14"><input tabIndex="2" id="tc008" onKeyPress="keyFunction()"  onchange="" name="tc008" value="<?php echo $tc008; ?>" size="12" type="text" /></td>
        
		<td class="normal14">處分損益：</td>
        <td class="normal14"><input tabIndex="2" id="tc022" onKeyPress="keyFunction()"  onchange="" name="tc022" value="<?php echo $tc022; ?>" size="12" type="text" /></td>
	  </tr>
	  
	  <tr>
	    <td class="normal14">改良成本：</td>
        <td class="normal14"><input tabIndex="2" id="tc007" onKeyPress="keyFunction()"  onchange="" name="tc007" value="<?php echo $tc007; ?>" size="12" type="text" /></td>
        
		<td class="normal14">增減預留殘值：</td>
        <td class="normal14"><input tabIndex="2" id="tc010" onKeyPress="keyFunction()"  onchange="" name="tc010" value="<?php echo $tc010; ?>" size="12" type="text" /></td>
        
		<td class="normal14">備註：</td>
        <td class="normal14"><input tabIndex="2" id="tc013" onKeyPress="keyFunction()"  onchange="" name="tc013" value="<?php echo $tc013; ?>" size="24" type="text" /></td>
	  </tr>
	  
	  <tr>
	    <td class="normal14">自動銷帳：</td>
        <td class="normal14"><input type="hidden" name="tc025" value="N" />
		<input tabIndex="28" id="tc025" onKeyPress="keyFunction()" name="tc025" <?php if($tc025 == 'Y' ) echo 'checked'; ?>  <?php if($tc025 !== 'Y' ) echo 'check'; ?> value="Y" size="1" type='checkbox'  /></td>		
        
		<td class="normal14">產生分錄：</td>
        <td class="normal14"><input type="hidden" name="tc031" value="N" />
		<input tabIndex="28" id="tc031" onKeyPress="keyFunction()" name="tc031" <?php if($tc031 == 'Y' ) echo 'checked'; ?>  <?php if($tc025 !== 'Y' ) echo 'check'; ?> value="Y" size="1" type='checkbox'  /></td>		
	 ...
	 <div class="buttons">
	   ...
	   <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ast/asti09/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 </div> 
   </div> 	<!-- end 頁標籤 -->   
   </form>
	   <?php	if ($message!=' ') { ?>
...
<?php  include_once("./application/views/funnew/asti09_fundjs_v.php"); ?>  <!-- 明細開視窗 --> 
