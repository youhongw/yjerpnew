...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 投抵資產明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/astr10/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14a" width="14%" >起主管機關文號：</td>
	   ...
	   <tr>
	    <td class="start14a" >起國稅局文號：</td>
	    <td class="normal14a"><input tabIndex="1" id="tc002o"   onKeyPress="keyFunction()" type="text" name="tc002o"  value="<?php echo $tc002o; ?>"  size="20"  /></td>
      
	  </tr>
	   <tr>
	    <td class="start14a" >迄國稅局文號：</td>
	  ...
	  <tr>
	    ...
	    <td class="normal14" ><select id="tc004o" onKeyPress="keyFunction()" name="tc004o"  tabIndex="4">
            <option <?php if($tc004o == '1') echo 'selected="selected"';?> value='1'>依資產類別</option>  
            <option <?php if($tc004o == '2') echo 'selected="selected"';?> value='2'>依主管機關文號</option> 			
		    <option <?php if($tc004o == '3') echo 'selected="selected"';?> value='3'>依國稅局文號</option>
		  </select></td>
	  </tr>	
