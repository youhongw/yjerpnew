...
<?php if (!$results)  { ?>
	<script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/asti10/printdetailc';location = url; </script> 
<?php exit;}
...
?>
	<table class="store">
		...
		<tr>
			...
			<tr><td class="title" align="center" valign="top">資  產  調  整  單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="25%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>單別：</b><span><?php echo $results[0]->tc001."-".$results[0]->tc001disp; ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>單號：</b><?php echo $results[0]->tc002; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
					  ...
					  <td width="25%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>規格：</b><?php echo $results[0]->tc004disp2; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
					  ...
					  <td width="25%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>取得成本：</b><?php echo $results[0]->tc006; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>改良成本：</b><?php echo $results[0]->tc007; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
					  ...
					  <td width="25%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>累積折舊：</b><?php echo $results[0]->tc008; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>未用月數：</b><?php echo $results[0]->tc009; ?></td>
							  <td align="left" valign="top"></td>
							</tr>							
							<tr>
							  <td width="600" align="left" valign="top"><b>預留殘值：</b><?php echo $results[0]->tc010; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
