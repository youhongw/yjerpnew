...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產收回建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/ast/asti14/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TE001'> TE001 單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TE002'> TE002 單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TE003'> TE003 異動日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TE004'> TE004 備註 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.TE008'> TE008 單據日期 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.TE001'> TE001 單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.TE002' > TE002 單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.TE003'> TE003 異動日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.TE004'> TE004 備註 </option>
		    <option <?php if($find006 == '8') echo 'selected="selected"';?> value='a.TE008'> TE008 單據日期 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/ast/asti14/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
