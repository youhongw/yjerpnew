 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/astr12/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="right">數量<br>耐用月數</td>
		<td width="10%" align="right">未攤月數</td>
		<td width="10%" align="right">取得成本</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
        ...
        <td width="10%" align="right"><?php echo  $val->mb012;?><br><?php echo  $val->mb014;?></td>			
        <td width="10%" align="right"><?php echo  $val->mb015;?></td>		
        <td width="10%" align="right"><?php echo  $val->mb019;?></td> 
       		
        </tr>		
		 <?php $rownum++;$rownum1++;$vqty=$vqty+$val->mb019;$vnoqty=$vnoqty+$val->mb019;$vamt=$vamt+$val->mb019; ?>
