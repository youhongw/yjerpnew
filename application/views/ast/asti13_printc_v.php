...
<?php if (!$results)  { ?>
	<script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/asti13/printdetailc';location = url; </script> 
<?php exit;}
		...
		<tr>
			...
			<tr><td valign="top">
				...
				<?php foreach($value as $key=>$val){?>
					<tr>					 
					  <td align="left"><? echo $val->tg003;?></td>
					  <td align="left"><? echo $val->asti02;?></td>
					  <td align="left"><? echo $val->asti02_mb003;?></td>
					  <td align="left"><? echo $val->asti02_asti13_mc002disp;?></td>
					  <td align="left"><? echo $val->asti02_asti13_mc003disp;?></td>
					  <td align="right"><? echo $val->tg006;?></td>
					  <td align="right"><? echo $val->tg008;?></td>
					</tr>
				<?php }?>
