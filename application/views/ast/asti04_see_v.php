...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 保險資料建立作業 - 查看</h1>
	  <form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/asti04/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
	    <td class="start14a"  width="9%"><span class="required">保險號碼：</span></td>   <!--onchange="startasti03(this);check_title_no();"    -->
        <td class="normal14a"  width="24%"><input type="text" tabIndex="1" onKeyPress="keyFunction()" id="ta001" name="ta001"   value="<?php echo $ta001; ?>"  size="12" required readonly="value" style="background-color:#F0F0F0"/></td>
	    
		<td class="normal14a" width="9%">保險公司：</td>
        <td  class="normal14a" width="24%" ><input tabIndex="2" id="puri01" onKeyPress="keyFunction()"  onchange="check_puri01(this)" name="puri01" value="<?php echo $ta002; ?>" size="12" type="text" readonly="value" style="background-color:#F0F0F0" />
	  ...
	  <tr>
        ...
        <td class="normal14a"><input tabIndex="5"  ondblclick=""   id="ta004" onKeyPress="keyFunction()"  onchange="" name="ta004"  value="<?php echo $ta004; ?>"  size="12" type="text" readonly="value" style="background-color:#F0F0F0"  />
        ...
        <td class="normal14a"><input tabIndex="6"  ondblclick="scwShow(this,event);"   id="ta005" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="ta005"  value="<?php echo $ta005; ?>"  size="12" type="text" style="background-color:#F0F0F0"  />
		<img  onclick="scwShow(ta005,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/></td>
        <td class="normal14">備註：</td>
        <td  class="normal14"  ><input type="text" tabIndex="7" onKeyPress="keyFunction()" id="ta008" name="ta008"   value="<?php echo $ta008; ?>"  size="20" readonly="value" style="background-color:#F0F0F0"/></td>
	   </tr>
	</table>
	...
	<div class="buttons">
	<a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ast/asti04/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	
	    <?php if(isset($prev)){ 
			$prev_str = "";$prev_ary = explode('_',$prev);foreach($prev_ary as $k=>$v){if($prev_str){$prev_str.="/";}$prev_str.=$v;}
		?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('ast/asti04/see/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('ast/asti04/see/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
		<?php } ?>	
		</div> 
      </form>
     </div> <!-- div-6 -->
