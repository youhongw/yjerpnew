...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產資料建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/ast/asti02/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.MB001'> MB001 資產編號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.MB002'> MB002 資產名稱 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.MB003'> MB003 資產規格 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.MB005'> MB005 主件編號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='b.MB002'> MB005disp 主件名稱 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.MB006'> MB006 資產類別 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='c.MA002'> MB006disp 資產類別名稱 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.MB047'> MB047 確認日 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.MB001'> MB001 資產編號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.MB002'> MB002 資產名稱 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.MB003'> MB003 資產規格 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.MB005'> MB005 主件編號 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='b.MB002'> MB005disp 主件名稱 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.MB006'> MB006 資產類別 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='c.MA002'> MB006disp 資產類別名稱 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='a.MB047'> MB047 確認日 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/ast/asti02/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
