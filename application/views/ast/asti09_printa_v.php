<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ast/asti09/printdetail';location = url; </script> 
<?php exit;} ?>
  <!--   頁直行數44 橫行28  -->
...
?>    	
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr style="word-break:keep-all;">
	    <td width="9%" align="left">異動單別</td>
	    <td width="9%" align="left">異動單號</td>
	    <td width="9%" align="left">異動性質</td>
