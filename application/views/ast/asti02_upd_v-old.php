 ...
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  ...
	  <tr>	    
        ...
        <td  class="normal14"  ><input tabIndex="5" id="asti01" onKeyPress="keyFunction()"  onchange="check_asti01(this)" name="asti01" value="<?php echo $mb006; ?>" size="12" type="text" />
		<a href="javascript:;"><img id="Showasti01disp" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14"  width="8%">供應廠商：</td>
        <td class="normal14"  width="24%" ><input type="text" tabIndex="9" onKeyPress="keyFunction()" id="puri01" name="puri01" onchange="check_puri01(this)" value="<?php echo  $mb007; ?>" size="12" />
	    <a href="javascript:;"><img id="Showpuri01disp" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
	    
		<td class="normal14"  width="8%">管理區分：</td>
        <td class="normal14"  ><input type="text" tabIndex="15" id="mb013" onKeyPress="keyFunction()" name="mb013" value="<?php echo $mb013; ?>" size="12" /></td>
	    
		<td class="normal14"><span class="required">原幣幣別：</span></td>
        <td  class="normal14"  ><input tabIndex="20" id="cmsi06" onKeyPress="keyFunction()"  onchange="check_cmsi06(this)" name="cmsi06" value="<?php echo $mb018; ?>" size="12" type="text" />
		<a href="javascript:;"><img id="Showcmsi06disp" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="cmsi06disp"> <?php   echo $mb018disp; ?> </span></td>
	  </tr>	
	  
	  <tr>
	    <td class="normal14"><span class="required">供應商簡稱：</span></td>
	  ...
	  <tr>
	    ...
	    <a href="javascript:;"><img id="Showpuri01adisp" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
	  ...
	  <tr>
	    ...
	    <td class="normal14"><span class="required">取得日期：</span></td>
        <td class="normal14"><input tabIndex="18"  ondblclick="scwShow(this,event);" id="mb016" onKeyPress="keyFunction()" onchange="dateformat_ymd(this);" name="mb016"  value="<?php echo $mb016; ?>"  size="12" type="text" required style="background-color:#FFFFE4"/></td>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="19"  ondblclick="scwShow(this,event);" id="mb017" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mb017"  value="<?php echo $mb017; ?>"  size="12" type="text" style="background-color:#FFFFE4"/></td>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14a"  width="9%">折舊方法：</td>
        <td class="normal14" width="25%"><select id="mb023" onKeyPress="keyFunction()" name="mb023" onchange="" tabIndex="24">
	    ...
	    <td class="normal14a"  width="8%">累積折舊：</td>
        <td class="normal14"><input type="text" id="mb029" tabIndex="29" onchange="book_val();" onKeyPress="keyFunction()" name="mb029" value="<?php echo $mb029; ?>" size="12"/></td>
	    
		<td class="normal14a"  width="8%">定率遞減法年折舊額：</td>  
        <td class="normal14"><input type="text" id="mb049" tabIndex="34"   onKeyPress="keyFunction()" name="mb049" value="<?php echo $mb049; ?>" size="12"/></td>
	  </tr>		  
	  ...
	  <tr>
		...
		<a href="javascript:;"><img id="Showacti03disp" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
	  ...
	  <tr>
		...
		<a href="javascript:;"><img id="Showacti03adisp" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
        <span id="acti03adisp"><?php echo $mb031disp;?></span></td>
		
		<td class="normal14">開始提列</td>						
        <td class="normal14"><input tabIndex="35"  ondblclick="scwShow(this,event);" id="mb028" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mb028"  value="<?php echo $mb028; ?>"  size="12" type="text" style="background-color:#FFFFE4"/></td>
	  </tr>
	</table>
	</div> 	<!--  end 標籤2 -->
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14" width="12%">投資抵減：</td>						
        <td class="normal14" width="25%"><select id="mb033" tabIndex="36" onKeyPress="keyFunction()" name="mb033" onchange="" tabIndex="24">
	  ...
	  <tr>
	    <td class="normal14" width="12%">抵減率：</td>						
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="39"  ondblclick="scwShow(this,event);" id="mb036" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mb036"  value="<?php echo $mb036; ?>"  size="12" type="text" style="background-color:#FFFFE4"/></td>
	  </tr>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="41"  ondblclick="scwShow(this,event);" id="mb038" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mb038"  value="<?php echo $mb038; ?>"  size="12" type="text" style="background-color:#FFFFE4"/></td>
	  </tr>
