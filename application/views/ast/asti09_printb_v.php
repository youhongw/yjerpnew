	...
	<!-- 開始列印 -->
		<table class="store">
		  ...
		  <tr>
			...
			<tr><td class="title" align="center" valign="top">資  產  出  售  單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="25%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>出售單別：</b><span><?php echo $results[0]->tc001."-".$results[0]->tc001disp; ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>出售單號：</b><?php echo $results[0]->tc002; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
