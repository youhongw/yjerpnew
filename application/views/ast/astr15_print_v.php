...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產異動明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/astr15/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14a" width="14%" >起資產編號：</td>
	    <td class="normal14a" width="86%"><input tabIndex="1" id="tc001o"   onKeyPress="keyFunction()" type="text" name="tc001o"  value="<?php echo $tc001o; ?>"  size="20"  /></td>
	  ...
	  <tr>
	    <td class="start14a" >迄異動日期：</td>
	    <td class="normal14a"><input tabIndex="1" id="datec1" ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="datec1"  value="<?php echo $datec1; ?>"  size="20" style="background-color:#E7EFEF" />
        <img  onclick="scwShow(datec1,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
	  </tr>
	  <tr>
	    <td class="normal14" >異動性質：</td>
	    <td class="normal14" ><select id="tc003o" onKeyPress="keyFunction()" name="tc003o"  tabIndex="4">
            <option <?php if($tc003o == '8') echo 'selected="selected"';?> value='8'>全部</option>  
            <option <?php if($tc003o == '0') echo 'selected="selected"';?> value='0'>取得</option> 			
		    <option <?php if($tc003o == '1') echo 'selected="selected"';?> value='1'>改良</option>
			<option <?php if($tc003o == '2') echo 'selected="selected"';?> value='2'>重估</option>
			<option <?php if($tc003o == '3') echo 'selected="selected"';?> value='3'>報廢</option>
			<option <?php if($tc003o == '4') echo 'selected="selected"';?> value='4'>出售</option>
			<option <?php if($tc003o == '5') echo 'selected="selected"';?> value='5'>調整</option>
			<option <?php if($tc003o == '6') echo 'selected="selected"';?> value='6'>折舊</option>
			<option <?php if($tc003o == '7') echo 'selected="selected"';?> value='7'>移轉</option>
		  </select></td>
	  </tr>	
	   <tr>
	    <td class="normal14" >確認狀態：</td>
	    <td class="normal14" ><select id="tc003c" onKeyPress="keyFunction()" name="tc003c"  tabIndex="4">
            <option <?php if($tc003c == '0') echo 'selected="selected"';?> value='0'>全部</option>  
            <option <?php if($tc003c == '1') echo 'selected="selected"';?> value='1'>已確認</option> 			
		    <option <?php if($tc003c == '2') echo 'selected="selected"';?> value='2'>未確認</option>
			<option <?php if($tc003c == '3') echo 'selected="selected"';?> value='3'>作廢</option>
		  </select></td>
	  </tr>	
	   <tr>
	    <td class="normal14" >選擇排序：</td>
	    <td class="normal14" ><select id="tc002c" onKeyPress="keyFunction()" name="tc002c"  tabIndex="4">
            <option <?php if($tc002c == '1') echo 'selected="selected"';?> value='1'>1.異動日期</option>  
            <option <?php if($tc002c == '2') echo 'selected="selected"';?> value='2'>2.單據日期</option> 
		  </select></td>
	  </tr>	
