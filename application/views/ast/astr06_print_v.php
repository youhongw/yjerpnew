...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 資產購入明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ast/astr06/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="8%">資產類別：</td>
	    <td class="normal14a" width="92%"><input tabIndex="1" id="tc001o"  onKeyPress="keyFunction()" type="text" name="tc001o"  value="<?php echo $tc001o; ?>"  size="20"  /></td>
