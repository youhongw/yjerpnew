...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> cmsna Excel檔.xlsx上傳資料 - myslq作業</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/upl/cmsna/do_upload"  method="post"  enctype="multipart/form-data" > 
	...
	<!--  <tr>
      ...
      <a onclick="location = '<?=base_url()?>index.php/mym/myna01/delform/'.$ta002o" class="button"><span>刪除&nbsp</span><img src="<?=base_url()?>assets/image/png/del.png" />已上傳重新上傳時先刪除資料</a></td> 
	   ...
	   <tr>
		...
		<td class="start14" >&nbsp;&nbsp;</td>
	    <td class="normal14" ></td>
	    <td class="start14" ><a href="<?php echo site_url('mym/myna01/do_del/'.$ta002o."/".$ta002c)?>" class="button"><span>刪除&nbsp</span><img src="<?=base_url()?>assets/image/png/del.png" /></a></td>
