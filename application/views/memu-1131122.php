    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <?php if ($super == 'Y' or  substr($rms, 42, 1) == 'Y') { ?>
          <li class=""><a href="http://132.147.160.7/report/normal/YJ01.html"><i class="fa fa-circle-o"></i>YJ託外製令及託外進貨數量</a></li>
        <?php } ?>

        <?php if ($super == 'Y' or  substr($rms, 45, 1) == 'Y') { ?>
          <li class=""><a href="http://132.147.160.7/report/normal/YJ02.html"><i class="fa fa-circle-o"></i>DS每月折讓金額</a></li>
        <?php } ?>

        <?php if ($super == 'Y' or  substr($rms, 46, 1) == 'Y') { ?>
          <li class=""><a href="http://132.147.160.7/report/normal/YJ03.html"><i class="fa fa-circle-o"></i>DS國貿營收</a></li>
        <?php } ?>

        <?php if ($super == 'Y' or  substr($rms, 47, 1) == 'Y') { ?>
          <li class=""><a href="http://132.147.160.7/report/normal/YJ04.html"><i class="fa fa-circle-o"></i>LS上海辦銷售月報</a></li>
        <?php } ?>
