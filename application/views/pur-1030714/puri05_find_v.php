...
<div id="content">
 <div class="box">
    <div class="heading">
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?=base_url()?>index.php/pur/puri05/findsql" method="post" enctype="multipart/form-data" >
    </div>
	...
	<tr>
	  ...
	  <div class="buttons">
	    <button  type='submit' accesskey="s" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>&nbsp;確定 F8&nbsp;</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('pur/puri05/display'); ?>" class="button" ><span>取 消&nbsp;F9</span></a>
	  </div>
