...
<div id="content">
 ...
 <div class="box">
    ...
    <div class="content">
	<form class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/pur/puri05/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form12">
	  ...
	  <tr>
	    ...
	    <div class="buttons">
	      <button  type='submit' tabIndex="98" accesskey="s" name='submit' class="button"  target="_new" value='轉excel檔F8'><span>轉excel檔 F8</span></button>&nbsp;&nbsp;&nbsp;&nbsp; 
