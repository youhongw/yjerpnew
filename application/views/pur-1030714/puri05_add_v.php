...
<div id="content"> 
  <div class="box">
	...
	<?php       
	  ...
	  if ($this->session->userdata('ta001disp')) { $ta001disp = $this->session->userdata('ta001disp'); } else { $ta001disp=$this->input->post('ta001'); }
    ...
    //  $ta001disp=$this->input->post('ta001');
	  ...
	  if ($this->session->userdata('ta001')) { $ta001= $this->session->userdata('ta001'); }if ($this->session->userdata('ta001')) { $ta001= $this->session->userdata('ta001'); }
	...
	<table class="form12"  >     <!-- 頭部表格 -->
	  ...
	  <tr>
	    <td  class="normal12" >單據日期：</td>
            <td  class="normal12"  ><input tabIndex="3"  class="date" id="ta013" onKeyPress="keyFunction()"  onKeyUp="chkno1(this)" name="ta013"  value="<?php echo $ta013; ?>"  size="12" type="text"   /></td>
...
<!--	<div id="htabs" class="htabs14"  ><span>編輯項目-新增</span></div>    -->
	...
	<div class="buttons">
	<button type='submit' tabIndex="98" accesskey="s" name='submit' class="button" onclick="addItem();" value='&nbsp;儲存F8&nbsp;'><span>&nbsp;儲 存 F8&nbsp;</span></button>&nbsp;&nbsp;&nbsp;&nbsp;
	<a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('pur/puri05/display'); ?>" class="button" ><span>返 回&nbsp;F9</span></a>
	</div> 
...
//	html += '    <td class="left"><input type="text"  tabIndex="13"  name="order_product[' + product_row + '][tb003]" value="0" size="6" /></td>';
	...
	html += '    <td class="left"><input type="text"  tabIndex="16" id="tb011['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" value="" size="10" class="date" /></td>';
	html += '    <td class="center"><input type="text" tabIndex="17" id="tb009" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb009]" value="1" size="3" style="text-align:right" /></td>';
