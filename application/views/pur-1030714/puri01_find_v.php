...
<div id="content">
 <div class="box">
    <div class="heading">
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?=base_url()?>index.php/pur/puri01/findsql" method="post" enctype="multipart/form-data" >
    </div>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pur/puri01/display'); ?>" class="button" ><span>取 消&nbsp;F9</span></a>
	  </div>
