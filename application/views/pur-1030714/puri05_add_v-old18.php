	...
	<table class="form12"  >     <!-- 頭部表格 -->
	  <tr>
	     ...
	     <td class="start12a"  width="10%"><span class="required">請購單別：</span> </td>
            <td class="normal12a"  width="50%"><input tabIndex="1" id="ta001"    onKeyPress="keyFunction()"  onBlur="startdata1(this)"  name="ta001" value="<?php echo strtoupper($ta001); ?>"  type="text" required /><a href="javascript:;"><img id="Showpurq04a31" src="<?=base_url()?>assets/image/button-search.png" alt="" align="top"/></a>
	  ...
	  <tr>
	    <td class="start12" >講購單號： </td>
            <td class="normal12" ><input tabIndex="2" id="ta002" onKeyPress="keyFunction()" onBlur="chkno1(this)" name="ta002" value="<?php echo $ta002; ?>" size="30" type="text" required /><span id="ta002disp" ></span></td>
	  ...
	  <tr>
	    <td  class="normal12" >單據日期：</td>
            <td  class="normal12"  ><input tabIndex="3"  id="datepicker1" onKeyPress="keyFunction()" onBlur="chkno1(this)" name="ta013"  value="<?php echo $ta013; ?>"  size="30" type="text"   /></td>
			 <td class="normal12">&nbsp;&nbsp;</td>
            <td class="normal12"></td>
	  </tr>
...
<!--	<div id="htabs" class="htabs14"  ><span>編輯項目-新增</span></div>    -->
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="40%" ><input type="text" tabIndex="4" id="ta004" onKeyPress="keyFunction()"   onchange="startcmsq05a(this);" name="ta004"   value="<?php echo  $ta004; ?>"     /><a href="javascript:;"><img id="Showcmsq05a" src="<?=base_url()?>assets/image/button-search.png" alt="" align="top"/></a>
	  ...
	  <tr>
	   <td class="start14a"  >請購人員：</td>
        ...
        <td class="normal14"  ><input tabIndex="7" onKeyPress="keyFunction()" id="datepicker2"  name="ta003" value="<?php echo $ta003; ?>" type="text" disabled="disabled" /></td>
...
//	}
	//建立非同步請求
	 ...
	 var zstr=$('input[name=\'ta003\']').attr('value');
	 var zymd1 = zstr.substring(0,4);
	 var zymd2 = zstr.substring(5,6);
	 var zymd3 = zstr.substring(8,9);
	 var zymd = zymd1+zymd2+zymd3;
     alert(zno);
	 alert(zymd);
	createXMLHttpRequest();
   	var sUrl = "<?=base_url()?>index.php/pur/puri05/datachkno1/" + encodeURIComponent(oInput.value)+ "/" + new Date().getTime();   
	var QueryString = encodeURIComponent(oInput.value);
...
function addItem() {
	...
	html += '    <input type="hidden"  name="order_product[' + product_row + '][tb003]" value=""  />';
	html += '    <td class="left"><input type="text" id="tb004'+ product_row+'"   name="order_product[' + product_row + '][tb004]" value="" size="20"  /></td>';	
	...
	html += '    <td class="left"><input type="text"  id="tb011['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][tb011]" value="" size="10" class="date" /></td>';
    ...
    $('input[name=\'order_product[' + product_row + '][tb004]\']').catcomplete({
	    ...
	    //流水號
	$('input[name=\'order_product[' + product_row + '][tb003]\']').focus(function(){
		var real_value = product_row;
		 var n = this.name.replace(/order_product\[(\d+)].*/, '$1'); 
		 var num_1 = 1000;
		var input_1=$('input[name=\'order_product[' + n + '][tb003]\']').val()*10; 
        var input_2=num_1+input_1;		
		    $(this).val()=input_2;
		alert($(this).val());
	});
