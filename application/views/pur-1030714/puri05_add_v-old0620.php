	...
	<table class="form12"  >     <!-- 頭部表格 -->
	  ...
	  <tr>
	    <td class="start12" >講購單號： </td>
            <td class="normal12" ><input tabIndex="2" id="ta002" onKeyPress="keyFunction()" onBlur="chkno1(this)" name="ta002" value="<?php echo $ta002; ?>" size="30" type="text" required disabled="disabled" /><span id="ta002disp" ></span></td>
