...
<div id="content">  
 <div class="box">
    ...
    <div class="content">
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/pur/puri01/updsave" method="post" enctype="multipart/form-data" >
	...
	<?php 
      ...
      if($this->uri->segment(4) ) { $ma047=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma047', $ma047);$ma047 = $this->session->userdata('ma047'); }
      if($this->uri->segment(5) ) { $ma047disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma047disp', $ma047disp); $ma047disp = $this->session->userdata('ma047disp');} 
      if($this->uri->segment(4) ) { $ma021=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma021', $ma021);$ma021 = $this->session->userdata('ma021'); }
      if($this->uri->segment(5) ) { $ma021disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma021disp', $ma021disp); $ma021disp = $this->session->userdata('ma021disp');} 
	  if($this->uri->segment(4) ) { $ma007=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma007', $ma007);$ma007 = $this->session->userdata('ma007'); }
      if($this->uri->segment(5) ) { $ma007disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma007disp', $ma007disp); $ma007disp = $this->session->userdata('ma007disp');} 
	  if($this->uri->segment(4) ) { $ma006=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma006', $ma006);$ma006 = $this->session->userdata('ma006'); }
      if($this->uri->segment(5) ) { $ma006disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma006disp', $ma006disp); $ma047disp = $this->session->userdata('ma006disp');} 
	  if($this->uri->segment(4) ) { $ma004=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma004', $ma047);$ma004 = $this->session->userdata('ma004'); }
      if($this->uri->segment(5) ) { $ma004disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma004disp', $ma004disp); $ma004disp = $this->session->userdata('ma004disp');} 
	  if($this->uri->segment(4) ) { $ma042=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma042', $ma042);$ma042 = $this->session->userdata('ma042'); }
      if($this->uri->segment(5) ) { $ma042disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma042disp', $ma042disp); $ma042disp = $this->session->userdata('ma042disp');} 
	  if($this->uri->segment(4) ) { $ma041=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma041', $ma041);$ma041 = $this->session->userdata('ma041'); }
      if($this->uri->segment(5) ) { $ma041disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma041disp', $ma041disp); $ma041disp = $this->session->userdata('ma041disp');}
      if($this->uri->segment(4) ) { $ma043=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma043', $ma043);$ma043 = $this->session->userdata('ma043'); }
      if($this->uri->segment(5) ) { $ma043disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma043disp', $ma043disp); $ma043disp = $this->session->userdata('ma043disp');}
      if($this->uri->segment(4) ) { $ma025=urldecode(urldecode($this->uri->segment(4)));$this->session->set_userdata('ma025', $ma025);$ma025 = $this->session->userdata('ma025'); }
      if($this->uri->segment(5) ) { $ma025disp=urldecode(urldecode($this->uri->segment(5)));$this->session->set_userdata('ma025disp', $ma025disp); $ma025disp = $this->session->userdata('ma025disp');}
     
	  if ($this->session->userdata('ma047')) { $ma005= $this->session->userdata('ma047'); }
	  if ($this->session->userdata('ma021')) { $ma006= $this->session->userdata('ma021'); }
	  if ($this->session->userdata('ma007')) { $ma007= $this->session->userdata('ma007'); }
	  if ($this->session->userdata('ma006')) { $ma008= $this->session->userdata('ma006'); }
	  if ($this->session->userdata('ma004')) { $ma017= $this->session->userdata('ma004'); }
	  if ($this->session->userdata('ma042')) { $ma068= $this->session->userdata('ma042'); }
	  if ($this->session->userdata('ma041')) { $ma068= $this->session->userdata('ma041'); }
	  if ($this->session->userdata('ma043')) { $ma068= $this->session->userdata('ma043'); }
	  if ($this->session->userdata('ma025')) { $ma068= $this->session->userdata('ma025'); }
	...
	<div id="tab2" class="tab_content">  <!-- 交易資料 -->
	...
	<table class="form12">     <!-- 表格 -->
     ...
     <div id="tab3" class="tab_content">  <!-- 地址 3 -->
  ...
  <div class="buttons">
	    ...
	    <a  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pur/puri01/'.$this->session->userdata('search')); ?>" class="button" ><span>取 消&nbsp;F9</span></a>
	   </div>
</div>
    <?php  if ($message!=' ') { ?>
