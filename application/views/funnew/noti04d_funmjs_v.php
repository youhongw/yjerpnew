...
$(document).ready(function(){
	$("#Shownoti04ddisp").click(function() {
	$.blockUI({
		css: {
			top: '15%',
			left: '25%',
		...
		message: $('#divFnoti04d'),
		onOverlayClick: clear_noti04ddisp_sql
	});
...
function addnoti04ddisp(smb001,smb002){
	//alert('test2')e;
	addItem5(smb001,smb002);
	$('#noti04').focus();
	/*$.ajax({
		method: "POST",
...
function clear_noti04ddisp_sql(){
	$.unblockUI();
	/*$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/not/noti04/clear_sql"
...
<div id="divFnoti04d" style="display:none;width:100%;height:100%;">
<div style="float:right;"><input type="button" class="close" value="close" /></div> 
<iframe src="<?php echo base_url()?>index.php/not/noti04/display_childd" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
