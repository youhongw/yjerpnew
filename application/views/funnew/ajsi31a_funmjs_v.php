...
function addajsi31adisp(smb001,smb002){
	...
	//$('#ajsi31a').val(smb001);
	if (form.ajsi31a.value=='') {form.ajsi31a.value=smb001;} else
		{form.ajsi31a.value=form.ajsi31a.value+smb001;}
...
<iframe src="<?php echo base_url()?>index.php/ajs/ajsi31/display_child1" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
