	...
	$.ajax({
		...
		function(data){
			if(data.response == "true"){
				...
				$('#copi03').val(data.message[0].value1);
...
<iframe src="<?php echo base_url()?>index.php/cop/copi03/displayc_child" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
