        ...
        <thead>
		  ...
		  <?php
			foreach($title_array as $key => $val){
				...
				echo anchor("inv/invi04/displayb_child/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
				
				$str = "<img src='".base_url()."assets/image/desc.png' />";
				echo anchor("inv/invi04/displayb_child/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/inv/invi04/displayb_child/0/and_where?key=' + encodeURIComponent(key) + 
