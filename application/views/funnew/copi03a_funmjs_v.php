...
$(document).ready(function(){
    ...
    $('#copi03').catcomplete({
		...
		function(req, add){
			...
			console.log(smb001);
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/cop/copi03/lookup1a_copi03/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,
...
function check_copi03(row_obj){
	...
	$.ajax({
		url: '<?php echo base_url(); ?>index.php/cop/copi03/lookup2a_copi03/'+encodeURIComponent(smb001), 
		cache: false, 				
		dataType: 'json',  
		type: 'POST',  
...
<iframe src="<?php echo base_url()?>index.php/cop/copi03/display_childa" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
