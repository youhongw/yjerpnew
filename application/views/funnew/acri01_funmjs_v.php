...
function check_acri01(row_obj){
	...
	$.ajax({
		url: '<?php echo base_url(); ?>index.php/acr/acri01/lookup2_acri01/'+encodeURIComponent(smb001), 
		cache: false, 				
		dataType: 'json',  
		type: 'POST',  
...
<iframe src="<?php echo base_url()?>index.php/acr/acri01/display_child/22" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
