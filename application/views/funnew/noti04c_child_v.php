  ...
  <div class="content"> <!-- div-2 -->
    <form method="post" enctype="multipart/form-data" id="form">
        <table class="list"> <!-- 表格開始 -->						
			<tr>
				<td class="normal14a" width="8%" >還票日期： </td>  <!-- dateformat_ymd(this); -->
...
function check_submit(){
	...
	if(td003 == "" || exchange_rate == ""){
		...
		send_back_noti04c(td003, exchange_rate);
	}
}

function send_back_noti04c(smb001, smb002){
	window.parent.$.unblockUI();
	if(window.parent.addnoti04cdisp){
		window.parent.addnoti04cdisp(smb001,smb002);
		/*a.ajax({
			method:"POST",
