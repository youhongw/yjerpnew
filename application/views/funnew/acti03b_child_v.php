...
?>
        ...
        <tr onclick="parent.addacti03bdisp('<?php echo $row->ma001;?>','<?php echo $row->ma003;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_acti03b('<?php echo $row->ma001;?>','<?php echo $row->ma003;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/ok.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/act/acti03/display_child2/0/and_where?key=' + encodeURIComponent(key) + 
