...
<div id="content"> 
  <div class="box">
	...
	<?php
	  ...
	  $mz006disp=$this->input->post('mz006');
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="3"  ondblclick="scwShow(this,event);"   id="mz003" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mz003"  value="<?php echo $mz003; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
	  ...
	  <tr>
		...
		<input tabIndex="4" type="checkbox"  id="mz004" onKeyPress="keyFunction()"   name="mz004" <?php if($mz004 == 'Y' ) echo 'checked'; ?>  <?php if($mz004 !== 'Y' ) echo 'check'; ?> value="Y" size="1"   /></td>
	  </tr>
	  <tr>
	    <td class="normal14" >展開方式：</td>
		<td class="normal14"  ><select tabIndex="5" id="mz005" onKeyPress="keyFunction()" name="mz005" >
	  ...
	  <tr>
	    <td class="normal14">庫別：</td>
		<td class="normal14"  ><input tabIndex="1" id="cmsi03"    onKeyPress="keyFunction()" ondblclick="search_cmsi03_window()"  name="mz006"  onchange="check_cmsi03(this);"  value="<?php echo $mz006; ?>" size="12" type="text"  />
		  <a href="javascript:;"><img id="Showcmsi03disp" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		  <span id="cmsi03disp"> <?php    echo $mz006disp; ?> </span></td>
	  </tr>
	</table>
	...
	<a class="button" href='javascript:send_back_bomi02("<?php echo $mz001;?>","<?php echo $mz002;?>","<?php echo $mz003;?>","<?php echo $mz004;?>","<?php echo $mz006;?>","<?php  $mz006disp="<script>var v=$(#cmsi03disp).val(); document.write(v);</script>"; ?>");'>儲 存Alt+s<img src="<?php echo base_url()?>assets/image/png/save.png"/> </a> 
...
function send_back_bomi02(mz001,mz002, mz003, mz004, mz006, mz006disp1){
	...
	var mz006 = $('input[name=\'mz006\']').attr('value');
	var mz006disp=$('#cmsi03disp').val();
	console.log(mz006disp);
	window.parent.$.unblockUI();
	//console.log(window.parent.import_copi05);
	if(window.parent.import_moci02){	//以此判斷各呼叫此網頁的方法是否存在藉以給予相對應的需求
		window.parent.import_moci02(mz001,mz002,mz003,mz004,mz006,mz006disp);
		$.ajax({
			method: "POST",
