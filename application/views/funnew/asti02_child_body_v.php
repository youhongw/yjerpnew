...
?>
        ...
        <tr onclick="parent.addasti02_body('<?php echo $row->mb001;?>','<?php echo $row->mb002;?>','<?php echo $row->mb003;?>','<?php echo $row->mb012;?>','<?php echo $row->mb011;?>','<?php echo $row->mb016;?>','<?php echo $row->mb020;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_asti02('<?php echo $row->mb001;?>','<?php echo $row->mb002;?>','<?php echo $row->mb003;?>','<?php echo $row->mb012;?>','<?php echo $row->mb011;?>','<?php echo $row->mb016;?>','<?php echo $row->mb020;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/ok.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
