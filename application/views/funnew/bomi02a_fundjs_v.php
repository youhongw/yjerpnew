...
<script type="text/javascript">
	...
	function check_key(oInput) {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url() ?>index.php/bom/bomi02a/check_key",
			dataType: 'json',
			data: {
				mc001: mc001
			},
...
<script type="text/javascript">
	...
	function check_title_no() {
		...
		$.ajax({
				method: "POST",
				url: "<?php echo base_url() ?>index.php/bom/bomi02a/check_title_no",
				data: {
					invi02: invi02
				}
			})
	...
	function set_catcomplete(row) {
		...
		$('#ordera' + row).click(function() {
			...
			$('#hpa_ifmain').attr('src', "<?php echo base_url() ?>index.php/bom/bomi02a/edit_child/" + $("#puri01").val());
			$.blockUI({
				css: {
					top: '15%',
					left: '25%',
	...
	function import_copi05(mz001, mz002, mz003, mz004) {
		...
		$.ajax({
				method: "POST",
				dataType: "json",
				url: "<?php echo base_url() ?>index.php/bom/bomi02a/import_bomi02a",
				data: {
					mz001: mz001,
					mz002: mz002,
					mz003: mz003,
...
<script>
	function del_detail(md001, md002, md003, row) {
		...
		if (confirm("確定刪除細項:" + md002 + "-" + md003 + "?")) {
			$.ajax({
					method: "POST",
					url: "<?php echo base_url() ?>index.php/bom/bomi02a/del_detail_ajax",
					data: {
						md001: md001,
						md002: md002,
						md003: md003
