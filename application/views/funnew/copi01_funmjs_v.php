    ...
    $('#copi01').catcomplete({
		...
		select: function(event, ui) {
			if(ui.item.value!="查無資料"){
				...
				console.log($('#copi01disp').text(ui.item.value2));
				return false;
			}else{
...
function addcopi01disp(smb001,smb002){
	//alert('test2');
	$('#copi01').val(smb001);
...
<iframe src="<?php echo base_url()?>index.php/cop/copi01/display_child" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
