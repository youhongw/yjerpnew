...
?>
	    ...
	    <?php foreach($results as $row ) : ?>
         <tr onclick="parent.addacri03disp('<?php echo $row->td001;?>','<?php echo $row->td002;?>','<?php echo $row->td003;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_acri03('<?php echo $row->td001;?>','<?php echo $row->td002;?>','<?php echo $row->td003;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/ok.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
