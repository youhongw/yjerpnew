...
$(document).ready(function(){
	...
	$.blockUI({
		...
		message: $('#divFacti03b'),
		onOverlayClick: clear_acti03bdisp_sql
	});
...
function clear_acti03bdisp_sql(){
	$.unblockUI();
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/act/acti03/clear_sql"
...
<iframe src="<?php echo base_url()?>index.php/act/acti03/display_child3" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
