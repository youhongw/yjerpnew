...
<iframe src="<?php echo base_url()?>index.php/cms/cmsi06/display_child2" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
