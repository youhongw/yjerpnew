        ...
        <table style="width: 100%;">
            ...
            <td>使用者代號<br />
              ...
              <a href="http://dercaster.com/ci/index.php/forgotten">忘記密碼</a>
			   ...
			   <br /><br />
					  ...
					  <noscript>
						<span style='color:red;'>錯誤：驗證碼與圖片驗證號碼不符!</span>					  </noscript>	
		  ...
		  <tr>
            <td style="text-align: right;">
							<input id="submit" style="display:none;" type="submit" value="登入" class="button" />
						</td>
          </tr>
        </table>
              </form>
...
foreach($query->result() as $row)
    {
      ...
      if ($this->input->post('password')!='') {echo '帳號'.$this->input->post('username').' 或密碼輸入錯誤!, 請重輸入';} else {echo '   ';}
