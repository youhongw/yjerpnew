...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 區間別銷售統計表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pos/posr03/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    ...
	    <td class="normal14" ><input tabIndex="3" id="dateo" ondblclick="scwShow(this,event);" onChange="dataymd(this)" onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF" /><span > <?php   echo '輸入範例格式YYYYMMDD'; ?> </span></td>
        <td class="normal14" >結束日期：</td>
	    <td class="normal14" ><input tabIndex="4" id="datec"  ondblclick="scwShow(this,event);" onChange="dataymd1(this)" onKeyPress="keyFunction()" type="text" name="datec"  value="<?php echo $datec; ?>"  size="20" style="background-color:#E7EFEF"/><span > <?php   echo '輸入範例格式YYYYMMDD'; ?> </span></td>
	  </tr>
	   <tr>
