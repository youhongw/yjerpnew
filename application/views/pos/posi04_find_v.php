...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 會員基本資料建立 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" tabIndex="7" type='submit'  accesskey="k"  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a  accesskey="x"   tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pos/posi04/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pos/posi04/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='mc001'> mc001 會員代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='mc002'> mc002 會員姓名 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='mc003'> mc003 性別 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='mc004'> mc004 出生日期 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='mc005'> mc005 行動電話 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='mc006'> mc006 電話 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='mc001'> mc001 會員代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='mc002'> mc002 會員姓名 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='mc003'> mc003 性別 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='mc004'> mc004 出生日期 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='mc005'> mc005 行動電話</option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='mc006'> mc006 電話  </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pos/posi04/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
