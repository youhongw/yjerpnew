...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 公佈欄資料建立 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pos/posi06/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='md001'> md001 公告日期 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='md002'> md002 公告單號 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='md003'> md003 公告單位 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='md004'> md004 收件日期 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='md005'> md005 主旨 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='md006'> md006 內容描述 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='md001'> md001 公告日期 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='md002'> md002 公告單號 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='md003'> md003 公告單位 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='md004'> md004 收件日期 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='md005'> md005 主旨</option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='md006'> md006 內容描述  </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x"   tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pos/posi06/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pos/posi06/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
