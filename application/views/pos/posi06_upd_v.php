...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 公佈欄資料建立 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/pos/posi06/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
      <tr>
        ...
        <td class="normal14a" width="39%" ><input type="text" tabIndex="1"  ondblclick="scwShow(this,event);" id="md001" readonly="value" onKeyPress="keyFunction()"   name="md001" value="<?php echo $md001; ?>"  style="background-color:#E7EFEF" /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>         
	    <td class="normal14a" width="11%">公告單號：</td>
        <td class="normal14a"  width="39%"> <input  tabIndex="2" id="md002" onKeyPress="keyFunction()" readonly="value" name="md002"   value="<?php echo  $md002; ?>"    type="text"  /></td>
	  </tr>	
	 ...
	 <tr>		
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pos/posi06/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
