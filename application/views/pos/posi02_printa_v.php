	<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/pos/posi02/printdetail';location = url; </script> 
  <?php } ?>
<!--   頁直行數  -->
...
foreach($results as $key=>$value){
	...
	$pur_date = substr($value->ma004,0,4).'/'.substr($value->ma004,4,2).'/'.substr($value->ma004,6,2);
}
$totle_page = $page;
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="15%" align="center">門市代號</td>
	    <td width="17%" align="center">門市名稱</td>
	    <td width="17%" align="left">開店日期</td>
	    <td width="17%" align="left">歸屬庫別</td>
	    <td width="17%" align="left" >連絡人</td>
	    <td width="17%" align="center">電話</td>
          </tr>
	</table>
