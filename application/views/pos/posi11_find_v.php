...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 促銷單建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pos/posi11/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='tc001'> tc001 門市代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='tc002'> tc002  促銷單單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='tc003'> tc003 促銷單日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='tc004'> tc004 開始日期 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='tc005'> tc005 開始時間 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='tc006'> tc006 結束日期 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='tc007'> tc007 結束時間 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='tc001'> tc001 促銷單單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='tc002'> tc002 促銷單單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='tc003'> tc003 促銷單日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='tc004'> tc004 開始日期 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='tc005'> tc005 開始時間 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='tc006'> tc006 結束日期 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='tc007'> tc007 結束時間 </option>
