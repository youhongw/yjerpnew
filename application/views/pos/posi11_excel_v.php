...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 促銷單建立作業 - 轉Excel</h1>
    </div>
  
    <div class="content"> <!-- div-5 -->
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pos/posi11/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
      <tr>
	    <td class="start14a" width="13%">起始門市代號：</td>
	    <td class="normal14a" width="37%"><input tabIndex="1" id="tc001o" onKeyPress="keyFunction()" type="text" name="tc001o"  value="<?php echo $tc001o; ?>"  size="20" /></td>
        <td class="normal14a" width="13%">結束門市代號：</td>
		<td class="normal14a" width="37%"><input tabIndex="2" id="tc001c" onKeyPress="keyFunction()" type="text" name="tc001c"  value="<?php echo $tc001c; ?>"  size="20" /></td>
	  </tr>
	  <tr>
	    <td class="start14" >起始促銷單單號：</td>
