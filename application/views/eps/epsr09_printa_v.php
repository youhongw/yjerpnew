 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/eps/epsr09/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="left">通知銀行<br>通知銀行名</td>
	    ...
	    <td width="10%" align="left">收款單號<br>收款日期</td>
      </tr>
	</table>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	      ...
	      <tr>
		    ...
		    <td width="10%" align="left"><?php echo  $val->tf008;?><br><?php echo  $val->tf012;?></td>
		    <td width="10%" align="left"><?php echo // $val->tc002;?><br><?php echo // $val->tc003;?></td>
        </tr>		
