...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 信用狀餘額明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/eps/epsr09/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if(!isset($dateo2)) { $dateo2=''; }
	  if(!isset($datec2)) { $datec2=''; }
	  $date=date("Y/m/d");
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="12%">起信用狀號：</td>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="start14a" >起截止押匯日：</td>
	    <td class="normal14a"><input tabIndex="2" id="dateo2" onKeyPress="keyFunction()" ondblclick="scwShow(this,event);"  name="dateo2" value="<?php echo $dateo2; ?>"  type="text"  />
		 <img  onclick="scwShow(dateo2,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
	  </tr>
	   <tr>
	    <td class="start14a" >迄截止押匯日：</td>
	    <td class="normal14a"><input tabIndex="2" id="datec2" onKeyPress="keyFunction()" ondblclick="scwShow(this,event);"  name="datec2" value="<?php echo $datec2; ?>"  type="text"  />
		 <img  onclick="scwShow(datec2,event);"   src="<?php echo base_url()?>assets/image/png/calendar.png" alt="" align="top"/> 
           </td>
	  </tr>
	    <tr>
	    <td class="start14a" >起類別：</td>
	    <td class="normal14a"><input tabIndex="2" id="tc002o" onKeyPress="keyFunction()"   name="tc002o" value="<?php echo $tc002o; ?>"  type="text"  />
		 </td>
	  </tr>
	   <tr>
	    <td class="start14a" >迄類別：</td>
