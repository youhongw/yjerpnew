 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/eps/epsr14/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="30%" align="left">Item No.</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	      ...
	      <tr>
	    	<td width="30%" align="left"><?php echo  $val->tb004;?></td>
			<td width="30%" align="left"><?php echo  $val->tb005.' '.$val->tb006;?></td>
			<td width="10%" align="left"><?php echo  $val->tb007;?></td>
			<td width="10%" align="left"><?php echo  $val->tb008;?></td>
			<td width="10%" align="left"><?php echo  $val->tb009;?></td>
			<td width="10%" align="left"><?php echo  $val->tb010;?></td>
		     
        </tr>		
            
		 <?php  $rownum++;$rownum1++;$vqty=$vqty+$val->tb010;$vnoqty=$vnoqty+$val->tb010;$vamt=$vamt+$val->tb010; ?>
		<?php // $rownum++;$rownum1++; ?>			
