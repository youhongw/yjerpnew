...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/eps/epsi01/copysave" method="post" enctype="multipart/form-data" id="form">
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	    <td class="start14a" width="11%">原始單別代號：</td>
	    ...
	    <td class="normal14a" width="11%">複製單別代號：</td>
        <td class="normal14a" width="39%">
	   ...
	   <a accesskey="x" tabIndex="6" id='cancel' name='cancel' href="<?php echo site_url('eps/epsi01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a></div>
