			...
			<tr><td valign="top">
				<table class="order">
				  <tr>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>訂單單號：</b><span><?php echo $value[0]->tc002 ?></span></td>
						<td align="left" valign="top" ></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $value[0]->tc039 ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>客戶代號：</b><?php echo $value[0]->tc004.' '.$value[0]->tc004disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					</table>
				    </td>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>業務人員：</b><span><?php echo $value[0]->tc006.' '.$value[0]->tc006disp ?></span></td>
						<td align="left" valign="top" ></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>課 稅 別：</b><?php echo $value[0]->tc016 ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
						<td width="600" align="left" valign="top"><b>交易幣別：</b><?php echo $value[0]->tc008.' '.$value[0]->tc008disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					</table>
				    </td>
					...
					<table class="company">
					  <tr>
						<td width="600" align="left" valign="top"><b>付款條件：</b><?php echo $value[0]->tc014.' '.$value[0]->tc014disp ?></td>
						<td align="left" valign="top"></td>
					  </tr>
					  <tr>
