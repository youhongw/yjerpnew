...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 貨運通知單建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/eps/epsi07/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
	  ...
	  <tr>	    
        ...
        <td class="normal14" ><input tabIndex="4" id="cmsi02" ondblclick="search_cmsi02_window()" onKeyPress="keyFunction()" name="td003" onblur="check_cmsi02(this);"  value="<?php echo $td003; ?>"  type="text"   size="12" />
        ...
        <td  class="normal14"  ><input type="text" tabIndex="6"  onKeyPress="keyFunction()" id="td006" name="td006"   value="<?php echo $td006; ?>" size="12" />
	       </td>
	  </tr>
	  
		 <tr>
	    <td class="normal14" >SIZE：</td>		
        <td class="normal14"  ><input type="text"   tabIndex="7"   onKeyPress="keyFunction()"    name="td007" value="<?php echo $td007; ?>"   /></td>
	    <td class="normal14" >航次：</td>		
        <td class="normal14"  ><input type="text"    tabIndex="8"   onKeyPress="keyFunction()"    name="td008" value="<?php echo $td008; ?>"   /></td>
	    <td class="normal14" >業務人員：</td>		
        <td class="normal14"  ><input tabIndex="9" id="cmsi09" ondblclick="search_cmsi09_window()" onKeyPress="keyFunction()" name="td009" onblur="check_cmsi09(this)"  value="<?php echo $td009; ?>"  type="text"  size="12"  />
        ...
        <td class="normal14"  ><input type="text"   tabIndex="10"   onKeyPress="keyFunction()"    name="td007" value="<?php echo $td007; ?>"   /></td>
	   ...
	   <tr>
        ...
        <td class="normal14"  ><input type="text" id="td016"   tabIndex="12"   onKeyPress="keyFunction()"    name="td016" value="<?php echo $td016; ?>"   /></td>
	  	<td class="normal14a"  >運貨日期：</td>
        <td class="normal14" ><input type="text" tabIndex="13" readonly="value"  onKeyPress="keyFunction()" id="td004" name="td004"   value="<?php echo $td004; ?>" size="12"  style="background-color:#F0F0F0"/></td>
	    <td class="normal14a"  ></td>
        <td class="normal14" ></td>
		</tr>
		 <tr>
	    <td class="normal14">簽核狀態：</td>
        <td class="normal14"  ><select id="td018" tabIndex="14" readonly="value" onKeyPress="keyFunction()" name="td018"   style="background-color:#F0F0F0" >
        ...
        <td  class="normal14"  ><select id="verify" onKeyPress="keyFunction()" name="td013" onChange="selverify(this)" tabIndex="15">
        ...
        <td  class="normal14"  ><input type="text" tabIndex="16" readonly="value"  onKeyPress="keyFunction()" id="td017" name="td017"   value="<?php echo $td017; ?>" style="background-color:#F0F0F0" size="12" /></td>
	    </tr>
	</table>
	...
	<!-- 合計     -->
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('eps/epsi07/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('eps/epsi07/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>	
	  </div> 
	  </div> <!-- div-加 -->
    </form>  <!-- end 表單 -->
...
<form action="<?php echo base_url()?>index.php/eps/epsi07/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
...
<?php  include_once("./application/views/funnew/copi01_funmjs_v.php"); ?>  <!-- 客戶傳多欄 -->
