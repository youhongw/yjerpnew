...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> PACKING LIST 建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/eps/epsi06/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TA001'> TA001 通知單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TA002'> TA002 通知單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TA070'> TA070 單據日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TA022'> TA022 幣別 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TA023'> TA023 匯率 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TA041'> TA041 廠別 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TA001'> TA001 通知單別 </option>                                                                         
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TA002'> TA002 通知單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TA070'> TA070 單據日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TA022'> TA022 幣別 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TA023'> TA023 匯率 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TA041'> TA041 廠別 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/eps/epsi06/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
