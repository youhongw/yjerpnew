...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 商品包裝建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/eps/epsi03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
		    ...
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='mb002'> mb002 單位 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='mb003'> mb003 單位淨重 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='mb004'> mb004 主包裝方式 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='mb005'> mb005 備註     </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
		    ...
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='mb002'> mb002 單位 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='mb003'> mb003 單位淨重 </option
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='mb004'> mb004 主包裝方式 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='mb005'> mb005 備註     </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('eps/epsi03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/eps/epsi03/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
