 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/eps/epsr17/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	      ...
	      <tr>
	    	<td width="30%" align="left"><?php echo  $val->tj004;?></td>
			<td width="30%" align="left"><?php echo  $val->tj005.' '.$val->tj006;?></td>
			<td width="10%" align="left"><?php echo  $val->tj007;?></td>
			<td width="10%" align="left"><?php echo  $val->tj008;?></td>
			<td width="10%" align="left"><?php echo  $val->tj011;?></td>
			<td width="10%" align="left"><?php echo  $val->tj012;?></td>
		     
        </tr>		
            
		 <?php  $rownum++;$rownum1++;$vqty=$vqty+$val->tj012;$vnoqty=$vnoqty+$val->tj012;$vamt=$vamt+$val->tj012; ?>
		<?php // $rownum++;$rownum1++; ?>			
