...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> PACKING LIST 建立作業 - 查看</h1>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="epsi01"    onKeyPress="keyFunction()"   name="ta001" onfocus="check_title_no();selverify();" onchange="check_epsi01(this);"  value="<?php echo $ta001; ?>" size="12" type="text" required />
