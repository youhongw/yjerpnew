...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> CREDIT NOTE - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/eps/epsr17/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14a" width="15%">起銷退單號：</td>
	    <td class="normal14a" width="85%"><input tabIndex="1" id="tc001o" onKeyPress="keyFunction()"   name="tc001o" value="<?php echo $tc001o; ?>"  type="text"   />
		</td>
	  </tr>
	  <tr>
	    <td class="start14a" >迄銷退單號：</td>
	    <td class="normal14a"><input tabIndex="2" id="tc001c" onKeyPress="keyFunction()"   name="tc001c" value="<?php echo $tc001c; ?>"  type="text"  />
		 </td>
	  </tr>
	    <tr>
	    <td class="start14a" >起銷退日期：</td>
