...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 請假單資料建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali54/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
      <tr>
       ...
       <td class="normal14a" width="11%">請假日期： </td>
        <td class="normal14" width="23%"><input  tabIndex="3" onKeyPress="keyFunction()"   onchange="dateformat_ymd(this);" onclick="scwShow(this,event);"   id="tg003" name="tg003"  value="<?php echo $tg003; ?>"  type="text" style="background-color:#E7EFEF" /><input onclick="scwShow(this,event);" id="ori_date" name="ori_date" value="<?php echo $tg003; ?>" type="text" style="display:none;" /></td>
	  </tr>	
