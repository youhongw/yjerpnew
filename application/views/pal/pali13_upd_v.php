...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 獎懲紀錄維護作業- 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali13/updsave" method="post" enctype="multipart/form-data" >
	...
	<?php foreach($result as $row) { ?>
		  ...
		  <?php   $palq17a=$row->mv004;?>
		  <?php   $palq17adisp=$row->mv004disp;?>
          <?php   $mv003=$row->mv003;?>
	      <?php   $mv004=$row->mv004;?>
          <?php   $mv005=$row->mv005;?>
		  <?php   $mv006=$row->mv006;?>
