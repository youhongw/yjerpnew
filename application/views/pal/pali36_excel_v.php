...
<div id="content">
 ...
 <div class="box">
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 離職補發薪年月 - 轉Excel</h1>
    </div>
  
    <div class="content">
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali36/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
        ...
        <td class="normal14a" width="39%">
	     <input tabIndex="1" id="tk002" onKeyPress="keyFunction()" type="text" name="tk001c"  value="<?php echo $tk001c; ?>"   minlength="1" required /></td>
	  </tr>
	  <tr>
	    <td class="start14a" >起始補發薪年月：</td>
        <td class="normal14a" >
		 <input tabIndex="1" id="tk002o" onKeyPress="keyFunction()" type="text" name="tk002o" class="date-picker" value="<?php echo $tk002o; ?>"  style="background-color:#E7EFEF" /></td>
	    <td class="normal14a" >結束補發薪年月：</td>
        <td class="normal14a" >
	     <input tabIndex="1" id="tk002c" onKeyPress="keyFunction()" type="text" name="tk002c" class="date-picker" value="<?php echo $tk002c; ?>"   minlength="1" required style="background-color:#E7EFEF"/></td>
	  </tr>
