...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 年終發放彙總表 - 列印明細表</h1>
    </div>
	<div class="abgne_tab"> <!-- div-7 -->
		<ul class="tabs">
		    <li><a href="#tab1">彙總表</a></li>
			<li><a href="#tab2">轉excel檔</a></li>
	    </ul>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr33/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14" >核發年度：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();"  onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF"/><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
        <td class="normal14" ></td>
	    <td class="normal14" ></td>
	  </tr>
	  <tr>
	    <td class="start14" >起始列印別：</td>
	    <td class="normal14" ><input tabIndex="4" id="ta002o"  onKeyPress="keyFunction()" type="text" name="ta002o"  value="<?php echo $ta002o; ?>"  size="20" /></td>
        <td class="normal14" >截止列印別：</td>
	    <td class="normal14" ><input tabIndex="5" id="ta002c" onKeyPress="keyFunction()" type="text" name="ta002c"  value="<?php echo $ta002c; ?>"  size="20" /></td>
	  </tr>
	   <tr>
...
<div id="tab2" class="tab_content">
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr33/write"  method="post"  enctype="multipart/form-data" >
	<div id="tab-general"> <!-- div-6 -->
	<?php
	...
	<input id="type" name="type" value="B" style="display:none;" />
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <div class="buttons">
	      <button  type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;轉excel F8&nbsp;'><span>轉 excel </span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
	      <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('main/index/111'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	    </div>
    </form>
    </div> <!-- div-6 -->
