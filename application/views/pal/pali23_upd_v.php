...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 固定津貼建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali23/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td class="normal14"><input type="text" tabIndex="13" id="md013"  onfocus="addsel(this)" onKeyPress="keyFunction()"    name="md013" value="<?php echo $md013; ?>"  /></td>
