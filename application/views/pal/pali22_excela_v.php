...
<body >
	...
	<table class="store">
		<tr>
			<td align="center">列印別資料明細表</td>
        </tr>
	</table>
	
	<table class="thead">
		<tr>
			<td width="15%" align="center">列印別代號</td>
	        <td width="17%" align="center">列印別名稱</td>
	...
	<table class="list">
		...
		<tr>
		  <td width="60" align="center"><?php echo  $row->mm001;?></td>
		  <td width="100" align="center"><?php echo  $row->mm002;?></td>
		  <td align="left"><?php echo  $row->mm003;?></td>
        </tr>
		<?php $pagenum +=1; ?> 
