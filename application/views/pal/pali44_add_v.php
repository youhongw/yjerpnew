...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 年度出勤考績作業 - 新增</h1>
    </div>
	
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/pal/pali44/addsave" >	
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
		...
		<td class="normal14"  ><input type="text" tabIndex="7" id="ye007" onKeyPress="keyFunction()" name="ye007"   value="<?php echo  $ye007; ?>"   /></td>
		<td class="normal14" >全勤日：</td>
		<td class="normal14"  ><input type="text" tabIndex="8" id="ye008" onKeyPress="keyFunction()" name="ye008"   value="<?php echo  $ye008; ?>"   /></td>
	  </tr>
	   <tr>
	    <td class="normal14" >年資：</td>
		<td class="normal14"  ><input type="text" tabIndex="9" id="ye009" onKeyPress="keyFunction()" name="ye009"   value="<?php echo  $ye009; ?>"   /></td>
		<td class="normal14" >日薪：</td>
		<td class="normal14"  ><input type="text" tabIndex="10" id="ye010" onKeyPress="keyFunction()" name="ye010"   value="<?php echo  $ye010; ?>"   /></td>
	  </tr>
	   <tr>
	    <td class="normal14" >考績總分：</td>
		<td class="normal14"  ><input type="text" tabIndex="11" id="ye011" onKeyPress="keyFunction()" name="ye011"   value="<?php echo  $ye011; ?>"   /></td>
	...
	<div class="buttons">
	  ...
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('pal/pali44/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
    </form>
...
<?php include("./application/views/fun/pali44_funjs_v.php"); ?> 