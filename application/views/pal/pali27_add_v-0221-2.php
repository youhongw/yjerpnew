	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 ...
	 <tr>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input type="text" tabIndex="10" onfocus="dataapp15(this)" onKeyPress="keyFunction(event)"  ondblclick="scwShow(this,event);" onChange="dateformat_ymd(this)"  id="ti010" name="ti010" value="<?php echo $ti010; ?>" style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
