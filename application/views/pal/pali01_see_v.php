...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工資料建立作業 - 查看　　　</h1>
	   <div style="float:left;padding-top: 5px; ">
	   <a accesskey="x" id='cancel' name='cancel' href="<?php echo site_url('pal/pali01/'.$this->session->userdata('pali01_search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali01/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	if($mv217==2016){
		if(substr($row->mv021,0,4)<=2016 && substr($row->mv021,4,2)<7)
			$str_day1 = "2017/01/01";
	}
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="24%"><input tabIndex="1" id="mv001"    type="text"   onKeyPress="keyFunction()" onchange="startkey(this)"  name="mv001" value="<?php echo strtoupper($mv001); ?>"   required  disabled="disabled"/>
		  <span id="keydisp" ></span></td>
	    <td class="normal14y" width="11%" >員工姓名： </td>
        <td class="normal14a"  width="24%" ><input tabIndex="2" id="mv002" onKeyPress="keyFunction()" name="mv002"  onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase()" value="<?php echo  strtoupper($mv002); ?>"    type="text"  disabled="disabled"/></td>
		<td class="normal14y" width="9%" >英文名字： </td>
        <td class="normal14a"  width="24%" ><input tabIndex="3" id="mv047" onKeyPress="keyFunction()" name="mv047"  onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase()" value="<?php echo  strtoupper($mv047); ?>"    type="text"  disabled="disabled"/></td>
	 </tr>	
	 ...
	 <!--   <td class="normal14" >科目種類： </td>
        <td class="normal14" ><select id="mv010" onKeyPress="keyFunction()" name="mv010"  tabIndex="4" disabled="disabled">
        ...
        <td class="normal14"><input tabIndex="5" id="mv003" onKeyPress="keyFunction()" name="mv003"  value="<?php echo $mv003; ?>"  size="10" type="text"  disabled="disabled" /></td>
		<td class="normal14z">部門別：</td>
        <td class="normal14"><input type="text" tabIndex="6" onKeyPress="keyFunction()" id="mv004"  name="cmsq05a"  onchange="startcmsq05a(this)"    value="<?php echo  $cmsq05a; ?>"  disabled="disabled"   /><a href="javascript:;"><img id="Showcmsq05a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
	   <span id="cmsq05adisp" > <?php    echo $cmsq05adisp; ?> </span></td>
	  </tr>
		
	  <tr>
	    <td  class="normal14z" >職等：</td>
        <td  class="normal14"  ><input tabIndex="7" id="mv005" onKeyPress="keyFunction()" name="mv005"  value="<?php echo $mv005; ?>"  size="10" type="text"  disabled="disabled" /></td>
		<td class="normal14z">職稱類別：</td>
        <td class="normal14"><input type="text" tabIndex="6" onKeyPress="keyFunction()" id="mv006"  name="cmsq09b"  onchange="startcmsq09b(this)"    value="<?php echo  $cmsq09b; ?>"   disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq09b" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="22%" ><input type="text" tabIndex="12"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);" id="mv008" name="mv008"   value="<?php echo $mv008; ?>"  disabled="disabled"  /></td>
		<td class="normal14y"  width="11%" >身分證號：</td>
        <td class="normal14a"  width="23%" ><input tabIndex="13" id="mv009" onKeyPress="keyFunction()"   name="mv009" value="<?php echo $mv009; ?>" type="text" disabled="disabled" /></td>
	 </tr>	
		  
	  <tr>
	   <td class="normal14z"  >學歷：</td>
        <td class="normal14" ><input type="text" tabIndex="6" onKeyPress="keyFunction()" id="mv012"  name="palq09a"  onchange="startpalq09a(this)"    value="<?php echo  $palq09a; ?>"  disabled="disabled"   /><a href="javascript:;"><img id="Showpalq09a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   <span id="palq09adisp" > <?php    echo $palq09adisp; ?> </span></td>
	    <td class="normal14z" >專長：</td>
        <td class="normal14"  ><input tabIndex="15" id="mv013" onKeyPress="keyFunction()"   name="mv013" value="<?php echo $mv013; ?>" type="text" disabled="disabled" /></td>
		<td class="normal14z" >年資：</td>
        <td class="normal14"  ><input tabIndex="16" id="mv031" onKeyPress="keyFunction()"   name="mv031" value="<?php echo $mv031; ?>" type="text" disabled="disabled" /></td>
	  </tr>
		<tr>
		...
		<td class="normal14z" >到職期：</td>
        <td class="normal14a"   ><input type="text" tabIndex="18"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);" id="mv021" name="mv021"   value="<?php echo $mv021; ?>"  disabled="disabled"  /></td>
		<td class="normal14z"   >試用期滿：</td>
        <td class="normal14a"   ><input tabIndex="19" id="mv052"  onKeyPress="keyFunction()"  onclick="scwShow(this,event);"  name="mv052" value="<?php echo $mv052; ?>" type="text" disabled="disabled" /></td>
	 </tr>	
	 <tr>
	    <td class="normal14z" >離職期：</td>
        <td class="normal14a"   ><input type="text" tabIndex="20"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);" id="mv022" name="mv022"   value="<?php echo $mv022; ?>"  disabled="disabled" /></td>
		<td class="normal14z" >預計退休日：</td>
        <td class="normal14a"   ><input type="text" tabIndex="21"   onKeyPress="keyFunction()"  onclick="scwShow(this,event);" id="mv053" name="mv053"   value="<?php echo $mv053; ?>"   disabled="disabled" /></td>
		<td class="normal14z"   >退休日：</td>
        <td class="normal14a"   ><input tabIndex="22" id="mv023"  onKeyPress="keyFunction()"  onclick="scwShow(this,event);"  name="mv023" value="<?php echo $mv023; ?>" type="text" disabled="disabled"/></td>
	 </tr>	
	  <tr>
	    <!--<td  class="normal14" >文管代號：</td>
        <td  class="normal14"  ><input tabIndex="23" id="mv011" onKeyPress="keyFunction()"   name="mv029" value="<?php echo $mv029; ?>" type="text" disabled="disabled" /></td>
	    <td  class="normal14" >補助等級：</td>		
        <td  class="normal14"  ><input type="text" tabIndex="24"  id="mv024" onKeyPress="keyFunction()"   name="mv024" value="<?php echo $mv024; ?>" disabled="disabled"  /></td>-->
	    <td  class="normal14z" >投保身份：</td>
        <td class="normal14"><input tabIndex="25" id="mv011" onKeyPress="keyFunction()"   name="mv011" value="<?php echo $mv011; ?>" type="text" disabled="disabled" /></td>
		<td  class="normal14z" >特休1：</td>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input tabIndex="26" id="mv025" onKeyPress="keyFunction()"   name="mv025" value="<?php echo $mv025; ?>" type="text"  disabled="disabled"/></td>		   -->
	    <td  class="normal14z" >健保保號：</td>	
        <td  class="normal14"  ><input type="text" tabIndex="27"  id="mv030" onKeyPress="keyFunction()"   name="mv030" value="<?php echo $mv030; ?>"  disabled="disabled" /></td>
	    <td  class="normal14z" >特休2：</td>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="39%"><input tabIndex="28" id="mv015" onKeyPress="keyFunction()" name="mv015" value="<?php echo $mv015; ?>" size="40" type="text" disabled="disabled" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input tabIndex="30" id="mv016" onKeyPress="keyFunction()" name="mv016" value="<?php echo $mv016; ?>" size="40" type="text"  disabled="disabled"/></td>
	    <td class="normal14z" > 主要班別：</td>
        <td class="normal14" ><input type="text" tabIndex="31" onKeyPress="keyFunction()" id="mv027"  name="palq16a"  onchange="startpalq16a(this)"    value="<?php echo  $palq16a; ?>"  disabled="disabled"   /><a href="javascript:;"><img id="Showpalq16a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   <span id="palq16adisp" > <?php    echo $palq16adisp; ?> </span></td>
	  </tr>
	  <tr>
	    <td class="normal14z" > E-MAIL：</td>
        <td class="normal14" ><input tabIndex="32" id="mv020" onKeyPress="keyFunction()" name="mv020" value="<?php echo $mv020; ?>" size="40" type="text" disabled="disabled" /></td>
		<td class="normal14z" >刷卡卡號：</td>
        <td class="normal14" ><input tabIndex="33" id="mv028" onKeyPress="keyFunction()" name="mv028" value="<?php echo $mv028; ?>" size="10" type="text" disabled="disabled" /></td>
	  </tr>
	  <tr>
        <td class="normal14z" > 戶籍地址：</td>
        <td class="normal14" ><input tabIndex="34" id="mv017" onKeyPress="keyFunction()" name="mv017" value="<?php echo $mv017; ?>" size="40" type="text" disabled="disabled" /></td>	   
	   <td class="normal14z" > 郵遞區號：</td>
        <td class="normal14" ><input tabIndex="35" id="mv018" onKeyPress="keyFunction()" name="mv018" value="<?php echo $mv018; ?>"  type="text" disabled="disabled" /></td>
	  </tr>	
	  <tr>
	    <td class="normal14z" > 通信地址：</td>
        <td class="normal14" ><input tabIndex="36" id="mv019" onKeyPress="keyFunction()" name="mv019" value="<?php echo $mv019; ?>" size="40" type="text" disabled="disabled" /></td>
	    <td class="normal14z" > 備註：</td>
        <td class="normal14" ><input tabIndex="37" id="mv046" onKeyPress="keyFunction()" name="mv046" value="<?php echo $mv046; ?>" size="40" type="text" disabled="disabled" /></td>
	  </tr>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14z" width="9%" >薪資別：</td>
		...
		<td class="normal14z"  width="10%">底薪：</td>
        <td class="normal14a"  width="24%" >
		  <input tabIndex="39" id="mv033" onKeyPress="keyFunction()"   name="mv033" value="<?php echo $mv033; ?>" type="text" size="10" disabled="disabled"/></td>
		<td class="normal14z"  width="9%" >轉存方式：</td>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input tabIndex="41" id="mv035" onKeyPress="keyFunction()"   name="mv035" value="<?php echo $mv035; ?>" type="text" disabled="disabled"/></td>-->
	    <td class="normal14z" >帳號：</td>
        <td class="normal14" ><input tabIndex="42" id="mv036" onKeyPress="keyFunction()"   name="mv036" value="<?php echo $mv036; ?>" type="text"  disabled="disabled"/></td>
	   ...
	   <td class="normal14z"  >扶養人數：</td>
         <td class="normal14" ><input tabIndex="44" id="mv037" onKeyPress="keyFunction()"   name="mv037" value="<?php echo $mv037; ?>" type="text" disabled="disabled" /></td>
	    <td class="normal14z" >固定稅額：</td>
        <td class="normal14" ><input tabIndex="45" id="mv039" onKeyPress="keyFunction()"   name="mv039" value="<?php echo $mv039; ?>" type="text" disabled="disabled" /></td>
		<td class="normal14z" >固定稅率：</td>
        <td class="normal14" ><input tabIndex="46" id="mv040" onKeyPress="keyFunction()"   name="mv040" value="<?php echo $mv040; ?>" type="text" disabled="disabled" /></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input tabIndex="50" id="mv045" onKeyPress="keyFunction()"   name="mv045" value="<?php echo $mv045; ?>" type="text"  disabled="disabled"/>  
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
        <td class="normal14z"  width="9%"> 體檢日期：</td>
        <td class="normal14a"  width="24%"><input tabIndex="52" id="mv048" onKeyPress="keyFunction()"  onclick="scwShow(this,event);" name="mv048" value="<?php echo $mv048; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>		  
	    <td class="normal14z"  width="9%"> 入境日期：</td>
        <td class="normal14a"  width="24%"><input tabIndex="53" id="mv049" onKeyPress="keyFunction()"  onclick="scwShow(this,event);" name="mv049" value="<?php echo $mv049; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>
	    <td class="normal14z" width="10%" > 到期日期：</td>
        <td class="normal14a" width="24%"><input tabIndex="54" id="mv050" onKeyPress="keyFunction()"  onclick="scwShow(this,event);" name="mv050" value="<?php echo $mv050; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>
	  </tr>
	  <tr>	  
	   ...
	   <tr>	  
        ...
        <td class="normal14a"  ><input type="text" tabIndex="55" onKeyPress="keyFunction()" id="mv202"  name="palq22a"  onchange="startpalq22a(this)"    value="<?php echo  $palq22a; ?>"    disabled="disabled"  /><a href="javascript:;"><img id="Showpalq22a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   <span id="palq22adisp" > <?php    echo $palq22adisp; ?> </span></td>
		<td class="normal14z"  > 切傳票部門：</td>
        <td class="normal14a"  ><input type="text" tabIndex="56" onKeyPress="keyFunction()" id="mv205"  name="palq20a"  onchange="startpalq20a(this)"    value="<?php echo  $palq20a; ?>"     disabled="disabled" /><a href="javascript:;"><img id="Showpalq20a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   <span id="palq20adisp" > <?php    echo $palq20adisp; ?> </span></td>
	    <td class="normal14z"  > 切傳票公司別：</td>
        <td class="normal14a"  ><input type="text" tabIndex="57" onKeyPress="keyFunction()" id="mv206"  name="palq21a"  onchange="startpalq21a(this)"    value="<?php echo  $palq21a; ?>"    disabled="disabled"  /><a href="javascript:;"><img id="Showpalq21a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	   <span id="palq21adisp" > <?php    echo $palq21adisp; ?> </span></td>
	  </tr>
	   <tr>	  
	    <td class="normal14z"  > 固定減項額：</td>
        <td class="normal14a"  ><input tabIndex="58" id="mv203" onKeyPress="keyFunction()"   name="mv203" value="<?php echo $mv203; ?>"  type="text"  disabled="disabled" /></td>
		<td class="normal14z"  > 固支領現金：</td>
        <td class="normal14a"  ><input tabIndex="59" id="mv204" onKeyPress="keyFunction()"   name="mv204" value="<?php echo $mv204; ?>"  type="text"  disabled="disabled" /></td>
	    <td class="normal14z">選擇個人圖片.jpg：</td>
        <td class="normal14"><input type="file" name="userfile"  tabIndex="60" id="mv207" onchange="showimage(this)" onKeyPress="keyFunction()"  value="<?php echo $userfile; ?>"  size="30" /></td>
	 ...
	 <!--    <td colspan="3" class="normal14"  ><img id="showimg" src="<?php echo base_url();?>assets/image/jpg/<?php echo $uploadfile;?>" style="padding-top:5px"  id="ad" width="60" height="60" border="0" style="padding:5px"/></td> -->
		<td class="normal14"></td>
        <td class="normal14"></td>
	  </tr>
	</table>	 
