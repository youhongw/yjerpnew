...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#mv001').focus();" style= "cursor:pointer" form="commentForm" onfocus="$('#mv001').focus();" tabIndex="8" type='submit'  accesskey="s"  name='submit'  class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	...
	<table class="form14"  >     <!-- 頭部表格  onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase()"-->
	 <tr>
        ...
        <td class="normal14a"  width="24%" ><input tabIndex="3" id="mv047" onKeyPress="keyFunction()" name="mv047"   value="<?php echo  $mv047; ?>" size="16"  type="text"  />z年終扣健保</td>
	 </tr>	
	...
	<div class="abgne_tab"> <!-- div-7 -->
		<ul class="tabs">
			...
			<li><a href="#tab6"  accesskey="i" >特休資料</a></li>
	    </ul>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="22%" ><input type="text" tabIndex="11"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd1(this);check_len(this);" id="mv008" name="mv008"   value="<?php echo $mv008; ?>"   style="background-color:#E7EFEF"   /></td>
	  ...
	  <tr>
	   ...
	   <span id="palq09adisp" > <?php    echo $palq09adisp; ?> </span></td>
        ...
        <td class="normal14a"   ><input type="text" tabIndex="18"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_len(this);" id="mv021" name="mv021"   value="<?php echo $mv021; ?>"   style="background-color:#E7EFEF"   /><span ></td>
		<td class="normal14z"   >試用期滿：</td>
        <td class="normal14a"   ><input tabIndex="19" id="mv052"  onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_len(this);"  name="mv052" value="<?php echo $mv052; ?>" type="text"  style="background-color:#E7EFEF"  /><span ></span></td>
	 </tr>	
	 <tr>
	    <td class="normal14z" >離職期：</td>
        <td class="normal14a"   ><input type="text" tabIndex="20"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_len(this);" id="mv022" name="mv022"   value="<?php echo $mv022; ?>"   style="background-color:#E7EFEF"   /></span></td>
		<td class="normal14z" >預計退休日：</td>
        <td class="normal14a"   ><input type="text" tabIndex="21"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_len(this);" id="mv053" name="mv053"   value="<?php echo $mv053; ?>"    style="background-color:#E7EFEF"  /></span></td>
		<td class="normal14z"   >退休日：</td>
        <td class="normal14a"   ><input tabIndex="22" id="mv023"  onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_len(this);"  name="mv023" value="<?php echo $mv023; ?>" type="text"  style="background-color:#E7EFEF"  /></span></td>
	 </tr>	
	  <tr>
	 ...
	 <tr>
		<td  class="normal14z" >離職原因：</td>
        <td class="normal14" colspan="4" ><input tabIndex="25" id="mv399" onKeyPress="keyFunction()"   name="mv399" value="<?php echo $mv399; ?>" type="text" size="100" /></td>
        <td  class="normal14" ></td>
        <td class="normal14"></td>	 
	 </tr>
	</table>
...
<input name="code" size="5" type="text">
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>	
		<td colspan="1" class="normal14y" width="6%" >評語：</td>
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
        <td class="normal14y"  width="12%"> 起始特休日期1：</td>
        <td class="normal14a"  width="48%"><input tabIndex="53" id="mv301" readonly="readonly" onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);"   name="mv301" value="<?php echo $mv301; ?>"  type="text"   /></td>		  	   
		<td class="normal14y"  width="12%"> 截止特休日期1：</td>
        <td class="normal14a"  width="48%"><input tabIndex="54" id="mv302" readonly="readonly" onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);"   name="mv302" value="<?php echo $mv302; ?>"  type="text"   /></td>
	     </tr>
	  <tr>	  
	    <td class="normal14z"  > 延長特休月數：</td>
        <td class="normal14a"  ><input tabIndex="56" id="mv303" readonly="readonly" onKeyPress="keyFunction()"   name="mv303" value="<?php echo $mv303; ?>"  type="text"  /></td>
		<td class="normal14z"  > 延長特特休日期1：</td>
        <td class="normal14a"  ><input tabIndex="57" id="mv304" readonly="readonly" onKeyPress="keyFunction()"   name="mv304" value="<?php echo $mv304; ?>"  type="text"  /></td>
	     </tr>
	    <tr>	  
	    <td class="normal14z"  > 特休天數1：</td>
        <td class="normal14a"  ><input type="text" tabIndex="59" readonly="readonly" onKeyPress="keyFunction()" id="mv305"  name="mv305"      value="<?php echo  $mv305; ?>"     />
	   </td>
		<td class="normal14z"  >  已休天數1：</td>
        <td class="normal14a"  ><input type="text" tabIndex="60" readonly="readonly" onKeyPress="keyFunction()" id="mv306"  name="mv306"      value="<?php echo  $mv306; ?>"     />
	   </td>
	    </tr>
	   
	   <tr>	  
	    <td class="normal14z"  >起始特休日期2：</td>
        <td class="normal14a"  ><input type="text" tabIndex="59" readonly="readonly" onKeyPress="keyFunction()" id="mv307"  name="mv307"      value="<?php echo  $mv307; ?>"     />
	   </td>
		<td class="normal14z"  >截止特休日期2：</td>
        <td class="normal14a"  ><input type="text" tabIndex="60" readonly="readonly" onKeyPress="keyFunction()" id="mv308"  name="mv308"      value="<?php echo  $mv308; ?>"     />
	   </td>
	    </tr>
		 <tr>	  
	    <td class="normal14z"  >延長特特休日期2：</td>
        <td class="normal14a"  ><input type="text" tabIndex="59" readonly="readonly" onKeyPress="keyFunction()" id="mv309"  name="mv309"      value="<?php echo  $mv309; ?>"     />
	   </td>
		<td class="normal14z"  >特休天數2：</td>
        <td class="normal14a"  ><input type="text" tabIndex="60" readonly="readonly" onKeyPress="keyFunction()" id="mv310"  name="mv310"      value="<?php echo  $mv310; ?>"     />
	   </td>
	    </tr>
		 <tr>	  
	    <td class="normal14z"  >已休天數2：</td>
        <td class="normal14a"  ><input type="text" tabIndex="59" readonly="readonly" onKeyPress="keyFunction()" id="mv311"  name="mv311"      value="<?php echo  $mv311; ?>"     />
	   </td>
