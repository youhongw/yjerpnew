...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 特休控管計算 - 計算</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palb03/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14a"  >延長特休月數：</td>
        <td class="normal14a"  ><input tabIndex="1" id="dateym" readonly="readonly" name="dateym" onKeyPress="keyFunction()"  type="text"  value="<?php echo $dateym; ?>"  size="10"  /></td>
	  </tr>
    </table>
	...
	<!--	<a onclick="return doit();" class="button"><span>計算&nbsp</span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a> -->
		...
		<div class="buttons">
	   <!--   <a onclick="return doit();"   tabIndex="98" accesskey="c" class="button"  value='&nbsp;計 算F8&nbsp;'><span>轉 入Alt+c</span><img src="<?php echo base_url()?>assets/image/png/cal.png" /></a>  -->
...
function submit_ajax(){
	...
	//$('#ifm_batch').attr("src","<?php echo base_url()?>index.php/pal/palb03/batch_ajax?dateym="+dateym);
	//window.open("<?php echo base_url()?>index.php/pal/palb03/batch_ajax?ajax=1&dateym="+dateym, "年資特休計算中...", config='toolbar=no,scrollbars=no,resizeable=no,location=no,menubar=no,height=50,width=300');
	if(batching==0){
		//clear_progress();
		//start_check_progress();
		batching = 1;
		...
		$.ajax({
			method: "POST",
			dataType:"json",
			url: "<?php echo base_url()?>index.php/pal/palb03/batch_ajax",
			data: {
			  dateym : dateym
			}
		})
...
function check_progress(){
	...
	$.ajax({
		method: "POST",
		dataType:"json",
		url: "<?php echo base_url()?>index.php/pal/palb03/check_batch_ajax?times="+check_times,
		data: {
