...
function filter() {
	...
	if (filter_yg002disp) {
		url = '<?php echo base_url() ?>index.php/pal/pali46/filter1/yg002disp/desc/' + encodeURIComponent(filter_yg002disp);
	} 
...
function filtera() {
	...
	var filter_yg002disp = $('input[name=\'filter_yg002disp\']').val();
	if (filter_yg002disp) {
		url = '<?php echo base_url() ?>index.php/pal/pali46/filter1/yg002disp/asc/' + encodeURIComponent(filter_yg002disp);
	} 
