  <div class="box2" style="height:95%"> <!-- div-1 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 班別基本資料建立作業 - 瀏覽</h1>
	</div>
<?php 
/* title欄位設定區域 */
	$title_array = array(
		'rowid' => array('sort_name'=>"mo001",'name'=>"序號",'width'=>"",'align'=>"left",'use'=>"disable"),
		'mo001' => array('sort_name'=>"mo001",'name'=>"班別代號",'width'=>"",'align'=>"left"),
		'mo002' => array('sort_name'=>"mo002",'name'=>"班別名稱",'width'=>"",'align'=>"left"),
		'mo004' => array('sort_name'=>"mo004",'name'=>"上班時間",'width'=>"",'align'=>"left"),
		'mo005' => array('sort_name'=>"mo005",'name'=>"下班時間",'width'=>"",'align'=>"left"),
...
/* filter欄位設定區域 */
	$filter_array = array(
		...
		'mo001' => array('filter_name'=>"mo001",'name'=>"班別代號",'size'=>"8",'align'=>"left"),
		'mo002' => array('filter_name'=>"mo002",'name'=>"班別名稱",'size'=>"12",'align'=>"left"),
		'mo004' => array('filter_name'=>"mo004",'name'=>"上班時間",'size'=>"12",'align'=>"left"),
		'mo005' => array('filter_name'=>"mo005",'name'=>"下班時間",'size'=>"12",'align'=>"left")
	);
?>
        ...
        <tr>
			...
			<td class="center"><a href="javascript:send_back('<?php echo $row->mo001;?>','<?php echo $row->mo002;?>');">[ 選擇 </a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>  
		</tr>
		  <?php $chkval += 1; ?>
		  <?php endforeach;?>
        </tbody>		 
...
function send_back(mo001, mo002){
	window.parent.$.unblockUI();
	if(window.parent.addmt001disp){	//以此判斷各呼叫此網頁的方法是否存在藉以給予相對應的需求
		window.parent.addmt001disp(mo001,mo002);
		$.ajax({
			method: "POST",
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/pal/pali16/display_child/0/and_where?key=' + encodeURIComponent(key) + 
