...
foreach($rows as $key => $val){					//each 組
	unset($group_total);
	foreach($val as $k => $v){					//each Data  11筆一頁
...
?>
	  <tr><!-- 表身 物料 -->
	    <td width="4%" align="center" valign="top"><?php echo '' ?></td>
		...
		<td width="5%" align="right" valign="top"><?php echo $page_data_total[$i]['total']['yh043']?></td>
		<td width="5%" align="right" valign="top"><?php echo ''?></td>
      </tr>
	</table>
	<table class="store">
