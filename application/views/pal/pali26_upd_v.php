...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 異動薪資維護作業- 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali26/updsave" method="post" enctype="multipart/form-data" >
	...
	<?php foreach($result as $row) { ?>
		  ...
		  <?php   $md012=$row->md012;?>
		  <?php   $md013=$row->md013;?>
		  <?php   $md014=substr($row->md014,0,4).'/'.substr($row->md014,4,2).'/'.substr($row->md014,6,2);?>
		  <?php   $md015=$row->md015;?>
		  <?php   $md016=$row->md016;?>
		  <?php   $md017=$row->md017;?>
		  <?php   $md018=$row->md018;?>
		  <?php   $cmsq09bdisp=$row->md018;?>
		  <?php   $md019=$row->md019;?>
		  <?php   $md020=$row->md020;?>
          <?php   $flag=$row->flag;?>	  
	<?php  }?>
	...
	<table class="form14">  <!-- 表格 -->
        ...
        <td class="normal14a"  width="40%"> <input   tabIndex="2" id="md002" onKeyPress="keyFunction()" onchange="startcmsq05a(this)" name="cmsq05a" value="<?php echo $cmsq05a; ?>"  type="text" required /><img id="Showcmsq05a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
         <span id="cmsq05adisp"> <?php    echo $cmsq05adisp; ?> </span></td>
       
	  </tr>	
		<tr>
	    <td class="start14a" >異動日期： </td>
        <td class="normal14" ><input  tabIndex="3" onKeyPress="keyFunction()" onchange="dateformat_ymd(this);" onclick="scwShow(this,event);"  id="md014" name="md014"  value="<?php echo $md014; ?>"  type="text" style="background-color:#E7EFEF" /></td>
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="12" id="md013"  onfocus="addsel(this)"    onKeyPress="keyFunction()"    name="md013" value="<?php echo $md013; ?>"  /></td>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="11" id="md016"      onKeyPress="keyFunction()"    name="md016" value="<?php echo $md016; ?>"  /></td>	  
	    <td class="normal14">職級：</td>		
        <td  class="normal14"  ><input type="text" tabIndex="12" id="md017"      onKeyPress="keyFunction()"    name="md017" value="<?php echo $md017; ?>"  /></td>
	  </tr>
	  <tr>
	   ...
	   <td class="normal14">職務：</td>		
        <td  class="normal14"  ><input type="text" tabIndex="12" id="md019"      onKeyPress="keyFunction()"    name="md019" value="<?php echo $md019; ?>"  /></td>
	  </tr>
	  <tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pal/pali26/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
