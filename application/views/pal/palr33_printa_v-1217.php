...
foreach($rows as $key => $val){					//each 組
	...
	foreach($val as $k => $v){					//each Data
		if($k!=0 && $k%40 == 0){					//%多少等於一頁多少筆
			$page_data_total[$pages]['num'] = 40;//一頁多少筆(需跟上面一樣多)
...
?>
	  <tr><!-- 表身 物料 -->
		...
		<td width="8%" align="right" valign="top" class="grayback"><?php echo $val->yh051?></td>
...
?>
	  <tr><!-- 表身 物料 -->
		...
		<td width="7%" align="right" valign="top"><?php if(@$page_data_total[$i]['total']['yh005']=="") echo "";else echo $page_data_total[$i]['total']['yh005']?></td>
	    <td width="7%" align="right" valign="top"><?php echo ''?></td>
	    <td width="8%" align="right" valign="top"><?php echo ''?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
