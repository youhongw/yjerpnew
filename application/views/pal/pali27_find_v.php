...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工加保建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pal/pali27/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='ti001'> ti001 員工代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='ti002'> ti002 部門代號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='ti005'> ti005 健保加保金額 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='ti006'> ti006 健保加保日期 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='ti007'> ti007 健保退保日期 </option>
			<option <?php if($find001 == '6') echo 'selected="selected"';?> value='ti009'> ti009 勞保加保金額 </option>
            <option <?php if($find001 == '7') echo 'selected="selected"';?> value='ti010'> ti010 勞保加保日期 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='ti011'> ti011 勞保退保日期 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='ti001'> ti001 員工代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='ti002'> ti002 部門代號</option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='ti005'> ti005 健保加保金額 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='ti006'> ti006 健保加保日期 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='ti007'> ti007 健保退保日期 </option>
			<option <?php if($find006 == '6') echo 'selected="selected"';?> value='ti009'> ti009 勞保加保金額 </option>
            <option <?php if($find006 == '7') echo 'selected="selected"';?> value='ti010'> ti010 勞保加保日期 </option>
		    <option <?php if($find006 == '8') echo 'selected="selected"';?> value='ti011'> ti011 勞保退保日期 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = 'http://ci.dercaster.com/index.php/pur/puri01/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
