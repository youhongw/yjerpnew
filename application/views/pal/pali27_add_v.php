	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 ...
	 <tr>
	  ...
	  <tr>
        ...
        <td class="normal14"><input type="text" tabIndex="8"  onKeyPress="keyFunction(event)"   id="ti008" name="ti008" value="<?php echo $ti008; ?>" size="3" />投保金額：<input type="text" tabIndex="9"  onKeyPress="keyFunction()" onchange="check_ti0099(this)" id="ti009" name="ti009" value="<?php echo $ti009; ?>" size="8" />　<span id="ti009_true_insure"></span></td>
