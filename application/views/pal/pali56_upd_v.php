...
<div id="content">  <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
	...
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/pal/pali56/updsave" >	
...
<!--管理--><td class='normal14'><input type="button" onclick="del_overtime(<?php echo $origin_num;?>);" value="刪除"/></td>
	...
	<a accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pal/pali56/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
 ...
 <?php //include("./application/views/fun/pali56_funjs_v.php"); ?> 
