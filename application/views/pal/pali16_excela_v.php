...
<body >
	...
	<table class="list">
		...
		<tr>
		  <td  align="center"><?php echo  $row->mh001;?></td>
		  <td  align="center"><?php echo  $row->mh002;?></td>
		  <td align="left"><?php echo  $row->mh003;?></td>
		  <td align="left"><?php echo  $row->mh004;?></td>
        </tr>
		<?php $pagenum +=1; ?> 
