...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 年終薪資條 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr31/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
       <tr>
        ...
        <td class="normal14a" width="38%">
	     <input tabIndex="2" id="ta002" onKeyPress="keyFunction()" type="text" name="ta001c"  value="<?php echo $ta001c; ?>"   minlength="1" required /></td> 
	  <tr>
	    <td class="start14" >核薪年度：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();"   onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF"/><span > <?php echo '輸入範例yyyy'; ?> </span></td>
