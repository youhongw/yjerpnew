...
<div id="content">
 ...
 <div class="box">
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 出勤資料建立作業 - 轉Excel</h1>
    </div>
  
    <div class="content">
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali33/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
	  ...
	  <tr>
        ...
        <td class="normal14a" >
		 <input tabIndex="1" id="tc002o" onKeyPress="keyFunction()" type="text" name="tc002o" onchange="dateformat_ym(this);" class="date-picker" value="<?php echo date('Y/m'); ?>"  style="background-color:#E7EFEF" /></td>
	    <td class="normal14a" >結束發薪年月：</td>
        <td class="normal14a" >
	     <input tabIndex="1" id="tc002c" onKeyPress="keyFunction()" type="text" name="tc002c" onchange="dateformat_ym(this);" class="date-picker" value="<?php echo date('Y/m'); ?>"   minlength="1" required style="background-color:#E7EFEF"/></td>
	  </tr>
