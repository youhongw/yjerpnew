...
<body >
	...
	<table class="store">
		<tr>
			<td align="center">下拉選單名稱明細表</td>
        </tr>
	</table>
	
	<table class="thead">
		<tr>
			<td width="15%" align="center">名稱流水號</td>
	        <td width="17%" align="center">名稱</td>
	...
	<table class="list">
		...
		<tr>
		  <td width="60" align="center"><?php echo  $row->op1no;?></td>
		  <td width="100" align="center"><?php echo  $row->op1name;?></td>
		  <td align="left"><?php echo  $row->mi003;?></td>
        </tr>
		<?php $pagenum +=1; ?> 
