...
?>
	  <tr><!-- 表身 物料 -->
		...
		<td width="5%" align="right" valign="top"><?php echo $val->yh026?><br><?php echo $val->yh027?><br><?php echo $val->yh028?>
		                                          <br><?php echo $val->yh029?><br><?php echo $val->yh030?></td>
		<td width="5%" align="right" valign="top"><?php echo $val->yh031?><br><?php echo $val->yh032?><br><?php echo $val->yh033?>
		                                          <br><?php echo $val->yh034?><br><?php echo $val->yh035?></td>
