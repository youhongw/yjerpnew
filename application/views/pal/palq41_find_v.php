...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 薪資明細查詢 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pal/palq41/findsql" method="post" enctype="multipart/form-data" >
    </div>
   ...
   <!-- <div id="htabs" class="htabs14"><span>進階資料-設定查詢條件</span></div>-->
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='td001'> td001 員工代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='td002'> td002 部門代號 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='td003'> td003 發薪年月 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='td030'> td030 應領 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='td039'> td039 實領 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='td042'> td042 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='td001'> td001 員工代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='td002'> td002 部門代號 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='td003'> td003 發薪年月 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='td030'> td030 應領 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='td039'> td039 實領 </option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='td042'> td042 備註 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pal/palq41/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pal/palq41/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
