...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 扣繳憑單 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr61/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14" >起始扣繳年月：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();" onchange="dataym3(this)"  onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>" size="20" style="background-color:#E7EFEF" minlength="6" required  /><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
        <td class="normal14" >結束扣繳年月：</td>
	    <td class="normal14" ><input tabIndex="3" id="datec" onfocus="this.select();" onchange="dateformat_ym(this)"  onKeyPress="keyFunction()" type="text" name="datec"  value="<?php echo $dateo; ?>" size="20" style="background-color:#E7EFEF" minlength="6" required  /><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
	  </tr>
