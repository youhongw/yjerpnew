...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 學歷資料建立作業 - 新增　　　</h1>
	  ...
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('pal/pali09/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/pal/pali09/addsave" >	
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14"  width="39%"><input   tabIndex="1" id="mi001" onKeyPress="keyFunction()" onchange="startkey(this)" name="mi001" value="<?php echo $mi001; ?>"  type="text" required />
