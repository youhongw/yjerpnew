	...
	<table class="store">    <!-- 跳頁用 a4橫式--> <!-- 跳頁用 1.a4橫式 2.Letter -->
	   <tr> <?php echo $br ; ?><td align="left">刷卡日期:&nbsp;<?php echo $dateo.'至'.$datec; ?>
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="40%" align="left">刷卡時間</td>
      </tr>
	</table>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
		 ...
		 <td width="10%" align="left"><?php echo $row->te001disp;?></td>
		 <td width="10%" align="left"><?php echo $row->mv027disp;?></td>
         <td width="10%" align="left"><?php echo substr($row->te002,0,4)."/".substr($row->te002,4,2)."/".substr($row->te002,6,2);?></td> 
		 <td width="50%" align="left"><?php echo $row->te003;?></td> 
