 ...
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 ...
	 <tr>
	  ...
	  <tr>
        ...
        <td class="normal14"><input type="text" tabIndex="8"  onKeyPress="keyFunction()"   id="ti008" name="ti008" value="<?php echo $ti008; ?>" size="3" /> 投保金額：<input type="text" tabIndex="9" onchange="check_ti0099(this)" onKeyPress="keyFunction()" id="ti009" name="ti009" value="<?php echo $ti009; ?>" size="8" />　<span id="ti009_true_insure"></span></td>
	    <td class="normal14">勞保生效日期： </td>
        <td class="normal14"><input type="text" tabIndex="10"  onKeyPress="keyFunction()"   onfocus="dataapp15(this)" ondblclick="scwShow(this,event);" onChange="dataapp10(this)"  id="ti010" name="ti010" value="<?php echo $ti010; ?>" style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
		<td class="normal14">勞保退保日期：</td>
        <td class="normal14"><input type="text" tabIndex="11"  onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);" onChange="dataapp11(this)"  id="ti011" name="ti011" value="<?php echo $ti011; ?>"  style="background-color:#E7EFEF" /><span > <?php echo ''; ?> </span></td>
	  </tr>
	  <tr>
	...
	<!--	<td class="normal14">異動日期：</td>
        <td class="normal14"><?php echo substr($modi_date,0,4)."/".substr($modi_date,4,2)."/".substr($modi_date,6,2); ?></td> -->
          <td class="normal14">勞退公司提6%： </td>
        <td class="normal14"><input type="text" tabIndex="10"  onKeyPress="keyFunction()" onfocus="dataapp155(this)"   id="ti019" name="ti019" value="<?php echo $ti019; ?>"  /></td>
...
$(document).ready(function(){
	$('#ti004').change();$('#ti005').change();$('#ti008').change();$('#ti009').change();get_ti002();
});
...
<script type="text/javascript"><!--       
 function dataapp15(){
	...
	/*	var temp = $('#ti015').val();
		...
		console.log(temp);
		console.log(temp1);
		if(temp>='0'){form.ti016.value=Math.round(temp1*parseFloat(temp)/100);} else {form.ti016.value=0;}
		*/
}
 function dataapp155(){
	//首先判斷是否有輸入，沒有輸入直接返回，並提示
...
//不更新網頁 輸入直接跳出中文
/*
function check_pali18(row_obj){
	var sme001= $('#ti018').val();
	console.log(sme001);
	//if(!sme001){$('#cmsi05disp').text("");return;}
	$.ajax({
		url: '<?php echo base_url(); ?>index.php/pal/pali18/lookup_check/'+encodeURIComponent(sme001), 
		cache: false, 				
		dataType: 'json',  
		type: 'POST',  
		data: {ti018:row_obj.value},
		success:      
		function(data){
			if(data.response == "true"){
				...
				$('#ti018').val(sme001);
				$('#ti017').val(data.message[0].value2);
				console.log(sme001);
			}else{
				$('#ti018').val(sme001);
				$('#ti017').text("查無資料");
