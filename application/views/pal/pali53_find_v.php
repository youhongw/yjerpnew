...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 加班單建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pal/pali53/display_search" method="post" enctype="multipart/form-data" >
    </div>
   ...
   <!-- <div id="htabs" class="htabs14"><span>進階資料-設定查詢條件</span></div>-->
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='tf001'> tf001 員工代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='tf002'> tf002 加班日期 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='tf003'> tf003 星期 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='tf010'> tf010 平加班2內 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='tf011'> tf011 平加班2外 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='tf016'> tf016 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='tf001'> tf001 員工代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='tf002'> tf002 加班日期 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='tf003'> tf003 星期 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='tf010'> tf010 平加班2內 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='tf011'> tf011 平加班2外 </option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='tf016'> tf016 備註 </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pal/pali53/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pal/pali53/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
