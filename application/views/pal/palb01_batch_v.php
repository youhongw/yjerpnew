   ...
   //  if (!$this->input->post('datemm'))  {$datemm=date("m");}	
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td class="normal14a" width="88%" ><input tabIndex="1" id="dateyymm"  onfocus="this.select();" onKeyPress="keyFunction()"  onChange="dataym4(this)"    type="text" name="dateyymm"  value="<?php echo $dateyymm; ?>"  size="10" style="background-color:#E7EFEF"  /><span > <?php   echo '輸入範例格式YYYYMM'; ?> </span></td>
	  </tr>
    </table>
