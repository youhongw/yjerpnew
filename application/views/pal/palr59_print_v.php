...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 薪資印領清冊 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr59/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
       <tr>
        ...
        <td class="normal14a" width="38%">
		 <input tabIndex="1" id="mv001o" onKeyPress="keyFunction()" type="text" name="mv001o"  value="<?php echo $mv001o; ?>" /></td>
	    <td class="normal14a" width="12%">結束員工代號：</td>
        <td class="normal14a" width="38%">
	     <input tabIndex="2" id="mv001c" onKeyPress="keyFunction()" type="text" name="mv001c"  value="<?php echo $mv001c; ?>" /></td> 
	  <tr>
	    <td class="start14" >起始年月：</td>
        ...
        <td class="start14" >結束年月：</td>
	    <td class="normal14" ><input tabIndex="4" id="datec" onfocus="this.select();" onchange="dateformat_ym(this)" onKeyPress="keyFunction()" type="text" name="datec"  value="<?php echo $datec; ?>"  size="20" style="background-color:#E7EFEF"/><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
	  </tr>
	  <tr>
