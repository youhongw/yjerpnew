	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
		 ...
		 <td width="16%" align="left"><?php echo $row->td036;?></td>
		
       		
        </tr>		
		 <?php $pagenum +=1;$prow=1;$i++;$pagenum1=$pagenum;$mv013k=$mv013k+$row->td036;$mv013ak=$mv013ak;$mv013bk=$mv013bk; ?> 
