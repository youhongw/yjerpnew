...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali01/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="22%" ><input type="text" tabIndex="11"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd1(this)" id="mv008" name="mv008"   value="<?php echo $mv008; ?>"   style="background-color:#E7EFEF"   /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
	  ...
	  <tr>
	   ...
	   <span id="palq09adisp" > <?php    echo $palq09adisp; ?> </span></td>
        ...
        <td class="normal14"  ><input tabIndex="15" id="mv031" onKeyPress="keyFunction()"   name="mv031" value="<?php echo $mv031; ?>" type="text"  /></td>
	  </tr>
		<tr>
        ...
        <td class="normal14a"   ><input type="text" tabIndex="18"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd2(this)" id="mv021" name="mv021"   value="<?php echo $mv021; ?>"   style="background-color:#E7EFEF"   /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
		<td class="normal14a"   >試用期滿：</td>
        <td class="normal14a"   ><input tabIndex="19" id="mv052"  onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd3(this)"  name="mv052" value="<?php echo $mv052; ?>" type="text"  style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
	 </tr>	
	 <tr>
	    <td class="normal14a" >離職期：</td>
        <td class="normal14a"   ><input type="text" tabIndex="20"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd4(this)" id="mv022" name="mv022"   value="<?php echo $mv022; ?>"   style="background-color:#E7EFEF"   /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
		<td class="normal14a" >預計退休日：</td>
        <td class="normal14a"   ><input type="text" tabIndex="21"   onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd5(this)" id="mv053" name="mv053"   value="<?php echo $mv053; ?>"    style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
		<td class="normal14a"   >退休日：</td>
        <td class="normal14a"   ><input tabIndex="22" id="mv023"  onKeyPress="keyFunction()"  ondblclick="scwShow(this,event);" onchange="dataymd6(this)"  name="mv023" value="<?php echo $mv023; ?>" type="text"  style="background-color:#E7EFEF"  /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
	 </tr>	
	  <tr>
...
<input name="code" size="5" type="text">
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="24%"><input tabIndex="53" id="mv048" onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);" onchange="dataymd7(this)"  name="mv048" value="<?php echo $mv048; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>		  
	    <td class="normal14a"  width="9%"> 入境日期：</td>
        <td class="normal14a"  width="24%"><input tabIndex="54" id="mv049" onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);" onchange="dataymd8(this)"  name="mv049" value="<?php echo $mv049; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>
	    <td class="normal14a" width="10%" > 到期日期：</td>
        <td class="normal14a" width="24%"><input tabIndex="55" id="mv050" onKeyPress="keyFunction()"   ondblclick="scwShow(this,event);" onchange="dataymd9(this)"  name="mv050" value="<?php echo $mv050; ?>"  type="text"  style="background-color:#E7EFEF"  /></td>
	  </tr>
	  <tr>	  
	...
	<table class="form14">     <!-- 表格 -->
	 ...
	 <tr>
       ...
       <div class="buttons">
	    ...
	    <a   accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pal/pali01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
</div> <!-- div-3 -->
    <?php  if ($message!=' ') { ?>
...
<script type="text/javascript">
      ...
      {
       var vmv211=CKEDITOR.instances[elemID].getData();
			 vtot=vmv211+text;
			 CKEDITOR.instances[elemID].setData(vtot);
      }
    </script>
