...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 考績分數建立作業 - 新增</h1>
    </div>
	
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/pal/pali45/addsave" >	
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
		...
		<td class="normal14"  ><input type="text" tabIndex="4" id="yf004" onfocus="this.select" onKeyPress="keyFunction()" name="yf004"  onchange="circle() value="<?php echo  $yf004; ?>"   /></td>
		<td class="normal14">&nbsp;&nbsp;</td>
        <td class="normal14"></td>
	  </tr>
	   <tr>
	...
	<div class="buttons">
	  ...
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('pal/pali45/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
    </form>
...
<?php include("./application/views/fun/pali45_funjs_v.php"); ?> 