...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 每月固定扣款建立 - 查看</h1>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali35/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14">
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="6" id="ta006"     onKeyPress="keyFunction()"    name="ta006" value="<?php echo $ta006; ?>" disabled="disabled" /></td>
	  </tr>
	   <tr>
	    <td  class="normal14" >其他加項2：</td>
        <td  class="normal14"  ><input type="text" tabIndex="7" id="ta007"      onKeyPress="keyFunction()"    name="ta007" value="<?php echo $ta007; ?>"  disabled="disabled"/></td>	  
	    <td class="normal14a">食宿費：</td>		
        <td  class="normal14"  ><input type="text" tabIndex="8" id="ta008"      onKeyPress="keyFunction()"    name="ta008" value="<?php echo $ta008; ?>" disabled="disabled" /></td>
	  </tr>
	   <tr>
	    <td  class="normal14" >其他減項2：</td>
        <td  class="normal14"  ><input type="text" tabIndex="9" id="ta009"     onKeyPress="keyFunction()"    name="ta009" value="<?php echo $ta009; ?>" disabled="disabled"/></td>	  
	    <td class="normal14">水電費：</td>		
        <td  class="normal14"  ><input type="text" tabIndex="10" id="ta010"     onKeyPress="keyFunction()"    name="ta010" value="<?php echo $ta010; ?>"  disabled="disabled"/></td>
	  </tr>
	   <tr>
	    <td  class="normal14a" >破月伙食費：</td>
        <td  class="normal14"  ><input type="text" tabIndex="11" id="ta011"    onKeyPress="keyFunction()"    name="ta011" value="<?php echo $ta011; ?>"  disabled="disabled"/></td>	  
	    <td class="normal14"></td>		
        <td  class="normal14"  ></td>
	  </tr>
	   <tr>
