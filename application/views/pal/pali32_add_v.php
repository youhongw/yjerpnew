  ...
  <div class="box"> <!-- div-4 -->
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a" width="35%"> <input tabIndex="2" id="tb002" onKeyPress="keyFunction()" onblur="startcmsq05a(this)" name="cmsq05a" value="<?php echo $cmsq05a; ?>"  type="text" required /><img id="Showcmsq05a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
