...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 試算天數建立作業 - 新增</h1>
    </div>
	
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/pal/pali42/addsave" >	
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14"  width="39%"><input   tabIndex="1" id="yc001" onKeyPress="keyFunction()" onchange="startkey(this)" name="yc001" value="<?php echo $yc001; ?>"  type="text" required />
	...
	<div class="buttons">
	  ...
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('pal/pali42/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
    </form>
