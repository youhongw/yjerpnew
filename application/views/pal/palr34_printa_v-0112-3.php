...
?>
    ...
    <table class="list">
	<?php
	$vyh051=0;$vyh034=0;$vyh051t1=0;$vyh034t1=0;$vyh051t2=0;$vyh034t2=0;$vyh051t3=0;$vyh034t3=0;$vyh051t4=0;$vyh034t4=0;$vyh051t=0;$vyh034t=0;
	$num_each_page = $i*24;
       ...
       <?php if ($data[$j]->yh046=='2') {  $vyh034=$data[$j]->yh034;}  ?><?php if ($data[$j]->yh046=="1")  { $vyh034=0;}   ?>
		...
		<?php if (substr($data[$j]->mkj001,0,1)<>'T') { ?>
		 ...
		 <?php $vyh051t2=$vyh051t2+$vyh051; $vyh034t2=$vyh034t2+$vyh034; ?>
		  ...
		  <?php } ?>
		   <?php $vyh051t=$vyh051t+$vyh051; $vyh034t=$vyh034t+$vyh034; ?>
