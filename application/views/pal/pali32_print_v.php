...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工借支建立作業 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali32/printa"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-明細表</span></div>-->
	<div id="tab-general"> <!-- div-6 -->
	<?php
  	  $tb001o=$this->input->post('tb001o');
	  $tb001c=$this->input->post('tb001c');
	  $cmsq09a32disp=$this->input->post('tb001c');
	...
	<table class="form14">   <!-- 表格 -->
       <tr>
        ...
        <td class="normal14a" width="39%">
	     <input tabIndex="1" id="tb002" onKeyPress="keyFunction()" type="text" name="tb001c"  value="<?php echo $tb001c; ?>" /></td> 
	 <!--     <input   tabIndex="1" id="tb001c" onKeyPress="keyFunction()"  name="cmsq09a32" value="<?php echo $tb001c; ?>"  type="text" required /><img id="Showcmsq09a32" src="<?php echo base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
