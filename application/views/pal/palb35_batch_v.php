...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 固定加扣款轉入變動津貼 - 計算</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palb35/batcha"  method="post"  enctype="multipart/form-data" > 
   ...
   //  if (!$this->input->post('datemm'))  {$datemm=date("m");}	
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14a" width="12%" >轉入年月：</td>
        <td class="normal14a" width="88%" ><input tabIndex="1" id="dateyymm"   onKeyPress="keyFunction()"  onfocus="this.select();"  onChange="dataym4(this)"    type="text" name="dateyymm"  value="<?php echo $dateyymm; ?>"  size="10"  style="background-color:#E7EFEF"/><span > <?php   echo '輸入範例格式YYYYMM'; ?> </span></td>
	  </tr>
    </table>
