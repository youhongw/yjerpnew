	...
	<table class="store">    <!-- 跳頁用 a4橫式--> <!-- 跳頁用 1.a4橫式 2.Letter -->
	   <!--<tr> <?php echo $br ; ?><td align="left">起迄加班日期:&nbsp;<?php echo $dateo.'至'.$datec; ?>
	   &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->session->userdata('sysml003'); ?></td></tr>
		  ...
		  {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";} ?>		    
			...
			<tr>
				<td align="left" width="33%">起迄加班日期：&nbsp;<?php echo $dateo.'至'.$datec; ?></td>
				<td align="center" width="33%">外勞加班日報表</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
	    <tr>
		  <td width="9%" align="left"><?php echo  $row->tf002;?></td>
		 ...
		 <td width="8%" align="right"><?php echo  $row->tf010;?></td>
		 <td width="8%" align="right"><?php echo  $row->tf011;?></td>
		 <td width="8%" align="right"><?php echo  $row->tf012;?></td>
		 <td width="8%" align="right"><?php echo  $row->tf013;?></td>
		 <td width="8%" align="right"><?php echo  $row->tf014;?></td>
		 <td width="8%" align="right"><?php echo  $row->tf015;?></td>
