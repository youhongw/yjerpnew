...
foreach($rows as $key => $val){					//each 組
	...
	foreach($val as $k => $v){					//each Data
		if($k!=0 && $k%5 == 0){					//%多少等於一頁多少筆
			$page_data_total[$pages]['num'] = 5;//一頁多少筆(需跟上面一樣多)
...
?>
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
		...
		<td width="7%" align="center" valign="top">可發金額</td>
...
?>
	  <tr><!-- 表身 物料 -->
		...
		<td width="5%" align="right" valign="top" class="grayback"><?php echo $val->yh009?></td>
		...
		<td width="5%" align="right" valign="top"><?php echo $val->yh025?></td>
			<?php  $vyh026='應稅獎金';$vyh027='考勤功過';$vyh028='金額小計';$vyh029='免稅獎金';$vyh030='總獎金合計'; ?>
		...
		<td width="5%" align="right" valign="top"><?php echo $val->yh042?></td>
...
?>
	  <tr><!-- 表身 物料 -->
		...
		<td width="4%" align="right" valign="top"><?php if(@$page_data_total[$i]['total']['yh005']=="") echo "";else echo $page_data_total[$i]['total']['yh005']?></td>
	    <td width="5%" align="right" valign="top"><?php echo ''?></td>
	    <td width="5%" align="right" valign="top"><?php echo ''?></td>
		<td width="5%" align="right" valign="top"><?php echo ''?></td>
		<td width="5%" align="right" valign="top"><?php echo ''?></td>
		...
		<td width="7%" align="right" valign="top"><?php //echo $page_data_total[$i]['total']['yh029']?></td>
		...
		<td width="5%" align="right" valign="top"><?php if(@$page_data_total[$i]['total']['yh041']=="") echo "";else echo $page_data_total[$i]['total']['yh041']?></td>
