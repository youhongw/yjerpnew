   ...
   <script>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="35%"><input tabIndex="2"  onclick="scwShow(this,event);" onchange="dateformat_ymd(this);check_holiday(this);" id="tf002" onKeyPress="keyFunction()"  name="tf002"  value="<?php echo $tf002; ?>"  size="12" type="text"  style="background-color:#E7EFEF" /></td>
	...
	<a accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pal/pali53/'.$this->session->userdata('pali53_search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div> 
...
function check_holiday(obj){
	...
	$.ajax({
		method: "POST",
		url: "<?php echo base_url()?>index.php/pal/pali53/check_holiday",
		data: {
			date : obj.value
		}
	})
