...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 補充保費媒體申報 - 作業</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palb62/batcha"  method="post"  enctype="multipart/form-data" > 
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14"  width="12%">代扣保費年月：</td>
        ...
        <td class="normal14" width="12%"></td>
	    <td class="normal14" width="38%"></td>
	  </tr>
	  <tr>
	    <td class="start14" >起迄申報別：</td>
	    <td class="normal14" >
		<?php 
