...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr55/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14" >列印年月：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();" onchange="dataym3(this)" onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF"/><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="normal14" >選擇列印紙張(A,B,C)：</td>
