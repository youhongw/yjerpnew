...
<div id="content" style="min-width: 0px;">  <!-- div-3 -->
 <div class="box">  <!-- div-4 --> 
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 班別行事曆維護作業 - 新增</h1>
    </div>
	
    <div class="content">  <!-- div-5 --> 
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali11/addsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  <tr>
	    <td class="normal14" width="10%"><span class="required">班別：</span> </td>
	  ...
	  <tr>
		...
		<td class="normal14" >
		<select tabIndex="6" id="mt005" onKeyPress="keyFunction()" name="mt005" value="" >
			<option value="N" >N:正常上班</option>
			<!--<option value="H" >H:半天班</option>-->
			<option value="L" >L:休假</option>
		</select>
		</td>
	  </tr>
	  <tr>
...
function check_mt001(){
	...
	$.ajax({
		url: '<?php echo base_url(); ?>index.php/pal/pali11/lookup_pali16/'+encodeURIComponent(smb001), 
		cache: false, 				
		dataType: 'json',  
		type: 'POST',  
		data: {},
...
$(document).ready(function(){
	...
	$('#mt002').catcomplete({
		...
		function(req, add){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/pal/pali11/lookup_pali01/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,
