...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 二代健保代扣明細 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr46/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    ...
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();" onchange="dateformat_ym(this)" onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF" minlength="6" required /><span > <?php echo '輸入範例yyyymm'; ?> </span></td>
	  ...
	  <tr>
		...
		?>
		<input type="checkbox" id="" name="ml008[]" class="ml008" value="<?php echo $val['mm001'] ?>" /><?php echo $val['mm001'].":"?><?php echo $val['mm002'] ?>
		<?php 
		}
		?>
		<input type="checkbox" class="ml008_all" />全選
		</td>
...
$(".ml008_all").click(function() {
	check_check_all();
});
function check_check_all(){
   if($(".ml008_all").prop("checked")) {
     $("input[name='ml008[]']").each(function() {
...
$(".ml008").click(function() {
   if($(".ml008_all").prop("checked")) {
	   $(".ml008_all").prop("checked", false);
   }
});
</script>