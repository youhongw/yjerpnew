...
function view_days_of_month(current_year_month){
	...
	.done(function( msg ) {
		...
		for(var j=1;j<=12;j++){
			...
			<!--	append_str += '<br><div class="show_event">正常上班: '; <!--
			    ...
			    vdate=temp_year+'0'+j+k;
				vvdate='20180511';
				kkdata='1';
			    console.log(vdate.substr(0,8));
			  //  console.log(current_year_month.substr(0,5));
				/*append_str += '<br>半:';
	...
	.done(function( msg ) {
		...
		kkdata = msg.data ;
              ...
              if  ( vdate == "20180511" ) {append_str += '<br>國定:'+kkdata;}
                 else 	{append_str += '<br>'+kkdata ;}		  
