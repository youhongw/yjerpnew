...
$dateo = (substr($dateo,0,4)-1911)."/".substr($dateo,5,2);
?>
<?for($i=1;$i<=$page;$i++){?>
<br>
<div style="margin:11px 34px 11px 36px;overflow:auto;">
...
<font size="4"><b>
<?php echo $dateo ?> <?php echo mb_substr($results[$j]->td002,0,3,'UTF-8') ?>
</b></font>
</div>
</div>
<?}?>
