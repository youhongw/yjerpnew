	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
		 ...
		 <td width="10%" align="left"><?php if(@$row->mv022){echo substr($row->mv022,0,4)."/".substr($row->mv022,4,2)."/".substr($row->mv022,6,2);} ?></td>
	...
	<tr><td colspan="6"><span style="float:right;">共到職: <?php echo $num_results; ?> 人</span></td></tr>
    </table>
	<!-- <table >
			<tr>
