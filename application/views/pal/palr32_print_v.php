...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工標籤 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr32/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  //echo "<pre>";var_dump($data_col);exit;
	?>
       
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14" >列印年度：</td>
	  ...
	  <tr>
		...
		?>
		<input type="checkbox" id="" name="mv202[]" class="mv202" value="<?=$val->yb001?>" /><?=$val->yb001.":"?><?=$val->yb002?>
		<?php 
		}
		?>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><select id="te009p" onKeyPress="keyFunction()" name="te009p"  tabIndex="12">
            <option <?php if($te009p == '1') echo 'selected="selected"';?> value='1'>1.A4 (縱向)</option>                                                                        
