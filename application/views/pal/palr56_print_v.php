...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工特休標籤 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr56/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14" >員工編號起訖：</td>
	    <td class="normal14" ><input tabIndex="3" id="mv001o" onfocus="this.select();" onKeyPress="keyFunction()" type="text" name="mv001o"  value=""  size="20" style="background-color:#E7EFEF"/></td>
		<td class="normal14" ><input tabIndex="4" id="mv001c" onfocus="this.select();" onKeyPress="keyFunction()" type="text" name="mv001c"  value="ZZZZZ"  size="20" style="background-color:#E7EFEF"/></td>
