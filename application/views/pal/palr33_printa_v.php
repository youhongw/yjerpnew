...
foreach($rows as $key => $val){					//each 組
	...
	foreach($val as $k => $v){					//each Data
		if($k!=0 && $k%34 == 0){					//%多少等於一頁多少筆
			...
			$page_data_total[$pages]['total']['yh007'] = "小計：";
...
<?php
    $vyh051tt0=0;$vyh034tt0=0;$vyh051tt=0;$vyh052tt=0;$vyh053tt=0;$vyh054tt=0;$vyh056tt=0;$vyh057tt=0;
	for($i=0;$i<$pages;$i++){
?>
	<table class="store">
	    <tr>
    ...
    <table class="list">
<?php	
    $vyh051=0;$vyh034=0;$vyh051t0=0;$vyh034t0=0;
	$vyh051t=0;$vyh052t=0;$vyh053t=0;$vyh054t=0;$vyh056t=0;$vyh057t=0;
...
?>
	  <tr><!-- 表身 物料 -->
		...
		<?php if ($val->yh046=="2")  {$vyh051=$val->yh051-$val->yh034;} else {$vyh051=$val->yh051;}  ?>
		<?php if ($val->yh046=='2') { $vyh034=$val->yh034;}  else {$vyh034=0;} ?>
		...
		<?php $vyh051t0=$vyh051t0+$vyh051; $vyh034t0=$vyh034t0+$vyh034; ?>
		<?php $vyh051t=$vyh051t+$val->yh051;$vyh052t=$vyh052t+$val->yh052;$vyh053t=$vyh053t+$val->yh053;  ?>
		<?php $vyh054t=$vyh054t+$val->yh054;$vyh056t=$vyh056t+$val->yh056;$vyh057t=$vyh057t+$val->yh057;  ?>
      </tr>
<?php 
	}
?>
	  <tr><!-- 表身 物料 -->
	    ...
	    <td width="7%" align="right" valign="top"><?php echo ''?></td>
	    <td width="8%" align="right" valign="top"><?php echo $vyh051t0 ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh034t0 ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh051t ?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh053t ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh054t ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh056t ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh057t ?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
		<?php $vyh051tt0=$vyh051tt0+$vyh051t0; $vyh034tt0=$vyh034tt0+$vyh034t0; ?>
		<?php $vyh051tt=$vyh051tt+$vyh051t; $vyh052tt=$vyh052tt+$vyh052t;$vyh053tt=$vyh053tt+$vyh053t; ?>
		<?php $vyh054tt=$vyh054tt+$vyh054t; $vyh056tt=$vyh056tt+$vyh056t;$vyh057tt=$vyh057tt+$vyh057t; ?>
	   </tr>
		<tr><!-- 總計 -->
	    <td width="7%" align="right" valign="top"><?php echo ''?></td>
	    <td width="7%" align="center" valign="top"><?php echo '合計：'?></td>
		<td width="7%" align="right" valign="top"><?php if(@$page_data_total[$i]['total']['yh005']=="") echo "";else echo "" ?></td>
	    <td width="7%" align="right" valign="top"><?php echo ''?></td>
	    <td width="8%" align="right" valign="top"><?php echo $vyh051tt0 ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh034tt0 ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh051tt ?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh053tt ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh054tt ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh056tt ?></td>
		<td width="8%" align="right" valign="top"><?php echo $vyh057tt ?></td>
		<td width="8%" align="right" valign="top"><?php echo ''?></td>
      </tr>
