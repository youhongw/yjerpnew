...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 勞保計費建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?=base_url()?>index.php/pal/pali02/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td class="normal14" ><input  tabIndex="3" id="mp003" onKeyPress="keyFunction()"  name="mp003"   value="<?php echo  $mp003; ?>"    type="text"  /></td>
		<td class="normal14" >就業保費<?php echo $rates->mr002?>%：</td>
		<td class="normal14"><input  tabIndex="4" id="mp004" onKeyPress="keyFunction()"  name="mp004"   value="<?php echo  $mp004; ?>"    type="text"  /></td>
	  </tr>
	  <tr>
	    <td class="normal14" >職災<?php echo $rates->mr003?>%：</td>
        <td class="normal14" ><input  tabIndex="5" id="mp005" onKeyPress="keyFunction()" onchange="addsel(this)" name="mp005"   value="<?php echo  $mp005; ?>"    type="text"  /></td>
		<td class="normal14" >墊償<?php echo $rates->mr004?>%：</td>
		<td class="normal14"><input  tabIndex="6" id="mp006" onKeyPress="keyFunction()"  name="mp006"   value="<?php echo  $mp006; ?>"    type="text"  /></td>
	  </tr>
	  <tr>
	    <td class="normal14" >顧主<?php echo $rates->mr005?>%：</td>
        <td class="normal14" ><input  tabIndex="7" id="mp008" onKeyPress="keyFunction()" onchange="addsel(this)" name="mp008"   value="<?php echo  $mp008; ?>"    type="text"  /></td>
		<td class="normal14" >勞工<?php echo $rates->mr006?>%：</td>
		<td class="normal14"><input  tabIndex="8" id="mp009" onKeyPress="keyFunction()"  name="mp009"   value="<?php echo  $mp009; ?>"    type="text"  /></td>
	  </tr>
	  ...
	  <tr>	    
        ...
        <td class="normal14"><input  tabIndex="10" onKeyPress="keyFunction()" id="mp007" name="mp007"  value="<?php echo $mp007; ?>"  type="text" style="background-color:#E7EFEF" /></td>	
	  </tr>
        </table>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('pal/pali02/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	   </div>
