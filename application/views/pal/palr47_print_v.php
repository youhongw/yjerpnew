...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 外勞加班日報表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/palr47/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="start14" >起始加班日期：</td>
	    <td class="normal14" ><input tabIndex="3" id="dateo" onfocus="this.select();" ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this)"  onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF" minlength="6" required /><span > <?php echo '輸入範例yyyymmdd'; ?> </span></td>
        <td class="normal14" >起始加班日期：</td>
