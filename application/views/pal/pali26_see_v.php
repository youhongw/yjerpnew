...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 異動薪資維護作業 - 查看</h1>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali26/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14">
        ...
        <td class="normal14a"  width="42%"> <input   tabIndex="2" id="md002" onKeyPress="keyFunction()" onchange="startcmsq05a(this)" name="cmsq05a" value="<?php echo $cmsq05a; ?>"  type="text" required disabled="disabled" /><img id="Showcmsq05a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
         <span id="cmsq05adisp"> <?php    echo $cmsq05adisp; ?> </span></td>
       
	  </tr>	
		<tr>
	    <td class="start14a" >異動日期： </td>
        <td class="normal14" ><input  tabIndex="3" onKeyPress="keyFunction()" onclick="scwShow(this,event);"  id="md014" name="md014"  value="<?php echo $md014; ?>"  type="text" style="background-color:#E7EFEF" disabled="disabled"/></td>
		<td class="normal14" >異動原因：</td>
		<td class="normal14"><input  tabIndex="4" onKeyPress="keyFunction()"  id="md015" name="md015"  value="<?php echo $md015; ?>"  type="text" size="60" disabled="disabled" /></td>	
	  </tr>  
	  <tr>
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="12" id="md013"  onfocus="addsel(this)"    onKeyPress="keyFunction()"    name="md013" value="<?php echo $md013; ?>" disabled="disabled" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input type="text" tabIndex="11" id="md018"      onKeyPress="keyFunction()"    name="md018" value="<?php echo $md016; ?>"  /></td>	  
