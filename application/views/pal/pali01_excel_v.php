...
<div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 員工代號資料建立作業 - 明細檔xls　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#mv001o').focus();" tabIndex="5" type='submit'  accesskey="l"  name='submit' class="button"  target="_new" value='轉excel檔F8'><span>excel檔Alt+l</span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></button>&nbsp;&nbsp;  
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pal/pali01/write"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>轉Excel-明細檔xls</span></div> -->
	<div id="tab-general"> <!-- div-6 -->
	<?php
	  $mv001o=$this->input->post('mv001o');
	  $mv001c=$this->input->post('mv001c');
	  $mv002o=$this->input->post('mv002o');
	...
	<table class="form14">
	  ...
	  <tr>
	    <td class="normal14z" >起始到識日：</td>
	    <td class="normal14a" ><input tabIndex="1" id="mv002o" onKeyPress="keyFunction()" type="text" name="mv002o"  value="<?php echo $mv002o; ?>"  size="20" /></td>
        <td class="normal14z" >結束到識日：</td>
		<td class="normal14a" ><input tabIndex="2" id="mv002c" onKeyPress="keyFunction()" type="text" name="mv002c"  value="<?php echo $mv002c; ?>"  size="20" /></td>
	  </tr>
    </table>
