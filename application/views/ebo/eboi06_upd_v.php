...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> E-BOM轉BOM維護作業 - 修改　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ebo/eboi06/updsave" method="post" enctype="multipart/form-data" >
    ...
    <!--   明細0  --> 
		...
		<tbody   <?php echo    "id=product-row".$product_row ?> >		
	     <tr>
	     <td class="center"><img src="<?php echo base_url()?>assets/image/delete2.png" title="刪除資料" onclick="del_detail('<?php echo strtoupper($invq02a);?>','<?php echo $md002[$i]; ?>','<?php echo $md003[$i]; ?>');" /></td><!--$(\'#product-row0\').remove();原始方法-->
 ...
 <?php } ?>		
	...
	<?php include_once("./application/views/fun/eboi06_funjsupdjs_v.php"); ?> 
...
'◎操作說明:[ 品號欄位可輸入部份品號或品名下拉視窗選擇,按Enter鍵或Tab鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
		...
		<form action="<?php echo base_url()?>index.php/ebo/eboi06/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
			<input id="del_md001" name="del_md001" />
			<input id="del_md002" name="del_md002" />
			<input id="del_md003" name="del_md003" />
		</form>
 <?php include_once("./application/views/fun/eboi06_funjsupd_v.php"); ?>