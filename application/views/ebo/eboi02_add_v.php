...
<div id="content">  <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 工程品號建立作業 - 新增　　　</h1>
	...
	<a accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('ebo/eboi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ebo/eboi02/addsave" >	
	<!-- <div id="htabs" class="htabs14"  ><span>編輯項目-新增</span></div> -->
	<div id="tab-general"> <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mi001=$this->input->post('mi001');
	  $invq02a=$this->input->post('mi001');
	  $invq02adisp=$this->input->post('mi001');
	  $invq02adisp1=$this->input->post('mi001');
	  
	  $mi002=$this->input->post('mi002');
	  $purq01a=$this->input->post('mi002');
	  $purq01adisp=$this->input->post('mi002');
	  
	  $mi003=$this->input->post('mi003');
	  $cmsq06a=$this->input->post('mi003');
      $cmsq06adisp=$this->input->post('mi003');	  
	  $mi004=$this->input->post('mi004');
	  $mi005=$this->input->post('mi005');
	   $invi01a=$this->input->post('invi01a');
	  $invi01adisp=$this->input->post('invi01a');
	  
	    $bomi07=$this->input->post('bomi07');
	  $bomi07disp=$this->input->post('bomi07');
	  
	  $mi006=$this->input->post('mi006');
      $mi007=$this->input->post('mi007');
