...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 工程品號建立作業 - 設定查詢條件　　　</h1>
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" tabIndex="7" type='submit' accesskey="k"  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('ebo/eboi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/ebo/eboi02/findsql" method="post" enctype="multipart/form-data" >
    </div>
   ...
   <!-- <div id="htabs" class="htabs14"><span>進階資料-設定查詢條件</span></div>-->
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.MI001'> MI001 工程品號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.MI002'> MI002 品名 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.MI003'> MI003 規格 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.MI005'> MI005 會計 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.MI009'> MI009 品號屬性 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.MI010'> MI010 標準進價 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.MI001'> MI001 工程品號 </option>                                                                         
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.MI002'> MI002 品名 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.MI003'> MI003 規格 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.MI005'> MI005 會計 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.MI009'> MI009 品號屬性 </option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.MI010'> MI010 標準進價 </option>
		        <option <?php if($find006 == '7') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	     </select>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<!--  <div class="buttons">
	    ...
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('pur/puri02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>-->
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pur/puri02/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
