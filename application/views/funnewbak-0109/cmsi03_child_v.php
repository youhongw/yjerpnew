...
?>
	    ...
	    <?php foreach($results as $row ) : ?>
         <tr onclick="parent.addcmsi03disp('<?php echo $row->mc001;?>','<?php echo $row->mc002;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_cmsi03('<?php echo $row->mc001;?>','<?php echo $row->mc002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
