...
?>
        ...
        <tr>
		  ...
		  <td class="center"><a href="javascript:send_back_moci05('<?php echo $row->ta006;?>','<?php echo $row->mb002;?>','<?php echo $row->mb003;?>','<?php echo $row->mb004;?>','<?php echo $row->mb017;?>','<?php echo $row->mc002;?>','<?php echo $row->ta001;?>','<?php echo $row->ta002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
