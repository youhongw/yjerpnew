...
function check_title_no(){
	$('#tc002').val("");
	var asti03_asti06 = $('#asti03_asti06').val();
	var tc027 = $('#tc027').val();
	//alert(copi03);
	console.log(asti03_asti06);
	console.log(tc027);
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/ast/asti06/check_title_no",
		data: {
			asti03_asti06: asti03_asti06, 
			tc027: tc027
		}
	})
	.done(function( msg ) {
		if($('#asti03_asti06disp').text()!=""&&$('#asti03_asti06disp').text()!="查無資料")
		$('#tc002').val(msg);
	});
}
