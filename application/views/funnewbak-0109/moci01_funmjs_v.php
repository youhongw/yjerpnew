...
$(document).ready(function(){
    ...
    $('#moci01').catcomplete({
		...
		function(req, add){
			...
			console.log(smb001);
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/cop/moci01/lookup1_moci01/'+encodeURIComponent(smb001), 
                cache: false, 				
                dataType: 'json',  
                type: 'POST',  
                data: req,
...
function addmoci01disp(smb001,smb002){
	...
	//console.log(smb001);
  	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/cop/moci01/clear_sql"
	}); 
}
...
function check_moci01(row_obj){
	...
	$.ajax({
		url: '<?php echo base_url(); ?>index.php/cop/moci01/lookup2_moci01/'+encodeURIComponent(smb001), 
		cache: false, 				
		dataType: 'json',  
		type: 'POST',  
...
<iframe src="<?php echo base_url()?>index.php/cop/moci01/display_child" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
