...
$(document).ready(function(){
	$("#Shownoti04adisp").click(function() {
	$.blockUI({
		css: {
			top: '15%',
			left: '25%',
		...
		message: $('#divFnoti04a'),
		onOverlayClick: clear_noti04adisp_sql
	});
...
function addnoti04adisp(smb001,smb002,smb003,smb004,smb005){
	//alert('test2');
	addItem3(smb001,smb002,smb003,smb004,smb005);
	$('#noti04').focus();
	/*$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/not/noti04/clear_sqla"
	});*/
}
function clear_noti04adisp_sql(){
	$.unblockUI();
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/not/noti01/clear_sql3"  //刪除(銀行代號)小視窗的搜尋條件
	});
...
//不更新網頁 輸入直接跳出中文
/*function check_noti04a(row_obj){
	var smb001= $('#noti04').val();
...
<div id="divFnoti04a" style="display:none;width:100%;height:100%;">
<div style="float:right;"><input type="button" class="close" value="close" /></div> 
<iframe src="<?php echo base_url()?>index.php/not/noti04/display_childa" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
