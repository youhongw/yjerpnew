<div class="box2" style="height:95%"> <!-- div-1 -->
    <div class="heading"> 
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 生產線別建立作業 - 瀏覽</h1>
...
/* title欄位設定區域 */
	$title_array = array(
		...
		'md001' => array('sort_name'=>"md001",'name'=>"線別代號",'width'=>"",'align'=>"left"),
		'md002' => array('sort_name'=>"md002",'name'=>"線別名稱",'width'=>"",'align'=>"left"),
...
/* filter欄位設定區域 */
	$filter_array = array(
		...
		'md001' => array('filter_name'=>"md001",'name'=>"線別代號",'size'=>"8",'align'=>"left"),
		'md002' => array('filter_name'=>"md002",'name'=>"線別名稱",'size'=>"12",'align'=>"left")
	);
?>
		...
		<!--  <td class="center"><a href="javascript:send_back_cmsi04('<?php echo $row->md001;?>','<?php echo $row->md002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td> -->
		   <td class="center"><a href="javascript:send_back_cmsi04('<?php echo $row->md001;?>','<?php echo $row->md002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
