...
/* title欄位設定區域 */
	$title_array = array(
		...
		'mb001' => array('sort_name'=>"mb001",'name'=>"廠別代號",'width'=>"",'align'=>"left"),
		'mb002' => array('sort_name'=>"mb002",'name'=>"廠別名稱",'width'=>"",'align'=>"left"),
...
/* filter欄位設定區域 */
	$filter_array = array(
		...
		'mb001' => array('filter_name'=>"mb001",'name'=>"廠別代號",'size'=>"8",'align'=>"left"),
		'mb002' => array('filter_name'=>"mb002",'name'=>"廠別名稱",'size'=>"12",'align'=>"left")
	);
?>
        ...
        <tr onclick="parent.addcmsi02disp('<?php echo $row->mb001;?>','<?php echo $row->mb002;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_cmsi02('<?php echo $row->mb001;?>','<?php echo $row->mb002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
