...
?>
        ...
        <tr onclick="parent.addnoti09ddisp('<?php echo $row->tj001;?>','<?php echo $tl011;?>','<?php echo $tl012;?>');parent.$.unblockUI();" class="row_<?php  echo $chkval; ?>"  > 
		  ...
		  <td class="center"><a href='javascript:send_back_noti09d("<?php echo $row->tj001;?>","<?php echo $tl011;?>","<?php echo $tl012;?>");'>[ 選擇 </a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>
