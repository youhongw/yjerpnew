...
?>
        ...
        <tr onclick="parent.addcopi01disp('<?php echo $row->ma001;?>','<?php echo $row->ma002;?>','<?php echo $row->ma003;?>','<?php echo $row->ma010;?>','<?php echo $row->ma038;?>','<?php echo $row->ma025;?>');parent.$.unblockUI();" >
		  ...
		  <td class="center"><a href="javascript:send_back_copi01('<?php echo $row->ma001;?>','<?php echo $row->ma002;?>','<?php echo $row->ma003;?>','<?php echo $row->ma010;?>','<?php echo $row->ma038;?>','<?php echo $row->ma025;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
