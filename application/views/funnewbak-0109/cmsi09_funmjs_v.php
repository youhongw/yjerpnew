...
function search_cmsi09_asti02_body_window(row_obj){
	...
	console.log(temp);
	$("#iframe1").attr('src','<?php echo base_url()?>index.php/cms/cmsi09/display_child_body_asti02/'+temp);
...
<div style="float:right;"><input type="button" class="close" value="close" /></div> 
<iframe id="iframe1" src="" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
