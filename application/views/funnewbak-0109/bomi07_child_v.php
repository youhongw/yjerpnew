...
?>
		...
		<!--  <td class="center"><a href="javascript:send_back_bomi07('<?php echo $row->md001;?>','<?php echo $row->md002;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td> -->
		   <td class="center"><a href="javascript:send_back_bomi07('<?php echo $row->mf001;?>','<?php echo str_replace('"','!',$row->mb002);?>','<?php echo str_replace('"','!',$row->mb003);?>','<?php echo $row->mf002;?>','<?php echo $row->me003;?>');">[ 選擇</a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>		 
