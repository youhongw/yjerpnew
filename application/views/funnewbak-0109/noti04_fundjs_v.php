...
function del_detail(td004,row){
	...
	if(td004 != tc012){
		...
		if(confirm("確定刪除細項:"+tc001+"-"+td004+"-"+tc012+"?")){
		$.ajax({
			method: "POST",
		...
		.done(function( msg ) {
			...
			else{  alert ( "刪除細項:"+tc001+"-"+td004+"-"+tc012+" 失敗!");}
		});
		}
	}
}
//刪除一筆明細 (noti04轉付)
function del_detail2(td004,row){
	var tc012 = $('#tc012').val();
	if(td004 != tc012){
		alert('刪除的項目與目前票況不符!');
	}else{
		$("#product_row_"+row+"").remove();
		current_count --;
		var temp_num = $("#order_product").length;
		console.log(temp_num)
		temp = $('#order_product\\['+temp_num+'\\]\\[td004\\]').val();
		$('#tc012').val(temp);
		
		$('#Shownoti04adisp').attr('class','button');
		$('#Shownoti04adisp2').css('display','');
		$('#Shownoti04bdisp').attr('class','button');
		$('#Shownoti04bdisp2').css('display','');
...
//刪除一筆明細 (noti04託收)
function del_detail3(td004,row){
	var tc012 = $('#tc012').val();
	console.log(tc012);
	console.log(td004);
	if(td004 != tc012){
...
//刪除一筆明細 (noti04還票)
function del_detail4(td004,row){
	var tc012 = $('#tc012').val();
	if(td004 != tc012){
		alert('刪除的項目與目前票況不符!');
	}else{
		$("#product_row_"+row+"").remove();
		current_count --;
		temp = $('#order_product\\['+current_count+'\\]\\[td004\\]').val();
		$('#tc012').val(temp);
		
		if($("#order_product\\[2\\]\\[td004\\]").length > 0){
			$('#Shownoti04cdisp').attr('class','button');
			$('#Shownoti04cdisp2').css('display','');
		}else{
			$('#Shownoti04adisp').attr('class','button');
...
//刪除一筆明細 (noti04退票)
function del_detail5(td004,row){
	var tc012 = $('#tc012').val();
	if(td004 != tc012){
		alert('刪除的項目與目前票況不符!');
	}else{
...
//新增一筆明細 (noti04轉付新增)
function addItem2(smb001,smb002,smb003,smb004){
	//current_count = 0;
	...
	append_str += "<tr>";
	append_str += "<td class='center'><img src='<?php echo base_url()?>assets/image/delete2.png' title='刪除資料' onclick='del_detail2(\""+'4:轉付\"'+',\"'+current_count+"\");' /></td>";
				
	$('#tc026').val(smb001);
	$('#tc026disp').val(smb002);
	$('#tc012').val('4:轉付');
	...
	for(var key in usecol_array){
		...
		if(type == "text"){
			switch(key){
				case 'td003':
					append_str += "<input type='"+type+"' value='"+smb003+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td004':
					append_str += "<input type='"+type+"' value='4:轉付'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td005':
					append_str += "<input type='"+type+"' value='"+smb004+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				default:
			...
			/*if(key == 'td003'){
				append_str += "<input type='"+type+"' value='"+smb002+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
			}else{
				append_str += "<input type='"+type+"' id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
			}*/
...
//新增一筆明細 (noti04託收新增)
function addItem3(smb001,smb002,smb003,smb004,smb005){
	//current_count = 0;
	var max_no = get_max_no();
	...
	append_str += "<tbody id='product_row_"+current_count+"' class='product_row' >";
	append_str += "<tr>";
	append_str += "<td class='center'><img src='<?php echo base_url()?>assets/image/delete2.png' title='刪除資料' onclick='del_detail3(\""+'2:託收\"'+',\"'+current_count+"\");' /></td>";
				
	$('#tc025').val(smb001);
	$('#tc025disp').val(smb002);
	$('#tc025disp2').val(smb003);
	$('#tc012').val('2:託收');
		...
		if(type == "text"){
			switch(key){
				case 'td003':
					...
					break;
				case 'td004':
					append_str += "<input type='"+type+"' value='2:託收'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td005':
					append_str += "<input type='"+type+"' value='"+smb005+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				default:
					append_str += "<input type='"+type+"' id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
...
//新增一筆明細 (noti04還票新增)
function addItem4(smb001,smb002){
	//current_count = 0;
	var max_no = get_max_no();
	...
	append_str += "<tbody id='product_row_"+current_count+"' class='product_row' >";
	append_str += "<tr>";
	append_str += "<td class='center'><img src='<?php echo base_url()?>assets/image/delete2.png' title='刪除資料' onclick='del_detail4(\""+'7:還票\"'+',\"'+current_count+"\");' /></td>";
	...
	for(var key in usecol_array){
		...
		if(type == "text"){
			switch(key){
				case 'td003':
					append_str += "<input type='"+type+"' value='"+smb001+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td004':
					append_str += "<input type='"+type+"' value='7:還票'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td005':
					append_str += "<input type='"+type+"' value='"+smb002+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
...
//新增一筆明細 (noti04退票新增)
function addItem5(smb001,smb002){
	//current_count = 0;
	var max_no = get_max_no();
	...
	append_str += "<tbody id='product_row_"+current_count+"' class='product_row' >";
	append_str += "<tr>";
	append_str += "<td class='center'><img src='<?php echo base_url()?>assets/image/delete2.png' title='刪除資料' onclick='del_detail5(\""+'5:退票\"'+',\"'+current_count+"\");' /></td>";
		...
		if(type == "text"){
			switch(key){
				case 'td003':
					...
					break;
				case 'td004':
					append_str += "<input type='"+type+"' value='5:退票'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
				case 'td005':
					append_str += "<input type='"+type+"' value='"+smb002+"'  id='order_product["+current_count+"]["+key+"]' name='order_product["+current_count+"]["+key+"]' class='order_product_"+key+"'  onKeyPress='keyFunction()' ";
					break;
