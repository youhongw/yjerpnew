...
$(document).ready(function(){
	$("#Shownoti04cdisp").click(function() {
	$.blockUI({
		css: {
			top: '15%',
			left: '25%',
		...
		message: $('#divFnoti04c'),
		onOverlayClick: clear_noti04cdisp_sql
	});
...
function addnoti04cdisp(smb001,smb002){
	//alert('test2');
	addItem4(smb001,smb002);
	$('#noti04').focus();
	/*$.ajax({
		method: "POST",
...
function clear_noti04cdisp_sql(){
	$.unblockUI();
	/*$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/not/noti04/clear_sql"
...
//不更新網頁 輸入直接跳出中文
/*function check_noti04c(row_obj){
	var smb001= $('#noti04').val();
...
<div id="divFnoti04c" style="display:none;width:100%;height:100%;">
<div style="float:right;"><input type="button" class="close" value="close" /></div> 
<iframe src="<?php echo base_url()?>index.php/not/noti04/display_childc" allowTransparency="flase" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
