...
?>
        ...
        <tr class="row_<?php  echo $chkval; ?>"  > 
		  ...
		  <td class="center"><a href='javascript:send_back_invi02d("<?php echo $row->mb001;?>","<?php echo $row->mb002;?>","<?php echo addslashes($row->mb003);?>","<?php echo addslashes($row->mb004);?>","<?php echo $row->mb017;?>","<?php echo addslashes($row->mb017disp);?>");'>[ 選擇 </a><img src="<?php echo base_url()?>assets/image/png/eye.png" />]</td>
		</tr>
		<?php $chkval += 1; ?>
		<?php endforeach;?>
        </tbody>
