...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 庫別資料建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cms/cmsi03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MC001'> MC001 庫別代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MC002'> MC002 庫別名稱 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MC003'> MC003 廠別代號 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MC004'> MC004 庫別性質1,2 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MC005'> MC005 納入MRP計算Y/N </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MC006'> MC006 庫存不足准出庫Y/N </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MC001'> MC001 庫別代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MC002'> MC002 庫別名稱 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MC003'> MC003 廠別代號 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MC004'> MC004 庫別性質1,2 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MC005'> MC005 納入MRP計算Y/N </option>
	...
	<tr>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x"   tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('cms/cmsi03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
