...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
     ...
     <button style= "cursor:pointer" form="commentForm" onfocus="$('#moci01').focus();" type='submit' tabIndex="98" accesskey="s" name='submit' class="button" onclick="addItem();" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
   ...
   <?php 
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="moci01"    onKeyPress="keyFunction()" ondblclick="search_moci01_window()"  name="ta001"  onchange="check_moci01(this);check_title_no();"  value="<?php echo $ta001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="25%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="ta003" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="ta003"  value="<?php echo $ta003; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
        ...
        <td class="normal14a" width="25%"><input tabIndex="3" id="ta002" onKeyPress="keyFunction()" onfocus="check_title_no();" name="ta002" value="<?php echo $ta002; ?>" size="30" type="text" required /><span id="ta002disp" ></span></td>
	  </tr>	
	  <tr>
		 <td class="normal14z">產品品號：</td>
        <td  class="normal14"  ><input tabIndex="4" id="invi02" onKeyPress="keyFunction()" onfocus="check_title_no();" ondblclick="search_invi02_window()"  onchange="check_invi02(this)" name="ta006" value="<?php echo $ta006; ?>" size="12" type="text"  />
