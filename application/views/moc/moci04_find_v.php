...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 退料單建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit' accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('moc/moci04/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/moc/moci04/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TC001'> TC001 退料單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TC002'> TC002 退料單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TC003'> TC003 退料日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TC004'> TC004 廠商代號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.TC005'> TC005 生產線別 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.TC006'> TC006 加工廠商 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.TC007'> TC007 備註 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.TC001'> TC001 退料單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.TC002'> TC002 退料單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.TC003'> TC003 退料日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.TC004'> TC004 廠商代號 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.TC005'> TC005 生產線別 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.TC005'> TC006 加工廠商 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='a.TC007'> TC007 備註 </option>
