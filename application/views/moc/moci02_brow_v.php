<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/moc/moci02/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/moc/moci02/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'ta001' => array('sort_name'=>"ta001",'name'=>"製令單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"d.mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'ta002' => array('sort_name'=>"ta002",'name'=>"製令單號",'width'=>"6%",'align'=>"left"),
		'ta003' => array('sort_name'=>"ta003",'name'=>"開單日期",'width'=>"6%",'align'=>"left"),
		'ta006' => array('sort_name'=>"ta006",'name'=>"品號",'width'=>"5%",'align'=>"left"),
		'ta006disp' => array('sort_name'=>"ta006disp",'name'=>"品名",'width'=>"5%",'align'=>"left"),
		'ta006disp1' => array('sort_name'=>"ta006disp1",'name'=>"規格",'width'=>"6%",'align'=>"left"),
		'ta015' => array('sort_name'=>"ta015",'name'=>"預計產量",'width'=>"5%",'align'=>"left"),
		//'ta011' => array('sort_name'=>"ta011",'name'=>"狀態碼",'width'=>"5%",'align'=>"left"),
  ...
  <div class="content"> <!-- div-2 -->
    <form action="<?php echo base_url()?>index.php/moc/moci02/delete" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
	      ...
	      <?php
		   foreach($title_array as $key => $val){
			  ...
			  echo anchor("moc/moci02/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("moc/moci02/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	  ...
	  $filter_array = array(
		...
		'ta001' => array('filter_name'=>"ta001",'name'=>"製令單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'ta002' => array('filter_name'=>"ta002",'name'=>"製令單號",'size'=>"10",'align'=>"left"),
		'ta003' => array('filter_name'=>"ta003",'name'=>"開單日期",'size'=>"10",'align'=>"left"),
		'ta006' => array('filter_name'=>"ta006",'name'=>"品號",'size'=>"10",'align'=>"left"),
		'ta006disp' => array('filter_name'=>"ta006disp",'name'=>"品名",'size'=>"10",'align'=>"left"),
		'ta006disp1' => array('filter_name'=>"ta006disp1",'name'=>"規格",'size'=>"10",'align'=>"left"),
		'ta015' => array('filter_name'=>"ta015",'name'=>"預計產量",'size'=>"10",'align'=>"left"),
		//'ta011' => array('filter_name'=>"ta011",'name'=>"狀態碼",'size'=>"10",'align'=>"left"),
    ...
    ?> 
        ...
        <tr>
		  ...
		  <?php $vta011='未生產'; ?>
		  <?php if ($row->ta011=='1') {$vta011='未生產';} ?>
		  <?php if ($row->ta011=='2') {$vta011='已發料';} ?>
		  <?php if ($row->ta011=='3') {$vta011='生產中';} ?>
		  <?php if ($row->ta011=='Y') {$vta011='已完工';} ?>
		  <?php if ($row->ta011=='y') {$vta011='指定結案';} ?>
		  <td class="left"><?php echo  $row->ta001;?></td>
          <td class="left"><?php echo  $row->mq002.$vta011;?></td>		  
		...
		<!--  <td class="center"><?php echo  $row->ta011.$vta011;?></td>	                 			
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/moc/moci02/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/moc/moci02/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script> 