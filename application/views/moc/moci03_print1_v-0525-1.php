...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="start14" width="11%">採購單別：</td>
        ...
        <td class="start14" width="10%">採購單號：</td>
	    <td class="normal14" width="40%"><input tabIndex="2" id="tc002o" onKeyPress="keyFunction()" type="text" name="tc002o"  value="<?php echo $tc002o; ?>"  size="20" /></td>
	  </tr>	
		 <tr>
