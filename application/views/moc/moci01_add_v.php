...
<div id="content">  <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製令單據性質建立作業 - 新增　　　</h1>
	...
	<a  accesskey="x"  tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('moc/moci01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/moc/moci01/addsave" >	
	...
	<?php
	  ...
	  $taxq02adisp=$this->input->post('mq023');	  
	   ...
	   if (($mq008!="1") && ($mq008!="2") ) { $mq008="1" ;}
	   if (($mq011!="Y") && ($mq011!="N") ) { $mq011="Y" ;}
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td class="normal14" > <select tabIndex="20" id="mq008" onKeyPress="keyFunction()" name="mq008" >
        ...
        <td  class="normal14"  >
		  ...
		  <input tabIndex="21" id="mq011" onKeyPress="keyFunction()"  name="mq011" <?php if($mq011 == 'Y' ) echo 'checked';  ?>  <?php if($mq011 != 'Y' ) echo 'check'; ?>  value="Y" size="1" type='checkbox'  />
        </td>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input  tabIndex="23" id="mq007" onKeyPress="keyFunction()"  name="mq007"   value="<?php echo  $taxq02adisp; ?>"    type="text" style="background-color:#F5F5F5" /></td>
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
 ...
 <?php include("./application/views/fun/moci01_funjs_v.php"); ?> 
	 	 <!-- enter=tab test ok -->
