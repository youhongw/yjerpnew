...
<!--	<div id="bbb">
	<div class="box">
		<div class="heading">
				...
				<div id="zzz" style="float:right;margin:6px 0px;"><a id='set_detail_view' name='set_detail_view' href="<?php echo site_url('moc/moci07/set_detail_view'); ?>" class="button" ><span>變更明細檢視設定</span></a></div>
		</div>
 <!-- <div id="content1">
    <div id="list">
        <div>1</div>
				...
				<div class="abgne_tab"> <!--div-6-->
					...
					<div class="tab_container">
						...
						<div id="tab2" class="tab_content">
							<table class="form14">
								<tr>
									<td class="normal14y"  width="11%">幣別：</td>
									<td class="normal14a"  width="23%">
									...
									<td class="normal14y" width="12%" >匯率： </td>
									...
									<td class="normal14y" width="11%" >件數：</td>
									<td class="normal14a"  width="23%" >
...
<iframe src="<?php echo base_url()?>index.php/pur/puri04/display_child/0/or_where?key=mq001,mq001&val=5A,''" allowTransparency="false" name="ifmain" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
</div>
