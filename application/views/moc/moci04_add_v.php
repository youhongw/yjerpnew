			...
			<div id="tab-general"> <!-- div-6 -->
				<table class="form14"  >     <!-- 頭部表格 -->
					...
					<tr>
						...
						<td class="normal14a"  width="24%" >
							<input id="tc002" tabIndex="3" onfocus="check_title_no()" onKeyPress="keyFunction()" name="tc002" value="<?php echo $tc002; ?>" size="20" type="text" required />
						</td>
					</tr>		
					...
					<tr>
						...
						<td class="normal14a" >
							<input tabIndex="5" id="cmsi04" onKeyPress="keyFunction()"  name="cmsi04" onchange="check_cmsi04(this)"  value=""  type="text" />
							<a href="javascript:;"><img id="Showcmsi04disp" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
							<span id="cmsi04disp"><?php echo $cmsi04disp; ?></span>
						</td>
		
						<td class="normal14z">加工廠商：</td>
						<td  class="normal14"  >
							<input tabIndex="6" id="puri01" name="puri01" value="" size="10" onKeyPress="keyFunction()" onchange="check_puri01(this)" type="text" />
					...
					<tr>
						...
						<td class="normal14"  >
							<input type="text" tabIndex="7" onKeyPress="keyFunction()"   name="tc003" value="<?php echo date("Y/m/d")?>" style="background-color:#E7EFEF" readonly="readonly"/>
						</td>
					...
					<tr>
						...
						<td class="normal14a" >
							<input  tabIndex="8"  id="tc007" onKeyPress="keyFunction()"   name="tc007" value="" type="text"     />
						</td> 
					</tr>
...
<?php //include("./application/views/fun/moci04_funjs_v.php"); ?> 
