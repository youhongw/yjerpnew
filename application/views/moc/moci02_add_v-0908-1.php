...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?=base_url()?>assets/image/order.png" alt="" /> 製造命令建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<!--<div id="htabs" class="htabs14"><span>編輯項目-新增</span></div>-->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?=base_url()?>index.php/moc/moci02/addsave" >	
  ...
  <?php IF ($this->uri->segment(3)=='copybefore') {  ?>
   <?php $ii=0;$ta028=0;$ta019=0;$ta031=0;$ta032=0;$ta026=0; ?>
	<?php foreach($result as $row) { ?>
		  <?  $invq02a1=$row->mc001;?>  
		  <?  $ta015=$this->session->userdata('vta015');?> 
		  
		  <? // $mocq01a51=$this->session->userdata('vmocq01a51');?>
           <? // $ta003=$this->session->userdata('vta003');?> 
            <? // $ta002=$this->session->userdata('vta002');?> 		   
		   <?  $flag=$row->flag;?>	
		 ...
		 <!-- 明細 -->
			...
			<? $tb003[]=$row->md003;?>
		   <?  $tb012[]=$row->md003disp;?>
		   <?  $tb013[]=$row->md003disp1;?>
		   <?  $tb007[]=$row->md003disp2;?>
		   <?  $tb008[]=$row->md002;?> 
		   <?  $tb004[]=round($row->md006*$this->session->userdata('vta015'),0);?>
		   <?  $tb015[]=date("Ymd");?> 
		   <? $tb009[]=$this->session->userdata('vta009');?>
		   <? $tb009disp[]='';?>
		    <? $tb005[]='0';?>
			<? $tb016[]=round($row->md006,0);?>
		   <?  $tb011[]=$row->md017;?> 
		   <?  $tb017[]=$row->md016;?>   
            <? $tb010[]='';?>		   
		  <?  $mb991=' ';?>
   ...
   <?php 
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="ta001"    onKeyPress="keyFunction()"  onfocus="selappr()" onChange="startmocq01a51(this)"  name="mocq01a51" value="<?php echo strtoupper($mocq01a51); ?>"  type="text" required /><a href="javascript:;"><img id="Showmocq01a51" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="4" id="ta006" onKeyPress="keyFunction()" onfocus="chkno1(this)" onchange="startinvq02a1(this)" name="invq02a1" value="<?php echo $invq02a1; ?>" size="20" type="text"  /><img id="Showinvq02a1" src="<?=base_url()?>assets/image/png/distance.png" alt="" align="top"/></a>
	  ...
	  <tr>
	   ...
	   <td class="normal14">確認碼：</td>
          <td  class="normal14"  ><select id="ta011" onKeyPress="keyFunction()" name="ta013" onChange="selappr(this)" tabIndex="6">
...
<!--	
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
       ...
       <td class="normal14a"  width="40%" ><input type="text" tabIndex="25" onKeyPress="keyFunction()" id="ta019"  onchange="startcmsq02a(this)" name="cmsq02a"   value="<?php echo  $cmsq02a; ?>"     /><a href="javascript:;"><img id="Showcmsq02a" src="<?=base_url()?>assets/image/png/store.png" alt="" align="top"/></a>
	   <span id="cmsq02adisp"> <?php    echo $cmsq02adisp; ?> </span></td>
	   <td class="normal14a"  width="10%" >幣別：</td>
       <td class="normal14a"  width="40%" ><input tabIndex="26" id="ta042" onKeyPress="keyFunction()" name="cmsq06a" onchange="startcmsq06a(this)"  value="<?php echo $cmsq06a; ?>"  type="text"   /><a href="javascript:;"><img id="Showcmsq06a" src="<?=base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
       <span id="cmsq06adisp" > <?php    echo $cmsq06adisp; ?> </span></td>
	 </tr>	
	   <tr>
	    <td  class="normal14" >入庫庫別：</td>
        <td  class="normal14"  ><input tabIndex="27" id="ta020" onKeyPress="keyFunction()" name="cmsq03a" onchange="startcmsq03a(this)"  value="<?php echo $cmsq03a; ?>"  type="text"   /><a href="javascript:;"><img id="Showcmsq03a" src="<?=base_url()?>assets/image/png/store.png" alt="" align="top"/></a>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input tabIndex="29" id="ta021" onKeyPress="keyFunction()" name="cmsq04a" onchange="startcmsq04a(this)"  value="<?php echo $cmsq04a; ?>"  type="text"   /><a href="javascript:;"><img id="Showcmsq04a" src="<?=base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
       ...
       <tr>
        ...
        <td  class="normal14"  ><input tabIndex="31" id="tg032" onKeyPress="keyFunction()" name="purq01a" onchange="startpurq01a(this)"  value="<?php echo $purq01a; ?>"  type="text"   /><a href="javascript:;"><img id="Showpurq01a" src="<?=base_url()?>assets/image/png/factory.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	 <tr>
	  ...
	  <tr>
       ...
       <td class="normal14"  ><input tabIndex="35" id="ta026" onKeyPress="keyFunction()" name="copq06a" onchange="startcopq06a(this)"  value="<?php echo $copq06a; ?>"  type="text"   /><a href="javascript:;"><img id="Showcopq06a" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
 ...
 <?php } ?>		 
	...
	<!-- 合計     -->
	 ...
	 <a  accesskey="x" tabIndex="96" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('moc/moci02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?=base_url()?>assets/image/png/cancle.png" /></a>
	 <b style="color: #FF0000;"><span>　BOM展開方式　</span></b><a  href="javascript:;"><img id="Showbomc02a" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/>
	 </div> 
		</div> 	   
    </form>
	   <?php	if ($message!=' ') { ?>
