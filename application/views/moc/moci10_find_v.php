...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 加工核價單建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/moc/moci10/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TM001'> TM001 核價單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TM002'> TM002  核價單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TM003'> TM003 核價日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TM004'> TM004 加工廠商 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.TM005'> TM005 幣別 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.TM007'> TM007 確認碼 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.TM001'> TM001 核價單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.TM002'> TM002 核價單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.TM003'> TM003 核價日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.TM004'> TM004 廠商代號 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.TM005'> TM005 幣別 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='a.TM007'> TM007 單據日期 </option>
