...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製造命令資料建立 - 列印製令單　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/moc/moci02/printc"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-製令單</span></div>-->
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">製令單別：</td>
        ...
        <td class="normal14y" width="8%">製令單號：</td>
