	...
	<table class="list">     <!-- 列明細 -->
	   ...
	   <?php foreach($results as $row ) : ?>
		...
		<td width="17%" align="left"><?php echo  $row->mq003;?></td>
		<td width="17%" align="left"><?php echo  $row->mq004;?></td>
		<td width="17%" align="left" ><?php echo  $row->mq005;?></td>
		<td width="17%" align="center"><?php echo  $row->mq034;?></td>
              </tr>
	   <?php $pagenum +=1; ?> 
