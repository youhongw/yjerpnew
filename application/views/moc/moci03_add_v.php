...
<div id="container"> <!-- div-1 -->
  ...
  <div id="content"> <!-- div-3 --> 
	<div class="box"> <!-- div-4 --><span>　　　　　　</span>
		<div class="heading">
		  <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 領料單建立作業 - 新增　　　</h1>
		...
		<form class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/moc/moci03/addsave" >
		...
		<table class="form14" > <!-- 頭部表格 -->
		  ...
		  <tr>
			...
			<td class="normal14" width="40%">
				<input tabIndex="1" id="tc001" name="tc001" value="" size="12" onKeyPress="keyFunction()" onChange="check_tc001(this);check_title_no();" type="text" required />
		  ...
		  <tr>
			...
			<td class="normal14a" >
				<input tabIndex="2" id="tc002" name="tc002" value="" size="12" onKeyPress="keyFunction()" type="text" readonly="readonly" required />
			</td>
			<td class="normal14z" >生產線別：</td>
			<td class="normal14" >
				<input tabIndex="8" id="tc005" name="tc005" value="" size="10" onKeyPress="keyFunction()" onchange="check_tc005(this)" type="text" />
		  ...
		  <tr>
			...
			<td class="normal14" >
				<input tabIndex="3" id="tc014" name="tc014" value="<?php echo date("Y/m/d"); ?>" size="10" onKeyPress="keyFunction()" onchange="dateformat_ymd(this);check_title_no();" type="text" />
			</td> 
			<td class="normal14z" >加工廠商：</td>
			<td class="normal14" >
				<input tabIndex="9" id="tc006" name="tc006" value="" size="10" onKeyPress="keyFunction()" onchange="check_tc006(this)" type="text" />
		  ...
		  <tr>
			...
			<td class="normal14" >
				<input tabIndex="3" id="tc003" name="tc003" value="<?php echo date("Y/m/d"); ?>" size="10" onKeyPress="keyFunction()" onchange="dateformat_ymd(this)" type="text" />
			</td> 
		  ...
		  <tr>
			...
			<td class="normal14" >
				<input tabIndex="4" id="tc007" name="tc007" value="" size="50" onKeyPress="keyFunction()" type="text" />
			</td>
			...
			<td class="normal14z" >庫存不足照領：
				<input tabIndex="11" id="tc013" name="tc013" value="Y" onKeyPress="keyFunction()" type="checkbox" />
			</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td class="normal14a" >
				<input tabIndex="6" id="tc015" name="tc015" value="" size="10" onKeyPress="keyFunction()" type="text" readonly="readonly" />
			</td>
...
function check_title_no(){
	...
	$.ajax({
		method: "POST",
		url: "<?php echo base_url() ?>index.php/moc/moci03/check_title_no",
		data: {
			tc001: tc001, 
			tc014: tc014
		}
