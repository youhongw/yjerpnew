...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 退料單資料建立作業 - 轉Excel　　　</h1>
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/moc/moci04/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
      <tr>
	    <td class="normal14y" width="11%">起始退料單別：</td>
