<div id="container"> <!-- div-1 -->
	...
	$date=date("Y/m/d");
	  ...
	  if(!isset($cmsi04)) { $cmsi04=$this->input->post('cmsi04'); }
	  if(!isset($cmsi04disp)) { $cmsi04disp=$this->input->post('cmsi04disp'); }
	  if(!isset($tf008)) { $tf008=$this->input->post('tf008'); }
	 //  $tc025=$this->input->post('tc025');  第一筆存檔清空白
	...
	<div id="content"> <!-- div-3 --> 
			...
			<div id="tab-general"> <!-- div-6 -->
				<table class="form14"  >     <!-- 頭部表格 -->
					...
					<tr>
						...
						<td class="normal14y" width="10%" ><span class="required">入庫單號：</span> </td>
						<td class="normal14a"  width="24%" >
							<input id="tf002" tabIndex="3" onfocus="check_title_no()" onKeyPress="keyFunction()" name="tf002" value="<?php echo $tf002; ?>" size="20" type="text" required />
						</td>
					</tr>		
		  
					<tr>
						<td class="normal14z" ><span class="required">廠別代號：</span></td>
						<td class="normal14" >
							<input   tabIndex="4" id="cmsi02" onKeyPress="keyFunction()" onchange="check_cmsi02(this)" name="cmsi02" value="<?php echo $cmsi02; ?>"  type="text" required />
							<a href="javascript:;"><img id="Showcmsi02disp" src="<?php echo base_url()?>assets/image/png/store.png" alt="" align="top"/></a>
							<span id="cmsi02disp"></span>
						</td>
		
						<td class="normal14z" >生產線別：</td>
						<td class="normal14a" >
							<input tabIndex="5" id="cmsi04" onKeyPress="keyFunction()"  name="cmsi04" onchange="check_cmsi04(this)"  value="<?php echo $cmsi04; ?>"  type="text" />
							<a href="javascript:;"><img id="Showcmsi04disp" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
							<span id="cmsi04disp"></span>
						</td>
		
						<td class="normal14z">簽核狀態：</td>
						<td  class="normal14"  >
							<select id="tf014" readonly="value" onKeyPress="keyFunction()" name="tf014"   style="background-color:#EBEBE4" >
					...
					<tr>
						...
						<td class="normal14"  >
							<input type="text" tabIndex="6" onKeyPress="keyFunction()"   name="tf003" value="<?php echo date("Y/m/d")?>" style="background-color:#E7EFEF" readonly="readonly"/>
						</td>
						...
						<td  class="normal14"  >
							<input type="text" readonly="value"  onKeyPress="keyFunction()" id="tf008" name="tf008" size="5"  value="<?php echo $tf008; ?>" style="background-color:#EBEBE4" />
						</td>
						
						<td class="normal14z" >備註：</td>
						<td class="normal14a" >
							<input  tabIndex="7"  id="tf005" onKeyPress="keyFunction()"   name="tf005" value="" type="text"     />
						</td> 
					</tr>
					...
					<tr>
						...
						<td  class="normal14"  >
							<input id="tf013" readonly="value" onKeyPress="keyFunction()"  name="tf013" value="<?php echo $tf013; ?>" size="10" type="text" style="background-color:#EBEBE4"  />
						</td>
		
						<td class="normal14z" >確認碼：</td>
						<td class="normal14" >
							<select id="tf006" name="tf006" onKeyPress="keyFunction()">
					...
					<tr>
						...
						<td  class="normal14"  >
							<input id="tf010" name="tf010" value="Y" onKeyPress="keyFunction()" type="checkbox" />
						</td>
						
						<td class="normal14z">自動扣料：</td>
						<td  class="normal14"  >
							<input id="tf009" name="tf009" value="Y" onKeyPress="keyFunction()" type="checkbox" />
						</td>
		...
		<!--<div class="buttons">
			<button type='submit' accesskey="s" name='submit' class="button" onKeyPress="keyFunction()" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;
			<a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('moc/moci05/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>&nbsp;&nbsp;&nbsp;&nbsp;　　　　
		</div> -->
...
<?php //include("./application/views/fun/moci05_funjs_v.php"); ?> 
...
/*function addtitle(){
	...
	$('#order_product\\['+current_count+'\\]\\[te002\\]').val($('#tf002').val());
}*/
