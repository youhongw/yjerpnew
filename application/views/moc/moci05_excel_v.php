...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 入庫單資料建立作業 - 轉Excel　　　</h1>
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/moc/moci05/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
      <tr>
	    <td class="normal14y" width="11%">起始入庫單別：</td>
	    <td class="normal14" width="39%"><input tabIndex="1" id="tf001o" onKeyPress="keyFunction()" type="text" name="tf001o"  value="<?php echo $tf001o; ?>"  size="20" /></td>
