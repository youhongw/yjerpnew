...
<?php if (!$results)  { ?>
	<script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/moc/moci04/printdetailc';location = url; </script> 
<?php exit;}
//$data		按單裝資料
$data = Array();
	...
	<table class="store">
		<tr>
		  ...
		  <tr>
			...
			<tr><td class="title" align="center" valign="top">退　料  單</td></tr>
			<tr><td valign="top">
				<table class="order">
					<tr>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>訂單單別：</b><span><?php echo $results[0]->tc001 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>退料單號：</b><?php echo $results[0]->tc002 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo substr($results[0]->tc014,0,4).'/'.substr($results[0]->tc014,4,2).'/'.substr($results[0]->tc014,6,2) ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="35%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>廠別：</b><span><?php echo $results[0]->tc004 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>生產線別：</b><?php echo $results[0]->tc005 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>加工廠商：</b><?php echo $results[0]->tc006 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="30%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>確認者：</b><?php echo $results[0]->tc015 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					<tr class="heading">
					  ...
					  <td align="left" width="10%"><b>退料數量</b></td>
					  <td align="left" width="10%"><b>庫別</b></td>
					  <td align="left" width="10%"><b>製程代號</b></td>
				...
				<?php foreach($value as $key=>$val){?>
					<tr>					 
					  <td align="left"><? echo $val->te004;?></td>
					  <td align="left"><? echo $val->te017;?></td>
					  <td align="left"><? echo $val->te018;?></td>
					  <td align="left"><? echo $val->te006;?></td>
					  <td align="right"><? echo $val->te005;?></td>
					  <td align="right"><? echo $val->te008;?></td>
					  <td align="right"><? echo $val->te009;?></td>
					  <td align="right"><? echo $val->te001;?></td>
					  <td align="right"><? echo $val->te002;?></td>
					  <td align="right"><? echo $val->te014;?></td>	
					</tr>
				<?php }?>
