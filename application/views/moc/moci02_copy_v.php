...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	    <td class="normal14y" width="11%">原始製令單別：</td>           
		<td class="normal14a"  width="39%"><input tabIndex="1" id="ta001o" onchange="copya(this);" onKeyPress="keyFunction()"   name="ta001o" value="<?php echo strtoupper($ta001o); ?>" size="20" type="text" required />
		 <span id="ta001dispo" ></span></td>
	    <td class="normal14y" width="11%">複製製令單別：</td>
