...
<body onLoad="window.print()">
		...
		<?php $pagerow=10;$page=1;$pagetot=1; $tb007qty=0; $tb045amt=0; ?>	
        <?php foreach($results as $row ) : ?>
			  ...
			  <?php $rowtot++;$tb007qty=$tb007qty+round($row->tb004,0);$tb045amt=$tb045amt+round($row->tb005,0); ?>
        <?php endforeach;?>
		...
		<!--	<tr><td valign="top">
			...
			<!--		<tr>
					  <td colspan="5" align="left">
						<b>數量合計：</b><? echo $tb007qty;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;
						<b>金額合計：</b><? echo $tb045amt;?>
					  </td>
					</tr> -->
				</table>
			</td></tr>
