...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 託外退貨單建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/moc/moci07/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TK001'> TK001 託外退]貨單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TK002'> TK002 託外退貨單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TK003'> TK003 託外退貨日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TK005'> TK005 廠別 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.TK004'> TK004 加工廠商 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.TK006'> TK006 幣別 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.TK007'> TK007 匯率 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.TK009'> TK009 備註 </option>
