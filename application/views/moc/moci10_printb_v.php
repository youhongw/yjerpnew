...
foreach($results as $key=>$value){
	...
	$moc_date = substr($value->tm003,0,4).'/'.substr($value->tm003,4,2).'/'.substr($value->tm003,6,2);
}
$totle_page = $page;
				...
				<table class="order">
					<tr>
					  <td width="60%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>加工核價單號：</b><span><?php echo $results[0]->tm001."-".$results[0]->tm002 ?></span></td>
							  <td align="left" valign="top" ></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>單據日期：</b><?php echo $results[0]->tm003 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
							  <td width="600" align="left" valign="top"><b>幣別：</b><?php echo $results[0]->tm005 ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
					  <td width="40%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>加工廠商：</b><?php echo $results[0]->tm004.' '.$results[0]->tm004disp ?></td>
							  <td align="left" valign="top"></td>
							</tr>
							<tr>
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
				   <!--   110,250,250,40,60,40,60         -->
					...
					<tr>					 
					  <td align="left"><?php echo $val->tn004;?></td>
					  <td align="left"><?php echo $val->tn005;?></td>
					  <td align="left"><?php echo $val->tn006;?></td>
					  <td align="left"><?php echo $val->tn008;?></td>
					  <td align="right"><?php echo $val->tn011;?></td>
					  <td align="right"><?php echo $val->tn009;?></td>
					  <td align="right"><?php echo $val->tn013;?></td>					 
					</tr>
					 <?php $rownum++;$rownum1++; ?>
					...
					<tr>
					  <td colspan="7" align="left">
						...
						<b>備　　註：<?php echo $results[0]->tm007 ?></b> <?php echo '';} ?> 
						<?php if ($totle_page > $page ) { ?>
