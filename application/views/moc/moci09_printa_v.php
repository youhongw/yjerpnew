	<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/moc/moci09/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="17%" align="center">規格</td>
	    <td width="17%" align="center">計價單位</td>
	    <td width="17%" align="center" >加工單價</td>
          </tr>
	</table>
	...
	<table class="list">     <!-- 列明細 -->
	   <?php  $rownum=$vbb;$rownum1=0;$rownum2=$vaa;  ?>
		...
		<td width="17%" align="center"><?php echo  $val->mb003;?></td>
