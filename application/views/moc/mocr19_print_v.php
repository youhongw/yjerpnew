...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 生產進度表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/moc/mocr19/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">起始加工廠商：</td>
	    <td class="normal14" width="39%"><input tabIndex="4" id="purq01a" onKeyPress="keyFunction()"  onchange="startpurq01a(this)" name="purq01a" value="<?php echo $purq01a; ?>" size="10" type="text" required />
        ...
        <td class="normal14y" width="11%">結束加工廠商：</td>
		<td class="normal14" width="39%"><input tabIndex="4" id="purq01a1" onKeyPress="keyFunction()"  onchange="startpurq01a1(this)" name="purq01a1" value="<?php echo $purq01a1; ?>" size="10" type="text" required />
		<img id="Showpurq01a1" src="<?php echo base_url()?>assets/image/png/factory.png" alt="" align="top"/></a>
	  ...
	  <tr>
	    <td class="normal14z" >起始生產線別：</td>
	    <td class="normal14" ><input tabIndex="29" id="tc004c" onKeyPress="keyFunction()" name="cmsq04a" onchange="startcmsq04a(this)"  value="<?php echo $cmsq04a; ?>"  type="text"   /><a href="javascript:;">
		<img id="Showcmsq04a" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
       <span id="cmsq04adisp" > <?php    echo $cmsq04adisp; ?> </span></td>	  
        <td class="normal14z" >結束生產線別：</td>
	    <td class="normal14" ><input tabIndex="29" id="tc004o" onKeyPress="keyFunction()" name="cmsq04a1" onchange="startcmsq04a1(this)"  value="<?php echo $cmsq04a1; ?>"  type="text"   />
		<a href="javascript:;"><img id="Showcmsq04a1" src="<?php echo base_url()?>assets/image/png/linedo.png" alt="" align="top"/></a>
       <span id="cmsq04a1disp" > <?php    echo $cmsq04a1disp; ?> </span></td>	  
	  </tr>
	   <tr>
...
<?php include_once("./application/views/fun/mocr19_funjs_v.php"); ?> 