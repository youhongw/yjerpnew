...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 借/還款建立作業 - 查看　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <a  accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('not/noti09/display'); ?>" class="button" ><span>返 回Alt+x</span></a>
	
	    <?php if(isset($prev)){ 
			$prev_str = "";$prev_ary = explode('_',$prev);foreach($prev_ary as $k=>$v){if($prev_str){$prev_str.="/";}$prev_str.=$v;}
		?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('not/noti09/see/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('not/noti09/see/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
		<?php } ?>
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/noti09/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
        ...
        <td class="normal14a"  width="38%"><input tabIndex="1" id="noti06"    onKeyPress="keyFunction()"   name="noti06" onfocus="check_title_no();" onblur="turn_tl008(this);" onchange="check_noti06(this);check_title_no();"  value="<?php echo $tk001; ?>" size="12" type="text" style="background-color:#F0F0F0" readonly="value" required />
        ...
        <td class="normal14a"  width="40%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tk003" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="tk003"  value="<?php echo $tk003; ?>"  size="12" type="text" style="background-color:#F0F0F0" readonly="value"  /></td>
	    
	  </tr>
	  
	  <tr>	    
		<td class="normal14z" ><span class="required">借/還款單號：</span></td>
        <td class="normal14a" ><input tabIndex="3" id="tk002" onKeyPress="keyFunction()" readonly="value" name="tk002" onfocus="check_title_no();" value="<?php echo $tk002; ?>" size="12" type="text" style="background-color:#F0F0F0" readonly="value" required /></td>
	  ...
	  <tr>
        ...
        <td class="normal14a"><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tk005" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="tk005"  value="<?php echo $tk005; ?>"  size="12" type="text" style="background-color:#F0F0F0" readonly="value"  /></td>
		
        <td class="normal14z">簽核狀態：</td>
        <td class="normal14"  ><select id="tk011" tabIndex="21" readonly="value" onKeyPress="keyFunction()" name="tk011"   style="background-color:#F0F0F0" disabled="disabled" >
	  ...
	  <tr>
        ...
        <td class="normal14" ><input tabIndex="11" id="cmsi06" onKeyPress="keyFunction()" name="cmsi06" onblur="check_cmsi06(this);check_rate(this);"  value="<?php echo $tk008; ?>"  type="text" style="background-color:#F0F0F0" readonly="value" size="12" />
        ...
        <td class="normal14"  ><input type="text" id="exchange_rate"   tabIndex="12"   onKeyPress="keyFunction()" name="exchange_rate" value="<?php echo $tk009; ?>" style="background-color:#F0F0F0" readonly="value" size="12" /></td>
	  </tr>
		  
	  <tr>
	    <td class="normal14z">備註：</td>
        <td class="normal14" ><input type="text" tabIndex="24"   onKeyPress="keyFunction()" id="tk004" name="tk004"  size="60" value="<?php echo $tk004; ?>" style="background-color:#F0F0F0" readonly="value"/></td>
		
		<td class="normal14z" >確認者：</td>   <!-- onchange="startcmsi02(this)"  onchange="check_cmsi02(this)"   -->
        <td  class="normal14"  ><input type="text" tabIndex="5" readonly="value"  onKeyPress="keyFunction()" id="tk007" name="tk007"   value="<?php echo $tk007; ?>" style="background-color:#F0F0F0" readonly="value" size="12" /></td>
	  </tr>
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
        ...
        <thead>
			...
			<?php foreach($body_data as $key => $val){	
				...
				echo "<tr>";
				echo "<td class='center'><img src='".base_url()."assets/image/delete.png' title='刪除資料' onclick='del_detail(\"".$val->tk001."\",\"".$val->tk002."\",\"".$val->tl003."\",\"".$current_product_count."\");' /></td>";
