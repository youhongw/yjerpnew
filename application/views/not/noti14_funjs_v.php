...
function addItem() {
    ...
    html += '    <td class="left"><input type="text" tabIndex="18" id="mf003['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mf003]" onchange="startnoti13a(this)" value="" size="20" style="text-align:right" /><span id="shownoti13a"></span></td>';
    html += '    <td class="left"><input type="text" tabIndex="17" id="mf005'+ product_row +'" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mf005]" size="20"  style="text-align:;" disabled="disabled" /></td>';
	html += '    <td class="left"><input type="text" tabIndex="18" id="mf004['+ product_row +']" onKeyPress="keyFunction()" name="order_product[' + product_row + '][mf004]" value="" size="20" style="text-align:right" /></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
<script type="text/javascript">
	...
	<iframe src="<?php echo base_url()?>index.php/fun/noti01a/display" allowTransparency="flase" name="ifmain" width="640" height="480" marginwidth="0" marginheight="0" frameborder="0"></iframe> 	   
	</div> 
