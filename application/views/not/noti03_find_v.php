...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 應付票據資料建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TA001'> TA001 票號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TA002'> TA002 幣別 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TA003'> TA003 票面金額 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TA004'> TA004 開票日 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TA005'> TA005 到期日 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TA008'> TA008 目前票況 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TA001'> TA001 票號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TA002'> TA002 幣別 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TA003'> TA003 票面金額 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TA004'> TA004 開票日 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TA005'> TA005 到期日 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TA008'> TA008 目前票況 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/not/noti03/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
