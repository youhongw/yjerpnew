...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 信貸融資建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti14/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.ME001'> ME001 信貸銀行 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='b.MA002'> MA002 銀行名稱 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.ME002'> ME002 幣別 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.ME003'> ME003 匯率 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.ME004'> ME004 授信生效日 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.ME005'> ME005 授信到期日 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.ME006'> ME006 綜合額度 </option>
			<option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.ME007'> ME007 額度 </option>
			<option <?php if($find001 == '9') echo 'selected="selected"';?> value='a.ME008'> ME008 備註 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
