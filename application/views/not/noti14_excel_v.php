...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 信貸融資資料建立作業 - 明細檔xls　　　</h1>
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/noti14/write"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">
      <tr>
	    <td class="normal14y" width="8%">起始信貸融資代號：</td>
	    <td class="normal14a" width="42%"><input tabIndex="1" id="me001o" onKeyPress="keyFunction()" type="text" name="me001o"  value="<?php echo $me001o; ?>"  size="20" /></td>
