 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/not/notr18/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="left">收入金額</td>
	    <td width="10%" align="left">支出金額</td>
	    <td width="10%" align="right">可用資金餘額</td>
		<td width="30%" align="right">來源描述</td>
		<td width="30%" align="right">說明</td>
      </tr>
	</table>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
        ...
        <td width="30%" align="right"><?php echo  $val->tc026;?></td>
        <td width="30%" align="right"><?php echo  $val->tc013;?></td>	
        </tr>		
