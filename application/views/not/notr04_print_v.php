...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 廠商應付票據明細表 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/notr04/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	   ...
	   <tr>
	    <td class="normal14z" >起始廠商代號：</td>
	    <td class="normal14a" ><input tabIndex="1" id="ta003o"   onKeyPress="keyFunction()" type="text" name="ta003o"  value="<?php echo $ta003o; ?>"  size="20"  /></td>
	  </tr>
	   <tr>
	    <td class="normal14z" >截止廠商代號：</td>
	    <td class="normal14a" ><input tabIndex="1" id="ta003c"   onKeyPress="keyFunction()" type="text" name="ta003c"  value="<?php echo $ta003c; ?>"  size="20"  /></td>
	  </tr>
	   <tr>
