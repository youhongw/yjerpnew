...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 應收票據資料 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti04/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='tc001'> tc001 客戶代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='tc002'> tc002 收票日 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='tc003'> tc003 付款銀行 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='tc013'> tc013 客戶代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='tc008'> tc008 收票日 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='tc004'> tc004 付款銀行 </option>
