...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 抵押資料建立作業 - 列印明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/noti08/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">起始借款批號：</td>
	    <td class="normal14a" width="39%"><input tabIndex="1" id="tj001o" onKeyPress="keyFunction()" type="text" name="tj001o"  value="<?php echo $tj001o; ?>"  size="10" /></td>
        <td class="normal14y" width="11%">結束借款批號：</td>
		<td class="normal14a" width="39%"><input tabIndex="2" id="tj001c" onKeyPress="keyFunction()" type="text" name="tj001c"  value="<?php echo $tj001c; ?>"  size="10" /></td>
	  </tr>
	  
	  <tr>
	    <td class="normal14z" >起始合約日期：</td>
	    <td class="normal14" ><input tabIndex="3" id="tj002o" ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="tj002o"  value="<?php echo $tj002o; ?>"  size="20" /></td>
        <td class="normal14z" >結束合約日期：</td>
	    <td class="normal14" ><input tabIndex="4" id="tj002c" ondblclick="scwShow(this,event);" onchange="dateformat_ymd(this);" onKeyPress="keyFunction()" type="text" name="tj002c"  value="<?php echo $tj002c; ?>"  size="20" /></td>
	  </tr>
