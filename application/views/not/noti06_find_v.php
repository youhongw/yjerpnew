...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 票據單據性質建立作業 - 設定查詢條件　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();"  tabIndex="7" type='submit'  name='submit' accesskey="k"  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k&nbsp;</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('not/noti06/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti06/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MQ001'> MQ001 單別代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MQ002'> MQ002 單據名稱 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MQ003'> MQ003 單據性質 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MQ004'> MQ004 編碼方式 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MQ005'> MQ005 年碼數 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MQ006'> MQ006 流水號碼 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MQ001'> MQ001 單別代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MQ002'> MQ002 單據名稱 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MQ003'> MQ003 單據性質 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MQ004'> MQ004 編碼方式 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MQ005'> MQ005 年碼數 </option>
				<option <?php if($find006 == '6') echo 'selected="selected"';?> value='MQ006'> MQ006 流水號碼 </option>
	...
	<!--  <div class="buttons">
	    <button tabIndex="7" type='submit'  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>&nbsp;查詢 F8&nbsp;</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('not/noti06/display'); ?>" class="button" ><span>返 回&nbsp;F9&nbsp;</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>-->
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/not/noti06/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
