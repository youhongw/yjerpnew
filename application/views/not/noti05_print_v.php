...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 預計收支建立作業 - 明細表　　　</h1>
    <div style="float:left;padding-top: 5px; ">
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#te001o').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/noti05/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    ...
	    <td class="normal14a" width="38%"><input tabIndex="1" id="te001o" onKeyPress="keyFunction()" type="text" name="te001o"  size="20" /></td>
        <td class="normal14y" width="12%">結束預計收支代號：</td>
		<td class="normal14a" width="38%"><input tabIndex="2" id="te001c" onKeyPress="keyFunction()" type="text" name="te001c"  size="20" /></td>
	  </tr>
	  <tr>
