...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 抵押資料建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit' accesskey="k" name='submit'  class="button" value='查詢Alt+k'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('not/noti08/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti08/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TJ001'> TJ001 借款批號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TJ002'> TJ002 合約日期 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TJ003'> TJ003 借款銀行 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TJ004'> TJ004 到期日 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TJ005'> TJ005 幣別 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TJ007'> TJ007 年利率 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TJ001'> TJ001 借款批號 </option>                                                                       
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TJ002'> TJ002 合約日期 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TJ003'> TJ003 借款銀行 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TJ004'> TJ004 到期日 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TJ005'> TJ005 幣別 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='TJ007'> TJ007 年利率 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/not/noti08/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
