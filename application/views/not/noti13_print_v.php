...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 融資種類建立作業 - 明細表　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/not/noti13/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">起始融資代號：</td>
	    <td class="normal14a" width="39%"><input tabIndex="1" id="mc001o" onKeyPress="keyFunction()" type="text" name="mc001o"  size="20" /></td>
        <td class="normal14y" width="8%">結束融資代號：</td>
		<td class="normal14a" width="42%"><input tabIndex="2" id="mc001c" onKeyPress="keyFunction()" type="text" name="mc001c"  size="20" /></td>
	  </tr>
	  <tr>
