...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 銀行存提款作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti02/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TF001'> TF001 存提單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TF002'> TF002 存提單號 </option>
		    <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TF003'> TF003 存提日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TF004'> TF004 銀行代號 </option>
            <option <?php if($find001 == '5') echo 'selected="selected"';?> value='b.MA002'> MA002 銀行簡稱	 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='b.MA005'> MA005 銀行存提科目 </option>
            <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.TF005'> TF005 幣別	 </option>
            <option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.TF008'> TF008 傳票單別	 </option>
            <option <?php if($find001 == '9') echo 'selected="selected"';?> value='a.TF009'> TF009 傳票單號	 </option>
            <option <?php if($find001 == '10') echo 'selected="selected"';?> value='a.TF011'> TF011 單據日期 </option>
		    <option <?php if($find001 == '11') echo 'selected="selected"';?> value='a.TF012'> TF012 確認者 </option>
		    <option <?php if($find001 == '12') echo 'selected="selected"';?> value='a.TF013'> TF013 原幣合計 </option>
		    <option <?php if($find001 == '13') echo 'selected="selected"';?> value='a.TF014'> TF014 本國幣合計 </option>
		    <option <?php if($find001 == '14') echo 'selected="selected"';?> value='a.TF017'> TF017 簽核狀態碼 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
