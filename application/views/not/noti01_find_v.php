...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 銀行帳號建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/not/noti01/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MA001'> MA001 銀行代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MA006'> MA006 銀行行號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MA004'> MA004 銀行帳號 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MA002'> MA002 銀行簡稱 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MA003'> MA003 銀行全名 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MA005'> MA005 銀行存款科目 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='MA007'> MA007 聯絡人 </option>
			<option <?php if($find001 == '8') echo 'selected="selected"';?> value='MA008'> MA008 電話 </option>
			<option <?php if($find001 == '9') echo 'selected="selected"';?> value='MA009'> MA009 地址 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            ...
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MA002'> MA002 銀行簡稱 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MA003'> MA003 銀行全名 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MA006'> MA006 銀行存款科目 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='MA007'> MA007 聯絡人 </option>
			<option <?php if($find001 == '8') echo 'selected="selected"';?> value='MA008'> MA008 電話 </option>
			<option <?php if($find001 == '9') echo 'selected="selected"';?> value='MA009'> MA009 地址 </option>
	    </select>&nbsp;&nbsp;&nbsp;&nbsp;
