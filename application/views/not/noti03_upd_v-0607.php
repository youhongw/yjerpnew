...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
		<td class="normal14a" width="8%">廠商代號：</td>
	    ...
	    <td class="normal14a" width="8%" >開票日： </td>  <!-- dateformat_ymd(this); -->
        <td class="normal14a"  width="25%" >
	  ...
	  <tr>	
        ...
        <td class="normal14">
			<input tabIndex="3" id="noti01" onKeyPress="keyFunction()"  onchange="check_noti01(this)" name="noti01" value="<?php echo $ta006; ?>" size="12" type="text"/>
	...
	<div id="tab1" class="tab_content">
      <table class="form14">     <!-- 表格 -->
	    <tr>
	    <td class="start14a"  width="12%"><span class="required">票號：</span></td>
	    ...
	    <td class="normal14a"  width="12%">票據種類：</td>  <!-- onchange="startcmsi09(this)"     -->
        <td  class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14" >銀行帳號：</td>		
        <td class="normal14"  >
			<input type="text" id="noti01disp3" readonly="value"  tabIndex="14"   onKeyPress="keyFunction()"    name="noti01disp3" value="<?php echo $noti01disp3 ?>"  size="20" style="background-color:#F0F0F0"/>
		</td>
	  </tr>
	  
	  <tr>
	    <td class="normal14" >銀行簡稱：</td>		
        <td class="normal14"  >
			<input type="text" id="noti01disp2"  readonly="value"  tabIndex="16"   onKeyPress="keyFunction()"    name="noti01disp2" value="<?php echo $noti01disp2; ?>"  size="20" style="background-color:#F0F0F0"/>
		</td>
	  </tr>
	  </table>
	</div>
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
        ...
        <!--  依照資料庫紀錄的明細先列一遍 原0會由1加  -->
			...
			<?php foreach($body_data as $key => $val){
				...
				echo "<tr>";
				echo "<td class='center'><img src='".base_url()."assets/image/delete2.png' title='刪除資料' onclick='del_detail".$temp."(\"".$temp1."\",\"".$current_product_count."\");' /></td>";
...
<?php  include_once("./application/views/funnew/noti01_funmjs_v.php"); ?>  <!-- 銀行帳戶 -->
