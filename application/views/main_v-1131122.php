          ...
          <div class="box-body border-radius-none">
            <div>
              ...
              <?php if ($super == 'Y' or  substr($rms, 42, 1) == 'Y') { ?>
                <button type="button" class="btn btn-block btn-success btn-lg" onclick="javascript:location.href='<?php echo "http://132.147.160.7/"; ?>report/normal/YJ01.html'">YJ託外製令及託外進貨數量</button>
              <?php } ?>

              <?php if ($super == 'Y' or  substr($rms, 45, 1) == 'Y') { ?>
                <button type="button" class="btn btn-block btn-success btn-lg" onclick="javascript:location.href='<?php echo "http://132.147.160.7/"; ?>report/normal/YJ02.html'">DS每月折讓金額</button>
              <?php } ?>

              <?php if ($super == 'Y' or  substr($rms, 46, 1) == 'Y') { ?>
                <button type="button" class="btn btn-block btn-success btn-lg" onclick="javascript:location.href='<?php echo "http://132.147.160.7/"; ?>report/normal/YJ03.html'">DS國貿營收</button>
              <?php } ?>

              <?php if ($super == 'Y' or  substr($rms, 47, 1) == 'Y') { ?>
                <button type="button" class="btn btn-block btn-success btn-lg" onclick="javascript:location.href='<?php echo "http://132.147.160.7/"; ?>report/normal/YJ04.html'">LS上海辦銷售月報</button>
              <?php } ?>
