 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ips/ipsr04/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    ...
	    <td width="10%" align="left">開狀原幣額<br>已到貨額</td>
	    <td width="10%" align="left" >進貨單號<br>品號</td>
	    <td width="10%" align="left">品名<br>規格</td>
	    <td width="10%" align="left">單位<br>進貨數量</td>
		<td width="10%" align="left">包裝數量<br>進貨單價</td>
	    <td width="10%" align="left">進貨金額<br>有效日期</td>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	      ...
	      <tr>
		    ...
		    <td width="10%" align="left"><?php echo  $val->ta018;?><br><?php echo  $val->ta020;?></td>
			<td width="10%" align="left"><?php echo  $val->ti008;?><br><?php echo  $val->ti010;?></td>
		    <td width="10%" align="left"><?php echo  $val->ti055;?><br><?php echo  $val->ti056;?></td>
			<td width="10%" align="left"><?php echo  $val->ti027;?><br><?php echo  $val->ti014;?></td>
		    <td width="10%" align="left"><?php echo  $val->ti029;?><br><?php echo  ''?></td>
		    <td width="10%" align="left"><?php echo  $val->ti017;?><br><?php echo  $val->ta009;?></td>
		   	...
		   	<?php if (($totle_page == $page) and ($totle_page==1) and  ($rownum1 <=$vaa ) )  { ?>
	                ...
	                <tr>
					  <td colspan="10" align="left">
						...
						<b></b> <?php if ($tprint=='Y') { echo '';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>合計進貨金額：</b> <?php if ($tprint=='Y') { echo $vamt;} ?>  <?php echo '';} ?> 
						<?php if ($totle_page > $page ) { ?>
						<b></b> <?php if ($tprint=='Y') { echo '';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b></b> <?php if ($tprint=='Y') { echo '';} ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>合計進貨金額</b> <?php if ($tprint=='Y') { echo '　　　　　　';} ?>  <?php echo '續下頁..';} ?> 
