...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 單據性質建立作業 - 複製</h1>
    </div>
    
    <div class="content"> <!-- div-5 -->
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ips/ipsi06/copysave" method="post" enctype="multipart/form-data" id="form">
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	   ...
	   <a accesskey="x" tabIndex="6" id='cancel' name='cancel' href="<?php echo site_url('ips/ipsi06/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a></div>
