	<?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/ips/ipsi01/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
?>       
	...
	<table class="thead">    <!-- 列表頭 -->
	  <tr>
	    <td width="15%" align="center">費用代號</td>
	    <td width="17%" align="center">費用名稱</td>
	    <td width="17%" align="left">會計科目</td>
