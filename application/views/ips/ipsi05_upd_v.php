...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 報關/贖單資料建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ips/ipsi05/updsave" method="post" enctype="multipart/form-data" >
	<div id="tab-general"> <!-- div-6 -->
	
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="start14a"  width="10%"><span class="required">報關單別：</span></td>   <!--onchange="startipsi06(this);check_title_no();"    -->
        <td class="normal14a"  width="24%"><input tabIndex="1" id="ipsi06"  ondblclick="search_ipsi06_window()"  onKeyPress="keyFunction()"   name="tg001" onfocus="" onchange=""  value="<?php echo $tg001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a" width="23%"><input tabIndex="3" id="tg002" onKeyPress="keyFunction()"  name="tg002" onfocus="" value="<?php echo $tg002; ?>" size="12" type="text" required /></td>
	  </tr>
	...
	<!-- 合計     -->
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('ips/ipsi05/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('ips/ipsi05/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>	
	  </div> 
	  </div> <!-- div-加 -->
    </form>  <!-- end 表單 -->
...
<form action="<?php echo base_url()?>index.php/ips/ipsi05/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
