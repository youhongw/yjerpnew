...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 預付購料建立作業 - 新增</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ips/ipsi02/addsave" >	
	<?php       
	  ...
	  if(!isset($ta036)) { $ta036=$sysma200; } else {$ta036=$this->input->post('ta036');}
	  if(!isset($ta016)) { $ta016=$this->session->userdata('sysma003'); } else  {$ta022=$this->input->post('ta022');}
	  if(!isset($ta043)) { $ta043=$username; }
	  ...
	  if(!isset($ta036disp)) { $ta036disp=$this->input->post('ta036disp'); }
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="24%"><input tabIndex="1" id="ipsi06"  ondblclick="search_ipsi06_window()"  onKeyPress="keyFunction()"   name="ta001" onfocus="check_title_no();selverify();" onchange="check_ipsi06(this);check_title_no();"  value="<?php echo $ta001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a" width="23%"><input tabIndex="3" id="ta002" onKeyPress="keyFunction()"  name="ta002" onfocus="check_title_no();" value="<?php echo $ta002; ?>" size="12" type="text" required /></td>
	  </tr>
	...
	<!-- 合計     -->
	 ...
	 <div class="buttons">
	   ...
	   <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('ips/ipsi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 </div> 
   </div> 	<!-- end 頁標籤 -->   
   </form>
	   <?php	if ($message!=' ') { ?>
