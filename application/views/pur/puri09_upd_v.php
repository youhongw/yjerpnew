...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('pur/puri09/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('pur/puri09/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>	 
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	 <tr>
        ...
        <td class="normal14a"  width="40%"><input tabIndex="1" id="puri04"    onKeyPress="keyFunction()" ondblclick="search_puri04_window()"  name="tg001"  onchange="check_puri04(this);"  value="<?php echo $tg001; ?>" size="12" type="text" required />
	    ...
	    <td class="normal14y" width="10%" >單據日期： </td>
          <td class="normal14a"  width="40%"> <input tabIndex="2"  ondblclick="scwShow(this,event);"   id="tg014" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="tg014"  value="<?php echo $tg014; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="4" id="puri01" onKeyPress="keyFunction()"  ondblclick="search_puri01_window()"  onchange="check_puri01(this)" name="tg005" value="<?php echo $tg005; ?>" size="12" type="text"  />
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td  class="normal14"  ><input tabIndex="22"  ondblclick="scwShow(this,event);"   id="tg029" onKeyPress="keyFunction()"  onchange="dateformat_ym(this);" name="tg029"  value="<?php echo $tg029; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
           ...
           </td></tr>	<td  class="normal14">營業稅率：</td>		
