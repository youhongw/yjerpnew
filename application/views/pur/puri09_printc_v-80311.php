...
<body onLoad="window.print()">
		...
		<?php $pagerow=17;$page=1;$pagetot=1;$th007qty=0; $th019amt=0; ?>	
        <?php foreach($results as $row ) : ?>
			  ...
			  <?php  $th019[] = round($row->th019,0); ?>
			  <?php  $th033[] = $row->th033; ?>
			  <?php  $th009[] = $row->th009; ?>
			 
			  
			  <?php $rowtot++;$th007qty=$th007qty+round($row->th007,0);$th019amt=$th019amt+round($row->th019,0); ?>
        <?php endforeach;?>
		         
        <?php $pagetot=ceil($rowtot/17); ?>
		...
		<!--	<tr><td valign="top">
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  <td align="left"><? echo $th004[$rownum];?><br><? echo $th008[$rownum];?></td>
					  <td align="left"><? echo $th005[$rownum];?><br><? echo $th006[$rownum];?></td>
					  <td align="right"><? echo $th012[$rownum];?><br><? echo $th007[$rownum];?></td>
					  <td align="right"><? echo $th018[$rownum];?><br><? echo $th019[$rownum];?></td>
					...
					<tr>
					  <td colspan="5" align="left">
						<b>數量合計：</b><span><? echo $tg026;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>進貨金額：</b><span><? echo $tg028;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>稅額：</b><span><? echo $tg019;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<b>金額合計：</b><span><? echo $tg028+$tg019;?></span>
					  </td>
					</tr>
				</table>
			</td></tr>
