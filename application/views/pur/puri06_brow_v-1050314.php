  <div class="box2">  <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri06/addform'"  style="float:left" accesskey="+" class="button"><span>新增</span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri06/findform'"  style="float:left" accesskey="k" class="button"><span>進階查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>   
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri06/printdetail'"   style="float:left"  accesskey="p" class="button"><span>列印pdf p </span><img src="<?php echo base_url()?>assets/image/png/print.png" /></a>  
	  <?PHP } ?> 
      <?PHP if (substr($this->session->userdata('sysmg006'),9910,1)=='Y') { ?>	 
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri06/exceldetail'"   style="float:left"  accesskey="l" class="button"><span>轉EXCEL檔 l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></a>  
	  <?PHP } ?> 
      ...
      <table class="list">      <!-- 表格開始 -->
        <thead>
          ...
          <tr>                          <!-- 表格表頭 -->
		    ...
		    <?php echo anchor("pur/puri06/display/create_date/" . (($sort_order == 'asc' && $sort_by == 'create_date') ? 'desc' : 'asc') ,'建立日期'); ?>
		    <?php if ($sort_order == 'asc'  ) { ?>  <img src="<?php echo base_url()?>assets/image/desc.png" /> <?php } else { ?>
		    <img src="<?php echo base_url()?>assets/image/asc.png" />  <?php }  ?>
	      </td>
	    ...
	    <tr class="filter">
          ...
          <td align="left">
		   <div class="button-search"></div>
		    <div  class="button-search"></div>
		   <input type="text" id="filter_tb001" name="filter_tb001" value="" />
		   </div>
	      </td>
