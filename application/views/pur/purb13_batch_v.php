...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 進貨單轉入品號廠商檔 - 作業　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/purb13/batcha"  method="post"  enctype="multipart/form-data" > 
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="12%">計算截止年月：</td>
        <td class="normal14a" width="88%"><input tabIndex="3" id="ta034c"  onclick="fPopCalendar(event,vdate,vdate);" class="date-picker" onChange="dateformat_ym(this)"    onKeyPress="keyFunction()"    type="text" name="ta034c"  value="<?php echo $ta034c; ?>"  size="16" style="background-color:#E7EFEF" /></td>
	  </tr>
