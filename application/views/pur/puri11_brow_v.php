<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri11/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重整 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri11/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
      ...
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri11/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		'rowid' => array('sort_name'=>"ti001",'name'=>"序號",'width'=>"5%",'align'=>"left",'use'=>"disable"),
		'ti001' => array('sort_name'=>"ti001",'name'=>"退貨單別",'width'=>"6%",'align'=>"left"),
		'mq002' => array('sort_name'=>"c.mq002",'name'=>"單別名稱",'width'=>"6%",'align'=>"left"),
		'ti002' => array('sort_name'=>"ti002",'name'=>"退貨單號",'width'=>"7%",'align'=>"left"),
		'ti014' => array('sort_name'=>"ti014",'name'=>"單據日期",'width'=>"7%",'align'=>"left"),
		'ti004' => array('sort_name'=>"ti004",'name'=>"廠商代號",'width'=>"7%",'align'=>"left"),
		'ma002' => array('sort_name'=>"b.ma002",'name'=>"廠商名稱",'width'=>"7%",'align'=>"left"),
		'ti011' => array('sort_name'=>"ti011",'name'=>"退貨金額",'width'=>"7%",'align'=>"left"),
		'ti015' => array('sort_name'=>"ti015",'name'=>"稅額",'width'=>"7%",'align'=>"left"),
		//'ti020' => array('sort_name'=>"ti020",'name'=>"已結帳",'width'=>"7%",'align'=>"left"),
		'see' => array('sort_name'=>"",'name'=>"查看管理",'width'=>"11%",'align'=>"center"),
		'edit' => array('sort_name'=>"",'name'=>"修改管理",'width'=>"11%",'align'=>"center"),
		'print' => array('sort_name'=>"",'name'=>"印退貨單",'width'=>"11%",'align'=>"center")
	  );
    ?>
  <div class="content"> <!-- div-2 -->
		  ...
		  <input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" />
	       ...
	       <?php
			foreach($title_array as $key => $val){
			  ...
			  echo anchor("cop/puri11/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("cop/puri11/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	...
	<?php 
	  $filter_array = array(
		...
		'ti001' => array('filter_name'=>"ti001",'name'=>"退貨單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'ti002' => array('filter_name'=>"ti002",'name'=>"退貨單號",'size'=>"10",'align'=>"left"),
		'ti014' => array('filter_name'=>"ti014",'name'=>"單據日期",'size'=>"10",'align'=>"left"),
		'ti004' => array('filter_name'=>"ti004",'name'=>"廠商代號",'size'=>"10",'align'=>"left"),
		'ma002' => array('filter_name'=>"ma002",'name'=>"廠商名稱",'size'=>"10",'align'=>"left"),
		'ti011' => array('filter_name'=>"ti011",'name'=>"退貨金額",'size'=>"10",'align'=>"left"),
		'ti015' => array('filter_name'=>"ti015",'name'=>"稅額",'size'=>"10",'align'=>"left"),
		//'ti020' => array('filter_name'=>"ti020",'name'=>"已結帳",'size'=>"10",'align'=>"left"),
	  );
    ?> 
        ...
        <tr>
		  ...
		  <td class="left"><?php echo  trim($row->mq002).''.trim($row->ti020);?></td>
		  <td class="left"><?php echo  $row->ti002;?></td>
		  <td class="left"><?php echo  substr($row->ti014,0,4).'/'.substr($row->ti014,4,2).'/'.substr($row->ti014,6,2);?></td>
		...
		<!--  <td class="center"><?php echo  $row->ti020;?></td>	-->	                 			
		 ...
		 <!-- 修改時 留在原來那一筆資料使用 -->
		  <?php $this->session->set_userdata('puri11_search',$this->uri->segment(3)."/".$this->uri->segment(4,0));
		    if($this->uri->segment(3)=="display" || $this->uri->segment(3)=="display_leave"){
			  $this->session->set_userdata('puri11_search',$this->uri->segment(3)."/".$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6,0));
			} ?>   
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/pur/puri11/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/pur/puri11/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>