...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 請購資料維護作業 - 設定查詢條件　　　</h1>
	  ...
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pur/puri06/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
             <option <?php if($find001 == '1') echo 'selected="selected"';?> value='TB001'> TB001 單別 </option>                                                                        
		     <option <?php if($find001 == '2') echo 'selected="selected"';?> value='TB002'> TB002 請購單號 </option>
             <option <?php if($find001 == '3') echo 'selected="selected"';?> value='TB003'> TB003 序號 </option>
             <option <?php if($find001 == '4') echo 'selected="selected"';?> value='TB004'> TB004 品號 </option>
		     <option <?php if($find001 == '5') echo 'selected="selected"';?> value='TB013'> TB013 採購人員 </option>
		     <option <?php if($find001 == '6') echo 'selected="selected"';?> value='TB010'> TB010 供應廠商 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='TB001'> TB001 單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='TB002'> TB002 請購單號  </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='TB003'> TB003 序號 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='TB004'> TB004 品號  </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='TB013'> TB013 採購人員 </option>
			<option <?php if($find006 == '6') echo 'selected="selected"';?> value='TB010'> TB010 供應廠商 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/pur/puri06/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
