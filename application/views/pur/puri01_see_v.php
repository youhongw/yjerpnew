...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 廠商資料建立作業 - 查看　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	   <a  accesskey="x"  id='cancel' name='cancel' href="<?php echo site_url('pur/puri01/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/puri01/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<?php foreach($result as $row) { ?>
          ...
          <?php   $ma055=$row->ma055;?>
          <?php   $ma056=$row->ma056;?>
		  <?php   $ma047disp=$row->ma047disp;?>
		  <?php   $ma021disp=$row->ma021disp;?>
		  <?php   $ma007disp=$row->ma007disp;?>	
		  <?php   $ma006disp=$row->ma006disp;?>		
		  <?php   $ma004disp=$row->ma004disp;?>	
		  <?php   $ma042disp=$row->ma042disp;?>
		  <?php   $ma041disp=$row->ma041disp;?>
		  <?php   $ma043disp=$row->ma043disp;?>
		  <?php   $ma025disp=$row->ma025disp;?>	
		  <?php   $mb991=' ';?>
		  <?php   $mb992=' ';?>
		  <?php   $mb999=' ';?>
	<?php  }?>
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="42%"><input tabIndex="1" id="ma001"      onKeyPress="keyFunction()" onBlur="startpurq01a(this)"  name="ma001" value="<?php echo strtoupper($ma001); ?>"  type="text" required disabled="disabled" />
        ...
        <td class="normal14a"  width="42%" ><input tabIndex="2" id="ma005" onKeyPress="keyFunction()" name="ma005"  onkeyup="this.value=this.value.replace(/[^A-Z0-9]/gi,'');this.value=this.value.toLocaleUpperCase()" value="<?php echo  strtoupper($ma005); ?>"    type="text" disabled="disabled" /></td>
	 </tr>	
		  
	  <tr>
	    <td class="normal14z" >廠商簡稱： </td>
        <td class="normal14" ><input tabIndex="3" id="ma002" onKeyPress="keyFunction()" onBlur="checkspace2(this)" name="ma002" value="<?php echo $ma002; ?>" size="30" type="text" required disabled="disabled" /><span id="ma002disp" ></span></td>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="23%" ><input type="text" tabIndex="6" id="ma007" onKeyPress="keyFunction()"   onBlur="startcmsq15a3(this)" name="ma007"   value="<?php echo  $ma007; ?>"   disabled="disabled"  /><a href="javascript:;"><img id="Showcmsq15a3" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input type="text" tabIndex="8" id="ma006" onKeyPress="keyFunction()"   onBlur="startcmsq15a4(this)" name="ma006"   value="<?php echo  $ma006; ?>"    size="6" disabled="disabled" /><a href="javascript:;"><img id="Showcmsq15a4" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        ...
        <td class="normal14"  ><input tabIndex="10" id="ma004" onKeyPress="keyFunction()" name="ma004" onBlur="startcmsq15a9(this)"   value="<?php echo  $ma004; ?>"     type="text" disabled="disabled" /><img id="Showcmsq15a9" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="18" id="ma021" onKeyPress="keyFunction()" name="ma021" onBlur="startcmsq06a(this)"  value="<?php echo $ma021; ?>"  type="text" disabled="disabled"  /><img id="Showcmsq06a" src="<?php echo base_url()?>assets/image/png/currency.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="23" id="ma047" onKeyPress="keyFunction()" name="ma047" onBlur="startcmsq09a4(this)"   value="<?php echo  $ma047; ?>"     type="text" disabled="disabled" /><img id="Showcmsq09a4" src="<?php echo base_url()?>assets/image/png/person.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="33" id="ma042" onKeyPress="keyFunction()" name="ma042" onBlur="startactq03a1(this)"   value="<?php echo  $ma042; ?>"     type="text" disabled="disabled" /><img id="Showactq03a1" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td  class="normal14a"  ><select id="ma024" onKeyPress="keyFunction()" name="ma024" " tabIndex="34" disabled="disabled">
        ...
        <td  class="normal14"  ><input tabIndex="35" id="ma025" onKeyPress="keyFunction()" name="ma025" onBlur="startcmsq21a1(this)"   value="<?php echo  $ma025; ?>"     type="text" disabled="disabled" /><img id="Showcmsq21a1" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        ...
        <td  class="normal14"  ><input tabIndex="36" id="ma041" onKeyPress="keyFunction()" name="ma041" onBlur="startactq03a2(this)"   value="<?php echo  $ma041; ?>"     type="text" disabled="disabled" /><img id="Showactq03a2" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	  ...
	  <tr>
        ...
        <td class="normal14"><input tabIndex="37" id="ma026" onKeyPress="keyFunction()"   name="ma026" value="<?php echo $ma026; ?>" type="text"  disabled="disabled" /></td>
	    <td class="normal14z">應付票據科目：</td>						
        <td  class="normal14"  ><input tabIndex="38" id="ma043" onKeyPress="keyFunction()" name="ma043" onBlur="startactq03a3(this)"   value="<?php echo  $ma043; ?>"     type="text" disabled="disabled" /><img id="Showactq03a3" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="89%"><input tabIndex="46" id="ma046" onKeyPress="keyFunction()" name="ma046" value="<?php echo $ma046; ?>"  type="text" disabled="disabled" /></td>
	  </tr>	
		  
	  <tr>
	    <td class="normal14z" > 聯絡地址(一)：</td>
        <td class="normal14" ><input tabIndex="47" id="ma048" onKeyPress="keyFunction()" name="ma048" value="<?php echo $ma048; ?>" size="80" type="text" disabled="disabled" /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" > 聯絡地址(二)：</td>
        <td class="normal14" ><input tabIndex="48" id="ma049" onKeyPress="keyFunction()" name="ma049" value="<?php echo $ma049; ?>" size="80" type="text" disabled="disabled" /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" > 郵遞區號(二)：</td>
        <td class="normal14" ><input tabIndex="49" id="ma050" onKeyPress="keyFunction()" name="ma050" value="<?php echo $ma050; ?>"  type="text" disabled="disabled" /></td>
	  </tr>	
	  <tr>
	    <td class="normal14z" > 帳單地址(一)：</td>
        <td class="normal14" ><input tabIndex="50" id="ma051" onKeyPress="keyFunction()" name="ma051" value="<?php echo $ma051; ?>" size="80" type="text" disabled="disabled" /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" > 帳單地址(二)：</td>
        <td class="normal14" ><input tabIndex="51" id="ma052" onKeyPress="keyFunction()" name="ma052" value="<?php echo $ma052; ?>" size="80" type="text" disabled="disabled" /></td>
	  </tr>
