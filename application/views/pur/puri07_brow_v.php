<div class="box2"> <!-- div-1 -->
    <div class="heading">
	  ...
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri07/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重整 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri07/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	  <?PHP } ?>
      ...
      <?PHP } ?>
	  <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	  <a onclick="location = '<?php echo base_url()?>index.php/pur/puri07/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>		
      <?PHP } ?>
	...
	<?php 
	  $title_array = array(
		...
		'tc001' => array('sort_name'=>"tc001",'name'=>"採購單別",'width'=>"7%",'align'=>"left"),
		'mq002' => array('sort_name'=>"d.mq002",'name'=>"單別名稱",'width'=>"7%",'align'=>"left"),
		'tc002' => array('sort_name'=>"tc002",'name'=>"採購單號",'width'=>"7%",'align'=>"left"),
		'tc003' => array('sort_name'=>"tc003",'name'=>"單據日期",'width'=>"7%",'align'=>"left"),
		'tc004' => array('sort_name'=>"tc004",'name'=>"廠商代號",'width'=>"5%",'align'=>"left"),
		'ma002' => array('sort_name'=>"b.ma002",'name'=>"廠商名稱",'width'=>"5%",'align'=>"left"),
	//	'mv002' => array('sort_name'=>"c.mv002",'name'=>"採購人員",'width'=>"6%",'align'=>"left"),
		'tc019' => array('sort_name'=>"tc019",'name'=>"採購金額",'width'=>"5%",'align'=>"left"),
		'tc020' => array('sort_name'=>"tc020",'name'=>"稅額",'width'=>"5%",'align'=>"left"),
		...
		'print' => array('sort_name'=>"",'name'=>"印採購單",'width'=>"12%",'align'=>"center")
	  );
    ?>
  <div class="content"> <!-- div-2 -->
       ...
       <table class="list">      <!-- 表格開始 -->
	     ...
	     <?php
		   foreach($title_array as $key => $val){
			  ...
			  echo anchor("pur/puri07/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
			  $str = "<img src='".base_url()."assets/image/desc.png' />";
			  echo anchor("pur/puri07/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
	...
	<?php 
	  $filter_array = array(
		...
		'tc001' => array('filter_name'=>"tc001",'name'=>"採購單別",'size'=>"10",'align'=>"left"),
		'mq002' => array('filter_name'=>"mq002",'name'=>"單別名稱",'size'=>"10",'align'=>"left"),
		'tc002' => array('filter_name'=>"tc002",'name'=>"採購單號",'size'=>"10",'align'=>"left"),
		'tc003' => array('filter_name'=>"tc003",'name'=>"單據日期",'size'=>"10",'align'=>"left"),
		'tc004' => array('filter_name'=>"tc004",'name'=>"廠商代號",'size'=>"10",'align'=>"left"),
		'ma002' => array('filter_name'=>"ma002",'name'=>"廠商名稱",'size'=>"10",'align'=>"left"),
		//'mv002' => array('filter_name'=>"mv002",'name'=>"採購人員",'size'=>"10",'align'=>"left"),
		'tc019' => array('filter_name'=>"tc029",'name'=>"採購金額",'size'=>"10",'align'=>"left"),
		'tc020' => array('filter_name'=>"tc030",'name'=>"稅額",'size'=>"10",'align'=>"left"),
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/pur/puri07/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/pur/puri07/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>