...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 品號廠商建立作業 - 設定查詢條件　　　</h1>
	 ...
	 <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pur/puri02/findsql" method="post" enctype="multipart/form-data" >
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.MB001'> MB001 品別代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.MB002'> MB002 廠商代號 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.MB003'> MB003 幣別代號 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.MB005'> MB005 初次交易 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.MB008'> MB008 核價日期 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.MB014'> MB014 生效日期 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.MB001'> MB001 品別代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.MB002'> MB002 廠商代號 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.MB003'> MB003 幣別代號 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.MB005'> MB005 初次交易 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.MB008'> MB008 核價日期 </option>
			    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.MB014'> MB014 生效日期 </option>
