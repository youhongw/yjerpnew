...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
	 ...
	 <a  href="javascript:;"><span class="button">　複製進貨單據　</span><a  href="javascript:;"><img id="Showpurc11a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	...
	<?php       
	  ...
	  if(!isset($ti001disp)) { $ti001disp=$this->input->post('ti001disp'); }
	//  if(!isset(ti001disp)) { $ti001disp=$this->input->post('ti001disp'); }
	...
	?>
	 <?php
	  ...
	  // $ti042=$this->input->post('ti042');
	   ...
	   $ti011=$this->input->post('ti011');
	   $ti011disp=$this->input->post('ti011');
	   
	    $ti005=$this->input->post('ti005');
	    $ti005disp=$this->input->post('ti005');	 
		IF (!isset($ti006)) { $ti006=$this->session->userdata('sysma003');}
   ...
   <?php 
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
        ...
        <td class="normal14a"  width="40%"><input tabIndex="1" id="puri04"    onKeyPress="keyFunction()" ondblclick="search_puri04_window()"  name="ti001"  onchange="check_puri04(this);check_title_no();"  value="<?php echo $ti001; ?>" size="12" type="text" required />
        ...
        <td class="normal14a"  width="40%" > <input tabIndex="2"  ondblclick="scwShow(this,event);"   id="ti014" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="ti014"  value="<?php echo $ti014; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /> 
	  ...
	  <tr>
        ...
        <td class="normal14a" ><input tabIndex="3" id="ti002" onKeyPress="keyFunction()" onfocus="check_title_no();" name="ti002" value="<?php echo $ti002; ?>" size="30" type="text" required /></td>
		 <td class="normal14z">供應廠商：</td>
        <td  class="normal14"  ><input tabIndex="4" id="puri01" onKeyPress="keyFunction()" onfocus="check_title_no();" ondblclick="search_puri01_window()"  onchange="check_puri01(this)" name="ti004" value="<?php echo $ti004; ?>" size="12" type="text"  />
...
<!--	
	...
	<!-- <div class="buttons">
	 ...
	 <a  accesskey="x" tabIndex="96" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('pur/puri11/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	 <b style="color: #FF0000;"><span>　複製進貨單據　</span></b><a  href="javascript:;"><img id="Showpurc11a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/>
