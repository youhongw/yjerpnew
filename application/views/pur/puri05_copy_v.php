...
<div id="content"> <!-- div-3 -->
  <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 請購單資料建立作業 - 複製　　　</h1>
	...
	<form class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/puri05/copysave" method="post" enctype="multipart/form-data" id="form">
	...
	<table class="form14">    <!-- 表格開始 -->
      <tr>
	    <td class="normal14y" width="12%">原始請購單別：</td>           
		<td class="normal14a"  width="38%"><input tabIndex="1" id="ta001o" onchange="copya(this);"  onKeyPress="keyFunction()"   name="ta001o" value="<?php echo strtoupper($ta001o); ?>" size="20" type="text" required />
		 <span id="ta001dispo" ></span></td>
	    <td class="normal14y" width="12%">複製請購單別：</td>
	  ...
	  <tr>
        ...
        <td  class="normal14a" width="42%" ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="ta013" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);check_title_no();" name="ta013"  value="<?php echo $ta013; ?>"type="text" required  size="12" type="text" style="background-color:#FFFFE4"  /> 
