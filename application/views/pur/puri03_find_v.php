...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 核價單資料建立作業 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();"  type='submit' accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('pur/puri03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/pur/puri03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.TL001'> TL001 核價單別 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.TL002'> TL002  核價單號 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.TL003'> TL003 核價日期 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.TL004'> TL004 廠商代號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.TL005'> TL005 幣別 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.TL006'> TL006 確認碼 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='a.TL010'> TL010 單據日期 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.TL001'> TL001 核價單別 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.TL002'> TL002 核價單號 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.TL003'> TL003 核價日期 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.TL004'> TL004 廠商代號 </option>
			<option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.TL005'> TL005 幣別 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.TL006'> TL006 確認碼 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='a.TL010'> TL010 單據日期 </option>
		    <option <?php if($find006 == '8') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	    </select>&nbsp;&nbsp;&nbsp;&nbsp;
