...
<div id="content">  <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 採購單據性質建立作業 - 修改　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#mq001').focus();"  tabIndex="27" type='submit'  accesskey="s"  name='submit'  class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	    <a   accesskey="x"  tabIndex="28" id='cancel' name='cancel' href="<?php echo site_url('pur/puri04/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	   
	</div>
	</div>
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/puri04/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="normal14z" style="background-color:#F5F5F5">應付憑單別： </td>
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td  class="normal14"  >
		  ...
		  <input tabIndex="21" id="mq017" onKeyPress="keyFunction()"  name="mq017" <?php if($mq017 == 'Y' ) echo 'checked';  ?>  <?php if($mq017 != 'Y' ) echo 'check'; ?>  value="Y" size="1" type='checkbox' style="background-color:#F5F5F5" />
        </td>
