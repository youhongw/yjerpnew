...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 請購單資料建立作業 - 列印明細表　　　</h1>
	  ...
	  <button  type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
		  ...
		  <button style= "cursor:pointer" form="commentForm" onfocus="$('#ta001o').focus();" type='submit' accesskey="l" class="button" name='action' value='excel'>轉EXCEL檔Alt+l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></button>&nbsp;&nbsp;
		  <?PHP } ?>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/pur/puri05/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="12%">起始請購單別：</td>
        ...
        <td class="normal14y" width="12%">結束請購單別：</td>
		<td class="normal14" width="38%"><input tabIndex="2" id="ta001c" onKeyPress="keyFunction()" type="text" name="ta001c"  value="<?php echo $ta001c; ?>"  size="20" /></td>
	  </tr>
	  <tr>
	    <td class="normal14z" >起始請購單號：</td>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><input tabIndex="3" id="ta003o" onKeyPress="keyFunction()" type="text" name="ta003o"  value="<?php echo $ta003o; ?>"  size="20" /></td>
        <td class="normal14z" >結束進貨日期：</td>
	    <td class="normal14" ><input tabIndex="4" id="ta003c" onKeyPress="keyFunction()" type="text" name="ta003c"  value="<?php echo $ta003c; ?>"  size="20" /></td>
	  </tr>
	    <tr>
	    <td class="normal14z" >起始產品編號：</td>
	    <td class="normal14" ><input tabIndex="3" id="ta004o" onKeyPress="keyFunction()" type="text" name="ta004o"  value="<?php echo $ta004o; ?>"  size="20" /></td>
        <td class="normal14z" >結束產品編號：</td>
	    <td class="normal14" ><input tabIndex="4" id="ta004c" onKeyPress="keyFunction()" type="text" name="ta004c"  value="<?php echo $ta004c; ?>"  size="20" /></td>
	  </tr>
		<tr>
