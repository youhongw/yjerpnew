...
<body onLoad="window.print()">
			...
			<tr><td valign="top">
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					<tr class="heading">
					  ...
					  <td with="12%" align="left"><b>品號</b></td>
					  <td  with="40%" align="left" ><b>品名</b><br><b>規格</b></td>
					 
					  <td with="12%" align="left"><b>單位</b></td>
					  <td with="12%" align="right" width="40"><b>數量</b></td>
					  <td with="12%" align="right" width="50"><b>單價</b></td>
					  <td with="12%" align="right" width="60"><b>金額</b></td>
					</tr>
					      <?php $rownum=0;  ?>
						  <?php for ($i=1; $i<=$pagerownow; $i++) { ?>
					<tr>					 
					  <td align="left"><?php echo $tb004[$rownum];?></td>
					  <td align="left"><?php echo $tb005[$rownum];?><br><?php echo $tb006[$rownum];?></td>
					
					  <td align="left"><?php echo $tb007[$rownum];?></td>
					  <td align="right"><?php echo $tb009[$rownum];?></td>
					  <td align="right"><?php echo $tb017[$rownum];?></td>
					  <td align="right"><?php echo $tb018[$rownum];?></td>					 
					</tr>
					   <?php $rownum++; ?>
					<?php } ?>
	...
	<!--	  <table class="footer">  -->
		  ...
		  <br/>
		   ...
		   <!-- 第二頁 -->
		  <?php if($rowtot>=9) { ?> <div style="page-break-after: always;"></div>
		  <?php $page +=1; ?> 
          <?php if ($rowtot-$pagerow>=0) {$rowtot=$rowtot-$pagerow;$pagespace=0;$pagerownow=$pagerow;} else
			       {$pagespace=$pagerow-$rowtot;$pagerownow=$pagerow-$pagespace;$rowtot=0;}  ?>
		  <table class="store">
