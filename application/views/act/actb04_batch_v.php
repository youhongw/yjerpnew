...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 傳票整批過帳作業 - 過帳　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#vdate').focus();" type='submit' onclick="return doit();"  tabIndex="98" accesskey="c" name='submit'  class="button"   target="_new" value='&nbsp;計 算F8&nbsp;'><span>計 算Alt+c</span><img src="<?php echo base_url()?>assets/image/png/cal.png" /></button>&nbsp;&nbsp;
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/act/actb04/batcha"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-應付憑單自動結帳</span></div>-->
	<div id="tab-general"> <!-- div-6 -->
	<?php
  	//  $ta004c=$this->input->post('ta004c');
	  $ta034c=$this->input->post('ta034c');
	if (!$this->input->post('vdate')) {$vdate=date("Y/m");} else $vdate=$this->input->post('vdate');
...
//	 if (!$this->input->post('ta034o')) {$ta034o=date("Y/m/d");}
	...
	<table class="form14">   <!-- 表格 onfocus="this.select()" -->
	  <tr>
	    <td class="normal14y"  width="12%">選擇傳票年月：</td>
