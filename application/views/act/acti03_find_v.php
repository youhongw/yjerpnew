...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 科目資料建立作業 - 設定查詢條件　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <button tabIndex="7" style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit'  accesskey="k"  name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a  accesskey="x"  tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('act/acti03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/act/acti03/findsql" method="post" enctype="multipart/form-data" >
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
                <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MA001'> MA001 科目代號 </option>                                                                        
		        <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MA003'> MA003 科目名稱 </option>
                <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MA005'> MA005 科目性質 </option>
                <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MA006'> MA006 資產損益 </option>
		        <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MA007'> MA007 餘額借貸別 </option>
		        <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MA008'> MA008 科目類別 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	     <select name="find006" id="find006" " tabIndex="5" >
            	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='MA001'> MA001 科目代號 </option>                                                                        
		        <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MA003'> MA003 科目名稱 </option>
                <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MA005'> MA005 科目性質 </option>
                <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MA006'> MA006 資產損益 </option>
		        <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MA007'> MA007 餘額借貸別</option>
				<option <?php if($find006 == '6') echo 'selected="selected"';?> value='MA008'> MA008 科目類別</option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/act/acti03/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
