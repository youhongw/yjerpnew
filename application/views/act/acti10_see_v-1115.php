...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
        ...
        <td class="normal14a"  width="22%"><input tabIndex="1" id="ta001"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startactq02a(this)"  name="actq02a" value="<?php echo strtoupper($actq02a); ?>"  type="text" required disabled="disabled"/><a href="javascript:;"><img id="Showactq02a" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="actq02adisp"> <?php    echo $actq02adisp; ?> </span></td>
	    <td class="normal14a" width="10%" >單據日期：</td>
        <td class="normal14a"  width="24%" ><input tabIndex="2"  onclick="scwShow(this,event);"  class="date" id="ta003" onKeyPress="keyFunction()"  onchange="chkno1(this)" name="ta003"  value="<?php echo $ta003; ?>"  size="12" type="text" style="background-color:#E7EFEF" disabled="disabled" /></td>
	  ...
	  <tr>
        ...
        <td class="normal14a" ><input tabIndex="5" id="ta005"   onKeyPress="keyFunction()"  name="ta005" value="<?php echo $ta005; ?>" size="10" type="text"  disabled="disabled" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><input tabIndex="7" id="ta009"   onKeyPress="keyFunction()"  name="ta009" value="<?php echo $ta009; ?>" size="20" type="text"  disabled="disabled" /></td>
	  ...
	  <tr>
        ...
        <td  class="normal14"  ><select id="ta010" onKeyPress="keyFunction()" name="ta010" onChange="selappr(this)" tabIndex="13" disabled="disabled">
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
   	...
   	<!--   明細0  --> 
		...
		<tbody   <?php echo    "id=product-row".$product_row ?> >		  		
		 ...
		 <td class="right"><input readonly="value" type="text"  name="order_product[<?php echo $i ?>][tb014]" value="<?php echo $tb014[$i]; ?>" size="10" style="text-align:right;" disabled="disabled"/></td>
 ...
 <?php } ?>		 
	...
	<?php include("./application/views/fun/acti10_funjsupdjs_v.php"); ?> 
