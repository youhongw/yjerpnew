...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 本期損益期間設定作業 - 結轉　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/act/actb02/batcha"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-應付憑單自動結帳</span></div>-->
	<div id="tab-general"> <!-- div-6 -->
	<?php
  	//  $dateyy1=$this->input->post('dateyy1');
	  $datemm1=$this->input->post('datemm1');
	  if (!isset($dateyy1)) {$dateyy1=date("Y");}	else {$dateyy1=$this->input->post('dateyy1');}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	   ...
	   <tr>
        ...
        <td class="normal14a" width="88%"></td>
	  </tr>  
    </table>
...
<?php include("./application/views/fun/actb02_funjs_v.php"); ?>
<script>
  $(function() {
