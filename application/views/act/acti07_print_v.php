...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 會計期間設定作業 - 明細表　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#mg001o').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/act/acti07/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="11%">起始年度：</td>
	    <td class="normal14a" width="39%"><input tabIndex="1" id="mg001o" onKeyPress="keyFunction()" type="text" name="mg001o"  value="<?php echo $mg001o; ?>"  size="20" /></td>
        <td class="normal14y" width="11%">結束年度：</td>
		<td class="normal14a" width="39%"><input tabIndex="2" id="mg001c" onKeyPress="keyFunction()" type="text" name="mg001c"  value="<?php echo $mg001c; ?>"  size="20" /></td>
	  </tr>
	 <tr>
