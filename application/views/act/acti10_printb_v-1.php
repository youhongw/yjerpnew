		  ...
		  <tr>
				...
				<table class="order">
					<tr>
					  <td width="70%" align="left" valign="top">
						<table class="company">
							<tr>
							  <td width="600" align="left" valign="top"><b>傳票單別：</b><span><?php echo $results[0]->ta001.' '.$results[0]->ta001disp ?></span></td>
			...
			<tr><td valign="top">
				<table class="product" border=1  cellspacing=0 cellpadding=0>
					<tr class="heading">
					  <td border="1px solid #000000" align="center" width="8%"><b>會 計 科 目</b><br><b>會 計 名 稱</b></td>
					  <td border="1px solid #000000" align="center" width="18%"><b>摘    要</b></td>
					  <td border="1px solid #000000" align="center" width="6%"><b>部門代號</b><br><b>部門名稱</b></td>
					  <td border="1px solid #000000" align="right" width="6%"><b>借方金額</b></td>
					  <td border="1px solid #000000" align="right" width="6%"><b>貸方金額</b></td>
					</tr>
					  <?php $rownum=5;$rownum1=0;$rownum2=6;  ?>
					   <?php foreach($page_data[$key] as $k=>$val){?>
					<tr>	
					
					  <td border="1px solid #000000" align="left"><? echo $val->tb005;?><br><? echo $val->tb005disp;?></td>
					  <td border="1px solid #000000" align="left"><? echo $val->tb010;?></td>
					  <td border="1px solid #000000" align="left"><? echo $val->tb006;?><br><? echo $val->tb006disp;?></td>
					  <td border="1px solid #000000" align="right"><? if ($val->tb004==1) {echo $val->tb007;}?></td>
					  <td border="1px solid #000000" align="right"><? if ($val->tb004==-1) {echo $val->tb007;}?></td>
