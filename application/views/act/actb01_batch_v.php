...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/act/actb01/batcha"  method="post"  enctype="multipart/form-data" > 
...
<?php include("./application/views/fun/actb01_funjs_v.php"); ?>
<script>
  $(function() {
