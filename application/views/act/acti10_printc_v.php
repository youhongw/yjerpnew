		  ...
		  <tr>
					...
					<tr>
					  ...
					  <td width="30%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>頁    次：</b><?php echo '1' ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
				...
				<table class="product" border=1 cellspacing=0 cellpadding=0>
					...
					<tr>					 
					  ...
					  <td align="right"><? echo $val->tb006;?><br><? echo $val->tb006disp;?></td>
					   ...
					   <td align="right"><? if ($tb072>0) {echo $tb072;}?></td>			 
					</tr>
					   <?php $rownum++;$rownum1++;$vi++;$vii++; ?>
					...
					<tr>
					  <td colspan="6" align="left">
						<b>借方合計：<?php echo '' ?></b><b>
						 　　　　　　　　　　　　　　　　　　　　貸方合計：<?php echo '' ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;稅額：<?php echo '' ?></b><b>&nbsp;&nbsp;&nbsp;&nbsp;金額合計：</b> 
					         <?php echo '續下頁..'; ?> 
					  </td>
					</tr>
			<table >
			...
			<tr>
			  ...
			  <td width="300" align="left"><b>製  單：</b></td>
						...
						<!--  <P style='page-break-after:always'></P> 空白-->
						 <?php  $vii++;$total++; ?>
						 <?php  for ($i=$vii; $i<$vaa; $i++) { ?>
					...
					<tr>
					  ...
					  <td width="30%" align="left" valign="top">
						<table class="company">
							...
							<tr>
							  <td width="600" align="left" valign="top"><b>頁    次：</b><?php echo $total; ?></td>
							  <td align="left" valign="top"></td>
							</tr>
						</table>
					  </td>
