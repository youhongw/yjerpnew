...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 明 細 分 類 帳 - 列印　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/act/actr09/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<?php
	  ...
	  if (!$this->input->post('edate')) {$edate=date("Y/m/d");}
	   ...
	   $actq03a1disp=$this->input->post('bactno');
	...
	<table class="form14">   <!-- 表格 -->
      <tr>
	    <td class="normal14y" width="12%">明細分類帳年月：</td>
	    <td class="normal14a" width="38%"><input tabIndex="1" id="bdate"  onclick="fPopCalendar(event,this,this)"  class="date-picker" onChange="dateformat_ym(this)"  onKeyPress="keyFunction()"    type="text" name="bdate"  value="<?php echo $bdate; ?>"  size="16" style="background-color:#E7EFEF" /></td>
        <td class="normal14y" width="14%">截止列印傳票日期：</td>
	   ...
	   <tr>
	    <td class="normal14z" >科目代號：</td>
	    <td class="normal14" ><input tabIndex="3" id="bactno" onKeyPress="keyFunction()" name="bactno" onchange="startactq03a1(this)"   value="<?php echo  $bactno; ?>"     type="text"  /><img id="Showactq03a1" src="<?php echo base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
        <span id="actq03a1disp"> <?php   echo $actq03a1disp; ?> </span></td>
	    <td class="start14a" ></td>
		<td class="normal14" ></td>
	<!--	 <td class="normal14a" >截止科目代號：</td>  class="date-picker"
