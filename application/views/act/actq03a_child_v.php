      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
       <table class="list">      <!-- 表格開始 -->
		 ...
		 <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		          echo anchor("act/actq03a/display1/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'科目代號');} ?>
	     
		 <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		          echo anchor("act/actq03a/display2/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'科目代號');} ?>	  
	      
		  <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		          echo anchor("act/actq03a/display3/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'科目代號');} ?>
		  
		  <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		          echo anchor("act/actq03a/display4/ma002/" . (($sort_order == 'asc' && $sort_by == 'ma002') ? 'desc' : 'asc') ,'科目代號');} ?>
		  </td>
	      <td width="16%" class="left"> 
		   <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") {
		         echo anchor("act/actq03a/display1/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'科目名稱');} ?>
           
		   <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") {
		         echo anchor("act/actq03a/display2/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'科目名稱');} ?>   
			
			<?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") {
		         echo anchor("act/actq03a/display3/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'科目名稱');} ?>  
           
		   <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") {
		         echo anchor("act/actq03a/display4/ma003/" . (($sort_order == 'asc' && $sort_by == 'ma003') ? 'desc' : 'asc') ,'科目名稱');} ?>			 
			 </td>
	     ...
	     <!--  <td class="left"></td>
		  ...
		  <div  class="button-search"></div>
			...
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter1()" /><span>篩選</span>  <?php } ?>	
             <?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter2()" /><span>篩選</span> <?php } ?>	
              <?php  if($this->uri->segment(3)=="display3" || $this->uri->segment(3)=="filter3") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter3()" /><span>篩選</span> <?php } ?>				
	         <?php  if($this->uri->segment(3)=="display4" || $this->uri->segment(3)=="filter4") { ?>
			<input type="text" id="filter_ma002" name="filter_ma002" value="" onblur="filter4()" /><span>篩選</span> <?php } ?>	
		  </td>   
		  ...
		  <div id="search">
		   <div class="button-search"></div>
		    <?php  if($this->uri->segment(3)=="display1" || $this->uri->segment(3)=="filter1") { ?>
			<input type="text" id="filter_ma003" name="filter_ma003" value="" onblur="filter1()" /><span>篩選</span> <?php } ?>	
			<?php  if($this->uri->segment(3)=="display2" || $this->uri->segment(3)=="filter2") { ?>
...
function filter1() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/act/actq03a/filter1/ma001/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/act/actq03a/filter1/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/act/actq03a/display1/';location = url;
...
function filter2() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/act/actq03a/filter2/ma001/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/act/actq03a/filter2/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/act/actq03a/display2/';location = url;
...
function filter3() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/act/actq03a/filter3/ma001/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/act/actq03a/filter3/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/act/actq03a/display3/';location = url;
...
function filter4() {
	...
	if (filter_ma002) {
		...
		url = '<?php echo base_url()?>index.php/act/actq03a/filter4/ma001/asc/' + filter_ma002 ;
	} 
	
	var filter_ma003 = $('input[name=\'filter_ma003\']').attr('value');
	if (filter_ma003) {
		url = '<?php echo base_url()?>index.php/act/actq03a/filter4/ma003/asc/' + encodeURIComponent(filter_ma003);
	}
	
    if ( !filter_ma002  && !filter_ma003 ) {         
	   url = '<?php echo base_url()?>index.php/act/actq03a/display4/';location = url;
