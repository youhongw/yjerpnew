	...
	<?php $numrow1 =0;$vmb1004=0;$vmb1005=0;$vmb1006=0;$vmb1007=0;$vmb1009=0;$vmb1010=0;  ?>
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	   ...
	   <?php foreach($results as $row ) : ?>
		...
		<td width="8%" align="right"><?php echo round($row->mb1010);?></td>
		 ...
		 <?php $pagenum +=1;$pagenum1=$pagenum; ?> 
		   ...
		   <?php if($pagenum>=$paperal) {?> <?php $page=$page+1; } ?>
		   <?php //if($paper9=="1")  { $br="<br>"."<br>";} else { $br="";}  ?>
		   <?php //if($paper9!="1" and $page>=4  )  { $br=$br."<br>";}  ?>
		
		   
		    <?php if($pagenum>=$paperal) {?> <P STYLE="page-break-after:always; text-align:left"> </p>
	...
	<!--</table> -->
	 ...
	 <table >
			<tr>
			  <td width="30%" align="right"><b><?php echo '合  計:'; ?></b></td>
