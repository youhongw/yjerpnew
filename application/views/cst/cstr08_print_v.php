...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 製令成本明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cst/cstr08/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="start14a" >起始實際完工日：</td>
	    <td class="normal14a" ><input tabIndex="1" id="dateo1" ondblclick="scwShow(this,event);" onChange="dateformat_ym(this);" onKeyPress="keyFunction()" type="text" name="dateo1"  value="<?php echo $dateo1; ?>"  size="20" style="background-color:#E7EFEF" /></td>
      
	  </tr>
	  <tr>
	    <td class="start14a" >截止實際完工日：</td>
	    <td class="normal14a"><input tabIndex="1" id="datec1" ondblclick="scwShow(this,event);" onChange="dateformat_ym(this);" onKeyPress="keyFunction()" type="text" name="datec1"  value="<?php echo $datec1; ?>"  size="20" style="background-color:#E7EFEF" /></td>
       </tr>
