...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 線別成本建立作業 - 設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/cst/csti03/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MC001'> MC001 線別成本代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MC002'> MC002 線別成本名稱 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MC003'> MC003 資產科目 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MC004'> MC004 累計折舊科目 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MC005'> MC005 折舊科目 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MC006'> MC006 折舊方法 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='MC007'> MC007 耐用月數 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='MC001'> MC001 線別成本代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MC002'> MC002 線別成本名稱 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MC003'> MC003 資產科目 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MC004'> MC004 累計折舊科目 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MC005'> MC005 折舊科目 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='MC006'> MC006 折舊方法 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='MC007'> MC007 耐用月數 </option>
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
    {
	  url = '<?php echo base_url()?>index.php/cst/csti03/findsql/' + find005.value +'/'+ find007.value ; 
      location = url;
    }
