...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 生產成本計算作業 - 計算</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/cst/cstb03/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	   ...
	   <tr>
	    <td class="start14a" width="15%" >選擇計算年月：</td>
	    <td class="normal14a" width="85%" ><input tabIndex="1" id="dateo" ondblclick="scwShow(this,event);" onChange="dateformat_ym(this);" onKeyPress="keyFunction()" type="text" name="dateo"  value="<?php echo $dateo; ?>"  size="20" style="background-color:#E7EFEF" /></td>
      
	  </tr>
	   <tr>
	  <td class="normal14" >工資率及製費分攤率：</td>
		<td class="normal14">
			   <input type="radio" name="tc001o" <?php if (isset($tc001o) && $tc001o=="1") echo "checked";?> value="1" />標準  &nbsp;&nbsp;&nbsp; 
               <input type="radio" name="tc001o" <?php if (isset($tc001o) && $tc001o=="2") echo "checked";?> value="2" />實際
        </td>
