 <?php if (!$results)  { ?>
        <script> alert("無資料可列印!"); url = '<?=base_url() ?>index.php/cst/cstr04/printdetail';location = url; </script> 
  <?php exit;} ?>
<!--   頁直行數  -->
...
foreach($results as $key=>$value){
	...
	//$pur_date = substr($value->me003,0,4).'/'.substr($value->me003,4,2).'/'.substr($value->me003,6,2);
}
$totle_page = $page;
...
?>       
	...
	<table class="list">     <!-- 列明細 2 判斷 31, 3 判斷 32 4 判斷 32, 31-->
	      ...
	      <tr>
	    <td width="15%" align="center"><?php echo  $val->me001;?></td>
		<td width="15%" align="center"><?php echo  $val->me002;?></td>		
		<td width="14%" align="right"><?php echo  $val->me003;?></td>		
        <td width="14%" align="right"><?php echo  $val->me004;?></td>
        <td width="14%" align="right"><?php echo  $val->me005;?></td>		
        <td width="14%" align="right"><?php echo  $val->me006;?></td> 
        <td width="14%" align="right"><?php echo  $val->me007;?></td>	
        </tr>		
		 <?php $rownum++;$rownum1++;$vqty=$vqty+$val->me005;$vnoqty=$vnoqty+$val->me006;$vamt=$vamt+$val->me005; ?>
