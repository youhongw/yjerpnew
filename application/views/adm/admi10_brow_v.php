<div class="box2">  <!-- div-1 -->
      ...
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 使用者資料建立作業 - 瀏覽　　　</h1>
	   ...
	   <div style="float:left; "> 
	      <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	         <a onclick="location = '<?php echo base_url()?>index.php/adm/admi10/clear_sql_term'"  style="float:left" accesskey="a" class="button"><span>重新整理 a </span><img height="12" width="12" src="<?php echo base_url()?>assets/image/delete2.png" /></a>	
          <?PHP } ?>
	      <?PHP if (substr($this->session->userdata('sysmg006'),0,1)=='Y') { ?>
	         <a onclick="location = '<?php echo base_url()?>index.php/adm/admi10/addform'"  style="float:left" accesskey="i" class="button"><span>新增 i </span><img src="<?php echo base_url()?>assets/image/png/add.png" /></a>
	      <?PHP } ?>
          ...
          <?PHP } ?>
	      <?PHP if (substr($this->session->userdata('sysmg006'),1,1)=='Y') { ?>
	         <a onclick="location = '<?php echo base_url()?>index.php/adm/admi10/findform'"  style="float:left" accesskey="k" class="button"><span>查詢 k </span><img src="<?php echo base_url()?>assets/image/png/find.png" /></a>	
          <?PHP } ?>
	      ...
	      <?PHP if (substr($this->session->userdata('sysmg006'),10999,1)=='Y') { ?>
	        <a onclick="location = '<?php echo base_url()?>index.php/adm/admi10/exceldetail'"  style="float:left"  accesskey="l" class="button"><span>EXCEL檔 l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></a>  
	      <?PHP } ?>	   
	...
	<?php 
	  $title_array = array(
		'rowid' => array('sort_name'=>"mf001",'name'=>"序號",'width'=>"4%",'align'=>"left",'use'=>"disable"),
		'mf001' => array('sort_name'=>"mf001",'name'=>"使用者代號",'width'=>"10%",'align'=>"left"),
		'mf002' => array('sort_name'=>"mf002",'name'=>"使用者名稱",'width'=>"10%",'align'=>"left"),
		'mf003' => array('sort_name'=>"mf003",'name'=>"使用者密碼",'width'=>"10%",'align'=>"left"),
		'mf004' => array('sort_name'=>"mf004",'name'=>"群組代號",'width'=>"10%",'align'=>"left"),
		'mf005' => array('sort_name'=>"mf005",'name'=>"超級使用者",'width'=>"10%",'align'=>"left"),
		'mf007' => array('sort_name'=>"mf007",'name'=>"部門代號",'width'=>"10%",'align'=>"left"),
		'a.create_date' => array('sort_name'=>"a.create_date",'name'=>"建立日期",'width'=>"10%",'align'=>"left"),
  ...
  <div class="content">  <!-- div-2 -->
            ...
            <tr>                  <!-- 表格表頭 attribute和property都可以翻译为属性，为了以示区别，通常把这两个单词翻译为属性与特性-->
	          ...
	          <?php
			    foreach($title_array as $key => $val){
				  ...
				  echo anchor("adm/admi10/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." asc",$str);
				
				  $str = "<img src='".base_url()."assets/image/desc.png' />";
				  echo anchor("adm/admi10/display_search/".$this->uri->segment(4,0)."/order?val=".$val['sort_name']." desc",$str);
				  echo "</td>";
			    }
		     ?>
            </tr>
	...
	<?php 
	  $filter_array = array(
		...
		'mf001' => array('filter_name'=>"mf001",'name'=>"使用者代號",'size'=>"10",'align'=>"left"),
		'mf002' => array('filter_name'=>"mf002",'name'=>"使用者名稱",'size'=>"10",'align'=>"left"),
		'mf003' => array('filter_name'=>"mf003",'name'=>"使用者密碼",'size'=>"10",'align'=>"left"),
		'mf004' => array('filter_name'=>"mf004",'name'=>"群組代號",'size'=>"10",'align'=>"left"),
		'mf005' => array('filter_name'=>"mf005",'name'=>"超級使用者",'size'=>"10",'align'=>"left"),
		'mf007' => array('filter_name'=>"mf007",'name'=>"部門代號",'size'=>"10",'align'=>"left"),
    ...
    ?>  
        ...
        <tr>
          ...
          <td class="left"><?php echo  $row->mf004.':'.$row->mf004disp;?></td>		
          <td class="left"><?php echo  $row->mf005;?></td>
          <td class="left"><?php echo  $row->mf007.':'.$row->mf007disp;?></td>			  
...
function filter() {
	...
	url = '<?php echo base_url() ?>index.php/adm/admi10/display_search/0/and_where?key=' + encodeURIComponent(key) + 
...
function filtera() {
	...
	url = '<?php echo base_url() ?>index.php/adm/admi10/display_search/0/or_where?key=' + encodeURIComponent(key) + 
	'&val=' + encodeURIComponent(val);
	location = url;
}
</script>