...
<body >
	...
	<table class="list">
		...
		<tr>
		  <td width="60" align="center"><?php echo  $row->mf001;?></td>
		  <td width="100" align="center"><?php echo  $row->mf002;?></td>
		  <td align="left"><?php echo  $row->mf003;?></td>
		  <td align="left"><?php echo  $row->mf004;?></td>
		  <td align="left"><?php echo  $row->mf005;?></td>
		  <td align="left"><?php echo  $row->mf007;?></td>
