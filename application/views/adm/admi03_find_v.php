...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" />檔案建立作業 - 設定查詢條件　　　</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/adm/admi03/findsql" method="post" enctype="multipart/form-data" >
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();"  type='submit' accesskey="k" name='submit'  class="button" value='&nbsp;確定F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" onKeyPress="keyFunction()" id='cancel' name='cancel' href="<?php echo site_url('adm/admi03/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='a.MC001'> MC001 檔案代號 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='a.MC002'> MC002 檔案名稱 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='a.MC003'> MC003 類型 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='a.MC004'> MC004 系統代號 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='a.MC005'> MC005 備註 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
           	<option <?php if($find006 == '1') echo 'selected="selected"';?> value='a.MC001'> MC001 檔案代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='a.MC002'> MC002 檔案名稱 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='a.MC003'> MC003 類型 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='a.MC004'> MC004 系統代號 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='a.MC005'> MC005 加工廠商 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='a.CREATE_DATE'> CREATE_DATE 建立日期 </option>
	    </select>&nbsp;&nbsp;&nbsp;&nbsp;
