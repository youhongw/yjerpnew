...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 檔案資料建立作業 - 修改　　　</h1>
      <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#mc001').focus();" type='submit' accesskey="s" name='submit' class="button" onKeyPress="keyFunction()" onclick="" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	 ...
	 <?php if(isset($prev)){ 
		...
		?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('adm/admi03/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
		<?php } ?>
		<?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
		?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('adm/admi03/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
		<?php } ?>
	</div>
	</div>
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/adm/admi03/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="mc001"    onKeyPress="keyFunction()"   name="mc001" onchange=""  value="<?php echo $mc001; ?>" size="12" type="text" readonly="readonly" style="background-color:#F0F0F0" required />
	  ...
	  <tr>	    
        ...
        <td class="normal14" >
		<input   tabIndex="4" id="admi01" onKeyPress="keyFunction()" onchange="check_admi01(this)" name="admi01" value="<?php echo $mc004; ?>"  type="text" />
    ...
    <!--   明細0  --> <?php $current_product_count = 0; //依照資料庫紀錄的明細先列一遍 原0會由1加才改-1?>
...
<form action="<?php echo base_url()?>index.php/adm/admi03/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
