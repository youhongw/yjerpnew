...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 還原會計傳票作業 - 還原　　　</h1>
    <div style="float:left;padding-top: 5px; ">
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#td004c').focus();" type='submit' onclick="return doit();"  tabIndex="98" accesskey="c" name='submit'  class="button"   target="_new" value='&nbsp;計 算F8&nbsp;'><span>計 算Alt+c</span><img src="<?php echo base_url()?>assets/image/png/cal.png" /></button>&nbsp;&nbsp; 
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsb22/batcha"  method="post"  enctype="multipart/form-data" > 
	<!--<div id="htabs" class="htabs14"><span>列印項目-應付憑單自動結帳</span></div>-->
	<div id="tab-general"> <!-- div-6 -->
	<?php
  	  $td001c=$this->input->post('td001c');
	  if(!isset($td002c)) { $td002c=''; } else {$td002c=$this->input->post('td002c');}
	...
	<table class="form14">   <!-- 表格 -->
	  <tr>
	    <td class="start14a" width="10%" >還原方式：</td>
        <td class="normal14a" width="90%"><input type="radio" name="td004c" <?php if (isset($td004c) && $td004c=="1") echo "checked";?> value="1" />作廢  &nbsp;&nbsp;&nbsp; 
               <input type="radio" name="td004c" <?php if (isset($td004c) && $td004c=="2") echo "checked";?> value="2" />刪除
        </td>
		</tr> 
		<tr>
	    <td class="start14a"  >傳票單別：</td>
        <td class="normal14a" ><input tabIndex="3" id="td001c"    onKeyPress="keyFunction()"    type="text" name="td001c"  value="<?php echo $td001c; ?>"  size="16"  />
		</td></tr> 
       <tr>
	    <td class="start14a"  >傳票號碼：</td>
...
<?php // include_once("./application/views/fun/ajsb22_funjs_v.php"); ?>
<script>
  $(function() {
