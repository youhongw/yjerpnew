...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(庫存異動單) - 查看　　　</h1>
	<div style="float:left;padding-top: 5px; ">
	<a accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi02/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsi02/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<?php foreach($result as $row) { ?>
            <?php   $mb001=$row->mb001;?>
          <?php   $invq04a=$row->mb002;?>
		  <?php   $invq04adisp=$row->mb002disp;?>
	...
	<table class="form14">
	    ...
	    <tr>
	    <td class="normal14y"  width="12%" ><span class="required">庫存異動單性質代號：</span> </td>
	  ...
	  <tr>
	    <td class="normal14z" >庫存異動單單別：</td>
		<td class="normal14"  ><input tabIndex="1" id="invq04a"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startinvq04a(this)"  name="invq04a" value="<?php echo strtoupper($invq04a); ?>"  type="text"  disabled="disabled" />
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="1" id="mb003"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startactq02a(this)"  name="actq02a" value="<?php echo strtoupper($actq02a); ?>"  type="text"  disabled="disabled" />
	 ...
	 <tr>
	  ...
	  <tr>
	    <td  class="normal14z" >區分部門：</td>
        <td  class="normal14" ><input type="hidden" name="mb005" value="N" />
		<input tabIndex="12" type="checkbox"  id="mb005" onKeyPress="keyFunction()"   name="mb005" <?php if($mb005 == 'Y' ) echo 'checked'; ?>  <?php if($mb005 !== 'Y' ) echo 'check'; ?> value="Y" size="1"  disabled="disabled"  /></td>
	  </tr>	
	   <tr>
	  ...
	  <tr>
	    <td class="normal14z" >存貨會計科目：</td>		
        <td class="normal14"  >
			<input tabIndex="22" id="acti03" onKeyPress="keyFunction()" name="acti03" onblur="check_acti03(this);"  value="<?php echo $mb006; ?>"  type="text"   size="12"  disabled="disabled" />
	  ...
	  <tr>
	    <td class="normal14z" >對方科目借方：</td>
        <td class="normal14"  >
			<input tabIndex="23" id="acti03a" onKeyPress="keyFunction()" name="acti03a" onblur="check_acti03a(this);"  value="<?php echo $mb007; ?>"  type="text"   size="12"  disabled="disabled"/>
	  ...
	  <tr>
	    <td class="normal14z" >對方科目貸方：</td>
        <td class="normal14"  >
			<input tabIndex="23" id="acti03b" onKeyPress="keyFunction()" name="acti03b" onblur="check_acti03b(this);"  value="<?php echo $mb012; ?>"  type="text"   size="12"  disabled="disabled"/>
	  ...
	  <tr>
        ...
        <td class="normal14" ><input type="text"  tabIndex="1" id="mb020" onKeyPress="keyFunction()"  name="mb020" value="<?php echo $mb020; ?>"  readonly="readonly"  disabled="disabled" />
	        <span id="keydisp" ></span></td>
