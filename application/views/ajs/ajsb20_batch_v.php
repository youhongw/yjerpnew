...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 拋轉會計傳票作業 - 產生　　　</h1>
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsb20/batcha"  method="post"  enctype="multipart/form-data" > 
...
<?php // include_once("./application/views/fun/ajsb20_funjs_v.php"); ?>
<script>
  $(function() {
