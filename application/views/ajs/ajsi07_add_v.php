...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(結帳單) - 新增　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();" type='submit' accesskey="s" name='submit' class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi07/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ajs/ajsi07/addsave" >	
	<div id="tab-general">  <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mb001='61';
	  if(!isset($acrq01a61)) { $acrq01a61=$this->input->post('acrq01a61'); }
	  if(!isset($acrq0163disp)) { $acrq01a61disp=$this->input->post('acrq01a61'); }
	  ...
	  if(!isset($acti03bdisp)) { $acti03bdisp=$this->input->post('acti03b'); }
	   ...
	   if(!isset($acti03c)) { $acti03c=$this->input->post('acti03c'); }
	  if(!isset($acti03cdisp)) { $acti03cdisp=$this->input->post('acti03c'); }
	  ...
	  $mb013disp=$this->input->post('mb013disp');
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="14%" ><span class="required">結帳單性質代號：</span> </td>
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="1" id="acrq01a61"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startacrq01a61(this)"  name="acrq01a61" value="<?php echo strtoupper($acrq01a61); ?>"  type="text" required />
		<a href="javascript:;"><img id="Showacrq01a61" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目賖銷：</td>		
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目差額：</td>
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方會計科目收入：</td>
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方會計科目稅額：</td>
        <td class="normal14"  >
	...
	<!--  <tr>
	    <td class="normal14" >貸方會計科目差額：</td>
        <td class="normal14"  >
			<input tabIndex="23" id="acti03b" onKeyPress="keyFunction()" name="acti03b" onblur="check_acti03b(this);"  value="<?php echo $mb013; ?>"  type="text"   size="12" />
			<a href="javascript:;"><img id="Showacti03bdisp" src="<?php echo base_url()?>assets/image/png/actno.png" alt="" align="top"/></a>
			<span id="acti03bdisp"> <?php echo $mb012disp; ?> </span>
		</td>
	  </tr>	 -->
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
 ...
 <?php  include_once("./application/views/fun/ajsi07_funjs_v.php"); ?> 
