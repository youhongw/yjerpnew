...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(應付憑單) - 新增　　　</h1>
	...
	<button  style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();" type='submit' accesskey="s" name='submit' class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi11/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ajs/ajsi11/addsave" >	
	<div id="tab-general">  <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mb001='71';
	  if(!isset($acpq01a71)) { $acpq01a71=$this->input->post('acpq01a71'); }
	  if(!isset($acrq0163disp)) { $acpq01a71disp=$this->input->post('acpq01a71'); }
	...
	<table class="form14">     <!-- 表格 -->
	  <tr>
	    <td class="normal14y"  width="12%" ><span class="required">應付憑單性質代號：</span> </td>
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="1" id="acpq01a71"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startacpq01a71(this)"  name="acpq01a71" value="<?php echo strtoupper($acpq01a71); ?>"  type="text" required />
		<a href="javascript:;"><img id="Showacpq01a71" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目貨款：</td>		
        <td class="normal14"  >
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
 ...
 <?php  include_once("./application/views/fun/ajsi11_funjs_v.php"); ?> 
