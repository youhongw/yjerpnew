...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(銷退單) - 查看　　　</h1>
	<div style="float:left;padding-top: 5px; ">
	<a accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi05/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsi05/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<?php foreach($result as $row) { ?>
            <?php   $mb001=$row->mb001;?>
          <?php   $copq03a24=$row->mb002;?>
		  <?php   $copq03a24disp=$row->mb002disp;?>
	...
	<table class="form14">
	    ...
	    <tr>
	    <td class="normal14y"  width="14%" ><span class="required">銷退單性質代號：</span> </td>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目折讓：</td>
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方會計科目應收：</td>
        <td class="normal14"  >
