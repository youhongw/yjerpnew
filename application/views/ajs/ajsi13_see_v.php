...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(領料單) - 查看　　　</h1>
	<div style="float:left;padding-top: 5px; ">
	 <a accesskey="x" tabIndex="9" id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi13/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	</div>
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsi13/display"  method="post" enctype="multipart/form-data" >
    </div>
	...
	<table class="form14">
	    ...
	    <tr>
	    <td class="normal14y"  width="14%" ><span class="required">領料單性質代號：</span> </td>
	  ...
	  <tr>
	    <td class="normal14z" >領料單單別：</td>
		<td class="normal14"  ><input tabIndex="1" id="tc001"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="starttc001(this)"  name="tc001" value="<?php echo strtoupper($tc001); ?>"  type="text" required />
		<a href="javascript:;"><img id="Showtc001disp" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="tc001disp"> <?php    echo $tc001disp; ?> </span></td>
	  </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目在製：</td>		
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >借方會計科目製費：</td>
        <td class="normal14"  >
...
<?php  include_once("./application/views/fun/ajsi13_funjs_v.php"); ?> 
