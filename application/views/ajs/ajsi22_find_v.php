...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(營業日報成本) - -設定查詢條件</h1>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/ajs/ajsi22/findsql" method="post" enctype="multipart/form-data" >
    </div>
   ...
   <!--<div id="htabs" class="htabs14"><span>進階資料-設定查詢條件</span></div>-->
	...
	<table class="form14"> <!-- 表格 -->
      <tr>
	    <td class="start14a" width="18">
	       <select name="find001" id="find001" tabIndex="1" >
             <option <?php if($find001 == '1') echo 'selected="selected"';?> value='mb001'> mb001 營業日報成本性質代號 </option>                                                                        
		     <option <?php if($find001 == '2') echo 'selected="selected"';?> value='mb002'> mb002 營業日報成本單別 </option>
	  ...
	  <tr>
	    <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	      <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='mb001'> mb001 營業日報成本性質代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='mb002'> mb002 營業日報成本單別 </option>
	  ...
	  <div class="buttons">
	    ...
	    <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi22/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
function trim(strvalue) {
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>/index.php/ajs/ajsi22/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>