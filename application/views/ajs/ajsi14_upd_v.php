...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 --> 
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(退料單) - 修改　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();"  type='submit'  accesskey="s"  name="submit"  class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	   <a  accesskey="x"  onKeyPress="keyFunction()" id="cancel" name="cancel" href="<?php echo site_url('ajs/ajsi14/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 --> 
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsi14/updsave" method="post" enctype="multipart/form-data" >
	<!--<div id="htabs" class="htabs14"><span>編輯項目-修改</span></div>--> 
	<div id="tab-general">  <!-- div-6 --> 
	<?php  foreach($result as $row) { ?>
          <?php   $mb001=$row->mb001;?>
          <?php   $puri04=$row->mb002;?>
		  <?php   $puri04disp=$row->mb002disp;?>
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14y"  width="14%" ><span class="required">退料單性質代號：</span> </td>
	  ...
	  <tr>
	    <td class="normal14z" >退料單單別：</td>
		<td class="normal14"  ><input tabIndex="1" id="puri04"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startpuri04(this)"  name="puri04" value="<?php echo strtoupper($puri04); ?>"  type="text" required />
		<a href="javascript:;"><img id="Showpuri04" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
		 <span id="puri04disp"> <?php    echo $puri04disp; ?> </span></td>
	  </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >貸方會計科目在製：</td>
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方會計科目製費：</td>
        <td class="normal14"  >
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php  } ?>
 ...
 <?php  include_once("./application/views/fun/ajsi14_funjs_v.php"); ?> 
