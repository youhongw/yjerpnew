...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 底稿來源單據表 - 列印明細表　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#tc001o').focus();" type='submit' tabIndex="98" accesskey="p" name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+p</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
	      <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('main/index/161'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	    
	</div>
	</div>
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsr02/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14y" width="12%">起底稿批號：</td>
	    <td class="normal14a" width="88%"><input tabIndex="1" id="tc001o"   onKeyPress="keyFunction()" type="text" name="tc001o"  value="<?php echo $tc001o; ?>"  size="20"  /></td>
      
	  </tr>
	   <tr>
	    <td class="normal14z" >迄底稿批號：</td>
	  ...
	  <tr>
	    ...
	    <tr>
	    <td class="normal14z" >選擇排序：</td>
	    <td class="normal14a"><input type="radio" name="tc002o" <?php if (isset($tc002o) && $tc002o=="1") echo "checked";?> value="1" />存貨庫  &nbsp;&nbsp;&nbsp; 
               <input type="radio" name="tc002o" <?php if (isset($tc002o) && $tc002o=="2") echo "checked";?> value="2" />非存貨庫
        </td>
	  </tr>
	   <tr>
	    <td class="normal14z" >抛轉狀態：</td>
	    <td class="normal14a"><select id="tc002c" onKeyPress="keyFunction()" name="tc002c"  tabIndex="31">
            <option <?php if($tc002c == '0') echo 'selected="selected"';?> value='0'>全部</option>                                                                        
		    <option <?php if($tc002c == '1') echo 'selected="selected"';?> value='1'>已抛轉</option>
            <option <?php if($tc002c == '2') echo 'selected="selected"';?> value='2'>未抛轉</option>
		  </select>
		</td>
	  </tr>
	   <tr>
