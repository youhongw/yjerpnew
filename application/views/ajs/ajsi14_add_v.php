...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(退料單) - 新增　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();"  type='submit' accesskey="s" name='submit' class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi14/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ajs/ajsi14/addsave" >	
	<div id="tab-general">  <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mb001='56';
	  if(!isset($puri04)) { $puri04=$this->input->post('puri04'); }
	  if(!isset($puri04disp)) { $puri04disp=$this->input->post('puri04'); }
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="1" id="puri04" name="puri04" onKeyPress="keyFunction()"  value="<?php echo $puri04 ?>" onChange="check_puri04(this);check_title_no();" type="text" required />
...
<?php  include_once("./application/views/fun/ajsi14_funjs_v.php"); ?> 
 <?php // include_once("./application/views/funnew/moci04_funmjs_v.php"); ?>  <!-- 退料 -->
