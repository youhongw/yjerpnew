...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 --> 
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(託外退費用) - 修改　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();" type='submit'  accesskey="s"  name="submit"  class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	   <a  accesskey="x"  onKeyPress="keyFunction()" id="cancel" name="cancel" href="<?php echo site_url('ajs/ajsi18/'.$this->session->userdata('search')); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 --> 
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsi18/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14">  <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14y"  width="14%" ><span class="required">託外退費用性質代號：</span> </td>
	  ...
	  <tr>
		...
		<a href="javascript:;"><img id="Showpuri04disp" src="<?=base_url()?>assets/image/png/invoice.png" alt="" align="top"/></a>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td class="normal14z" >借方科目(應付帳款)：</td>		
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方科目(加工費用)：</td>
        <td class="normal14"  >
	  ...
	  <tr>
	    <td class="normal14z" >貸方科目(進項稅額)：</td>
        <td class="normal14"  >
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php  } ?>
 ...
 <?php  include_once("./application/views/fun/ajsi18_funjs_v.php"); ?> 
