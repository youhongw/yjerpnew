...
<div id="content">    <!-- div-3 -->
  <div class="box">   <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(收款單) - 新增　　　</h1>
	...
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#mb001').focus();"  type='submit' accesskey="s" name='submit' class="button" value='&nbsp;儲存F8&nbsp;'><span>儲 存Alt+s</span><img src="<?php echo base_url()?>assets/image/png/save.png" /></button>&nbsp;&nbsp;
	  <a  accesskey="x"   id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi08/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	
	</div>
	</div>
    <div class="content">  <!-- div-5 -->
	<form   class="cmxform" id="commentForm"  name="form"  method="post" enctype="multipart/form-data"  action="<?php echo base_url()?>index.php/ajs/ajsi08/addsave" >	
	<div id="tab-general">  <!-- div-6 -->
	<?php
	  $date=date("Ymd");
	  $mb001='63';
	  if(!isset($acrq01a63)) { $acrq01a63=$this->input->post('acrq01a63'); }
	  if(!isset($acrq0163disp)) { $acrq01a63disp=$this->input->post('acrq01a63'); }
	...
	<table class="form14">     <!-- 表格 -->
	  ...
	  <tr>
		...
		<td class="normal14"  ><input tabIndex="1" id="mb002"    onKeyPress="keyFunction()" onfocus="selappr()" onChange="startacrq01a63(this)"  name="acrq01a63" value="<?php echo strtoupper($acrq01a63); ?>"  type="text" required />
...
'◎操作說明:[ 欄位名稱紅色代表必需輸入欄位,按Tab鍵或Enter鍵跳下一個欄位,按Shift+Tab鍵跳上一個欄位,Tab鍵停留在有選項欄位按上下鍵可選擇資料. ] ' ?> </div>  <?php } ?>
 ...
 <?php  include_once("./application/views/fun/ajsi08_funjs_v.php"); ?> 
