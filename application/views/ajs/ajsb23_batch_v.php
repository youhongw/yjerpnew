...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 --><span>　　　　　　</span>
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 自動分錄自動清除 - 作業　　　</h1>
    <div style="float:left;padding-top: 5px; ">
	<button style= "cursor:pointer" form="commentForm" onfocus="$('#td002c').focus();" type='submit' onclick="return doit();"  tabIndex="98" accesskey="c" name='submit'  class="button"   target="_new" value='&nbsp;計 算F8&nbsp;'><span>計 算Alt+c</span><img src="<?php echo base_url()?>assets/image/png/cal.png" /></button>&nbsp;&nbsp; 
	...
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/ajs/ajsb23/batcha"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
       ...
       <tr>
	    <td class="start14a" width="10%" >起底稿編號：</td>
        <td class="normal14a" width="90%" ><input tabIndex="1" id="td002c"   onKeyPress="keyFunction()"    type="text" name="td002c"  value="<?php echo $td002c; ?>"    /></td>
	  </tr> 
	    <tr>
	    <td class="start14a"  >迄底稿編號：</td>
...
<?php // include_once("./application/views/fun/ajsb23_funjs_v.php"); ?>
<script>
  $(function() {
