...
<div id="content">  <!-- div-3 -->
 <div class="box">  <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 分錄性質設定(成本開帳調整單)-設定查詢條件　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" type='submit' tabIndex="98" accesskey="k" name='submit'  class="button" value='&nbsp;查詢F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi24/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/ajs/ajsi24/findsql" method="post" enctype="multipart/form-data" >
    </div>
   ...
   <!--<div id="htabs" class="htabs14"><span>進階資料-設定查詢條件</span></div>-->
	...
	<table class="form14"> <!-- 表格 -->
      <tr>
	    <td class="start14a" width="18">
	       <select name="find001" id="find001" tabIndex="1" >
             <option <?php if($find001 == '1') echo 'selected="selected"';?> value='mb001'> mb001 成本開帳調整單性質代號 </option>                                                                        
		     <option <?php if($find001 == '2') echo 'selected="selected"';?> value='mb002'> mb002 成本開帳調整單單別 </option>
             <option <?php if($find001 == '3') echo 'selected="selected"';?> value='mb003'> mb003 傳票單別 </option>
			 <option <?php if($find001 == '4') echo 'selected="selected"';?> value='mb004'> mb004 底稿開立方式 </option>
			 <option <?php if($find001 == '5') echo 'selected="selected"';?> value='mb021'> mb021 傳同單號科目彙總 </option>
			 <option <?php if($find001 == '6') echo 'selected="selected"';?> value='mb018'> mb018 借方摘要來源 </option>
			 <option <?php if($find001 == '7') echo 'selected="selected"';?> value='mb022'> mb022 貸方摘要來源 </option>
		     <option <?php if($find001 == '8') echo 'selected="selected"';?> value='CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <tr>
	    <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	      <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='mb001'> mb001 成本開帳調整單性質代號 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='mb002'> mb002 成本開帳調整單單別 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='mb003'> mb003 傳票單別 </option>
			<option <?php if($find006 == '4') echo 'selected="selected"';?> value='mb004'> mb004 底稿開立方式 </option>
            <option <?php if($find006 == '5') echo 'selected="selected"';?> value='mb021'> mb021 傳同單號科目彙總 </option
			<option <?php if($find006 == '6') echo 'selected="selected"';?> value='mb018'> mb018 借方摘要來源 </option>
            <option <?php if($find006 == '7') echo 'selected="selected"';?> value='mb022'> mb022 貸方摘要來源 </option>
		    <option <?php if($find006 == '8') echo 'selected="selected"';?> value='CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <div class="buttons">
	    <button  type='submit' tabIndex="98" accesskey="k" name='submit'  class="button" value='&nbsp;查詢F8&nbsp;'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('ajs/ajsi24/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>
...
function trim(strvalue) {
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>/index.php/ajs/ajsi24/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>