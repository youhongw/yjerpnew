...
<div id="content"> <!-- div-3 --> 
  <div class="box"> <!-- div-4 -->
	...
	<?php       
	  ...
	  if(!isset($mc007)) { $mc007= '0';  }
	  if(!isset($mc008)) { $mc008= '0';  }
	  if(!isset($mc009)) { $mc009= 'N';  }
	  ...
	  if(!isset($mc013)) { $mc013=$this->input->post('mc013'); }
	   ...
	   if(!isset($mc014)) { $mc014=$this->input->post('mc014'); }
	  if(!isset($mc015)) { $mc015=$this->input->post('mc015'); }
	   if(!isset($mc016)) { $mc016=$this->input->post('mc016'); }
	  if(!isset($mc017)) { $mc017=$this->input->post('mc017'); }
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="start14a"  width="9%"><span class="required">用戶代號：</span></td>   <!--onchange="startcopi03(this);check_title_no();"    -->
        <td class="normal14a"  width="25%"><input tabIndex="4" id="copi01" onKeyPress="keyFunction()"  onchange="check_copi01(this)" name="copi01" value="<?php echo $mc001; ?>" size="12" type="text"  />
		  <a href="javascript:;"><img id="Showcopi01disp" src="<?php echo base_url()?>assets/image/png/customer.png" alt="" align="top"/></a>
          <span id="copi01disp"> <?php   echo $mc001disp; ?> </span></td>
	  ...
	  <tr>	    
        ...
        <td  class="normal14"  ><input tabIndex="2"     id="mc005" onKeyPress="keyFunction()"   name="mc005"  value="<?php echo $mc005; ?>"  size="12" type="text"  /></td>
        ...
        <td  class="normal14"  ><input tabIndex="3" type="hidden" id="mc006" onKeyPress="keyFunction()"  name="mc006" onfocus="check_title_no();" value="<?php echo $mc006; ?>" size="16"   /></td>
	  </tr>
	  
	  <tr>	    
		<td class="normal14">總冊數：</td>
        <td  class="normal14"  ><input tabIndex="2"     id="mc007" onKeyPress="keyFunction()"   name="mc007"  value="<?php echo $mc007; ?>"  size="12" type="text"   /></td>
	    <td class="normal14">累冊數：</td>
        <td  class="normal14"  ><input tabIndex="2"     id="mc008" onKeyPress="keyFunction()"   name="mc008"  value="<?php echo $mc008; ?>"  size="12" type="text"   /></td>
		<td class="normal14a">列印註記：</td>
        <td  class="normal14"  ><input tabIndex="2"     id="mc009" onKeyPress="keyFunction()"   name="mc009"  value="<?php echo $mc009; ?>"  size="12" type="text"   /></td>
	  </tr>
	...
	<!-- 合計     -->
		     <tr>
				...
				<td class="right" valign="top"><b style="color: #003A88;">　進貨-費用金額：</b></td>
				<td ><input type='text' readonly="value" name='mc011' id="mc011" size="8" value="<?php echo $mc011; ?>"  style="background-color:#F0F0F0" /></td>
				<td class="right" valign="top"><b style="color: #003A88;">　進貨-費用稅額：</b></td>
				<td ><input type='text' readonly="value" name='mc013' id="mc013" size="8" value="<?php echo $mc013; ?>"  style="background-color:#F0F0F0" /></td>
			    <td class="right" valign="top"><b style="color: #003A88;">　　固資金額：</b></td>
				<td ><input type='text' readonly="value" name='mc017' id="mc017" size="8" value="<?php echo $mc017; ?>"  style="background-color:#F0F0F0" /></td>
				<td class="right" valign="top"><b style="color: #003A88;">　　固資稅額：</b></td>
				<td ><input type='text' readonly="value" name='mc018' id="mc018" size="8" value="<?php echo $mc018; ?>"  style="background-color:#F0F0F0" /></td>
				
				
				<td class="right" valign="top"><b style="color: #003A88;">　　本冊總金額：</b></td>
				<td ><input type='text' readonly="value" name="mc016" id="mc016" size="8" value="<?php echo $mc011+$mc013+$mc017+$mc018; ?>"  style="background-color:#F0F0F0" /></td>
...
<?php  include_once("./application/views/funnew/erp_funjs_v_tax07.php"); ?>      <!-- 全域變數 -->
