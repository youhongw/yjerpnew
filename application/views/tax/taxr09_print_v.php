...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 進項稅額封面列印 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/tax/taxr09/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14" >輸入課稅方式：</td>
	    <td class="normal14" ><select id="tc001o" onKeyPress="keyFunction()" name="tc001o"  tabIndex="4">
            <option <?php if($tc001o == '1') echo 'selected="selected"';?> value='1'>1.自動報繳</option>                                                                        
		    <option <?php if($tc001o == '2') echo 'selected="selected"';?> value='2'>2.查定課徵</option>
		  </select></td>
	  </tr>	
