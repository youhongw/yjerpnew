...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 發票號碼設定作業 - 設定查詢條件　　　</h1>
	  <div style="float:left;padding-top: 5px; ">
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" tabIndex="7" accesskey="k" type='submit'  name='submit'  class="button" value='查詢Alt+k'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('tax/taxi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/tax/taxi02/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='MB001'> MB001 申報公司 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='MB200'> MB200 申報年月 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='MB204'> MB204 發票起日 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='MB205'> MB205 發票迄日 </option>
		    <option <?php if($find001 == '5') echo 'selected="selected"';?> value='MB206'> MB206 發票字軌 </option>
		    <option <?php if($find001 == '6') echo 'selected="selected"';?> value='MB207'> MB207 發票號碼起 </option>
			<option <?php if($find001 == '7') echo 'selected="selected"';?> value='MB208'> MB208 發票號碼迄 </option>
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='MB001'> MB001 申報公司 </option>                                                                        
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='MB200'> MB200 申報年月 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='MB204'> MB204 發票起日 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='MB205'> MB205 發票迄日 </option>
		    <option <?php if($find006 == '5') echo 'selected="selected"';?> value='MB206'> MB206 發票字軌 </option>
		    <option <?php if($find006 == '6') echo 'selected="selected"';?> value='MB207'> MB207 發票號碼起 </option>
			<option <?php if($find006 == '7') echo 'selected="selected"';?> value='MB208'> MB208 發票號碼迄 </option>
	...
	<tr>
	  ...
	  <!--<div class="buttons">
	    <button tabIndex="7" accesskey="k" type='submit'  name='submit'  class="button" value='查詢Alt+k'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('tax/taxi02/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  </div>-->
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/tax/taxi02/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>