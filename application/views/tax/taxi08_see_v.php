...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	  <tr>
	    <td class="start14a" width="12%"><span class="required">借款批號：</span></td>
	    ...
	    <td class="normal14a" width="12%" >合約日期： </td>  <!-- dateformat_ymd(this); -->
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
        ...
        <thead>
			...
			<?php foreach($body_data as $key => $val){
				...
				echo "<tr>";
				echo "<td class='center'><img src='".base_url()."assets/image/delete2.png' title='刪除資料' onclick='del_detail(\"".$val->to001."\",\"".$val->to002."\",\"".$current_product_count."\");' /></td>";
