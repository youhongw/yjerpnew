...
<div id="content"> <!-- div-3 --> 
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 電子發票建立作業 - 修改</h1>
    </div>
	
    <div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/tax/taxi06/updsave" method="post" enctype="multipart/form-data" >
	...
	<table class="form14"  >     <!-- 頭部表格 -->
	   <tr>
        ...
        <td class="normal14a"  width="25%"><input tabIndex="1" id="cmsi11"    onKeyPress="keyFunction()"   name="cmsi11"  onchange="check_cmsi11(this);check_title_no();"  value="<?php echo $mc200; ?>" size="12" type="text" required />
		  ...
		  <span id="cmsi11disp"> <?php    echo $mc200disp; ?> </span></td>
	  ...
	  <tr>	    
        ...
        <td class="normal14a"   ><input tabIndex="2"  ondblclick="scwShow(this,event);"   id="mc213" onKeyPress="keyFunction()"  onchange="dateformat_ymd(this);" name="mc213"  value="<?php echo $mc213; ?>"  size="12" type="text" style="background-color:#FFFFE4"  /></td>
	  ...
	  <tr>	    
        ...
        <td  class="normal14" colspan="6" ><input type="text" tabIndex="5" readonly="value"  onKeyPress="keyFunction()" id="mc215" name="mc215"   value="<?php echo $mc215; ?>"  size="72" /></td>
	  ...
	  <div style="width:100%; overflow-x: auto;  ">
        ...
        <!--  依照資料庫紀錄的明細先列一遍 原0會由1加  -->
			...
			<?php foreach($body_data as $key => $val){
				...
				echo "<tr>";
				echo "<td class='center'><img src='".base_url()."assets/image/delete2.png' title='刪除資料' onclick='del_detail(\"".$val->md001."\",\"".$val->md002."\",\"".$val->md003."\",\"".$current_product_count."\");' /></td>";
	...
	<!-- 合計     -->
	  ...
	  ?>
			<a accesskey="," tabIndex="11" id='prev' name='prev' href="<?php echo site_url('tax/taxi06/updform/'.$prev_str); ?>" class="button" ><span>上一筆Alt+<</span><img src="<?php echo base_url()?>assets/image/png/pre.png" /></a>
	  <?php } ?>
	  <?php if(isset($next)){ 
			$next_str = "";$next_ary = explode('_',$next);foreach($next_ary as $k=>$v){if($next_str){$next_str.="/";}$next_str.=$v;}
	  ?>
			<a accesskey="." tabIndex="12" id='next' name='next' href="<?php echo site_url('tax/taxi06/updform/'.$next_str); ?>" class="button" ><span>下一筆Alt+></span><img src="<?php echo base_url()?>assets/image/png/next.png" /></a>
	  <?php } ?>	
	  </div> 
	  </div> <!-- div-加 -->
    </form>  <!-- end 表單 -->
...
<form action="<?php echo base_url()?>index.php/tax/taxi06/delete_detail" method="post" enctype="multipart/form-data" id="del_form" style="display:none;">
