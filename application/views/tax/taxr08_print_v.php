...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 營業稅申報403表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/tax/taxr08/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    ...
	    <td class="normal14" ><select id="tc001o" onKeyPress="keyFunction()" name="tc001o"  tabIndex="2">
            <option <?php if($tc001o == '1') echo 'selected="selected"';?> value='1'>1.獨立申報</option>                                                                        
		    <option <?php if($tc001o == '2') echo 'selected="selected"';?> value='2'>2.各單位分別申報</option>
		  </select></td>
	   ...
	   <tr>
	    ...
	    <td class="normal14" ><select id="tc009p" onKeyPress="keyFunction()" name="tc009p"  tabIndex="4">
            <option <?php if($tc009p == '1') echo 'selected="selected"';?> value='1'>1.A4(橫式72%)</option>                                                                        
