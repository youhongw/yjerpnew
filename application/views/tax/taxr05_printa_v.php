...
<body onLoad="window.print()">
        ...
        <table class="store1"> <!-- 第1行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,0,1) ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,1,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,2,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,3,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,4,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,5,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,6,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;"  width="3%" align="center" ><?php echo substr($row->mg003,7,1) ?></td>
        ...
        <table class="store1"> <!-- 第2行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;margin-right:1px;" width="23%" align="left" ><?php echo $row->mg005 ?></td>
        ...
        <table class="store1"> <!-- 第3行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,0,1) ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,1,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,2,1) ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,3,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,4,1) ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,5,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,6,1) ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,7,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px" width="3%" align="center" ><?php echo substr($row->mg007,8,1) ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px ;border-bottom: 1px ;height:14px" width="38%" align="center" ><?php echo '所屬年月:'."$row->mg002".'　金額單位:新臺幣元'; ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px ;height:14px" width="5%" align="left" ><?php echo '　' ?></td>
		  ...
		  <table class="store1"> <!-- 第4行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="18%" align="left" ><?php echo $row->mg008 ?></td>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="41%" align="center" ><?php echo $row->mg009; ?></td>
		...
		<table class="store1"> <!-- 第7行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '1'.'　　　　'.$row->mg602 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '2'.'　　　　'.$row->mg601 ?></td>
		...
		<table class="store1"> <!-- 第8行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '5'.'　　　　'.$row->mg605 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '6'.'　　　　'.$row->mg606 ?></td>
		...
		<table class="store1"> <!-- 第9行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '9'.'　　　　'.$row->mg609 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '10'.'　　　　'.$row->mg610 ?></td>
		...
		<table class="store1"> <!-- 第10行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '13'.'　　　　'.$row->mg613 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '14'.'　　　　'.$row->mg614 ?></td>
		...
		<table class="store1"> <!-- 第11行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '17'.'　　　　'.$row->mg617 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '18'.'　　　　'.$row->mg618 ?></td>
		...
		<table class="store1"> <!-- 第12行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '21(1)'.'　　　　'.$row->mg621 ?></td>
			    <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '22(2)'.'　　　　'.$row->mg622 ?></td>
		...
		<table class="store1"> <!-- 第13行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="39%" align="left" ><?php echo '內含銷售25(7)'.'　　　　'.$row->mg625 ?><?php echo '元' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px ;height:14px;" width="4%" align="center" ><?php echo ''; ?></td>
		...
		<table class="store1"> <!-- 第14行 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="39%" align="left" ><?php echo '固定資產27'.'　　　　'.$row->mg627 ?><?php echo '元' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px ;height:14px;" width="4%" align="center" ><?php echo ''; ?></td>
		...
		<table class="store1"> <!-- 第3行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '28'.'　　　　'.$row->mg628 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '29'.'　　　　'.$row->mg629 ?></td>
		...
		<table class="store1"> <!-- 第5行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '30'.'　　　　'.$row->mg630 ?></td>
				<td style="border-left: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '31'.'　　　　'.$row->mg631 ?></td>
		...
		<table class="store1"> <!-- 第6行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '32'.'　　　　'.$row->mg632 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '33'.'　　　　'.$row->mg633 ?></td>
		...
		<table class="store1"> <!-- 第7行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '34'.'　　　　'.$row->mg634 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '35'.'　　　　'.$row->mg635 ?></td>
		...
		<table class="store1"> <!-- 第8行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '36'.'　　　　'.$row->mg636 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '37'.'　　　　'.$row->mg637 ?></td>
				 <td style="border-left: 1px solid #000000;border-top: 1px solid #000000;height:14px" width="22%" align="left" ><?php echo '附1.統一發票明細表　　　　'.$row->mg691 ?><?php echo '份' ?> </td>
		...
		<table class="store1"> <!-- 第9行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '固定資產' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '38'.'　　　　'.$row->mg638 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '39'.'　　　　'.$row->mg639 ?></td>
				 <td style="border-left: 1px solid #000000;height:14px" width="22%" align="left" ><?php echo '　2.進項憑證　　　　冊　　　　'.$row->mg692 ?><?php echo '份' ?></td>
				 <td style="border-left: 1px solid #000000;border-right: 1px solid #000000;height:14px" width="18%" align="center" ><?php echo ''.'' ?></td>
			</tr>
		</table >
		<table class="store1"> <!-- 第10行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '78'.'　　　　'.$row->mg678 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '79'.'　　　　'.$row->mg679 ?></td>
		...
		<table class="store1"> <!-- 第11行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '固定資產' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '80'.'　　　　'.$row->mg680 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '81'.'　　　　'.$row->mg681 ?></td>
		...
		<table class="store1"> <!-- 第12行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '40'.'　　　　'.$row->mg640 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '41'.'　　　　'.$row->mg641 ?></td>
		...
		<table class="store1"> <!-- 第13行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '固定資產' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '42'.'　　　　'.$row->mg642 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '43'.'　　　　'.$row->mg643 ?></td>
		...
		<table class="store1"> <!-- 第14行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;height:14px;" width="20%" align="center" ><?php echo '' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '44'.'　　　　'.$row->mg644 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '45(9)'.'　　　　'.$row->mg645 ?></td>
		...
		<table class="store1"> <!-- 第15行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '固定資產' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="13%" align="left" ><?php echo '46'.'　　　　'.$row->mg646 ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="12%" align="left" ><?php echo '47(10)'.'　　　　'.$row->mg647 ?></td>
		...
		<table class="store1"> <!-- 第16行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '進貨及費用' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="25%" align="left" ><?php echo '48'.'　　　　'.$row->mg648 ?><?php echo '元' ?></td>
		...
		<table class="store1"> <!-- 第17行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="10%" align="center" ><?php echo '固定資產' ?></td>
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="25%" align="left" ><?php echo '49'.'　　　　'.$row->mg649 ?><?php echo '元' ?> </td>
		...
		<table class="store1"> <!-- 第18行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="35%" align="left" ><?php echo '73'.'　　　　'.$row->mg673 ?><?php echo '元' ?></td>
		...
		<table class="store1"> <!-- 第19行進項 -->
			<tr>
				...
				<td style="border-left: 1px solid #000000;border-top: 1px solid #000000;border-bottom: 1px solid #000000;height:14px;" width="35%" align="left" ><?php echo '74'.'　　　　'.$row->mg674 ?><?php echo '元' ?></td>
