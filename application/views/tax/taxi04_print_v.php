...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 營業稅申報資料 - 列印明細表　　　</h1>
	...
	<button accesskey="p" tabIndex="5" type='submit'  name='submit' class="button"   target="_new" value='&nbsp;列印F8&nbsp;'><span>列 印Alt+k</span><img src="<?php echo base_url()?>assets/image/png/print.png" /></button>&nbsp;&nbsp;
		  ...
		  <button style= "cursor:pointer" form="commentForm" onfocus="$('#me001o').focus();" type='submit' accesskey="l" class="button" name='action' value='excel'>轉EXCEL檔Alt+l </span><img src="<?php echo base_url()?>assets/image/png/excel.png" /></button>&nbsp;&nbsp;
		  <?PHP } ?>
		  <a accesskey="x" tabIndex="6" id='cancel' name='cancel' href="<?php echo site_url('tax/taxi04/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	    
	</div>
	</div>
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/tax/taxi04/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	    <td class="normal14y" width="10%">起始申報公司：</td>           
		<td class="normal14a"  width="40%"><input tabIndex="1" id="me001o"  onKeyPress="keyFunction()"   name="me001o" value="<?php echo strtoupper($me001o); ?>" size="20" type="text" required />
		  <span id="me001dispo" ></span></td>
	    <td class="normal14y" width="10%">結束申報公司：</td>
	    <td class="normal14a"  width="40%"><input tabIndex="2" id="me001c"  onKeyPress="keyFunction()"   name="me001c" value="<?php echo strtoupper($me001c); ?>" size="20" type="text" required />
