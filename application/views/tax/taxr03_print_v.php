...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 統一發票明細表 - 列印明細表</h1>
    </div>
	
	<div class="content"> <!-- div-5 -->
	<form  class="cmxform" id="commentForm"  name="form" action="<?php echo base_url()?>index.php/tax/taxr03/printa"  method="post"  enctype="multipart/form-data" > 
	...
	<table class="form14">   <!-- 表格 -->
	  ...
	  <tr>
	   ...
	   <tr>
	    <td class="start14" >申報公司別：</td>
	    <td class="normal14" ><input tabIndex="3" id="cmsi11" onKeyPress="keyFunction()"  onchange="check_cmsi11(this);" name="cmsi11" value="<?php echo $cmsi11; ?>"  type="text"  />
	...
	<!--  <tr>
	    <td class="normal14" >發票種類：</td>
	    <td class="normal14" ><select id="tc001o" onKeyPress="keyFunction()" name="tc001o"  tabIndex="4">
            <option <?php if($tc001o == '1') echo 'selected="selected"';?> value='1'>1.二聯</option>                                                                        
		    <option <?php if($tc001o == '2') echo 'selected="selected"';?> value='2'>2.三聯</option>
			<option <?php if($tc001o == '3') echo 'selected="selected"';?> value='3'>3.二聯收銀機</option>                                                                        
		    <option <?php if($tc001o == '4') echo 'selected="selected"';?> value='4'>4.三聯收銀機</option>
		  </select></td>
	  </tr>	-->
	<!--  <tr>
	    <td class="normal14" >發票跳號：</td>
	    <td class="normal14" ><select id="tc002o" onKeyPress="keyFunction()" name="tc002o"  tabIndex="4">
            <option <?php if($tc002o == '1') echo 'selected="selected"';?> value='1'>1.作廢</option>                                                                        
		    <option <?php if($tc002o == '2') echo 'selected="selected"';?> value='2'>2.空白</option>
		  </select></td>
	  </tr>	-->
	  <tr>
	    <td class="start14" >起始發票號碼：</td>
	    <td class="normal14" ><input tabIndex="3" id="tc003o" onKeyPress="keyFunction()"   name="tc003o" value="<?php echo $tc003o; ?>"  type="text"  />
		</td>
	  </tr>
	  <tr>
	    <td class="start14" >截止發票號碼：</td>
	    <td class="normal14" ><input tabIndex="3" id="tc003c" onKeyPress="keyFunction()"   name="tc003c" value="<?php echo $tc003c; ?>"  type="text"  />
		</td>
	  </tr>
	   <tr>
	    ...
	    <div class="buttons">
	      ...
	      <a  accesskey="x" tabIndex="97" onKeyPress="keyFunction()"  id='cancel' name='cancel' href="<?php echo site_url('main/index/146'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	    </div>
