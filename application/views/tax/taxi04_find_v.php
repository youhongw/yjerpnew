...
<div id="content"> <!-- div-3 -->
 <div class="box"> <!-- div-4 -->
    <div class="heading">
      <h1><img src="<?php echo base_url()?>assets/image/order.png" alt="" /> 營業稅申報資料 - 設定查詢條件　　　</h1>
	  ...
	  <button style= "cursor:pointer" form="commentForm" onfocus="$('#find003').focus();" tabIndex="7" accesskey="k" type='submit'  name='submit'  class="button" value='查詢Alt+k'><span>查詢Alt+k</span><img src="<?php echo base_url()?>assets/image/png/find.png" /></button>&nbsp;&nbsp;
	    <a accesskey="x" tabIndex="8" id='cancel' name='cancel' href="<?php echo site_url('tax/taxi04/display'); ?>" class="button" ><span>返 回Alt+x</span><img src="<?php echo base_url()?>assets/image/png/cancle.png" /></a>
	  
	  </div>
	  <form  class="cmxform" id="commentForm"  name="form"  action="<?php echo base_url()?>index.php/tax/taxi04/findsql" method="post" enctype="multipart/form-data" >
    </div>
      ...
      <tr>
	    <td class="start14a" width="18">
	      <select name="find001" id="find001" tabIndex="1" >
            <option <?php if($find001 == '1') echo 'selected="selected"';?> value='me001'> me001 申報公司 </option>                                                                        
		    <option <?php if($find001 == '2') echo 'selected="selected"';?> value='me002'> me002 起始年月 </option>
            <option <?php if($find001 == '3') echo 'selected="selected"';?> value='me003'> me003 截止年月 </option>
            <option <?php if($find001 == '4') echo 'selected="selected"';?> value='me004'> me004 發票份數 </option>
		    <option <?php if($find001 == '7') echo 'selected="selected"';?> value='me007'> me007 退稅方式 </option>
		    <option <?php if($find001 == '8') echo 'selected="selected"';?> value='me008'> me008 銷售固定資產金額 </option>
		    <option <?php if($find001 == '9') echo 'selected="selected"';?> value='CREATE_DATE'> CREATE_DATE 建立日期 </option>
	      </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
	  <td class="start14" width="04">&nbsp;&nbsp;排序欄位：
	    <select name="find006" id="find006" " tabIndex="5" >
            <option <?php if($find006 == '1') echo 'selected="selected"';?> value='me001'> me001 申報公司 </option>                                                                       
		    <option <?php if($find006 == '2') echo 'selected="selected"';?> value='me002'> me002 起始年月 </option>
            <option <?php if($find006 == '3') echo 'selected="selected"';?> value='me003'> me003 截止年月 </option>
            <option <?php if($find006 == '4') echo 'selected="selected"';?> value='me004'> me004 發票份數 </option>
		    <option <?php if($find006 == '7') echo 'selected="selected"';?> value='me007'> me007 退稅方式 </option>
		    <option <?php if($find006 == '8') echo 'selected="selected"';?> value='me008'> me008 銷售固定資產金額 </option>
		    <option <?php if($find006 == '9') echo 'selected="selected"';?> value='CREATE_DATE'> CREATE_DATE 建立日期 </option>
	    </select>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script language="javascript">
   ...
   function OnBlur2()
    ...
    function OnBlur9()
     {
	url = '<?php echo base_url()?>index.php/tax/taxi04/findsql/' + find005.value +'/'+ find007.value ; 
        location = url;
     }
</script>